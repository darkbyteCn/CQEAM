...
<%@ page import="com.sino.soa.td.srv.assetretire.dto.TDSrvRetiredAssetDTO" %>
...
<% TDSrvRetiredAssetDTO dtoOpt= (TDSrvRetiredAssetDTO) request.getAttribute(QueryConstant.QUERY_DTO); 
...
<form action="/servlet/com.sino.soa.td.srv.assetretire.servlet.TDTransRetiredAssetDetailServlet" method="post" name="mainFrm">
