...
<%@ page import="com.sino.soa.mis.srv.assettransincompanysrv.dto.SBFIFAAssetsTransInCompanyDTO" %>
...
<%
	...
	SBFIFAAssetsTransInCompanyDTO dto = (SBFIFAAssetsTransInCompanyDTO)request.getAttribute(QueryConstant.QUERY_DTO);
	SfUserDTO userAccount = (SfUserDTO)SessionUtil.getUserAccount(request);
	Row row = null;
	String pageTitle = "公司内资产调拨同步";
%>
<body onkeydown="autoExeFunction('do_search()')" leftmargin="0" topmargin="0" onload="do_SetPageWidth()">
<%=WebConstant.WAIT_TIP_MSG%>
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.mis.srv.assettransincompanysrv.servlet.SBFIFAAssetsTransInCompanyServlet">
<jsp:include page="/message/MessageProcess"/>


<script type="text/javascript">
    printTitleBar("公司内资产调拨同步");
...
<table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF"  style="width:100%">
	<tr>
		...
		<td align="left" width="16%"><input type="text" name="newBarcode" value="<%=dto.getNewBarcode()%>" style="width:100%"></td>
		<td align="right" width="10%">地点代码：</td>
		<td align="left" width="16%"><input type="text" name="workorderObjectCode" value="<%=dto.getWorkorderObjectCode()%>" style="width:100%"></td>
	</tr>
	<tr>
		<td align="right" width="10%">调拨单号：</td>
		<td align="left" width="18%"><input type="text" name="transNo" value="<%=dto.getTransNo()%>" style="width:100%" size="20"></td>
		<td align="right" width="10%">资产描述：</td>
		<td align="left" width="16%"><input type="text" name="nameTo" value="<%=dto.getNameTo()%>" style="width:100%"></td>
		<td align="right" width="10%">地点位置：</td>
		<td align="left" width="16%"><input type="text" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>" style="width:100%"></td>
	</tr>
</table>
...
<script type="text/javascript">
	...
	function do_syschronize(){
	    ...
	    document.getElementById("$$$waitTipMsg$$$").style.visibility = "visible";
		document.mainFrm.action = "/servlet/com.sino.soa.mis.srv.assettransincompanysrv.servlet.SBFIFAAssetsTransInCompanyServlet";
