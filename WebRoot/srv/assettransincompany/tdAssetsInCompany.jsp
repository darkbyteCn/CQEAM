...
<%@ page import="com.sino.soa.td.srv.assettransincompanysrv.dto.SBFIFATdAssetsTransInCompanyDTO" %>
<%@ include file="/newasset/headerInclude.htm"%>

<html>
<head>
    <title>TD资产调拨结果同步</title>
...
<%
	...
	SBFIFATdAssetsTransInCompanyDTO dto = (SBFIFATdAssetsTransInCompanyDTO)request.getAttribute(QueryConstant.QUERY_DTO);
...
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.td.srv.assettransincompanysrv.servlet.SBFIFATdAssetsTransInCompanyServlet">
<jsp:include page="/message/MessageProcess"/>
<script type="text/javascript">
    printTitleBar("公司内TD资产调拨同步");    
...
<table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF"  style="width:100%">
	<tr>
		<td align="right" width="8%">调拨方式：</td>
		<td align="left" width="18%"><select name="transferType" style="width:100%"><%=dto.getTransferTypeOption()%></select></td>
		<td align="right" width="8%">资产标签：</td>
		<td align="left" width="18%"><input type="text" name="newBarcode" value="<%=dto.getNewBarcode()%>" style="width:100%"></td>
		<td align="right" width="8%">地点代码：</td>
		<td align="left" width="18%"><input type="text" name="workorderObjectCode" value="<%=dto.getWorkorderObjectCode()%>" style="width:100%"></td>
	</tr>
	<tr>
		<td align="right" width="8%">调拨单号：</td>
		<td align="left" width="18%">
			<input type="text" name="transNo" value="<%=dto.getTransNo()%>" style="width:100%" size="20"></td>
		<td align="right" width="8%">资产描述：</td>
		<td align="left" width="18%"><input type="text" name="nameTo" value="<%=dto.getNameTo()%>" style="width:100%"></td>
		<td align="right" width="8%">地点位置：</td>
		<td align="left" width="18%"><input type="text" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>" style="width:100%"></td>
	</tr>
</table>
...
<div id ="headDiv" style="position:absolute;width:100%;overflow:hidden;top:100px;padding:0px; margin:0px;">
 ...
 <div id="dataDiv" style="overflow:scroll;height:368px;width:100%;position:absolute;top:93px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
...
%>
        <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'" >
            ...
            <td width="5%"><input type="text" class="finput2" readonly value="<%=row.getValue("OLD_BARCODE")%>"></td>
            <td width="5%"><input type="text" class="finput2" readonly value="<%=row.getValue("NEW_BARCODE")%>"></td>
            ...
            <td width="8%"><input type="text" class="finput" readonly value="<%=row.getValue("NEW_ITEM_SPEC")%>"></td>
