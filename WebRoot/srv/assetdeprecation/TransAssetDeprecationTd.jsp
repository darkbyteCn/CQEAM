...
<%@ page import="com.sino.soa.td.srv.assetdeprecation.dto.SBFIFATdTransAssetDeprecationDTO" %>
...
<%
	SBFIFATdTransAssetDeprecationDTO dto = (SBFIFATdTransAssetDeprecationDTO)request.getAttribute(QueryConstant.QUERY_DTO);
	String pageTitle = "TD系统资产折旧信息(ODI)";
%>
<%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.td.srv.assetdeprecation.servlet.SBFIFATdTransAssetDeprecationServlet">
