...
<%@ page import="com.sino.soa.td.srv.transassetcustdetail.dto.SBFIFATdTransAssetCustDetailDTO" %>
...
<%
    SBFIFATdTransAssetCustDetailDTO dtoOpt = (SBFIFATdTransAssetCustDetailDTO) request.getAttribute(QueryConstant.QUERY_DTO);
    String pageTitle = "TD系统转资资产清单(ODI)";
%>
...
<form action="/servlet/com.sino.soa.td.srv.transassetcustdetail.servlet.SBFIFATdTransAssetCustDetailServlet" method="post"
      name="mainFrm">
