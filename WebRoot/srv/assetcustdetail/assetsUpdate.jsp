...
<%@ page import="com.sino.soa.mis.srv.assetsinfoupdate.dto.SrvEamSyschronizeDTO" %>
...
<%
    ...
    SrvEamSyschronizeDTO dto = (SrvEamSyschronizeDTO) request.getAttribute(WebAttrConstant.SYSCHRONIZE_DTO);
	RowSet rows = (RowSet) request.getAttribute(QueryConstant.SPLIT_DATA_VIEW);
    Row row = null;
%>
<body leftmargin="0" topmargin="0" onload="do_SetPageWidth();" onkeydown="autoExeFunction('do_search()');"> 
<%=WebConstant.WAIT_TIP_MSG%>
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.mis.srv.assetsinfoupdate.servlet.AssetsUpdateServlet">
<jsp:include page="/message/MessageProcess"/>
    <script type="text/javascript">
        printTitleBar("资产基本信息同步");
        var ArrAction0 = new Array(true, "查询", "action_view.gif", "查询", "do_search");
        var ArrAction1 = new Array(true, "同步", "cancel.gif", "同步", "do_syschronize");
    ...
    <table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF" style="width:100%">
        ...
        <tr>
            ...
            <td width="20%"><input style="width:80%" type="text" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>"><a href="#" onclick="chooseSit();" title="点击选择地点" class="linka">[…]</a></td>
    ...
    <div id="headDiv" style="position:absolute;width:870px;overflow:hidden;top:100px;padding:0px; margin:0px;">
        <table width="250%" class="headerTable" border="1" cellpadding="0" cellspacing="0">
            <tr height="22" onClick="executeClick(this)" style="cursor:hand">
				...
				<td width="6%" align="center">公司名称</td>
				<td width="4%" align="center">资产编号</td>
                <td width="5%" align="center">MIS条码</td>
                <td width="5%" align="center">EAM条码</td>

                <td width="8%" align="center">MIS名称</td>
                <td width="8%" align="center">EAM名称</td>
                <td width="8%" align="center">MIS型号</td>
                <td width="8%" align="center">EAM型号</td>
				<td width="6%" align="center">MIS厂商</td>
				<td width="6%" align="center">EAM厂商</td>
				
                <td width="4%" align="center">启用日期</td>
                <td width="4%" align="center">资产原值</td>
                <td width="4%" align="center">匹配人</td>
            </tr>
        </table>
    </div>

    <div id="dataDiv" style="overflow:scroll;height:368px;width:870px;position:absolute;top:93px;left:1px" align="left"
...
<div style="position:absolute;top:470px;left:0; right:20px"><%=StrUtil.nullToString(request.getAttribute(QueryConstant.SPLIT_PAGE_HTML))%>
</div>
</body>
...
function do_syschronize() {
	...
	document.getElementById("$$$waitTipMsg$$$").style.visibility = "visible";
	document.mainFrm.action = "/servlet/com.sino.soa.mis.srv.assetsinfoupdate.servlet.AssetsUpdateServlet";
