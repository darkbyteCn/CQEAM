...
<%@ page import="com.sino.soa.mis.srv.AssetPeriodStatus.dto.SrvAssetPeriodStatusDTO" %>
...
<body leftmargin="0" topmargin="0" onload="initPage();" onkeydown="autoExeFunction('query();')">
 <% SrvAssetPeriodStatusDTO periodStatusDTO=(SrvAssetPeriodStatusDTO)request.getAttribute(QueryConstant.QUERY_DTO);
...
<form action="<%=SrvURLDefineList.SRV_ASSET_PERIOD_SERVLET1 %>" method="post" name="mainFrm">
...
<%      SrvAssetPeriodStatusDTO dto=new SrvAssetPeriodStatusDTO();
		...
		for(int i=0;i<ds.getSize();i++){
		 dto=(SrvAssetPeriodStatusDTO)ds.getDTO(i);
