...
<%@ page import="com.sino.soa.td.srv.assetretire.dto.TDAssetRetirementDTO" %>
...
<%
	...
	TDAssetRetirementDTO dto = (TDAssetRetirementDTO)request.getAttribute(QueryConstant.QUERY_DTO);
...
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.td.srv.assetretire.servlet.TDImportAssetRetirmentServlet">
...
<table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF"  style="width:100%">
	<tr>
        ...
        <td align="left" width="23%"><select style="width:100%" name="organizationId"><%=orgOption%></select> </td>
        <td align="right" width="10%">资产标签：</td>
        <td align="left" width="23%"><input type="text" name="barcode" value="<%=dto.getBarcode()%>" style="width:100%"></td>
        <td align="right" width="10%">资产名称：</td>
        <td align="left" width="23%"><input type="text" name="itemname" value="<%=dto.getItemname()%>" style="width:100%"></td>
	</tr>
</table>
