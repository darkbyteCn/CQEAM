...
<%@ page import="com.sino.soa.mis.srv.transTaskInfo.dto.PageInquiryTaskinfoDTO" %>
...
<%
	PageInquiryTaskinfoDTO dto = (PageInquiryTaskinfoDTO)request.getAttribute(QueryConstant.QUERY_DTO);
	String assetsType = dto.getAssetsType();
	String pageTitle = "同步项目任务信息(分页)";
	
	if((AssetsWebAttributes.TD_ASSETS_TYPE).equals(assetsType)){
		pageTitle = "同步TD项目任务信息(分页)";
	}
%>
<%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.mis.srv.transTaskInfo.servlet.PageInquiryTaskinfoServlet">
