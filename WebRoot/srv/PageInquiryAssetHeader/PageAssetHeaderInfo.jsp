...
<%@ page import="com.sino.soa.mis.srv.PageInquiryAssetHeaderInfo.dto.InquiryAssetHeaderInfoSrvDTO" %>
...
<%
	InquiryAssetHeaderInfoSrvDTO dto = (InquiryAssetHeaderInfoSrvDTO)request.getAttribute(QueryConstant.QUERY_DTO);
	String assetsType = dto.getAssetsType();
	String pageTitle = "同步资产头基本信息(分页)";
	if((AssetsWebAttributes.TD_ASSETS_TYPE).equals(assetsType)){
		pageTitle = "同步TD资产头基本信息(分页)";
	}
%>
<%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<form name="mainFrm" action="<%=SrvURLDefineList.SRV_ASSET_HEADER_SERVLET%>"  method="post" >
    ...
    <table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF" style="width:100%">
        <tr>
            ...
            <td align="left" width="15%"><select name="bookTypeCode" class="noEmptyInput" id="bookTypeCode" ><%=dto.getOrgOption()%></select></td>
...
<script type="text/javascript">
	...
	*/
	function do_syschronize() {
		...
		document.getElementById("$$$waitTipMsg$$$").style.visibility = "visible";
		//document.mainFrm.action = "/servlet/com.sino.soa.mis.srv.assetsinfoupdate.servlet.TransAssetHeaderInfoServlet";
