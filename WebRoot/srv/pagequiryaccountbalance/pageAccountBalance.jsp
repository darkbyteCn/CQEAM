...
<%@ page import="com.sino.soa.mis.srv.pagequiryaccountbalance.dto.SBFIGLPageQuiryAccountBalanceDTO" %>
...
<%
    SBFIGLPageQuiryAccountBalanceDTO dtoOpt= (SBFIGLPageQuiryAccountBalanceDTO) request.getAttribute(QueryConstant.QUERY_DTO);
	String pageTitle = "MIS系统科目余额(分页)";
%>
 <%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<body leftmargin="0" topmargin="0" onload="do_SetPageWidth();" onkeydown="autoExeFunction('query();')">
<form action="/servlet/com.sino.soa.mis.srv.pagequiryaccountbalance.servlet.SBFIGLPageQuiryAccountBalanceServlet" method="post" name="mainFrm">
