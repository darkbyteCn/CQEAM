...
<%@ page import="com.sino.soa.td.srv.assetbook.dto.SBFIFATdAssetBookDTO" %>
...
<%	SBFIFATdAssetBookDTO dtoOpt = (SBFIFATdAssetBookDTO) request.getAttribute(QueryConstant.QUERY_DTO);
	String pageTitle = "TD系统资产账簿";
%>
 <%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<body leftmargin="0" topmargin="0"  onload="initPage();" onkeydown="autoExeFunction('query();')" >

<form action="<%=SrvURLDefineList.TD_SRV_ESSET_BOOK_SERVLET %>" method="post" name="mainFrm">
...
<%      SBFIFATdAssetBookDTO dto=new SBFIFATdAssetBookDTO();

		for(int i=0;i<ds.getSize();i++){
		 dto=(SBFIFATdAssetBookDTO)ds.getDTO(i);
