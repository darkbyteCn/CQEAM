...
<%@ page import="com.sino.soa.td.srv.valueinfo.dto.SBSYSYTdInquiryVSetValueInfoDTO" %>
...
<%
	SBSYSYTdInquiryVSetValueInfoDTO dto = (SBSYSYTdInquiryVSetValueInfoDTO)request.getAttribute(QueryConstant.QUERY_DTO);
	String pageTitle = "TD系统值集";
%>
<%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<form name="mainFrm" method="post"  action="/servlet/com.sino.soa.td.srv.valueinfo.servlet.SBSYSYTdInquiryVSetValueInfoServlet">
...
<script type="text/javascript">
	...
	*/
	function do_syschronize() {
		...
		document.getElementById("$$$waitTipMsg$$$").style.visibility = "visible";
		mainFrm.action = "/servlet/com.sino.soa.td.srv.valueinfo.servlet.SBSYSYTdInquiryVSetValueInfoServlet";
