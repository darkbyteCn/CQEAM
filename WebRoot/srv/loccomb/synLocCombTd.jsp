...
User: wangzhipeng
Date: 2011-09-15-11 
Function:地点信息同步_TD(SOA)
--%>
<%@ page contentType="text/html;charset=GBK" language="java" %>
<%@ page import="com.sino.ams.constant.WebAttrConstant" %>
<%@ page import="com.sino.soa.td.srv.assetLocComb.dto.TDSrvAssetLocCombDTO" %>
...
<html>
<head>
    <title>EAM资产地点同步_TD</title>
    <script type="text/javascript" src="/WebLibary/js/AppStandard.js"></script>
</head>
<%
    RowSet rows = (RowSet) request.getAttribute(QueryConstant.SPLIT_DATA_VIEW);
    TDSrvAssetLocCombDTO dto = (TDSrvAssetLocCombDTO) request.getAttribute(WebAttrConstant.SYSCHRONIZE_DTO);
    Row row = null;
%>
<body leftmargin="0" topmargin="0" onkeydown="autoExeFunction('do_search()');" onload="do_SetPageWidth();">
<%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<form name="mainFrm" method="post" action="<%=SrvURLDefineList.TD_SRV_ASSET_LOC_COMB_SERVLET%>">
    <script type="text/javascript">
        printTitleBar("地点变动同步(TD)");
    ...
    <table width="100%" border="0" bgcolor="#EFEFEF" style="width:100%">
        <tr>
            ...
            <td align="left" width="23%"><input type="text" name="workorderObjectCode" value="<%=dto.getWorkorderObjectCode()%>" style="width:80%"></td>
            <td align="right" width="10%">地点描述：</td>
            <td align="left" width="23%"><input type="text" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>" style="width:80%"></td>
        </tr>
        <tr>
    ...
    <div id="headDiv" style="position:absolute;width:841px;overflow:hidden;top:98px;padding:0px; margin:0px;">
    ...
    <div id="dataDiv" style="overflow:scroll;height:72%;width:847px;position:absolute;top:90px;left:0px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
...
<script type="text/javascript">
    ...
    function do_syschronize() {
        ...
        document.getElementById("$$$waitTipMsg$$$").style.visibility = "visible";
        document.mainFrm.action = "/servlet/com.sino.soa.td.srv.assetLocComb.servlet.TDSrvAssetLocCombServlet";
