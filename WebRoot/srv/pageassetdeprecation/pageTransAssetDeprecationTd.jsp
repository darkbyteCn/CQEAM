...
<%@ page import="com.sino.soa.td.srv.pagequiryassetdeprecation.dto.SBFIFATdPageQuiryAssetDeprecationDTO" %>
...
<%
    SBFIFATdPageQuiryAssetDeprecationDTO dtoOpt= (SBFIFATdPageQuiryAssetDeprecationDTO) request.getAttribute(QueryConstant.QUERY_DTO);
	String pageTitle = "TD系统资产折旧信息(分页)";
%>
 <%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<body leftmargin="0" topmargin="0" onload="do_SetPageWidth();" onkeydown="autoExeFunction('query();')">
<form action="/servlet/com.sino.soa.td.srv.pagequiryassetdeprecation.servlet.SBFIFATdPageQuiryAssetDeprecationServlet" method="post" name="mainFrm">
