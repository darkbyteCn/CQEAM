    ...
    <table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF" style="width:100%">
        <tr>
            ...
            <td align="left" width="20%">
                <input type="text" name="startLastUpdateDate" value="<%=dto.getStartLastUpdateDate()%>" id="startLastUpdateDate" class="noEmptyInput" title="点击选择更新开始日期" readonly class="readonlyInput" style="width:90%"><img src="/images/calendar.gif" alt="点击选择日期" onclick="gfPop.fStartPop(startLastUpdateDate, endLastUpdateDate);">
            </td>
            <td align="right" width="10%">更新结束日期：</td>
            <td align="left" width="20%">
                <input type="text" name="endLastUpdateDate" value="<%=dto.getEndLastUpdateDate()%>" id="endLastUpdateDate" class="noEmptyInput" title="点击选择更新结束日期" readonly class="readonlyInput" style="width:90%"><img src="/images/calendar.gif" alt="点击选择日期" onclick="gfPop.fEndPop(startLastUpdateDate, endLastUpdateDate);">
            </td>
