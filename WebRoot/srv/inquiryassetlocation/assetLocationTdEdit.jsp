...
<%@ page import="com.sino.soa.td.srv.inquiryassetlocation.dto.TdSrvAssetLocationDTO" %>
...
<%
	TdSrvAssetLocationDTO dtoOpt = (TdSrvAssetLocationDTO)request.getAttribute(QueryConstant.QUERY_DTO);
...
<form action="<%=SrvURLDefineList.TD_SRV_ASSET_LOCATION_SERVLET1 %>" method="post" name="mainFrm">
