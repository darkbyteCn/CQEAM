...
<%@ page import="com.sino.soa.td.srv.vendor.dto.TdSrvVendorInfoDTO" %>
...
<%
	TdSrvVendorInfoDTO dtoOpt = (TdSrvVendorInfoDTO)request.getAttribute(QueryConstant.QUERY_DTO);
...
<form action="<%=SrvURLDefineList.TD_SRV_VENDOR_INFO_SERVLET1 %>" method="post" name="mainFrm">
...
<%      TdSrvVendorInfoDTO dto=new TdSrvVendorInfoDTO();

		for(int i=0;i<ds.getSize();i++){
		 dto=(TdSrvVendorInfoDTO)ds.getDTO(i);
