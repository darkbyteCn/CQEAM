...
<%@ page import="com.sino.soa.td.srv.projectInfo.dto.TDSrvProjectInfoDTO" %>
...
<%
	TDSrvProjectInfoDTO dto = (TDSrvProjectInfoDTO)request.getAttribute(QueryConstant.QUERY_DTO);
...
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.td.srv.projectInfo.servlet.TDSrvProjectInfoServlet">
