...
<%@ page import="com.sino.soa.mis.srv.assetcategory.dto.SBFIFASrvAssetCategoryDTO" %>
...
<% SBFIFASrvAssetCategoryDTO dtoOpt= (SBFIFASrvAssetCategoryDTO) request.getAttribute(QueryConstant.QUERY_DTO);
	String pageTitle = "MIS系统资产类别";
%>
 <%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<body leftmargin="0" topmargin="0" onload="do_SetPageWidth();" onkeydown="autoExeFunction('query();')">
<form action="<%=SrvURLDefineList.SRV_ESSET_CATEGORY_SERVLET %>" method="post" name="mainFrm">
