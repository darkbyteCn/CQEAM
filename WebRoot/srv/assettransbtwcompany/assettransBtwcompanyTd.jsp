...
<%@ page import="com.sino.soa.td.srv.assettransbtwcompanysrv.dto.SBFIFATdAssetsTransBtwCompanyDTO" %>
<%@ include file="/newasset/headerInclude.htm"%>

<html>
<head>
    <title>公司间资产调拨同步(TD)</title>
...
<%
	...
	SBFIFATdAssetsTransBtwCompanyDTO dto = (SBFIFATdAssetsTransBtwCompanyDTO)request.getAttribute(QueryConstant.QUERY_DTO);
	SfUserDTO userAccount = (SfUserDTO)SessionUtil.getUserAccount(request);
	Row row = null;
%>
<body onkeydown="autoExeFunction('do_search()')" leftmargin="0" topmargin="0" onload="do_SetPageWidth()">
<%=WebConstant.WAIT_TIP_MSG%>
<form name="mainFrm" method="post" action="/servlet/com.sino.soa.td.srv.assettransbtwcompanysrv.servlet.SBFIFATdAssetsTransBtwCompanyServlet">
<jsp:include page="/message/MessageProcess"/>

<script type="text/javascript">
    printTitleBar("公司间资产调拨同步(TD)");
...
<table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF"  style="width:100%">
	<tr>
		...
		<td align="left" width="15%"><input type="text" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>" style="width:100%"></td>
	</tr>
</table>


<div id ="headDiv" style="position:absolute;width:841px;overflow:hidden;top:75px;padding:0px; margin:0px;">
...
<script type="text/javascript">
	...
	function do_syschronize(){
	    ...
	    document.getElementById("$$$waitTipMsg$$$").style.visibility = "visible";
		document.mainFrm.action = "/servlet/com.sino.soa.td.srv.assettransbtwcompanysrv.servlet.SBFIFATdAssetsTransBtwCompanyServlet";
