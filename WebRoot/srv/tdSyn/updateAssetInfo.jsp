...
<form name="mainFrm" method="post" action="/servlet/srv.tdams.synAssets.servlet.TDUpdateAssetRetirmentServlet">
<jsp:include page="/message/MessageProcess"/>
    ...
    <table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF" style="width:100%">
        <tr>
            ...
            <td align="left" width="12%"><select name="organizationId" style="width:100%"><%=dto.getOrganizationOpt()%></select></td>
        ...
        <tr>
            ...
            <td align="left" width="12%" colspan="3"><input style="width:90%" type="text" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>"><a href="#" onclick="chooseSit();" title="点击选择地点" class="linka">[…]</a></td>
            <td align="right" width="8%">资产类别：</td>
            <td align="left" width="12%">
                <select  name="netManger" style="width:100%">
                    <option>请选择
            ...
            <td width="5%" align="left" valign="top"><img src="/images/button/synchronize.gif" style="cursor:'hand'" onclick="do_syschronize();" alt="同步"></td>
        </tr>
    </table>

    <div id="headDiv" style="position:absolute;width:870px;overflow:hidden;top:70px;padding:0px; margin:0px;">
