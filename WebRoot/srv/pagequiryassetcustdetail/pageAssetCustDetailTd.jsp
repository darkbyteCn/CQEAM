...
<%@ page import="com.sino.soa.td.srv.pagequiryassetcustdetail.dto.SBFIFATdPageinquiryAssetCustDetailDTO" %>
...
<%
    SBFIFATdPageinquiryAssetCustDetailDTO dtoOpt= (SBFIFATdPageinquiryAssetCustDetailDTO) request.getAttribute(QueryConstant.QUERY_DTO);
	String pageTitle = "TD系统转资资产清单(分页)";
...
<form action="/servlet/com.sino.soa.td.srv.pagequiryassetcustdetail.servlet.SBFIFATdPageinquiryAssetCustDetailServlet" method="post" name="mainFrm">
...
<script type="text/javascript">
    ...
    function do_show(id) {
        ...
        var url = "/servlet/com.sino.soa.td.srv.pagequiryassetcustdetail.servlet.SBFIFATdPageinquiryAssetCustDetailServlet?act=DETAIL_ACTION";
