...
<html>
  ...
  <body text="000000" bgcolor="ffffff" leftmargin="0" topmargin="0" class="STYLE1" onload="window.focus();">
	...
	<form action="" name="mainFrm" method="post">
		...
		<table width="100%" border="0" style="position:absolute;top:20px">
			<tr>
                ...
                <input type="text" name="workorderObjectName" size="40" class="noemptyInput" style="width:92%"
                       value="" readonly="readonly">&nbsp;&nbsp;<a href="#" title="点击选择仓库" class="linka" onclick="do_SelectStore();">[…]</a>
            	</td>
			...
			<tr>
                ...
                <input type="text" name="userName" size="40" class="noemptyInput" style="width:92%"
                       value="" readonly="readonly">&nbsp;&nbsp;<a href="#" title="点击选择仓管员" class="linka" onclick="do_SelectStoreman();">[…]</a>
            	</td>
            	<td width=" " align="left" height="22"></td>
			</tr>
			<tr>
                ...
                <input type="text" name="createdUser" size="40" class="noemptyInput" style="width:92%"
                       value="" readonly="readonly">&nbsp;&nbsp;<a href="#" title="点击选择创建人" class="linka" onclick="do_SelectCreatedUser();">[…]</a>
            	</td>
            	<td width=" " align="left" height="22"></td>
			</tr>
		...
		<input type="hidden" name="workorderObjectNo" id="workorderObjectNo" value="">
...
function do_submit() {
    var fieldNames = "workorderObjectName;invCategoryName;bizCategoryName;userName;createdUser";
    var fieldLabels = "仓库名称;仓库类别;业务类型;仓管员;创建人";
    /*
...
function do_SelectCreatedUser(){
	...
	*/
	...
	var  url="/servlet/com.sino.ams.inv.storeman.bean.AMSInvLookUpServlet?lookUpName=<%=LookUpInvConstant.LOOK_UP_CREATED_USER%>";
    var popscript = "dialogWidth:47.5;dialogHeight:30;center:yes;status:no;scrollbars:no";
    var vendorNames = window.showModalDialog(url, null, popscript);
    if(vendorNames){
       var vendorName = null;
