		...
		<table width="100%" border="0" class="queryHeadBg">
			<tr>
				...
				<td align="right" width="26%">
					<img src="/images/eam_images/search.jpg" style="cursor: 'hand'" alt="查询" onclick="do_search();">
					<img src="/images/eam_images/new.jpg" style="cursor: 'hand'" alt="新增" onclick="do_add();">
					<img src="/images/eam_images/batch_update.jpg" style="cursor: 'hand'" alt="批量设置仓管员" onclick="do_BatchSet();">
				</td>
			</tr>
		</table>
...
function do_BatchSet(){
	...
	for(var i=0; i<storemanIds.length; i++){
		if(storemanIds[i].checked){
			//alert("第" + i + "个值：" + storemanIds[i].value);
