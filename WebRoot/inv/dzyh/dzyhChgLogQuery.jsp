...
<form method="post" name="mainFrm">
    ...
    <table width = "100%" border = "0" class = "queryHeadBg">
        <tr>
            ...
            <input type="text" name="barcode" value="<%=dto.getWorkorderObjectName() %>" size="13"><a href="#" title="点击选择条码" class="linka" onclick="do_SelectBarcode();">[…]</a>
			</td>
         ...
         <tr>
            ...
            <td width = "16%" align="right">
            	<input type="text" name="userName" value="<%=dto.getUserName()%>" size="13"><a href="#" title="点击选择领用人" class="linka" onclick="do_SelectUser();">[…]</a>
