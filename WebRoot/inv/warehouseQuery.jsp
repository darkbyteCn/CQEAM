...
%>
<form method="post" name="mainFrm" action="/servlet/com.sino.ams.inv.common.servlet.EtsObjectServlet">
        ...
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'"
                ...
                <td width="10%" align="left"
                    onclick="show_detail('<%=row.getValue("WORKORDER_OBJECT_NO")%>')"><%=row.getValue("VALUE")%>
                </td>
...
function show_detail(workorderObjectNo) {
    var url = "/servlet/com.sino.ams.inv.common.servlet.EtsObjectServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&workorderObjectNo=" + workorderObjectNo;
...
function do_add() {
    var url = "/servlet/com.sino.ams.inv.common.servlet.EtsObjectServlet?act=<%=WebActionConstant.NEW_ACTION%>";
    var popscript = 'width=400,height=200,top=200,left=300,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=yes';
    window.open(url, 'basePot', popscript);
}
var hasEqp = true;
