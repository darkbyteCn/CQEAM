...
<form method="post" name="mainFrm">
    ...
    <table width="100%" border="0" class="queryHeadBg">
            <input type="hidden" name="matchType" value="12">
        <tr>
        ...
        <table width="100%" align="left" border="1" cellpadding="2" cellspacing="0" class="headerTable">
            ...
            <tr>
               ...
               <td height="22" width="15%" align="center">条码</td>
                <td height="22" width="15%" align="center">设备名称</td>
    ...
    <div style="overflow-y:scroll;height:362px;width:100%;left:1px;margin-left:0px"
        ...
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr class="dataTR" onClick="executeClick(this)">
                <td width="2%" align="center"><input type="checkbox" name="systemId" id="systemId0" value="<%=row.getStrValue("SYSTEM_ID")%>;<%=i%>">
                ...
                <td style="word-wrap:break-word" height="22" width="14%"
                    align="center"><%=row.getValue("START_DATE")%>
                </td>
            </tr>
            <%
                    }
...
<script type="text/javascript">
    function do_search() {
        ...
        mainFrm.action = "/servlet/com.sino.ams.match.servlet.AmsRentAssetServlet?matchType=<%=12%>";
        mainFrm.submit();
    }
    function do_match() {
