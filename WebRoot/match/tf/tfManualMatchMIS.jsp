...
<form action="/servlet/com.sino.ams.match.servlet.TFManualMatchMIS" name="mainForm" method="post">
...
%>
        ...
        <tr>
            ...
            <td width="49%" colspan="2">
				<input class="input_style1" readonly type="text" name="assetsLocation" value="<%=dto.getAssetsLocation()%>" style="width:80%" class="blueBorder"><a href="#" onClick="do_selectAssetsLocation();" title="点击选择地点"  class="linka">[…]</a>
            </td>
...
%>
            <tr onclick="executeClick(this);" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
                <td height="22" width="2%" align="center">
                	<!-- 
                	<input type="radio" name="assetId" value="<%//=row.getValue("ASSET_ID")%>;<%//=row.getValue("NO_MATCH_UNITS")%>">
                	 -->
                	<input type="radio" name="assetId" value="<%=row.getValue("ASSET_ID")%>">
                </td>
