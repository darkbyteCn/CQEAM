...
<%@ page import="com.sino.ams.match.dto.TfAmsMactPropertyDTO" %>
<%@ include file="/match/prematch/headerInclude.htm"%>

<html>
<head>
    <title>已匹配通服资产清单</title>
</head>
<body onkeydown="autoExeFunction('do_search()')" onload="do_SetPageWidth();">

<%=WebConstant.WAIT_TIP_MSG%>
<%
	TfAmsMactPropertyDTO dto = (TfAmsMactPropertyDTO) request.getAttribute(QueryConstant.QUERY_DTO);
%>
<form method="post" name="mainFrm"  action="/servlet/com.sino.ams.match.servlet.TfAmsMactPropertyServlet" >
<script type="text/javascript">
    printTitleBar("已匹配通服资产清单")
</script>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:70px;left:1px;width:830px">
	<table class="headerTable" border="1" width="300%">
		<tr height="22px">
			...
			<td align="center" width="4%">金蝶标签号</td>
...
function chooseSit() {
	var lookUpName = "<%=LookUpConstant.LOOK_UP_TF_ASSETS_OBJECT%>";
