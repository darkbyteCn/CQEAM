...
<%
    ...
    String startDate = StrUtil.nullToString(reqParser.getParameter("startDate"));
    String endDate = StrUtil.nullToString(reqParser.getParameter("endDate"));
...
<table border="0" width="100%" class="queryTable">
    <tr>
        ...
        <td align="left" width="22%"><input class="input_style1" name="tagNumber" style="width:83%" type="text" value="<%=tagNumber%>"></td>
        <td align="right" width="8%">EAM标签号：</td>
        <td align="left" width="22%"><input class="input_style1" name="barcode" style="width:100%" type="text" value="<%=barcode%>"></td>
        <%-- 
        <td align="right" width="8%">匹配方式：</td>
        <td align="left" width="10%">
            <select class="select_style1" name=unyokeFlag style="width:100%">
    ...
    <tr>
        ...
        <td width="22%" align="left"><input class="input_style1" type=text name=itemSpec style="width:83%" value="<%=itemSpec%>"><input name=item_code type=hidden><a href=# title="点击选择名称型号" class="linka" onclick="do_SelectSpec();">[…]</a></td>
    ...
    <tr>
    	<td width="8%" align="right">匹配时间：</td>
    	<td width="22%" align="left">
				<input type="text" name="startDate" value="<%=startDate%>" class="input_style1" style="width:80%" title="点击选择日期" readonly class="readonlyInput" onclick="gfPop.fStartPop(startDate, endDate)"><img src="/images/calendar.gif" alt="点击查询" onclick="gfPop.fStartPop(startDate, endDate);">
        </td>
        <td width="8%" align="right">
        	到：
        </td>
        <td width="22%" align="left">
        	<input type="text" name="endDate" value="<%=endDate%>" class="input_style1" style="width:80%" title="点击选择日期" readonly class="readonlyInput" onclick="gfPop.fEndPop(startDate, endDate)"><img src="/images/calendar.gif" alt="点击查询" onclick="gfPop.fEndPop(startDate, endDate);">
        </td>
...
<div id="aa" style="overflow-y:scroll;overflow-x:hidden;position:absolute;top:95px;left:0px;width:100%" class="crystalScroll">
    <table class="eamHeaderTable" border="1" width="200%">
        ...
        <tr onClick="executeClick(this)" style="cursor:hand" title="点击全选或取消全选">
            ...
            <td height="22" width="6%" align="center">EAM条码</td>
            <td height="22" width="6%" align="center">MIS条码</td>
            <td height="22" width="10%" align="center">设备名称</td>
            <td height="22" width="8%" align="center">规格型号</td>
            ...
            <td height="22" width="4%" align="center">新资产类型</td>
...
<div style="overflow:scroll;height:68%;width:100%;position:absolute;top:118px;left:0px" align="left"
    ...
    <table width="200%" border="1" bordercolor="#666666">
        ...
        <tr class="dataTR" onClick="executeClick(this)">
			...
			<td style="word-wrap:break-word" height="22" width="4%"
                align="center"><%=row.getValue("NEW_FINANCE_PROP")%>
...
<div style="position:absolute;top:95%;left:0; right:20"><%=StrUtil.nullToString(request.getAttribute(QueryConstant.SPLIT_PAGE_HTML))%>
</div>
