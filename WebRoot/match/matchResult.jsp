...
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.match.servlet.MatchResultServlet">
    <script type="text/javascript">
        printTitleBar("匹配监控报表")
    </script>
    <table width="100%">
        <tr>
    ...
    <div id="headDiv" style="overflow:hidden;position:absolute;top:45px;left:1px;width:840px">
        <table class="headerTable" border="1" width="100%">
            <tr height="22">
                ...
                <td width="12%" align="center">已匹配资产百分比</td>
                <td width="12%" align="center">已同步资产百分比</td>
            </tr>
        </table>
    </div>
    <div id="dataDiv" style="overflow:scroll;height:300px;width:857px;position:absolute;top:68px;left:1px" align="left"
        ...
        <table id="dataTable" width="100%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
                ...
                <td width="10%" align="right"><%=row.getValue("SYN_COUNT")%></td>
                <td width="10%" align="right"><%=row.getValue("NO_SYN_COUNT")%></td>
                <td width="12%" align="right"><%=row.getValue("MATCH_RATE")%></td>
                <td width="12%" align="right"><%=row.getStrValue("SYN_RATE")%></td>
            </tr>
            <%
                    }
                }
...
<div style="position:absolute;top:400px;left:0; right:20px"><%=StrUtil.nullToString(request.getAttribute(QueryConstant.SPLIT_PAGE_HTML))%>
</div>
</body>
