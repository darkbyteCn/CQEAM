...
<form action="/servlet/com.sino.ams.match.servlet.AmsNoMactingAssetServlet" name="mainFrm" method="post">
    <script type="text/javascript">
    printTitleBar("未匹配资产清单")
</script>
    ...
    <table width="100%" border="0">
        ...
        <tr>
            ...
            <td width="26%"><input  class="input_style1" style="width:85%"  name="costCenterName" value = "<%=dto.getCostCenterName()%>"><a href="#" onclick= "do_SelectCostCenter();" class= "linka">[…]</a></td>
...
%>
		<tr class="dataTR" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
			...
			<td  width="6%"><input type="text" class="finput" readonly value="<%=row.getValue("COST_CENTER_NAME")%>"></td>
