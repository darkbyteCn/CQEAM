...
<%@ page import="com.sino.ams.match.dto.EtsItemMatchMisDTO" %>
...
<%
    EtsItemMatchMisDTO dto = (EtsItemMatchMisDTO) request.getAttribute(QueryConstant.QUERY_DTO);
%>
<body onkeydown="autoExeFunction('do_search()')" onload="do_SetPageWidth();">
<%=WebConstant.WAIT_TIP_MSG%>
<form method="post" name="mainFrm" action="/servlet/com.sino.ams.match.servlet.EtsItemMatchMisServlet">
    <script type="text/javascript">
        printTitleBar("已屏蔽的EAM设备清单");
    </script>
<table width="100%" border="0">
	<tr>
		<td width="13%" align="right">设备名称：</td>
		<td width="17%"><input class="input_style1" style="width:100%" type="text" name="itemName" value="<%=dto.getItemName()%>"></td>
		<td width="13%" align="right">设备型号：</td>
		<td width="17%"><input class="input_style1" style="width:85%" type="text" name="itemSpec" value="<%=dto.getItemSpec()%>"></td>
		<td width="20%" align="right"><img src="/images/eam_images/export.jpg" style="cursor:'hand'" onclick="do_Export();" alt="导出到Excel"></td>
	 </tr>
	 <tr>
		<td width="13%" align="right">标签号：</td>
		<td width="17%"><input class="input_style1" style="width:100%" type="text" name="barcode" value="<%=dto.getBarcode()%>"></td>
		<td width="13%" align="right">成本中心：</td>
		<td width="17%"><input class="input_style1" style="width:85%" type="text" name="costCenterName" value="<%=dto.getCostCenterName()%>"><a href="#" onClick="do_SelectCostCenter(); " class="linka">[…]</a></td>
		<td width="20%" align="right"><img src="/images/eam_images/search.jpg" style="cursor:'hand'" onclick="do_search();" alt="查询"></td>
	</tr>
</table>
