...
<head>
    ...
    <% 
    	...
    	if ("Y".equalsIgnoreCase(user.getIsTd())) { 
    		...
    		titleText="EAM-MIS人工匹配";
    		titleBar="EAM-MIS人工匹配";
    	}
    %>	
...
<iframe name='amsInfo' src='/servlet/com.sino.ams.match.servlet.ManualMatchAMS' height='93%' width='50%' scrolling="no" frameborder="1"></iframe>
<iframe name='misInfo' src='/servlet/com.sino.ams.match.servlet.ManualMatchMIS' height='93%' width='50%' scrolling="no" frameborder="1"></iframe>
