...
<form name="mainForm" action="/servlet/com.sino.ams.match.amsMisLocMatch.servlet.amsMisLocMatchServlet?act=<%=WebActionConstant.QUERY_ACTION%>" method="post">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="0" class="queryHeadBg">
        ...
        <input type="hidden" name="organizationId" value="">
                    ...
                    <tr>
                        <td align="center" width="45%">地点编号：<input style="width:60%" type="text" name="workorderObjectCode" value="<%=workorderObjectCode%>">
                        </td>
                        <td align="center" width="45%">所在地点：<input style="width:60%" type="text" name="EAMworkObjectLocation" value="<%=EAMworkObjectLocation%>">
                        </td>
    ...
    <script type="text/javascript">
        var columnArr = new Array("", "地点编号", "所在地点");
