...
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.match.amselementmatch.servlet.AmsElementMatchServlet">
    ...
    <table border="0" width="100%"  id="table1">
    	<input type = "hidden" name = "accessType" value = "lne">
    <tr>
    ...
    <tr>
    	<td width="8%" align="right">逻辑网络元素：</td>
        <td width="10%">
        	<input type="text" name="logNetEle" class="input_style1" style="width:100%" value="<%=aemDTO.getLogNetEle()%>">
        </td>  
    	<td width="8%" align="right">网络专业1：</td>
        <td width="10%"><input class="input_style1" style="width:100%" type="text" name="netCategory1" value="<%=aemDTO.getNetCategory1() %>"></td>
        <td width="8%" align="right">网络专业2：</td>
        <td width="10%"><input class="input_style1" style="width:100%" type="text" name="netCategory2" value="<%=aemDTO.getNetCategory2() %>"></td>
         <td width = "12%" >
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:73px;left:1px;width:838px">
	<table class="headerTable" border="1" width="100%">
	    <tr height=20px onClick="executeClick(this)" style="cursor:hand" title="点击全选或取消全选">
	        ...
	        <td align=center width="8%">网元编码</td>
	        <td align=center width="10%">逻辑网络元素</td>
	        <td align=center width="10%">网络专业1</td>
	        <td align=center width="10%">网络专业2</td>
		</tr>
    </table>
</div>
  ...
  <form  name="mainFrm1" method="post" action="/servlet/com.sino.ams.match.amselementmatch.servlet.AmsElementMatchServlet">
	...
	%>
		<tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
			...
			<td align=center width="8%"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: center" readonly value="<%=row.getValue("NET_UNIT_CODE")%>"></td>
			<td align=center width="10%"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: center" readonly value="<%=row.getValue("LOG_NET_ELE")%>"></td>
			<td align=center width="10%"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: center" readonly value="<%=row.getValue("NET_CATEGORY1")%>"></td>
			<td align=center width="10%"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: center" readonly value="<%=row.getValue("NET_CATEGORY2")%>"></td>
		</tr>
	<%
			    }
		}
