...
%>
<form method="post" name="mainFrm" action="/servlet/com.sino.ams.system.specialty.servlet.OtLocsVindicateServlet">
...
<table width="100%" border="0" >
        <tr>
            ...
            <img src="/images/eam_images/disable.jpg" style="cursor:'hand'" onclick="do_disabled();" alt="批量失效">
<div style="left:1px;width:100%;overflow-y:scroll" class="crystalScroll">
    <table width="100%" class="headerTable" border="1">
        <tr height="22">
            ...
            <td width="8%" align="center">地点编号</td>
            <td width="25%" align="center">地点简称</td>
...
<div style="overflow-y:scroll;width:100%;height:362px">
...
%>
        <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
            <td width="2%" align="center"><input type="checkbox" name="workorderObjectNos" value="<%=row.getValue("WORKORDER_OBJECT_NO")%>"></td>
...
%>
<div style="position:absolute;top:461px;left:0; right:20"><%=StrUtil.nullToString(request.getAttribute(QueryConstant.SPLIT_PAGE_HTML))%></div>
...
function show_detail(workorderObjectNo) {
    ...
    mainFrm.action = "/servlet/com.sino.ams.system.specialty.servlet.OtLocsVindicateServlet?&workorderObjectNo="+workorderObjectNo +"&categoryName="+mainFrm.categoryName.value;
    mainFrm.submit();
}
