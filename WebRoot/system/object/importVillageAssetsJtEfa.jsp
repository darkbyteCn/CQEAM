...
<form name="mainFrm" action="/servlet/com.sino.ams.system.object.servlet.ImportVillageAssetsServletJtEfa?act=UPLOAD_ACTION" method="post" enctype="multipart/form-data">
    <input type="hidden" name="flag" value="0">
    <input type="hidden" name="act">
    <script type="text/javascript">
        printTitleBar("Excel通服资产导入更新")
    </script>
    ...
    <table border = "0" width="100%">
        ...
        <tr>
            ...
            <a href="/document/template/VillageImportingJtEfa.zip"  style="cursor:pointer;text-decoration:underline;color:blue"><FONT COLOR="0000ff" size ="2">Excel通服资产导入更新模版</FONT></a><td width="20%">
            <td></td>
        </tr>
    </table>
</form>
