...
<form name="mainFrm" action="/servlet/com.sino.ams.system.object.servlet.ImportLastingAssetsServlet" method="post" enctype="multipart/form-data">
    <input type="hidden" name="flag" value="0">
    <script type="text/javascript">
        printTitleBar("Excel租赁资产导入")
    </script>
    ...
    <table border = "0" width="100%">
        ...
        <tr>
            ...
            <a href="/document/template/ItemImporting.zip"  style="cursor:pointer;text-decoration:underline;color:blue"><FONT COLOR="0000ff" size ="2">Excel租赁资产导入模版</FONT></a><td width="20%">
            <td></td>
        </tr>
    </table>
</form>
