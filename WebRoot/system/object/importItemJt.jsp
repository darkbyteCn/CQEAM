...
<form name="mainFrm" action="/servlet/com.sino.ams.system.object.servlet.ImportItemServletJt" method="post" enctype="multipart/form-data">
    <input type="hidden" name="flag" value="0">
    <script type="text/javascript">
        printTitleBar("实物成批更新")
    </script>
    ...
    <table border = "0" width="100%">
        ...
        <tr>
            ...
            <a href="/document/template/ItemImporting.zip"  style="cursor:pointer;text-decoration:underline;color:blue"><FONT COLOR="0000ff" size ="2">实物成批更新模板</FONT></a><td width="20%">
            <td></td>
        </tr>
    </table>
</form>
