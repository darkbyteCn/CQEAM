...
function do_submit() {
		...
		action="/servlet/com.sino.ams.system.switches.servlet.EtsObjectServlet";
		submit();
                   }
         }
}
...
function do_delete() {
    ...
    document.mainFrm.action = "/servlet/com.sino.ams.system.switches.servlet.EtsObjectServlet";
