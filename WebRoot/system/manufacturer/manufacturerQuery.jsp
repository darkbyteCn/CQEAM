    ...
    <table border="0" width="100%"  id="table1">
	    <tr>
	    	...
	    	<td width = "45%" colspan = "4" align = "right">
                ...
                <img src="/images/eam_images/enable.jpg" style="cursor:hand;display:none" onclick="do_EnableObject();" title="批量生效" id="enablePic">
			    <img src="/images/eam_images/disable.jpg" style="cursor:hand;display:none" onclick="do_DisableObject();" title="批量失效" id="disablePic">
	        </td>
	    </tr>    
	</table>   
</form>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:45px;left:1px;width:838px">
	<table class="headerTable" border="1" width="100%">
	    <tr height=20px onClick="executeClick(this)" style="cursor:hand" title="点击全选或取消全选">
	        ...
	        <td align=center width="10%">厂商描述</td>
	        <td align=center width="10%">是否有效</td>
	        <td align=center width="10%">创建人</td>
	        <td align=center width="10%">创建日期</td>
	        <td align=center width="10%">最后更新人</td>
	        <td align=center width="10%">最后更新时间</td>
		</tr>
    </table>
</div>
...
function do_DisableObject(){
    ...
    if(confirm("是否确定失效厂商信息？继续请点击“确定”，否则请点击“取消”按钮")){
...
function do_EnableObject(){
    ...
    if(confirm("是否确定生效厂商信息？继续请点击“确定”，否则请点击“取消”按钮")){
...
function do_Delete() {
    ...
    if (checkedCount < 1) {
    	...
    	if(confirm("是否确定删除厂商信息？继续请点击“确定”，否则请点击“取消”按钮")){
