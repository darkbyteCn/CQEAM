    ...
    <table border="0" width="100%" id="table1">
        <tr>
            ...
            <td width="50%" align="left" height="22">
				<input type="text" name="code" size="40" class="noemptyInput" style="width:100%" value="<%=flexValueSet.getCode()%>"></td>
            <td width="25%" align="left" height="22"></td>
        </tr>
        <tr>
            <td width="25%" align="right" height="22">分类名称：</td>
            <td width="50%" align="left" height="22">
			<input type="text" name="name" size="40" style="width:100%" value="<%=flexValueSet.getName()%>"></td>
            <td width="25%" align="left" height="22"></td>
        </tr>
        ...
        <tr>
            ...
            <td width="50%" align="left" height="22">
                <input type="text" name="description" size="40" style="width:100%" value="<%=flexValueSet.getDescription()%>"><td width="25%" align="left" height="22"></td>
        </tr>
        <tr>
...
function do_SaveDictionary() {
	...
	if (isValid) {
        ...
        if (mainFrm.flexValueSetId.value != "") {
