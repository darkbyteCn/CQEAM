...
<form name="mainFrm" method="POST" action="/servlet/com.sino.ams.system.dict.servlet.EtsFlexValueSetServlet">
    ...
    <table border="0" width="100%" class="queryTable" id="table1" >
        <tr>
            ...
            <td width="30%" colspan="2">
                <input type="text" name="code" class="input_style1" style="width:100%" value="<%=parser.getParameter("code")%>">
            </td>
            <td width="15%" align="right">分类名称：</td>
            <td width="30%" align="right" colspan="2">
                <input type="text" name="name" class="input_style1" style="width:100%" value="<%=parser.getParameter("name")%>"></td>
            <td width="10%">&nbsp;
              <img align="middle" src="/images/eam_images/search.jpg" alt="查询分类" onclick="do_Search(); return false;">
            </td>
        </tr>
        <tr>
            ...
            <td width="10%">&nbsp;
              <img align="middle" src="/images/eam_images/new.jpg" alt="新增分类" onclick="do_Create(); return false;">
            </td>
        </tr>
    </table>
    ...
    <%
        ...
        if (rows != null && !rows.isEmpty()) {
            Row row = null;
    %>
    <div style="overflow-y:scroll;height:75%;width:100%;left:1px;margin-left:0"
         align="left">
        <table width="100%" border="1" >
            ...
            <tr class="dataTR" onclick="do_ShowDetail('<%=row.getValue("FLEX_VALUE_SET_ID")%>'); return false;">
                <td height="21" width="15%"><%=row.getValue("CODE")%>
                </td>
                <td height="21" width="20%"><%=row.getValue("NAME")%>
                </td>
                <td height="21" width="20%"><%=row.getValue("DESCRIPTION")%>
                </td>
                <td height="21" width="10%"><%=row.getValue("ENABLED")%>
                </td>
                <td height="21" width="10%"><%=row.getValue("IS_INNER")%>
                </td>
                <td height="21" width="10%"><%=row.getValue("MAINTAIN_FLAG")%>
                </td>
                <td height="21" width="15%" align="center"><%=row.getValue("CREATION_DATE")%>
                </td>
            </tr>
            <%
                    }
