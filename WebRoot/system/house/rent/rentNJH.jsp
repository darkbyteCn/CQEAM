...
<tr>
    ...
    <td width="35%" align="left"><input name="rentFee" type="text" class="noEmptyInput" value="<%=housedto.getRentFee()%>"   style="width:80%" onblur="do_verify3();">
    </td>
</tr>
<tr>
    <td align="right" width="15%">名称：</td>
    <td width="35%" align="left"><input name="itemName" type="text" readonly class="noEmptyInput"
                                        value="<%=housedto.getItemName()%>" style="width:80%"><a class="linka" style="cursor:'hand'"  onclick="do_SelectSystemItem();">[…]</a>
    </td>
    <td align="right" width="15%">出租单位：</td>
    <td width="35%" align="left"><input name="rentUnit" type="text" class="noEmptyInput" value="<%=housedto.getRentUnit()%>"   style="width:80%" ></td>
</tr>
<tr>
...
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="houseCertificateNo" style="width:80%" value="<%=housedto.getHouseCertificateNo()%>"></td>
    <td align="right" width="15%">联系电话：</td>
    <td width="35%" align="left"><input name="contactPhone"  type="text"  value="<%=housedto.getContactPhone()%>"   style="width:80%" ></td>
</tr>
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="rentStartDate" class="noEmptyInput" value="<%=housedto.getRentStartDate()%>" style="width:80%" title="点击选择日期" readonly  onclick="gfPop.fPopCalendar(rentStartDate)"><img src="/images/calendar.gif" alt="点击选择日期" onclick="gfPop.fPopCalendar(rentStartDate)"></td>
</tr>
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="rentEndDate"  class="noEmptyInput"
<%
...
%>
        style="width:80%" title="点击选择日期" readonly  onclick="gfPop.fEndPop(rentStartDate,rentEndDate);"><img src="/images/calendar.gif" alt="点击选择日期" onclick="gfPop.fEndPop(rentStartDate,rentEndDate);">
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td width="35%" id="rent10"><textarea name = "hremark" cols="30"  rows="3"><%=housedto.getHremark()%></textarea></td>
</tr>
</table>
<fieldset>
    <legend>
        ...
        <front color="#0033FF" >房屋用途信息</front>
    </legend>
    ...
    %>
        ...
        <tr>
            <td width=16% align="right">用途：</td>
            <td width=16%><select style="width:100%" name="usage"><%--<%=houseUsage%>--%><option value="PRODUCE" >生产</option>
            </select></td>
            <td align="right" width=16%>面积(㎡)：</td>
            <td width=16% align="left">
                <input type="text" name="area" value="<%=dto.getArea()%>" onblur="do_area();">
        ...
        <tr>
            <td width=16% align="right">用途：</td>
            <td width=16%><select style="width:100%" name="usage"><%--<%=houseUsage%>--%><option value="WORK" >办公</option>
            </select></td>
            <td align="right" width=16%>面积(㎡)：</td>
            <td width=16% align="left">
                <input type="text" name="area" value="<%=dto.getArea()%>" onblur="do_area();">
        ...
        <tr>
            <td width=16% align="right">用途：</td>
            <td width=16%><select style="width:100%" name="usage"><%--<%=houseUsage%>--%><option value="OTHERS" >其它</option>
            </select></td>
            <td align="right" width=16%>面积(㎡)：</td>
            <td width=16% align="left">
                <input type="text" name="area" value="<%=dto.getArea()%>" onblur="do_area();">
...
<table width="100%" border="0">
    <tr>
        ...
        <td width="35%"> &nbsp;&nbsp;&nbsp;
            ...
            <img src="/images/eam_images/save.jpg" alt="保存信息"    onclick="do_save();" <%--onClick="do_save(); return false;"--%>> &nbsp;
          <%}%>
...
function do_SelectSystemItem() {
    ...
    if (users) {
        var user = null;
          user = users[0];
           document.mainForm.itemCode.value= users[0].itemCode;
           document.mainForm.itemName.value= users[0].itemName;
           document.mainForm.itemSpec.value= users[0].itemSpec;
    }
}
...
function do_verifybarcode() {
    ...
    if (document.mainForm.barcode.value) {
        url = "/servlet/com.sino.ams.system.house.servlet.RentHouseInfoServlet?act=verifyBarcode&barcode=" + document.mainForm.barcode.value;
...
function do_creatBarcode() {
    ...
    url = "/servlet/com.sino.ams.system.house.servlet.RentHouseInfoServlet?act=creatBarcode";
    xmlHttp.onreadystatechange = handleReadyStateChange1;
    xmlHttp.open("post", url, true);
    xmlHttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xmlHttp.send(null);
