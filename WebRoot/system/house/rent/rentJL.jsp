...
<tr>
    ...
    <td><input name="contactPerson" type="text"  value="<%=housedto.getContactPerson()%>"   style="width:80%" >
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="rentEndDate"
<%
...
%>
       value="<%=housedto.getRentEndDate().toString().substring(0,10)%>"
<%
  }
%>
...
<tr>
    ...
    <td align="right" id="rent9">备 注：</td>
    <td width="35%" id="rent10"><textarea name= "hremark" cols="30" rows="4"><%=housedto.getHremark()%></textarea></td>
</tr>
</table>
