...
<tr>
    ...
    <td width="35%" align="left"><input name="barcode" type="text"  value="<%=housedto.getBarcode()%>" readonly class="readonlyInput" style="width:80%">
    </td>
...
<tr>
    ...
    <%--<td rowspan = "5"><textarea name = "hremark" name = "hremark" cols="30" rows="4"><%=housedto.getHremark()%></textarea></td>--%>
</tr>
<tr>
    <td align="right" width="15%">土地证号：</td>
    <td width="35%" align="left"><input type="text" name="landCertficateNo" style="width:80%"
                                        value="<%=housedto.getLandCertficateNo()%>">
    </td>
...
<tr>
    ...
    <td width="35%" align="left"><input name="occupyArea" type="text" value="<%=housedto.getOccupyArea()%>" style="width:80%"
                           onblur="do_verifyLandArea();">
    </td>
...
<tr>
    ...
    <td width="35%" align="left"><select name="landType" style="width:80%">
        ...
        <td width="35%" ><input name="contractName" type="text" value="<%=housedto.getContractName()%>" style="width:80%"></td>
</tr>
<tr>
...
<input type="hidden" name ="officeType" value="土地">
