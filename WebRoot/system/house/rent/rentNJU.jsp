...
<tr>
    ...
    <td width="35%" align="left"><input name="rentFee" class="noEmptyInput" type="text"  value="<%=housedto.getRentFee()%>"   style="width:80%" onblur="do_verify3();">
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="houseCertificateNo" style="width:80%"
                                        value="<%=housedto.getHouseCertificateNo()%>"></td>
...
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="landCertficateNo" style="width:80%" value="<%=housedto.getLandCertficateNo()%>"></td>
...
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="occupyArea" style="width:80%" value="<%=housedto.getOccupyArea()%>" onblur ="do_verifyLandArea();"></td>
...
//    alert(document.mainForm.itemCode.value);
