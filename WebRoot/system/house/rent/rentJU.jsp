...
<script type="text/javascript">
    printTitleBar("租赁房屋土地维护-基站-房地合一")
</script>
...
<tr>
    ...
    <td width="35%" ><input name="contactPhone" type="text"  value="<%=housedto.getContactPhone()%>"   style="width:80%" ></td>
</tr>
<tr>
...
<tr>
    ...
    <td width="35%" ><input type="text" name="houseAddress" style="width:80%" class="noEmptyInput" readonly
                                        value="<%=housedto.getHouseAddress()%>"><a class="linka" style="cursor:'hand'"
                                                                                   onclick="do_selectAddress();">[…]</a></td>
</tr>
<tr>
