...
<tr>
    ...
    <td width="35%" align="left"><input name="itemName" type="text" readonly class="noEmptyInput"   value="<%=housedto.getItemName()%>" style="width:80%">
    </td>
...
<tr>
    ...
    <td width="35%" align="left"></td>
        <td align="right" width="15%" ></td>
        <td width="35%" rowspan ="3"><textarea name ="hremark"   rows = "3" cols="30" ><%=housedto.getHremark()%> </textarea></td>
</tr>
<tr>
...
function do_DownLoad(downPath) {
	mainForm.filePath.value = downPath;
	mainForm.act.value = "<%=WebActionConstant.DOWNLOAD_ACTION%>";
    mainForm.action = "/servlet/com.sino.ams.system.house.servlet.AmsItemFilesServlet";
    mainForm.submit();
}
