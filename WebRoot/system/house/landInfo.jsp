...
<%@ page import="com.sino.ams.system.house.dto.AmsLandInfoDTO" %>
...
<%
    ...
    AmsLandInfoDTO landdto = (AmsLandInfoDTO) request.getAttribute(WebAttrConstant.AMS_LAND_INFO_DTO);
...
<script type="text/javascript">
    printTitleBar("土地详细信息")
</script>
<body leftmargin="0" topmargin="0" onload="set_value()">

<jsp:include page="/message/MessageProcess"/>
<form action="/servlet/com.sino.ams.system.house.servlet.AmsLandInfoServlet" name="mainForm" method="post">
<table border="0" width="100%">
    ...
    <tr>
        ...
        <td width="35%" align="left"><input name="itemName" type="text" readonly class="input_style2"
    ...
    <tr>
        ...
        <td width="35%" align="left"><input name="itemSpec" type="text" class="input_style1" value="<%=landdto.getItemSpec()%>"
                                      readonly      style="width:46%" onclick="do_SelectSystemItem();"></td>
    </tr>
    <tr>
        <td align="right" width="15%">土地面积：</td>
        <td width="35%"><input name="landArea" class="input_style1" type="text" value="<%=landdto.getLandArea()%>" style="width:46%" onblur="do_verify2();">
        </td>

    </tr>
    <tr>
        <td align="right" width="15%">土地使用证号：</td>
        <td width="35%" align="left"><input type="text" name="landCertficateNo" style="width:46%" class="input_style1" 
                                            value="<%=landdto.getLandCertficateNo()%>" onblur="do_verify10();">
        </td>
    </tr>
    <tr>
        <td align="right" width="15%">所在地点：</td>
        <td width="35%" align="left"><input type="text" name="landAddress" style="width:46%" class="input_style2" readonly
    ...
    <tr>
        ...
        <td width="35%"><select style="width:46%" class="select_style1"  name="areaUnit"><%=parser.getAttribute(WebAttrConstant.LAND_AREA_UNIT_OPTION)%>
        </select></td>
    </tr>
...
//    if(!landdto.getIsRent().equals("N")){
        ...
        <tr>
            ...
            <td width="35%"><input name="rental" type="text" value="<%=landdto.getRental()%>" class="input_style1" style="width:46%" onblur="do_verify3();">
            </td>
        </tr>
        <tr>
            <td align="right" width="15%">金额单位：</td>
            <td width="35%"><input type="text" style="width:46%" class="input_style1" name="moneyUnit" value="<%=landdto.getMoneyUnit()%>" onblur="do_verify11();"></td>
        </tr>
        <tr>
            <td align="right" width="15%">出租人：</td>
            <td width="35%" align="left"><input name="rentPerson" type="text" class="input_style1" value="<%=landdto.getRentPerson()%>"  onblur="do_verify12();"
                                                style="width:46%"></td>
        </tr>
        <tr>
...
<table border="0" width="100%">
    ...
    <tr>
        ...
        <td width="35%"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <img src="/images/eam_images/save.jpg" alt="保存土地信息" onClick="do_save(); return false;">
...
//         selectAll("affix");
        ...
        with (mainForm) {
            ...
            action = "/servlet/com.sino.ams.system.house.servlet.AmsLandInfoServlet";
...
function do_AttachFiles() {
    <%--if (mainForm.systemId.value == "") {--%>
        ...
        <%--}--%>
    <%--} else {--%>
        <%--var url = "/servlet/com.sino.ams.system.house.servlet.AmsItemFilesServlet?act=<%=WebActionConstant.NEW_ACTION%>&barcode=<%=landdto.getBarcode()%>" + "&type=LAND";--%>
...
function initPage() {
    ...
    if (attachFile == "true") {
        var url = "/servlet/com.sino.ams.system.house.servlet.AmsItemFilesServlet?act=<%=WebActionConstant.NEW_ACTION%>&barcode=<%=landdto.getBarcode()%>";
        var style = "height=300,width=500,top=300,left=400";
        var winName = "uploadWin";
        window.open(url, winName, style);
    }
...
function do_verifybarcode() {
    ...
    if (document.mainForm.barcode.value) {
        url = "/servlet/com.sino.ams.system.house.servlet.AmsLandInfoServlet?act=verifyBarcode&barcode=" + document.mainForm.barcode.value;
