...
<tr>
    ...
    <td><input type="text" name="landCertficateNo" style="width:80%"
                                        value="<%=housedto.getLandCertficateNo()%>"></td>
</tr>
<tr>
...
<tr>
    ...
    <td width="35%" rowspan="6" ><textarea name = "hremark" cols="30" rows="4"><%=housedto.getHremark()%></textarea></td>
</tr>
<tr>
