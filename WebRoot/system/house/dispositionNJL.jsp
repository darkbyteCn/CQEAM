...
<tr>
    ...
    <td width="35%" align="left">
        <input name="barcode" type="text"  value="<%=housedto.getBarcode()%>" readonly class="readonlyInput" style="width:80%">
    </td>
...
<tr>
    ...
    <td ><input type="text" name="houseAddress" style="width:80%" class="noEmptyInput" readonly
...
<tr>
    ...
    <td width="35%" align="left"><select name="landType" style="width:80%">
        ...
        <td width="35%" rowspan = "2"><textarea name = "hremark" name = "hremark" cols="30" rows="4"><%=housedto.getHremark()%></textarea></td>
</tr>
<tr>
