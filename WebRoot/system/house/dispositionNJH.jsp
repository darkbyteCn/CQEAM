...
<tr>
    ...
    %>
    <td align="right"></td>
    <td rowspan="3" ><textarea name = "hremark" cols="30"  rows="6"><%=housedto.getHremark()%></textarea></td>
</tr>
<tr>
    ...
    <td width="35%" align="left"><input type="text" name="houseAddress" style="width:80%" class="noEmptyInput" readonly
        ...
        <td align="right" width="15%" id="rent1">备注：</td>
        <td width="35%" id="rent2"></td>
</tr>
<tr>
