...
//                    window.close();
                ...
                var url = "/servlet/com.sino.ams.system.house.servlet.DispositonHouserServlet?act=DETAIL_ACTION&barcode=" + document.mainFrm.barcode.value +"&bts=" + bts + "&category=" + category;
//                var url = "/servlet/com.sino.ams.system.house.servlet.DispositonHouserServlet?act=DETAIL_ACTION&barcode=" + document.mainFrm.barcode.value;
                var winStyle = "height=" + height + ",width=620px,top=150, left=150, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=yes,help=no";
                window.open(url, "_blank", winStyle);
//                window.close();
            }
