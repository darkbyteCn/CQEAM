...
<fieldset style="border:1px solid #397DF3; position:absolute;top:133px;width:100%;height:70%">
    <legend>
        ...
        %>
        <img src="/images/button/select.gif" alt="选择资产" onClick="do_SelectAssets();return false;">
        ...
        <input type="checkbox" name="allLocation" id="allLocation"><label for="allLocation">新地点</label>
    </legend>
    <div id="headDiv" style="overflow:hidden;position:absolute;top:25px;left:1px;width:990px">
        <table class="headerTable" border="1" width="140%">
            <tr height=20px onClick="executeClick(this)" style="cursor:hand" title="点击全选或取消全选">
                ...
                <!--<td align=center width="10%">新部门</td>-->
    ...
    <div id="dataDiv" style="overflow:scroll;height:88%;width:1007px;position:absolute;top:48px;left:1px" align="left"
        ...
        <table id="dataTable" width="140%" border="1" bordercolor="#666666">
            ...
            <tr id="model" class="dataTR" onClick="executeClick(this)" style="display:none">
                ...
                <td width="4%" align="right" title="点击查看资产详细信息" style="cursor:hand" onClick="do_ShowDetail(this)"><input
                ...
                <td width="4%" align="left"><input type="text" name="responsibilityUserName"
                                                   ...
                                                   onClick="do_SelectPerson(this)" title="点击选择或更改新责任人"
                                                   style="cursor:hand"></td>
               <td width="11%"><input type="text" name="assignedToLocationName" id="assignedToLocationName0" class="finputNoEmpty" readonly value="" onClick="do_SelectLocation(this)" title="点击选择或更改调入地点" style="cursor:hand"></td>
                ...
                <td width="5%" align="center"><input type="text" name="lineTransDate" id="lineTransDate0"
                                                     ...
                                                     title="点击选择或更改调拨日期" onBlur="do_SetLineTransDate(this)"></td>
            ...
            <tr id="model" class="dataTR" onClick="executeClick(this)" style="cursor:hand">
                ...
                <td width="4%" align="right" title="点击查看资产“<%=barcode%>”详细信息" style="cursor:hand"
             ...
             <td width="4%" align="left"><input type="text" name="responsibilityUserName"
                                                   ...
                                                   onClick="do_SelectPerson(this)" title="点击选择或更改新责任人"
                                                   style="cursor:hand"></td>
              <td width="11%"><input type="text" name="assignedToLocationName" id="assignedToLocationName<%=i%>" class="finputNoEmpty" readonly value="<%=lineDTO.getAssignedToLocationName()%>" onClick="do_SelectLocation(this)" title="点击选择或更改调入地点" style="cursor:hand"></td>

                <td width="5%" align="center"><input type="text" name="lineTransDate" id="lineTransDate<%=i%>"
                                                     style="width:100%; border: 1px solid #FFFFFF;cursor:hand" readonly
                                                     value="<%=lineDTO.getLineTransDate()%>"
                                                     onclick="gfPop.fPopCalendar(lineTransDate<%=i%>)" title="点击选择或更改调拨日期"
