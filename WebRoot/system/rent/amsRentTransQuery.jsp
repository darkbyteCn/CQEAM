...
<form action="/servlet/com.sino.ams.system.rent.servlet.AMSRentChangeQueryServlet" method="post" name="mainFrm">
<script type="text/javascript">
    printTitleBar("实物调拨查询");
</script>
    ...
    <table class="queryTable" style="width:100%;TABLE-LAYOUT:fixed;word-break:break-all">
        <tr>
            ...
            <td width="15%"><input type="text" class="input_style1" name="transNo" style="width:100%" value="<%=dto.getTransNo()%>"></td>
...
function showDetail(transId){
    var transType = mainFrm.transType.value;
    var url = "/servlet/com.sino.ams.system.rent.servlet.AMSRentChangeQueryServlet?act=<%=AssetsActionConstant.DETAIL_ACTION%>&transType=" + transType+"&transId="+transId;
    var style = "width=1024,height=700,top=0,left=0,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no";
    window.open(url, 'transferWin', style);
}
