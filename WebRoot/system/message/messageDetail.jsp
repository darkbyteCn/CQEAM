...
<script type="text/javascript">
    printTitleBar("短信息详细信息");
</script>
    <input type="hidden" name="act">
    <input type="hidden" name="msgCategoryId" value="<%=dto.getMsgCategoryId()%>">
...
function do_TurnBack(){
	window.location.href = "/servlet/com.sino.ams.system.message.servlet.SfMsgCategoryServlet";
}
</script>