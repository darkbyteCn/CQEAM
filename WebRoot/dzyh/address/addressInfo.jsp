...
<script type="text/javascript">
    printTitleBar("<%=spotDTO.getCategoryName()%>维护")
</script>
<body  leftmargin="0">
...
<form action="" method="post" name="mainFrm">
    ...
    <table width="60%" align="center">
        ...
        <tr>
            ...
            <td width="40%"><input  name="workorderObjectCode" type="text"   id="workorderObjectCode" value="<%=spotDTO.getWorkorderObjectCode()%>" class='noEmptyInput' style="width:80%" onblur="do_verifyworkNo();"
                                          <%
...
<script type="text/javascript">
function do_back() {
	document.mainFrm.workorderObjectCode.value="";
	document.mainFrm.workorderObjectName.value="";
	document.mainFrm.countyCode.value="";
...
function do_submit() {
        ...
        var fieldLabels = "交换机房号;交换机房名称;交换机房地点;所属区县";
		...
		action="/servlet/com.sino.ams.dzyh.servlet.EtsObjectServlet";
		submit();
                   }
         }
}
...
function do_delete() {
    ...
    document.mainFrm.action = "/servlet/com.sino.ams.dzyh.servlet.EtsObjectServlet";
...
//    var workorderObjectCode = document.form1.workorderObjectCode.value;
    ...
    if (document.mainFrm.workorderObjectCode.value) {
        url = "/servlet/com.sino.ams.dzyh.servlet.EtsObjectServlet?act=verifyworkNo&workorderObjectCode=" + document.mainFrm.workorderObjectCode.value;
