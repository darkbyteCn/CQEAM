...
<%
    ...
    String transTypeName = "条码设备入库";
    String url = "/servlet/com.sino.ams.others.servlet.BarcodeInServlet";
    if (transType.equals(DictConstant.TMCK)) {
        transTypeName = "条码设备出库";
        url = "/servlet/com.sino.ams.others.servlet.BarcodeOutServlet";
    }
%>
