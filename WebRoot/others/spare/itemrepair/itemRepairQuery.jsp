...
<form name="workForm" method="post" action="/servlet/com.sino.ams.spare.repair.servlet.AmsItemRepairServlet">
    ...
    <script type="text/javascript">
        var columnArr = new Array("公司","设备名称", "规格型号", "返修次数");
    ...
    <div style="overflow-y:scroll;height:362px;width:100%;left:1px;margin-left:0px" align="left">
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'"
                ...
                <td width="25%" align="left"><%=row.getValue("QUANTITY")%></td>
            </tr>
            <%
                    }
                }
