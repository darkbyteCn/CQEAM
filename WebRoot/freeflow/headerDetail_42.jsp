		...
		<td>
			<table width=100% border="0">
			    <tr>
			        ...
			        <td align=right width=8%>建单组别：</td>
			        <td width=17%>
						<input name="fromGroupName" class="readonlyInput" readonly style="border-style:solid; border-width:0px; width:100%; background-color:#F2F9FF" value="<%=headerDTO.getFromGroupName()%>" title="点击选择或更改“建单组别”" onclick="do_SelectFrmGroup();" ></td>
			    ...
			    <tr>
			    	<td width="8%" height="60" align="right">报废原因：</td>
	...
	<tr>
		<td>
			<table width=100% border="0">
			    ...
			    <tr>
			    	<td width="8%" height="60" align="right">处置原因：</td>
	...
	<tr>
		<td>
			<table width=100% border="0">
			    ...
			    <tr>
			    	<td width="8%" height="60" align="right">闲置原因：</td>
