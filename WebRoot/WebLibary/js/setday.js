<!--
//----------------------------------------------------------------------------
//  一个日历 Javascript 页面脚本控件，适用于微软的 IE （5.0以上）浏览器
...
var _VersionInfo="Version:1.0星通软件部&#13;公司: 星通信息技术有限公司&#13;作者: 王隆樟"	//版本信息
...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #70A0ED 1px solid;BORDER-TOP: ##70A0ED 1px solid;BORDER-LEFT: #70A0ED 1px solid;';
strFrame+='BORDER-BOTTOM: #70A0ED 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#70A0ED bgcolor=#70A0ED Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#70A0ED style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='        <td width=16 bgcolor=#70A0ED align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#70A0ED ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#70A0ED BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#70A0ED BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 Author="wayx">';
