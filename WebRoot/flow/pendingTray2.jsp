...
<form name="listform" action="/servlet/com.sino.sinoflow.servlet.PendingTray2" method="POST">
...
<%
    ...
    String allResName = (String) request.getAttribute( com.sino.ams.constant.WebAttrConstant.ALL_RES_NAME ); 
%>
<td nowrap align=left valign=bottom >&nbsp;<font  style="font-size: 10pt" color=#FFFFF><b> >><%= allResName %></b></font> <font  style="font-size: 8pt" color=#FFFFF><b>(共<%=allTaskCount%>个)</b></font></td>
...
function do_search()
{
    ...
    var url = "/servlet/com.sino.sinoflow.servlet.PendingTray2?keyword='" +
