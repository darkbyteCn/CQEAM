...
<div id="headDiv" style="overflow:hidden;position:absolute;top:1px;left:1px;width:990px">
	<table class="headerTable" border="1" width="140%">
		<tr>
			<td width="8%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">标签号</td>
			...
			<td width="17%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">设备型号</td>
			<td width="6%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">单位</td>
			<td width="25%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">所在地点</td>
			<td width="6%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">责任人</td>
			<td width="20%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">责任部门</td>
		</tr>
	</table>
</div>
...
%>					
		<tr onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
			<td width="8%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: center" readonly value="<%=row.getValue("BARCODE")%>"></td>
			...
			<td width="17%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: left" readonly value="<%=row.getValue("ITEM_SPEC")%>"></td>
			...
			<td width="25%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: left" readonly value="<%=row.getValue("WORKORDER_OBJECT_LOCATION")%>"></td>
			...
			<td width="20%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: left" readonly value="<%=row.getValue("DEPT_NAME")%>"></td>
		</tr>
<%
		}
	}
