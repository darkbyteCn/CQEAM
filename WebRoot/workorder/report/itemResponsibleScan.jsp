...
<script language="javascript">
	...
	var ArrAction1 = new Array(true, "导出当前地点设备清单", "toexcel.gif", "导出当前地点设备清单", "do_Export('<%=DictConstant.EXPORT_LOC_ITEM%>')");
	var ArrAction2 = new Array(true, "导出最近巡检结果", "toexcel.gif", "导出最近巡检结果", "do_Export('<%=DictConstant.EXPORT_SCAN_ITEM%>')");
	var ArrAction3 = new Array(true, "导出差异情况", "toexcel.gif", "导出差异情况", "do_Export('<%=DictConstant.EXPORT_DIFF_ITEM%>')");
...
<script language="javascript">
	...
	tabBox.addtab("scaneditems", "最近巡检结果");
