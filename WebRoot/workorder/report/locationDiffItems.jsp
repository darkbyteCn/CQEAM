...
<div id="headDiv" style="overflow:hidden;position:absolute;top:1px;left:1px;width:990px">
	<table class="headerTable" border="1" width="100%">
		<tr>
			...
			<td width="20%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">设备名称</td>
			<td width="20%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">设备型号</td>
			<td width="10%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">计量单位</td>
			<td width="10%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">系统属性</td>
			<td width="10%" align="center" background="/images/bg_011.gif" style="color: #FFFFFF" height="22">扫描属性</td>
		</tr>
	</table>
</div>
...
%>					
		<tr onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
			...
			<td width="20%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: left" readonly value="<%=row.getValue("ITEM_NAME")%>"></td>
			<td width="20%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: left" readonly value="<%=row.getValue("ITEM_SPEC")%>"></td>
			...
			<td width="10%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: center" readonly value="<%=row.getValue("SYSTEM_EXISTS")%>"></td>
			<td width="10%" height="22"><input type="text" style="width:100%; border: 1px solid #FFFFFF;text-align: center" readonly value="<%=row.getValue("SCAN_EXISTS")%>"></td>
		</tr>
<%
		}
	}
