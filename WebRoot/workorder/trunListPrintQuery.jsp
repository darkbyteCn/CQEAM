...
<form name="mainFrm" method="POST" action="/servlet/com.sino.ams.workorder.servlet.TrunListPrintQueryServlet">
<script type="text/javascript">
      printTitleBar("转资条码打印");
</script>
...
<table width="100%" border=0 class="queryTable" cellpadding="2" cellspacing="0"
    ...
    <tr>
        ...
        <td width="18%">
        	<input style="width:80%" type="text" readonly class="input_style1" name="deptName" value="<%=dto.getDeptName() %>" onclick="chooseDeptInfo();" title="">
        	<input style="width:80%" type="hidden" readonly class="input_style1" name="deptCode" value="<%=dto.getDeptCode() %>" >
        </td>
        <td align="right" width="8%">资产状态</td>
        <td width="8%">
    ...
    <tr>
        ...
        <td width="18%">
        	<input name="prjName" type="text" id="prjName" value="<%=dto.getPrjName()%>" class="input_style1" onClick="choosePrj()" title="点击选择项目" readonly style="width:80%">
        	<input name="prjId" type="hidden" value="<%=dto.getPrjId() %>">
        </td>
        <td align="right" width="8%">地点名称</td>
        <td width="18%" colspan="4">
        	<input style="width:95%" type="text" readonly class="input_style1" name="workorderObjectName" value="<%=dto.getWorkorderObjectName() %>"  onclick="showLocation()" title="点击选择地点" >
        </td>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:90px;left:0px;width:250%">
	<table class="headerTable" border="1" width="2500">
		<tr height=22px >
			...
			<td width="3%" align="center"><span class="resizeDivClass"></span>项目编号</td>
            <td width="8%" align="center"><span class="resizeDivClass"></span>项目名称</td>
...
<div id="dataDiv" style="overflow:scroll;height:65%;width:250%;position:absolute;top:112px;left:0px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
	<table id="dataTable" width="2500" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:keep-all">
        ...
        <tr >
            ...
            <td width="3%" align = "left" title="点击查看“<%=barcode%>”打印详细信息"  onClick="do_History('<%=barcode%>')"><%=row.getValue("SEGMENT1")%></td>
            <td width="8%" align = "left" title="点击查看“<%=barcode%>”打印详细信息"  onClick="do_History('<%=barcode%>')"><%=row.getValue("NAME")%></td>
