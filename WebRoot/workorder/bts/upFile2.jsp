...
<html>
  <head>
  <title>请导入Excel数据</title>
      <base target="_self">
    <script type="text/javascript">
        printTitleBar("请导入Excel数据");
        var ArrAction0 = new Array(true, "导入", "action_sign.gif", "导入", "do_sub");
        var ArrAction1 = new Array(true, "模板下载", "action_save.gif", "模板下载", "do_DownloadTemplate");
  ...
  <body>
  <form name="mainFrm" method="post" action="/servlet/com.sino.ams.workorder.util.workorderXls" enctype="multipart/form-data" >
      ...
      <table width="80%" border="0" align="center">
          ...
          <tr style="width:100%;height:30px">
              <td style="width:100%">1：此处导入用于巡检工单相关业务；</td>
          </tr>
          <tr style="width:100%;height:30px">
...
<script type="text/javascript">
    ...
    function do_DownloadTemplate(){
        window.open('/document/template/LocationImportTem.zip');
        return false;
    }
