...
%>
        ...
        <tr>
           ...
           <td align="left"  width="38%">
            ...
            <td align="left"  width="38%">
                <select class ="box2"  name="implementBy"  style="font-family:Verdana,Arial; font-size: 9pt; color: #FF0000; width:50%" ><%=userOtionHtml%></select>
            </td>
        </tr>
    </table>
        </td>
...
%>
    <table><tr></tr></table>
     <fieldset  style="position:absolute;left:1px;width:100%;height:270px"
<%
    if(!etsWorkorderTmp.getWorkorderType().equals(DictConstant.ORDER_TYPE_NEW)) {
       if (schemeRowSet != null && !schemeRowSet.isEmpty()) {
%>
...
%>
   style="position:absolute;top:138px;left:1px;width:100%;height:370px"
<%
    }
%>
              >
