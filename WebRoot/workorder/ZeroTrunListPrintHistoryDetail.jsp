<%@ page import="com.sino.ams.print.dto.ZeroBarcodePrintHistoryDTO" %>
<%@ page contentType="text/html; charset=GBK" language="java" errorPage="" %>
<%@ include file="/newasset/headerInclude.jsp"%>
<%@ include file="/newasset/headerInclude.htm"%>
<%
	ZeroBarcodePrintHistoryDTO dto=(ZeroBarcodePrintHistoryDTO)request.getAttribute(AssetsWebAttributes.ITEM_INFO_DTO);
%>
<html>
<head>
...
<%
	...
	if (lines != null && !lines.isEmpty()) {
		for (int i = 0; i < lines.getSize(); i++) {
			ZeroBarcodePrintHistoryDTO logDTO = (ZeroBarcodePrintHistoryDTO)lines.getDTO(i);
%>
        <tr class="dataTR">
