...
%>
        ...
        <tr>
           ...
           <td align="left"  width="38%">
            ...
            <td align="left"  width="38%">
                <select class ="box2" style="width:50%" name="implementBy" style="border:solid 1px;border-color:#9FD6FF;border:solid 1px;border-color:#9FD6FF;width:50%" style="font-family:Verdana,Arial; font-size: 9pt; color: #FF0000" ><%=userOtionHtml%></select>
            </td>
        </tr>
    </table>
        </td>
...
<fieldset style="position:absolute;left:1px;top:138px;width:100%;height:270px">
   <legend align="left">
    ...
    <div style="left:0px;width:100%;overflow-y:scroll;position:absolute;height:75%">
