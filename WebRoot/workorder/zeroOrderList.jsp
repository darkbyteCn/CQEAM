...
<%
    ...
    String prjId = StrUtil.nullToString(request.getParameter("prjId"));
%>
...
<form name="mainFrm" action="/servlet/com.sino.ams.workorder.servlet.ZeroOrderListServlet">
<script type="text/javascript">
    printTitleBar("零购待归档工单")
    printToolBar();
</script>
...
<script type="text/javascript">
        ...
        function do_Search() {
            ...
            document.mainFrm.action = "/servlet/com.sino.ams.workorder.servlet.ZeroOrderListServlet?workorderType=" + wt+"&prjId="+prjId;
            document.mainFrm.submit();
        }
        function do_check() {
            if (event.keyCode == 13) {
