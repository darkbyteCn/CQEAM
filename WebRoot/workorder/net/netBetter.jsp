...
<%}%>
    ...
    <table width="100%" align="center" border="1" cellpadding="2" cellspacing="0"  bordercolordark="#FFFFFF" bordercolor="#9FD6FF" bgcolor="F2F9FF">
        <tr>
        ...
        <tr>
            <td width="70">工单批号：</td>
            <td>
                <input readonly type="text" size="50" name="workorderBatch" value="<%=etsWorkorderBatch.getWorkorderBatch()%>" class="readonlyInput">
            </td>
            <td>任务名称：</td>
        ...
        <tr>
            <td width="70">所属工程：</td>
            <td>
                <input class="<%=prjClass%>"  type="text" size="50" name="prjName" value="<%=etsWorkorderBatch.getPrjName()%>"  readonly  <%if(isFirstNode){%> onclick="choosePrj();" title="点击选择工程" <%}%>>
                <%if(isFirstNode){%> <a href="#" onclick="choosePrj();" title="点击选择工程"><font color="blue">[…]</font></a> <%}%>
            </td>
            <td>工单类型：</td>
            <td colspan="2">
                <input class="readonlyInput" size="50" readonly="true" name="workorderTypeDesc" type="text" value="<%=etsWorkorderBatch.getWorkorderTypeDesc()%>">
        ...
        <td width="70">下单组别：</td>
        <td>
            <input readonly="true"  class="readonlyInput"  size="50"   name="distributeGroupName" type="text" value="<%=etsWorkorderBatch.getDistributeGroupName()%>" >
            <input name="distributeGroupId" type="hidden" value="<%=etsWorkorderBatch.getDistributeGroupId()%>" >
        </td>
        <td>创 建 人：</td>
        <td colspan="2">
            <input readonly="true" size="50"  class="readonlyInput"  name="created_by_desc" type="text" value="<%=etsWorkorderBatch.getCreateUser()%>" >
        </td>
      </tr>
