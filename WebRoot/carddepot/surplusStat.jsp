...
<form method="post" name="mainFrm">
    ...
    <div style="left:1px;width:100%;overflow-y:scroll" class="crystalScroll">
        <table width="100%" class="headerTable" border="1">
            <tr height="20">
                <td width="10%" align="center">上月结余</td>
                <td width="10%" align="center">当月入库</td>
                <td width="10%" align="center">当月退库</td>
                <td width="10%" align="center">当月出库</td>
                <td width="10%" align="center">当月结余</td>
    ...
    <div style="overflow-y:scroll;left:0px;width:100%;height:360px">
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'"
                ...
                <td width="10%" align="center" ><%=row.getValue("Q0")%></td>
                <td width="10%" align="center" ><%=row.getValue("Q2")%></td>
                <td width="10%" align="center" ><%=row.getValue("Q3")%></td>
                <td width="10%" align="center" ><%=row.getValue("Q1")%></td>
                <td width="10%" align="center" ><%=row.getValue("Q4")%></td>
                <td width="20%" align="center" ><%=row.getValue("CARD_NAME")%></td>
            </tr>
            <%
                    }
                }
