...
<form name="mainForm" action="/servlet/com.sino.ams.carddepot.servlet.YsOrderHeaderServlet" method="post">
    ...
    <input type="hidden" name="orderType" value="<%=cardDepotConstant.CANCELLING_STOCKS%>">
        ...
        <tr>
            <td>
                <table width="100%" id="table2" cellspacing="1">
                    <tr height="22">
                        <td width="10%" align="right">目的仓库:</td>
                        <td width="20%"><select name="materialTo" id="materialTo" style="width :100%" class="noborderYellow"><%=depotDefineListOption0%></select></td>
                        <td width="20%" align="right">统一设置退库单位:</td>
                        <td width="20%"><select name="depotAll" id="depotAll" style="width :100%" onchange="do_changeDepotAll()" class="noborderYellow"><%=depotDefineListOption1%></select></td>
    ...
    <fieldset>
        ...
        <script type="text/javascript">
            var columnArr = new Array("退库单位", "品名", "现有量", "申领数", "剩余量", "备注");
        ...
        <div style="overflow-y:scroll;width:100%;left:1px;margin-left:0"
            ...
            <table width="100%" border="1" bordercolor="#9FD6FF" id="dataTable" cellpadding="0" cellspacing="0">
                ...
                %>
                <tr id="mainTr<%=i%>">
                    <td width="20%" align="center"><select onchange="do_getQuantity(<%=i%>)" name="materialFrom" id="materialFrom<%=i%>" style="width :100%" class="noborderYellow"><%=depotDefineListOption1%></select></td>
