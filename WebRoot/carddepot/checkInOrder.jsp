...
<form name="mainForm" action="/servlet/com.sino.ams.carddepot.servlet.YsOrderHeaderServlet" method="post">
    ...
    <input type="hidden" name="orderType" value="<%=cardDepotConstant.GODOWN_ENTRY%>">
    <table border="1" bordercolor="#9FD6FF" class="detailHeader" id="table1">
        ...
        <tr></tr>
        <tr><input type=hidden name=materialTo value="-1"></tr>
        <tr></tr>
        <tr>
            <td>
    ...
    <fieldset>
        ...
        <script type="text/javascript">
            var columnArr = new Array("仓库", "品名", "现有量", "入库数", "合计", "备注");
        ...
        <div style="overflow-y:scroll;width:100%;left:1px;margin-left:0"
            ...
            <table width="100%" border="1" bordercolor="#9FD6FF" id="dataTable" cellpadding="0" cellspacing="0">
                ...
                <tr id="mainTr<%=i%>">
                    ...
                    <%--<td width="20%" align="center"><select onchange="do_getList(<%=i%>)" name="materialFrom" id="materialFrom<%=i%>" style="width :100%" class="noborderYellow"><%=depotDefineListOption0%></select></td>--%>
                    ...
                    <td width="10%" align="center"><input type="text" name="quantity" id="quantity<%=i%>" value="" class="noborderYellow" style="width:100%;text-align:center" onchange="do_setQuantity();do_checkValue(<%=i%>)"></td>
...
<script type="text/javascript">
    function do_checkValue(rowIndex) {
        var quantity = document.getElementById("quantity" + rowIndex).value ;
        var oldQuantity = document.getElementById("oldQuantity" + rowIndex).value ;
        if (quantity < 0) {
            alert("入库数必须大于0！");
            document.getElementById("quantity" + rowIndex).value = "";
        } else if (oldQuantity == "") {
            alert("请选择品名！");
            document.getElementById("quantity" + rowIndex).value = "";
        }
    ...
    function do_setQuantity() {
        ...
        for (i = 0; i < length; i++) {
            ...
            Number(document.getElementById("oldQuantity" + i).value) + Number(document.getElementById("quantity" + i).value);
