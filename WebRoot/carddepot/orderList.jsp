...
<form method="post" name="mainFrm">
    <script type="text/javascript">
        ...
        if (queryType == "<%=cardDepotConstant.OT_LIST%>") {
            printTitleBar("历史出库明细");
        } else if (queryType == "<%=cardDepotConstant.IN_LIST%>") {
            printTitleBar("历史入库明细");
        } else if (queryType == "<%=cardDepotConstant.BK_LIST%>") {
            printTitleBar("历史退库明细");
        }
    ...
    <div style="left:1px;width:100%;overflow-y:scroll" class="crystalScroll">
        <table width="100%" class="headerTable" border="1">
            <tr height="20">
                ...
                <td width="10%" align="center">地点1</td>
                <td width="10%" align="center">地点2</td>
                <td width="10%" align="center">数量</td>
                <td width="10%" align="center">创建时间</td>
                <td width="20%" align="center">单据号</td>
            </tr>
        </table>
    </div>
    ...
    <div style="overflow-y:scroll;left:0px;width:100%;height:360px">
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'"
                ...
                <td width="10%" align="center"><%=row.getValue("DEPOT_NAME1")%></td>
                <td width="10%" align="center"><%=row.getValue("DEPOT_NAME2")%></td>
                <td width="10%" align="center"><%=row.getValue("QUANTITY")%></td>
                <td width="10%" align="center"><%=row.getValue("CREATE_DATE")%></td>
                <td width="20%" align="center"><%=row.getValue("HEADER_NO")%></td>
            </tr>
            <%
                    }
                }
