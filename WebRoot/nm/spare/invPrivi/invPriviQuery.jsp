...
<%@ page import = "com.sino.nm.ams.spare.invprivi.dto.AmsInvPriviDTO" %>
<%--
  created by YS
  Date: 2007-09-28
  Time: 8:23:36
...
%>
<form method = "post" name = "mainFrm" action = "/servlet/com.sino.nm.ams.spare.invprivi.servlet.AmsInvPriviServlet">
    ...
    <div style = "/*overflow-x:scroll;*/width:100%">
        ...
        <%-- <div style = " left:0px;width:150%; height:350px">--%>
...
<script type = "text/javascript">
    function do_search() {
        ...
        <%--mainFrm.act.value = "<%=WebActionConstant.QUERY_ACTION%>";--%>
            mainFrm.action = "/servlet/com.sino.nm.ams.spare.invprivi.servlet.AmsInvPriviServlet?act=<%=WebActionConstant.QUERY_ACTION%>";
            mainFrm.submit();
        }
        else {
            alert("至少需要一个查询条件");
    ...
    <%--mainFrm.act.value = "<%=WebActionConstant.SAVE_ACTION%>";--%>
        mainFrm.action = "/servlet/com.sino.nm.ams.spare.invprivi.servlet.AmsInvPriviServlet?act=<%=WebActionConstant.SAVE_ACTION%>";
        mainFrm.submit();
    }
