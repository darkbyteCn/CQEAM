...
%>
<form name="mainFrm"  method="post" action="/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeServlet">
<script type="text/javascript">
    printTitleBar("非条码物资入库查询");
</script>
...
function do_Create(){
    var url = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeServlet?act=<%=WebActionConstant.NEW_ACTION%>"+"&flag="+"IN";
...
//	document.mainFrm.flexValueId.value = primaryKey;
	...
	var url = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId="+primaryKey;
    var popscript = "width=1020,height=700,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=yes,location=no, status=yes";
    window.open(url,"xgrkOrder",popscript);
}
