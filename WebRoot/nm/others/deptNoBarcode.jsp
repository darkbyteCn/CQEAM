...
%>
<form name="mainForm" action="/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeServlet" method="post">
...
<fieldset>
    <legend>设备信息
        ...
        %>
        <img src="/images/button/addData.gif" alt="添加数据" onclick="createLine();">
...
function do_SelectObject() {
    var projects = getLookUpValues("<%=LookUpConstant.LOOK_UP_DEPT_IN%>", 48, 30, "organizationId=<%=user.getOrganizationId()%>&objectCategory=<%=DictConstant.INV_NORMAL%>&actioncode="+"INV_IN");
    if (projects) {
