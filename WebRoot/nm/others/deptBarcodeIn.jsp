...
%>
 <form name="mainForm" action="/servlet/com.sino.nm.ams.others.servlet.DeptItemBarcodeInServlet" method="post">
...
<fieldset>
    <legend>
        ...
        <img src="/images/button/save.gif" alt="暂存" id="img3" onClick="do_SavePo(1);">
   ...
   <%-- <div style="left:1px;width:100%;overflow-y:scroll" id="headDiv">
    ...
    <script type="text/javascript">
        var columnArr = new Array("checkbox","设备条码","设备名称","规格型号");
...
<script type="text/javascript">
    ...
    function do_SelectObject() {
        ...
        var ac="INV_IN" ;
        var projects = getLookUpValues("<%=LookUpConstant.LOOK_UP_DEPT_IN%>", 48, 30,"organizationId=<%=user.getOrganizationId()%>&objectCategory="+objectCategory+"&actioncode="+ac);
        if(projects){
