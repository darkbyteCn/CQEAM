...
%>
<form name="mainFrm"  method="post" action="/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeOutServlet">
<script type="text/javascript">
    printTitleBar("非条码物资出库查询");
</script>
<table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" style="background-color:#efefef">
	<tr>
        ...
        <td height="22" colspan="2" align="center"><img src="/images/button/add.gif" onclick="do_Create();"></td>
    </tr>
	<tr>
		...
		<td height="22" colspan="2" align="center"><img src="/images/button/query.gif" onclick="do_Search();"></td>
	</tr>
</table>
...
function do_Create(){
    var url = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeOutServlet?act=<%=WebActionConstant.NEW_ACTION%>"+"&flag="+"OUT"+"&fromObjectNo="+document.mainFrm.fromObjectNo.value;
...
//	document.mainFrm.flexValueId.value = primaryKey;
	...
	var url = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeOutServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId="+primaryKey;
    var popscript = "width=1020,height=700,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=yes,location=no, status=yes";
    window.open(url,"xgrkOrder",popscript);
}
