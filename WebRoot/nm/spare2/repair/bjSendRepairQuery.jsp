...
<%
    ...
    String url = "/servlet/com.sino.nm.spare2.repair.servlet.BjSendRepairServlet";
%>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.nm.spare2.repair.servlet.BjSendRepairServlet">
