...
%>
<form name="mainForm" action="/servlet/com.sino.nm.spare2.repair.servlet.BjSendRepairServlet" method="post">
...
<fieldset>
    <legend>
        <%
            ...
            if (!amsItemTransH.getTransStatus().equals(DictConstant.COMPLETED) && amsItemTransH.getCreatedBy()==sfUser.getUserId()) {
        %>
    ...
    <script type="text/javascript">
        var columnArr = new Array("checkbox", "物料编码", "设备名称", "规格型号", "可用量", "送修数量");
...
<script type="text/javascript">
    ...
    function do_print() {
        var url = "/servlet/com.sino.nm.spare2.repair.servlet.BjSendRepairServlet?act=print&transId=" + mainForm.transId.value;
