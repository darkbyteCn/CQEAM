...
<%
    ...
    String url = "/servlet/com.sino.nm.spare2.servlet.BjInvTransServlet";
%>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.nm.spare2.servlet.BjInvTransServlet">
