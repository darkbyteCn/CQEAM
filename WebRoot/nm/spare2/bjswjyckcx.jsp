...
<form name="mainFrm" method="POST" action="/servlet/com.sino.nm.spare2.servlet.BjswyjckcxServlet">
    ...
    <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" class="queryHeadBg">
        ...
        <tr>
            ...
            <td height="22" align="left"><img src="/images/button/query.gif" onclick="do_Search();" alt="查询"></td>
        </tr>
    </table>
