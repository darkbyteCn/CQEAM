...
<%
    ...
    String url = "/servlet/com.sino.nm.spare2.returnBj.servlet.BjReturnRepairServlet";
%>
...
<form name="mainForm" method="POST" action="<%=url%>">
    ...
    <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" class="queryHeadBg">
        ...
        <tr>
            ...
            <td height="22" colspan="2" align="right"><img src="/images/button/query.gif" onclick="do_Search();"
                                                           alt="查询">&nbsp;&nbsp;<img src="/images/button/add.gif"
