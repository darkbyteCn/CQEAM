...
%>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.nm.spare2.servlet.BjswjyckServlet">
...
function do_Create(){
    var url = "/servlet/com.sino.nm.spare2.servlet.AmsItemTransHServlet?act=<%=WebActionConstant.NEW_ACTION%>";
...
//	document.mainFrm.flexValueId.value = primaryKey;
	...
	var url = "/servlet/com.sino.nm.spare2.servlet.BjswjyckServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId="+primaryKey;
    var popscript = "width=1020,height=700,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=yes,location=no, status=yes";
