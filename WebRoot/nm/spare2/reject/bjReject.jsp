...
%>
<form action="/servlet/com.sino.nm.spare2.reject.servlet.AmsBjRejectServlet" name="mainForm" method="post">
...
<fieldset>
    <legend>
        ...
        <img src="/images/button/submit.gif" alt="提交" onClick="submitH()">
        ...
        <table width="100%" border="1" bordercolor="#9FD6FF" id="mtlTable" cellpadding="1" cellspacing="0">
            ...
            <tr height=20px onMouseMove="style.backgroundColor='#EFEFEF'"
                ...
                <td width="8%"><input type="text" class="blueBorderYellow" name="quantity" id="quantity<%=i%>"
                                      ...
                                      value="<%=lineDto.getQuantity()>0?lineDto.getQuantity():0%>">
                </td>
