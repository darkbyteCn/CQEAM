...
%>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.nm.spare2.reject.servlet.AmsBjRejectServlet">
...
function do_Create(){
    ...
    var url = "/servlet/com.sino.nm.spare2.reject.servlet.AmsBjRejectServlet";
