...
%>
<form action="/servlet/com.sino.nm.spare2.query.servlet.AmsBjTransQueryServlet" name="mainForm" method="post">
...
//        dropSpecialOption(transStatus, 'APPROVED');
    ...
    function do_ShowDetail(transId, transType) {
        ...
        var url = "/servlet/com.sino.nm.spare2.query.servlet.AmsBjTransQueryServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId=" + transId + "&transType=" + transType;
