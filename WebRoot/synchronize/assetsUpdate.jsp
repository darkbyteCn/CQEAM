...
%>
    <table width="100%" border="0" style="width:100%;top:0">
        ...
        <tr>
            ...
            <td width="20%"><input style="width:80%" class="input_style1" type="text" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>"><a href="#" onclick="chooseSit();" title="点击选择地点" class="linka">[…]</a></td>
            ...
            <td align="left" width="12%"><input class="input_style1" type="text" name="matchUserName" value="<%=dto.getMatchUserName()%>" style="width:100%" onclick="do_selectUser();" title="点击选择用户" readonly></td>
...
%>
    <table width="100%" border="0" style="width:100%;top:0">
        ...
        <tr>
            ...
            <td align="right" width="8%">EAM地点：</td>
            <td width="30%"><input style="width:80%" type="text" class="input_style1" name="newAssetsLocation" value="<%=dto.getNewAssetsLocation()%>"><a href="#" onclick="chooseSit();" title="点击选择地点" class="linka">[…]</a></td>
            <td align="right" width="8%">匹配人</td>
            <td align="left" width="12%"><input  type="text" class="input_style2" name="matchUserName" value="<%=dto.getMatchUserName()%>" style="width:100%" onclick="do_selectUser();" title="点击选择用户" readonly></td>
            <td align="right" width="10%">项目名称：</td>
            <td align="left" width="12%"><input type="text" class="input_style1" name="projectName" value="<%=dto.getProjectName()%>" style="width:100%" size="20"></td>
        </tr>
        <tr>
    ...
    <div id="headDiv" style="position:absolute;width:840px;overflow:hidden;top:96px;padding:0px; margin:0px;">
        <table width="240%" class="headerTable" border="1" cellpadding="0" cellspacing="0">
            <tr height="22" onClick="executeClick(this)" style="cursor:hand">
                ...
                <td width="12%" align="center">MIS地点</td>
                <td width="12%" align="center">EAM地点</td>
