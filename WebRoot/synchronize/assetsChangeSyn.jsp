...
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.synchronize.servlet.AssetsChangeSynServlet">
<jsp:include page="/message/MessageProcess"/>
    <script type="text/javascript">
        printTitleBar("资产变动直接同步(市用)")
    </script>
    ...
    <div id="dataDiv" style="overflow:scroll;height:368px;width:857px;position:absolute;top:93px;left:1px" align="left"
...
function do_syschronize() {
	...
	document.getElementById("$$$waitTipMsg$$$").style.visibility = "visible";
	mainFrm.action = "/servlet/com.sino.ams.synchronize.servlet.AssetsChangeSynServlet";
