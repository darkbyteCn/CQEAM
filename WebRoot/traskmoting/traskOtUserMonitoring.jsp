		...
		<div
			...
			<input type="hidden" name="act" value="">
				<table>
                    ...
                    <td width="2%"></td>
                    <td colspan="6" ><img id='<%=btidSubName%>' STYLE='cursor:pointer' border="0" alt="expand" src="/images/expand.gif" onclick="doOutline(this)">&nbsp;<font color="blue"><%=std.getSfactSignStatus()%></font></td><td bordercolordark=white bordercolorlight=white nowrap></td>
                    </tr>
                    <%
                            l = 1;
                            signStatus = status;
