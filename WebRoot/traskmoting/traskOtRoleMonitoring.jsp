    ...
    <form name="listform" action="/servlet/com.sino.traskmoting.servlet.SfActInfoTaskServlet" method="POST">
       ...
       function printTool(){
           ...
           toolBar.SinoActions = new Array(ArrAction,ArrAction1,ArrAction4,ArrAction5);
            ...
            toolBar.treeViewTitle = new Array("角色","<input type=checkbox name='checkAll' STYLE='cursor:pointer' onclick='ChangeCheckListEx();'>","任务名称","签收时间","预定时间","转发时间","");
            toolBar.treeViewWidth = new Array("3%","2%","15%","20%","20%","20%","2%");
               toolBar.print();
        }
			...
			align="left">
			 <input type="hidden" name="act" value="">
				<table   width="100%">
                    ...
                    <tr id="<%=tridName%>">
						<td colspan="7">
							<img id='<%=btidName%>' STYLE='cursor:pointer' border="0" alt="expand" src="/images/expand.gif" onclick="doOutline(this)" />&nbsp;<font color="blue"><%=std.getSfactTaskRole()%></font></td>
                    ...
                    <%
                        ...
                        String subName;
                        if(!applColumn.equals(applColumn1) || isNewStatus) {
                            isNewStatus = false;
                            l = 1;
                    ...
                    <td width="2%"></td>
                    <td colspan="6" ><img id='<%=btidSubName%>' STYLE='cursor:pointer' border="0" alt="expand" src="/images/expand.gif" onclick="doOutline(this)">&nbsp;<font color="blue"><%=std.getSfactApplColumn1()%></font></td><td bordercolordark=white bordercolorlight=white nowrap></td>
                    </tr>
                    <%
                            l = 1;
                    		applColumn1 = applColumn;
                        } else {
                            l++;
                        }
...
//    signDueDateCal.setTime(now.getTime());
                    ...
                    <td width="20%" bordercolordark=white bordercolorlight=white nowrap align="LEFT"><font color="black"><table border=0 width=100% style='cursor:pointer'><tr><td nowrap  onclick="do_ShowDetail('<%=std.getSfactActId()%>'); return false;"><%=std.getSfactFromDate()%></td></tr></table></font></td>
                    <%
                        } else {
                    %>
