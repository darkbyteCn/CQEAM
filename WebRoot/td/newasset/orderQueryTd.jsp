...
<script type="text/javascript">
    ...
    <table bgcolor="#E9EAE9" style="width:100%;TABLE-LAYOUT:fixed;word-break:break-all">
        <tr>
<%
	if(transType.equals(AssetsDictConstant.ASS_RED)){//资产调拨单据
%>
...
<%
	if(!transType.equals(AssetsDictConstant.ASS_RED)){//其他资产单据
%>
