...
<jsp:include page="/td/newasset/transLineDetailTd.jsp" flush="true"/>
    ...
    <div style="position:absolute;bottom:0px;top:700px;left:0px;right:0px;width:100%;height:100%">
         <jsp:include page="/td/newasset/uploadIncludeTd.jsp" flush="true"/>
			...
			if(transferType == "<%=AssetsDictConstant.TRANS_INN_DEPT%>"){//部门内调拨
                ...
                if(sectionRight == "<%=AssetsDictConstant.END_BTW_DEPT%>"){
                    ...
                    if(attribute1 != "<%=AssetsDictConstant.GROUP_PROP_SPEC%>"){
                        paramObj.flowCode = mainFrm.faContentCode.value; //MGR-ASSETS
                    }
				}
...
function do_ProduceNewTag() {
	var url = "/servlet/com.sino.td.newasset.servlet.TdNewTagProduceServlet";
