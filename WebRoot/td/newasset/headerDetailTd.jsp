		...
		<td>
			<table width=100% border="0">
			    ...
			    <tr>
			        ...
			        <td width=17%><input name="accessSheet" readonly style="border-style:solid; border-width:0px; width:100%; background-color:#F2F9FF" value="<%=headerDTO.getAccessSheet()%>"></td>
                    <td width="8%" height="60" align="right">报废说明：</td>
			    	<td width="92%" height="60" colspan="6"><textarea name="createdReason" readonly style="border-style:solid; border-width:0px; width:100%;height:100%; background-color:#F2F9FF"><%=headerDTO.getCreatedReason()%></textarea></td>
			    </tr>
			</table>
		</td>
	</tr>
