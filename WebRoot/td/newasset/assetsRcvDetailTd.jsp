...
<jsp:include page="/td/newasset/receiveLineTd.jsp" flush="true"/>
</fieldset>
...
var srcToOrgValue = mainFrm.toOrganizationId.value;
if(mainFrm.fromDept){
...
function do_Receive(){
	...
	{
//	var fieldNames = "assignedToLocationName;responsibilityUserName;depreciationAccount;faCategoryCode";
//	var fieldLabels = "调入地点;新责任人;新折旧账户;新类别";
	...
	if(formValidate(fieldNames, fieldLabels, validateType)){
		mainFrm.act.value = "<%=AssetsActionConstant.ASSIGN_ACTION%>";
		mainFrm.action = "/servlet/com.sino.td.newasset.servlet.TdReceiveServlet";
		mainFrm.submit();
