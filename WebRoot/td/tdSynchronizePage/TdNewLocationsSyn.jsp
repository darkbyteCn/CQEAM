...
<table width="100%" border="0" bgcolor="#EFEFEF" style="width:100%">
	<tr>
        ...
        <td width="12%">
        	<input style="width:80%" type="text" name="startDate" value="<%=StrUtil.nullToString(dto.getStartDate()) %>" title="点击选择起始日期" readonly class="readonlyInput" onclick="gfPop.fStartPop(startDate, endDate)">
        </td>
        <td align = "right" width="8">至：</td>
        <td width="12%">
        	<input style="width:80%" type="text" name="endDate" value="<%=StrUtil.nullToString(dto.getEndDate())%>" title="点击选择结束日期" readonly class="readonlyInput" onclick="gfPop.fEndPop(startDate, endDate)">
        </td>
