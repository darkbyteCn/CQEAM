...
<%@ page import="com.sino.ams.newasset.dto.AmsAssetsPriviDTO"%>
...
<form name="mainFrm" method="post" action="/servlet/com.sino.td.synAssets.servlet.TdAssetsTransServlet">
...
<table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF"  style="width:100%">
	<tr>
		...
		<td align="left" rowspan="2" width="20%"><img src="/images/eam_images/search.jpg" style="cursor:'hand'"  onclick="do_search();" alt="查询">&nbsp;&nbsp;<img src="/images/eam_images/export.jpg" style="cursor:'hand'"  onclick="do_Export();" alt="导出">&nbsp;&nbsp;<img src="/images/button/synchronize.gif" style="cursor:'hand'" onclick="do_syschronize();" alt="ERP同步"></td>
	</tr>
	<tr>
