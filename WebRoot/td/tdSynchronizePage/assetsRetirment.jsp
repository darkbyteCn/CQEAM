...
<form name="mainFrm" method="post" action="/servlet/srv.tdams.assetretirment.servlet.ImportAssetRetirmentServlet">
...
<table width="100%" topmargin="0" border="0" bgcolor="#EFEFEF"  style="width:100%">
	<tr>
        ...
        <td align="left" width="20%"><select style="width:60%" name="organizationId"><%=dto.getOrganizationOpt()%></select> </td>
		<td align="left" width="20%"><img src="/images/eam_images/search.jpg" style="cursor:'hand'"  onclick="do_search();" alt="查询">&nbsp;&nbsp;<img src="/images/button/synchronize.gif" style="cursor:'hand'" onclick="do_syschronize();" alt="ERP同步"></td>
	</tr>
