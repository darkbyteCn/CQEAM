...
<html>
	...
	<body leftmargin="0" topmargin="0"
        ...
        <div id="buttonDiv" style="position:absolute;top:160px;left:1px;width:100%">
        <!-- 
    ...
    <div id="dataDiv" style="overflow:scroll;height:100%;width:100%;position:absolute;top:225px;left:0px;height:310px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table id="dataTable" width="100%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
            ...
            <tr id="model" class="dataTR" style="display:none">
			    <td width="15%" style="cursor:pointer" ><input type="text" name="orderTypeName"   class="finput" readonly/></td>
                <td width="15%" style="cursor:pointer" ><input type="text" name="flag"     class="finput" readonly/></td>
                <td width="15%" style="cursor:pointer" ><input type="text" name="orderSum"    readonly class="finput"/></td>
                <td width="35%" style="cursor:pointer" ><input type="text" name="errorMessage"   readonly class="finput"/> </td>
            </tr>
       <%  
            }
        %>
