...
<html>
	...
	<script type="text/javascript" src="/yearchecktaskmanager/yeartchecktask.js"></script>
		<%
			...
			List lineSet = (List) request.getAttribute("ORDER_LINE_DATA");
	...
	<body leftmargin="0" topmargin="0"
		...
		<form name="mainFrm" method="post"
		 ...
		 <!-- 
		   <tr>
			  ...
			  <td width="20%">
			     <input name="addressWireLess" id="addressWireLess" class="input_style2" readonly style="width: 95%;" value="无资产资产盘点责任人">
			  </td>
			  <td align=right width="15%">
						实地[非无线类]下发方式：
			   </td>
			  <td width="20%">
			  	<input name="addressNonWireLess" id="addressNonWireLess" class="input_style2" readonly style="width: 95%;" value="部门资产管理员">
			  </td>
		   </tr>
		    -->
			<tr>
        ...
        <div id="headDiv" style="overflow-y:scroll;overflow-x:hidden;position:absolute;top:181px;left:0px;width:100%">
		    <table class="eamHeaderTable" border="1" width="100%">
		        <tr height=23px>
		            <td align=center width="15%">盘点任务类型</td>
		            <td align=center width="15%">下发结果</td>
		            <td align=center width="15%">已下发任务个数</td>
		            <td align=center width="35%">错误信息</td>
    ...
    <div id="dataDiv" style="overflow:scroll;height:100%;width:100%;position:absolute;top:205px;left:0px;height:310px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table id="dataTable" width="100%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
            ...
            <%
                    	AssetsYearCheckSendOneTimeDTO lineDTO = null;
                        for (int i = 0; i < lineSet.size(); i++) {
                            lineDTO = (AssetsYearCheckSendOneTimeDTO) lineSet.get(i);
            %>
              <tr id="model" class="dataTR">
			    <td width="15%" style="cursor:pointer" ><input type="text" name="orderTypeName"  value="<%=lineDTO.getOrderType() %>" class="finput" readonly/></td>
                <td width="15%" style="cursor:pointer" ><input type="text" name="flag"   value="<%=lineDTO.getFlag() %>" class="finput" readonly/></td>
                <td width="15%" style="cursor:pointer" ><input type="text" name="orderSum"  value="<%=lineDTO.getOrderSum() %>"  readonly class="finput"/></td>
                <td width="35%" style="cursor:pointer" ><input type="text" name="errorMessage"  value="<%=lineDTO.getErrorMessage() %>" readonly class="finput"/> </td>
            </tr>
            <%
                }
             %>
...
var dataTable = document.getElementById("dataTable");
	...
	function do_send(){
	    ...
	    document.mainFrm.act.value = "DO_SEND_ONE_TIME";
