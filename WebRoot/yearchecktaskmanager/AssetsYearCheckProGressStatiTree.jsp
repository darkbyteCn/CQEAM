...
<head>
    ...
    <link href="/yearchecktaskmanager/treetable/master.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/yearchecktaskmanager/treetable/jquery.js"></script>
    <script type="text/javascript" src="/yearchecktaskmanager/treetable/jquery.ui.js"></script>
    
    <link href="/yearchecktaskmanager/treetable/jquery.treeTable.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/yearchecktaskmanager/treetable/jquery.treeTable.js"></script>
