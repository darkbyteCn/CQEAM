...
//    alert("pageObj.innerHTML = " + pageObj.tagName);
...
//    alert(top + height);
	...
	//层显示
	if (addText != "") {
		divObj.innerText = addText + "：" + pageObj.alt;
	} else {
		divObj.innerText = pageObj.alt;
	}
}
 ...
 */
function isAllEmpty(fieldNames) {
	var retValue = true;
	if (!fieldNames) {
		alert("没有指定表单域");
		retValue = false;
