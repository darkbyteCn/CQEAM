...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.sampling.report.servlet.AssetsSamplingReportThreeServlet">
...
<div id="aa" style="overflow-y:scroll;overflow-x:hidden;position:absolute;top:21px;left:0px;width:100%" class="crystalScroll">
	<table border="1" class="eamHeaderTable" width="200%">
...
%>
		<tr height="22">
  			...
  			<td width="5%"><input type="text" class="finput2" readonly value="<%=row.getValue("ITEM_NAME")%>"></td>
  			<td width="6%"><input type="text" class="finput2" readonly value="<%=row.getValue("ITEM_SPEC")%>"></td>
