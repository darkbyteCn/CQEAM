...
<form method="post" name="mainFrm" action="/servlet/com.sino.ams.newasset.message.servlet.FreeAssetsMsgSetAndQueryServlet">
...
<%	    
		...
		FreeAssetsMsgSetAndQueryDTO message = null;
    	String msgCategoryId = "";
        for (int i = 0; i < dtoCount; i++) {
            message = (FreeAssetsMsgSetAndQueryDTO)dtos.getDTO(i);
...
function do_Search() {
    ...
    mainFrm.action="/servlet/com.sino.ams.newasset.message.servlet.FreeAssetsMsgSetAndQueryServlet";
    mainFrm.submit();
}

function do_ShowDetail(msgCategoryId) {
    mainFrm.act.value = '<%=AMSActionConstant.DETAIL_ACTION%>';
    mainFrm.action="/servlet/com.sino.ams.newasset.message.servlet.FreeAssetsMsgSetAndQueryServlet?msgCategoryId=" + msgCategoryId;
    mainFrm.submit();
}
