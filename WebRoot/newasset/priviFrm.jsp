...
<%
	...
	String topURL = "/servlet/com.sino.ams.newasset.servlet.PriviTopServlet?roleId=" + roleId + "&roleName=" + roleName;
	String leftURL = "/servlet/com.sino.ams.newasset.servlet.PriviLeftServlet?roleId=" + roleId + "&roleName=" + roleName;
%>
<html>
<head>
