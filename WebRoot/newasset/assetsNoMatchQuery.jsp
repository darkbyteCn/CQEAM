...
%>
<form action="/servlet/com.sino.ams.newasset.servlet.AmsAssetsNoMatchServlet" name="mainForm" method="post">
    <script type="text/javascript">
        printTitleBar("未匹配资产统计")
    </script>
    ...
    <script type="text/javascript">
        var columnArr = new Array("公司名称", "资产类别", "未匹配数量");
        var widthArr = new Array("20%", "10%",  "10%");
    ...
    <div style="overflow-y:scroll;left:1px;width:100%;height:300px">
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'"
                ...
                <td width="20%" align="center"><%=row.getValue("ORGANIZATION_NAME")%>
                </td>
                <td width="10%" align="left"><%=row.getValue("FA_CATEGORY_CODE")%>
                </td>
                <td width="10%" align="center"><%=String.valueOf(row.getValue("NO_MATCH_QTY"))%>
                </td>
