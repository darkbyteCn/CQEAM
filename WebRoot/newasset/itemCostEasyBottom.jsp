    ...
    <div id="headDiv" style="overflow-x:hidden;overflow-y:scroll;position:absolute;top:0px;left:0px;width:100%">
        <table border=1 width="200%" class="headerTable">
            <tr height="22px">
                ...
                <td width="2%" align="center" style="color: #FFFFFF" background="/images/bg_01.gif">启用日期</td>
    ...
    <div id="dataDiv" style="overflow:scroll;;width:100%;position:absolute;top:22px;left:0px;height:55%" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table id="dataTable" width="200%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
            <tr>
				...
				<td width="2%"><input type="text" name="responsibilityUserName" class="input_style2" style="width:100%" style="width:100%;cursor:hand" readonly title="点击选择责任人" onClick="do_SelectPerson();"></td>
