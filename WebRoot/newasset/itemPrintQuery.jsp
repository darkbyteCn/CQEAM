...
<form action="/servlet/com.sino.ams.newasset.servlet.ItemOrderPrintServlet" name="mainFrm" method="post">
...
%>
            ...
            <td width="20%">
				<input class="input_style2" type="text" name="startDate" value="<%=dto.getStartDate()%>" style="width:48%" title="点击选择日期" readonly class="readonlyInput" onclick="gfPop.fStartPop(startDate, endDate)">
				<input class="input_style2" type="text" name="endDate" value="<%=dto.getEndDate()%>" style="width:48%" title="点击选择日期" readonly class="readonlyInput" onclick="gfPop.fEndPop(startDate, endDate)">
            </td>
...
function showDetail(transId){
    ...
    var url = "/servlet/com.sino.ams.newasset.servlet.ItemOrderPrintServlet?act=<%=AssetsActionConstant.DETAIL_ACTION%>&transType=" + transType+"&transId="+transId;
