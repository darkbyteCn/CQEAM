...
<%
	...
	LoseHeaderDTO dto = (LoseHeaderDTO)parser.getAttribute( QueryConstant.QUERY_DTO );
	RowSet rows = (RowSet) request.getAttribute(QueryConstant.SPLIT_DATA_VIEW);
	String pageTitle = "挂失单据打印";
...
<form action="<%= LoseURLListConstant.LOSE_PRINT_SERVELT %>" method="post" name="mainFrm">
...
function showDetail(transId){
	var url = "<%= LoseURLListConstant.LOSE_PRINT_SERVELT %>?act=<%= WebActionConstant.DETAIL_ACTION %>&transId="+transId;
