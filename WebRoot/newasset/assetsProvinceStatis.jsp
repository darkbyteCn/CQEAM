...
<script type="text/javascript">
    ...
    var widthArr = new Array("10%","12%","26%","26%", "8%", "8%", "8%");
...
%>		
			<tr class="dataTR">
				...
				<td width="12%" align="left"><%=row.getValue("FA_CATEGORY2")%></td>
				<td width="26%" align="left"><%=row.getValue("ASSETS_DESCRIPTION")%></td>
				<td width="26%" align="left"><%=row.getValue("MODEL_NUMBER")%></td>
				<td width="8%" align="center" ><%=row.getValue("UNIT_OF_MEASURE")%></td>
				<td width="8%" align="right" ><%=row.getValue("ASSETS_COUNT")%>&nbsp;</td>
