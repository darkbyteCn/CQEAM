  ...
  <form name="mainFrm" method="post" action="/servlet/com.sino.ams.newSite.servlet.ImpEamAddressServlet" enctype="multipart/form-data" >
      ...
      <table width="80%" border="0" align="center">
          ...
          <tr style="width:100%;height:30px">
              <td style="width:100%">1：此处导入地点(第二段)维护流程业务；</td>
          </tr>
          <tr style="width:100%;height:30px">
...
<script type="text/javascript">
    function do_sub(){
        if(do_Validate(true)){
        	if(confirm("确定导入数据将清除已导入或已添加的数据，是否继续？继续请点击“确定”按钮，否则请点击“取消”按钮！")){
				mainFrm.submit();
			}
        }
    }
    ...
    function do_DownloadTemplate(){
        window.open('/document/template/Location Importing Template3.zip');
        return false;
    }
