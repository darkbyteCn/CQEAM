...
<body onkeydown="autoExeFunction('do_search()');" onload="initPage();">
	...
	<form action="/servlet/com.sino.ams.newSite.servlet.EamAddressAddServlet" name="mainFrm" method="post">
		<input type="hidden" name="act" value="">
		<script type="text/javascript">
		    printTitleBar("地点维护单据查询")
		</script>
...
<script type="text/javascript">
	...
	function showDetail(transId){
	   	var url = "/servlet/com.sino.ams.newSite.servlet.EamAddressAddServlet?act=<%=AssetsActionConstant.DETAIL_ACTION%>&transId="+transId;
