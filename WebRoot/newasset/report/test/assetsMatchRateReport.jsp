<%@ page import="com.sino.ams.newasset.report.test.dto.SpecialAssetsReportDTO"%>
<%--
...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.test.servlet.AssetsMatchRateServlet">
    ...
    <table width="100%" border="0" class="queryHeadBg">
		<tr>
			...
			<td width="15%" align="left">
                <select name="organizationId" style="width:55%"><%=request.getAttribute(AssetsWebAttributes.CITY_OPTION)%></select>
            </td>
<%
    if (comManager && !provManager) {
%>
            <td width="6%" align="right">责任部门：</td>
...
<%}%>
            ...
            <td width="10%" align="left">
                <input type="text" name="endDate" value="<%=dto.getEndDate()%>" style="width:60%" title="点击选择截至日期" readonly class="readonlyInput" onclick="gfPop.fEndPop('', endDate)"><img src="/images/calendar.gif" alt="点击选择截至日期" onclick="gfPop.fEndPop('', endDate);">
            </td>
            <td width="10%">
...
function do_Search(){
	...
	mainFrm.action = "/servlet/com.sino.ams.newasset.report.test.servlet.AssetsMatchRateServlet";
	mainFrm.submit();
