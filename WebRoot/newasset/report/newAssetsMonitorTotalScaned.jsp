...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsMonitorTotalScanedServlet">
<%=WebConstant.WAIT_TIP_MSG%>
    <table width="100%" border="0" class="queryHeadBg">
		<tr>
			...
			<td width="25%"><select name="costCenterCode" style="width:100%"><%=dto.getCostCenterOpt()%></select></td>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:21px;left:1px;width:990px">
	...
	<table border="1" style="color: #FFFFFF" bgcolor="#2983CB" width="200%">
		<tr height="21">
			...
			<td width="6%" align="center">启用日期</td>
...
<div id="dataDiv" style="overflow:scroll;height:80%;width:1007px;position:absolute;top:44px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
...
%>
		<tr height="22">
			...
			<td width="10%"><input type="text" class="finput" readonly value="<%=row.getValue("AMS_ITEM_NAME")%>"></td>
			<td width="10%"><input type="text" class="finput" readonly value="<%=row.getValue("AMS_ITEM_SPEC")%>"></td>
			<td width="6%"><input type="text" class="finput2" readonly value="<%=row.getValue("AMS_START_DATE")%>"></td>

			<td width="10%"><input type="text" class="finput2" readonly value="<%=row.getValue("AMS_LOCATION_CODE")%>"></td>
			<td width="14%"><input type="text" class="finput" readonly value="<%=row.getValue("AMS_LOCATION")%>"></td>
			<td width="8%"><input type="text" class="finput2" readonly value="<%=row.getValue("AMS_EMPLOYEE_NUMBER")%>"></td>

			<td width="8%"><input type="text" class="finput" readonly value="<%=row.getValue("AMS_USER_NAME")%>"></td>
			<td width="10%"><input type="text" class="finput" readonly value="<%=row.getValue("AMS_PROJECT_NAME")%>"></td>
			<td width="8%"><input type="text" class="finput2" readonly value="<%=row.getValue("AMS_PROJECT_NUMBER")%>"></td>
		</tr>
<%
		}
	}
