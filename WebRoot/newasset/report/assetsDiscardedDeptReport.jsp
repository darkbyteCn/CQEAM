...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.DiscardedDeptAssetsReportServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
    var deptAssetsType = "<%=dto.getDeptAssetsType()%>";
    printTitleBar("资产基础报表>>部门资产构成分布(报废)")
</script>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:46px;left:1px;width:170%">
	<table class="eamDbHeaderTable" border="1" width="170%" style="height:40">
		<tr height="20">
