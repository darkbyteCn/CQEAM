...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsMonitorFalseServlet">
...
function do_Search(){
    ...
    if(objExp.test(threshold)){
        if(parseInt(threshold) <= 30){
            document.mainFrm.action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsMonitorFalseServlet";
