...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsNotScanedServlet">
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:21px;left:1px;width:990px">
	...
	<table border="1" style="color: #FFFFFF" bgcolor="#2983CB" width="400%">
		<tr height="21">
			...
			<td width="6%" align="center" >员工编号</td>
...
%>
		<tr height="22">
  			<td width="8%"><input type="text" class="finput" readonly value="<%=row.getValue("COMPANY")%>"></td>
			...
			<td width="14%"><input type="text" class="finput" readonly value="<%=row.getValue("MIS_LOCATION")%>"></td>

			<td width="6%"><input type="text" class="finput2" readonly value="<%=row.getValue("MIS_EMPLOYEE_NUMBER")%>"></td>
			<td width="8%"><input type="text" class="finput" readonly value="<%=row.getValue("MIS_USER_NAME")%>"></td>

			<td width="10%"><input type="text" class="finput" readonly value="<%=row.getValue("MIS_PROJECT_NAME")%>"></td>
