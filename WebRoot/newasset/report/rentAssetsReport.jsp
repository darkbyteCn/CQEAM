...
<%--
  JSP Name :    rentAssetsReport.jsp
  Author:		李轶
  Date: 2009-6-2
  Time: 10:20:55
--%>
<html>
<head><title>出租资产统计</title>
</head>
<%
...
<form action="/servlet/com.sino.ams.newasset.report.servlet.RentAssetsReportServlet" name="mainFrm" method="post">
    <script type="text/javascript">
        printTitleBar("资产基础报表>>出租资产统计")
    </script>
	...
	<div id="dataDiv" style="overflow:scroll;height:72%;width:100%;position:absolute;top:91px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table width="100%" border="1" bordercolor="#666666" id="dataTab" >
            ...
            <tr class="dataTR" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
                ...
                <td width="6%" align = "center"><%=row.getValue("ITEM_NAME")%></td>
                <td width="7%" align = "center"><%=row.getValue("ITEM_SPEC")%></td>
