...
%>
<form name="mainFrm" id="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.CheckResultServletSix">
    ...
    <table width="100%" border="0" class="queryTable">
        <tr>
            ...
            <td width="10%" align="right"><img alt="点击查询" border="0" src="/images/eam_images/search.jpg" onclick="do_Search();"></td>
        </tr>
    </table>
    ...
    <input type="hidden" name="analyseType" value="<%=AssetsDictConstant.CHECK_RESULT_6%>"><!--用于控制导出类型-->
...
<div id="aa" style="overflow-y:scroll;overflow-x:hidden;position:absolute;top:26px;left:0px;width:100%" class="crystalScroll">
    ...
    <table class="eamHeaderTable" border="1" width="360%">
        <tr height="22">
            ...
            <td width="8%" align="center">资产类别</td>
            ...
            <td width="9%" align="center">折旧费用账户</td>
...
<div style="overflow:scroll;height:510px;width:100%;position:absolute;top:49px;left:0px" align="left"
    ...
    <table id="dataTable" width="360%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
        ...
        <tr height="22">
            ...
            <td width="5%"><input type="text" class="finput2" readonly value="<%=row.getValue("DEPT_NAME")%>"></td>
            ...
            <td width="9%"><input type="text" class="finput" readonly value="<%=row.getValue("DEPRECIATION_ACCOUNT")%>"></td>
...
<script type="text/javascript">
    ...
    <%
            if (!disabled.equals("")) { //市用
    %>
//        document.mainFrm.costCenterCode.disabled = false;
    <%
    }
    %>
