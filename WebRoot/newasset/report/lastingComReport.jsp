...
%>
    <title>租赁资产统计(公司)</title>
</head>
<body leftmargin="0" topmargin="0" onload="initPage()" onkeydown="autoExeFunction('do_Search();')">
<%=WebConstant.WAIT_TIP_MSG%>
<jsp:include page="/message/MessageProcess"/>
<form method="post" name="mainFrm" action="/servlet/com.sino.ams.newasset.report.servlet.LastingAssetsReportServlet">
    <input type="hidden" name="act">
    <input type="hidden" name="companyName">
    <script type="text/javascript">
        printTitleBar("租赁资产统计（公司）")
    </script>
    <table width="100%">
        <tr height="15">
    ...
    <div id="headDiv" style="overflow:hidden;position:absolute;top:48px;left:1px;width:830px">
        <table border="1" width="100%" class="headerTable" cellpadding="0" cellspacing="0">
            <tr height="22">
                <td width="50%" align="center">公司</td>
                <td width="50%" align="center">租赁资产总量</td>
            </tr>
        </table>
    </div>
    <div id="dataDiv" style="overflow:scroll;height:330px;width:847px;position:absolute;top:72px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table id="dataTable" width="100%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
            ...
            <tr height="20">
                ...
                <td width="25%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("LASTING_COUNT")%>"></td>
            </tr>
            <%
                    }
                }
...
<script type="text/javascript">
    ...
    function do_ShowDetail(organizationId, companyName){
        mainFrm.action = "/servlet/com.sino.ams.newasset.report.servlet.LastingAssetsReportServlet";
