...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsIdenticalDeptServlet">
...
<div id="dataDiv" style="overflow:scroll;height:542px;width:1007px;position:absolute;top:43px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
