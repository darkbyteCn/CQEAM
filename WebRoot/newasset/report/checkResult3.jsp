...
%>
<form name="mainFrm" id="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.CheckResultServletThree">
    ...
    <input type="hidden" name="analyseType" value="<%=AssetsDictConstant.CHECK_RESULT_3%>"><!--用于控制导出类型-->
