...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.CTAreaAssetsReportServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
    var areaAssetsType = "<%=dto.getAreaAssetsType()%>";
    printTitleBar("资产基础报表>>地域资产构成分布(村通资产)")
</script>
    ...
    <table width="100%" border="0">
		<tr>
			...
			<td width="25%" align="left">
                <select class="select_style1" name="organizationId" style="width:100%"><%=request.getAttribute(AssetsWebAttributes.CITY_OPTION)%></select>
            </td>
            <td width="15%" align="right">会计期间：</td>
            <td width="25%" colspan="3"><select class="select_style1" style="width:30%" name="year"><%=yearOption%></select>—<select class="select_style1" style="width:20%" name="month"><%=monthOption%></select></td>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:46px;left:1px;width:840px">
	<table class="eamDbHeaderTable" border="1" width="330%" height="40" style="table-layout:fixed;word-wrap:break-word">
		<tr height="20">
            ...
            <td width="5%" align="center" rowspan="2" height="10">省市区域占当期资产总数比重</td>
			<td width="5%" align="center" rowspan="2" height="10">县城区域占当期资产总数比重</td>
			<td width="5%" align="center" rowspan="2" height="10">农村区域占当期资产总数比重</td>
...
<div id="dataDiv" style="overflow:scroll;height:72%;width:857px;position:absolute;top:76px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
