...
<script type="text/javascript">
    printTitleBar("资产基础报表>>应用领域统计(出租)")
</script>
	<table width="100%" border="0" class="queryHeadBg">
		<tr>
            ...
            <%--<td width="12%" align="left">--%>
				<%--<input style="width:75%" type="text" name="accountingPeriod" value="<%=StrUtil.nullToString(dto.getAccountingPeriod())%>" title="点击选择会计期" readonly class="noEmptyInput" onclick="gfPop.fPopCalendar(accountingPeriod)">--%>
            <%--</td>--%>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:44px;left:1px;width:200%">
	<table class="headerTable" border="1" width="200%">
        <tr height="22">
			...
			<td width="10%" align="center" rowspan="2" height="10">应用领域</td>
			
            <td width="6%" align="center" height="10" rowspan="2">资产数量</td>
			<td width="6%" align="center" height="10" rowspan="2">原值</td>
            <td width="6%" align="center" height="10" rowspan="2">累计折旧</td>
            <td width="6%" align="center" height="10" rowspan="2">净值</td>
            <td width="6%" align="center" height="10" rowspan="2">累计减值准备</td>
            <td width="6%" align="center" height="10" rowspan="2">净额</td>
			
			<td width="6%" align="center" height="10" rowspan="2">当期折旧</td>
            <td width="6%" align="center" height="10" rowspan="2">占当期资产总额比重</td>
            <%--<td width="6%" align="center" height="10" rowspan="2">比上月增长率</td>--%>
            <td width="6%" align="center" height="10" rowspan="2">较去年同期增长率</td>
...
%>
		<tr>
			<td colspan = "2" height= "22" align = "left">合计：</td>
