...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsMonitorNotScanedServlet">
...
%>
		<tr height="22">
  			<td width="6%"><input type="text" class="finput" readonly value="<%=row.getValue("COMPANY")%>"></td>
			...
			<td width="7%"><input type="text" class="finput2" readonly value="<%=row.getValue("ASSETS_LOCATION_CODE")%>"></td>
			<td width="14%"><input type="text" class="finput" readonly value="<%=row.getValue("ASSETS_LOCATION")%>"></td>
