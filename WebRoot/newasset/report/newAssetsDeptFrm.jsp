...
<%
    ...
    String commonURL = "";
	commonURL += "?act=";
	commonURL += "&costCode=" + costCode;
	commonURL += "&costCenterName=" + costCenterName;
	commonURL += "&startDate=" + startDate;
	commonURL += "&endDate=" + endDate;

	String checkResultURL1 = "/servlet/com.sino.ams.newasset.report.servlet.NewAssetsReportDeptServlet";
	checkResultURL1 += commonURL;

	String checkResultURL2 = "/servlet/com.sino.ams.newasset.report.servlet.NewAssetsScanedDeptServlet";
	checkResultURL2 += commonURL;

	String checkResultURL3 = "/servlet/com.sino.ams.newasset.report.servlet.NewAssetsIdenticalDeptServlet";
	checkResultURL3 += commonURL;

    String checkResultURL4 = "/servlet/com.sino.ams.newasset.report.servlet.NewAssetsDifferentDeptServlet";
	checkResultURL4 += commonURL;

    String checkResultURL5 = "/servlet/com.sino.ams.newasset.report.servlet.NewAssetsNotScanedDeptServlet";
	checkResultURL5 += commonURL;
    String pageTitle = "";
	if(startDate.equals("") && endDate.equals("")){
		pageTitle = "截至今天" + costCenterName + "创建资产盘点情况";
	} else if(!startDate.equals("") && endDate.equals("")){
		pageTitle = startDate + "之后" + costCenterName + "创建资产盘点情况";
	} else if(startDate.equals("") && !endDate.equals("")){
		pageTitle = endDate + "之前" + costCenterName + "创建资产盘点情况";
	} else if(!startDate.equals("") && !endDate.equals("")){
		pageTitle = startDate + "和" + endDate + "之间" + costCenterName + "创建新增资产盘点情况";
	}
%>
<script language="javascript">
...
<form name="mainFrm" method="post" action="">
    ...
    <input type="hidden" name="costCenterName" value="<%=costCenterName%>">
...
function do_Export(exportType){
	...
	if(exportType == "1"){
		...
		tabName = "新增资产";
		action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsReportDeptServlet"
	} else if(exportType == "2"){
		strDiv = "checkResult2";
		strFrm = "checkResultFrm2";
		tabName = "扫描资产";
		action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsScanedDeptServlet"
	} else if(exportType == "3"){
		strDiv = "checkResult3";
		strFrm = "checkResultFrm3";
		tabName = "帐实一致";
		action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsIdenticalDeptServlet"
	} else if(exportType == "4"){
		strDiv = "checkResult4";
		strFrm = "checkResultFrm4";
		tabName = "帐实不符";
		action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsDifferentDeptServlet"
	} else if(exportType == "5"){
		strDiv = "checkResult5";
		strFrm = "checkResultFrm5";
		tabName = "帐实不符";
		action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsNotScanedDeptServlet"
	}
	tabName += "选项卡";
