...
<%--
  JSP Name :    donateAssetsReport.jsp
  Author:		李轶
  Date: 2009-6-2
  Time: 10:20:55
--%>
<html>
<head><title>捐赠资产统计</title>
</head>
<%
...
<form action="/servlet/com.sino.ams.newasset.report.servlet.DonateAssetsReportServlet" name="mainFrm" method="post">
    <script type="text/javascript">
        printTitleBar("资产基础报表>>捐赠资产统计")
    </script>
	...
	<div id="dataDiv" style="overflow:scroll;height:72%;width:100%;position:absolute;top:91px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table width="100%" border="1" bordercolor="#666666" id="dataTab" >
            ...
            <tr class="dataTR" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
                ...
                <td width="3%" align= "center"><%=row.getValue("ITEM_QTY")%></td>                
                <td width="5%" align= "center"><%=row.getValue("COST")%></td>
