...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsMonitorByMisServlet">
...
<div id="dataDiv" style="overflow:scroll;height:80%;width:1007px;position:absolute;top:41px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
