...
<title>已完成新转资并且需PDA扫描确认资产</title>
 </head>
...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.NewAssetsMonitorNeedScanedServlet">
...
<div id="dataDiv" style="overflow:scroll;height:80%;width:1007px;position:absolute;top:64px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
