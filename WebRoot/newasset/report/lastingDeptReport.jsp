...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.LastingAssetsDeptReportServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
    printTitleBar("租赁资产统计（部门）");
</script>
...
function do_Search(){
	...
	document.mainFrm.action = "/servlet/com.sino.ams.newasset.report.servlet.LastingAssetsDeptReportServlet";
