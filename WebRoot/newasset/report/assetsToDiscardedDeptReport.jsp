...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.report.servlet.ToDiscardedDeptAssetsReportServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
    var deptAssetsType = "<%=dto.getDeptAssetsType()%>";
    printTitleBar("资产基础报表>>部门资产构成分布(待报废)")
</script>
		...
		<tr>
            ...
            %>
	            ...
	            <td width="25%" align="left">
	           		<select class="select_style1" name="responsibilityDept" style="width:97%"><%=request.getAttribute(AssetsWebAttributes.DEPT_OPTIONS)%></select>
	            </td>
            <%	
            }
            %>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:46px;left:1px;width:170%">
	<table class="eamDbHeaderTable" border="1" width="170%" style="height:40px">
		<tr height="20">
			<td width="10%" align="center" rowspan="2" height="10">公司</td>
...
<div id="dataDiv" style="overflow:scroll;height:70%;width:170%;position:absolute;top:86px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
    <table id="dataTable" width="170%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
<%
	if(hasData){
		Row row = null;
        String COMPANY="";
