...
%>
       <legend><span class="STYLE1">日常巡检资产盘点完成率维护页面</span></legend>
<%
    } else if (managerGuideType.equals("COP_MATCH_RATE")) {
%>
       <legend><span class="STYLE1">日常巡检资产盘点账实相符率维护页面</span></legend>
<%
    } else if (managerGuideType.equals("ACCOUNTING_ACCURATE")) {
%>
       <legend><span class="STYLE1">资产核算准确率维护页面</span></legend>
<%
...
%>
        ...
        <tr>
            ...
            <td width="60%" align="left" height="22">
                <input type="text"  class="noEmptyInput" style="width:60%"  value="（期初总固定资产净额+期末总固定资产净额）/2">
            </td>
        </tr>
        <tr>
...
%>
        ...
        <tr>
            <td width="30%" align="right" height="22">值描述：</td>
            <td width="60%" align="left" height="22">
                <input type="text"  class="noEmptyInput" style="width:60%"  value="及时上报次数/考核期应上报次数×100％">
            </td>
        </tr>
        <tr>
            <td width="30%" align="right" height="22">值</td>
...
%>
        <tr>
          ...
          <tr>
            <td width="30%" align="right" height="22">值描述：</td>
            <td width="60%" align="left" height="22">
                <input type="text"  class="noEmptyInput" style="width:60%"  value="系统自动计算的盘亏资产的卡片数量/资产卡片总数量×100％">
            </td>
        </tr>
        <tr>
            <td width="30%" align="right" height="22">值</td>
...
%>
        <tr>
         ...
         <tr>
            <td width="30%" align="right" height="22">值描述：</td>
            <td width="60%" align="left" height="22">
                <input type="text"  class="noEmptyInput" style="width:60%"  value="=盘点中账实相符的资产原值/盘点资产原值×100％">
            </td>
        </tr>
        <tr>
            <td width="30%" align="right" height="22">值</td>
...
%>
        ...
        <tr>
            <td width="30%" align="right" height="22">值描述：</td>
            <td width="60%" align="left" height="22">
                <input type="text"  class="noEmptyInput" style="width:60%"  value="=盘点中账实相符的资产（不包括载频）原值/盘点资产（不包括载频）原值×100％">
            </td>
        </tr>
        <tr>
            <td width="30%" align="right" height="22">值</td>
...
%>
        ...
        <tr>
            <td width="30%" align="right" height="22">值描述：</td>
            <td width="60%" align="left" height="22">
                <input type="text"  class="noEmptyInput" style="width:60%"  value="=盘点中账实相符的资产（不包括载频）卡片数量/盘点资产（不包括载频）卡片总数量×100％">
            </td>
        </tr>
        <tr>
            <td width="30%" align="right" height="22">值</td>
...
%>        <input type="hidden" name="isKpi" value="<%=dto.getKpi()%>">
          <tr>
            ...
            <tr>
                <td width="10%" align="right" height="22">会计期间：</td>
                <td width="60%" align="left" height="22">
                    <input type="text" name="period" style="width:60%" class="noEmptyInput" value="<%=StrUtil.nullToString(dto.getPeriod())%>" title="点击选择会计期" readonly class="noEmptyInput">
                </td>
            </tr>
            <tr>
