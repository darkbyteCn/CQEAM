...
<form method="post" name="mainFrm" action="/servlet/com.sino.ams.newasset.servlet.AmsSynJobServlet">
    <input type="hidden" name="act">
    <input type="hidden" name="companyName">
    <script type="text/javascript">
        printTitleBar("同步JOB运行情况")
    </script>
    ...
    <div id="headDiv" style="overflow:hidden;position:absolute;top:42px;left:1px;width:830px">
        <table border="1" width="100%" class="headerTable" cellpadding="0" cellspacing="0">
            <tr height="22">
                <td width="10%" align="center">JOB名称</td>
                <td width="30%" align="center">JOB来源</td>
                <td width="20%" align="center">上次同步日期</td>
                <td width="20%" align="center">下次同步日期</td>
                <td width="20%" align="center">JOB同步周期</td>
            </tr>
        </table>
    </div>
    <div id="dataDiv" style="overflow:scroll;height:350px;width:847px;position:absolute;top:66px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table id="dataTable" width="100%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
            ...
            %>
            <tr height="22">
                <td width="10%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("JOB")%>"></td>
                <td width="30%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("WHAT")%>"></td>
                <td width="20%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("LAST_DATE")%>"></td>
                <td width="20%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("NEXT_DATE")%>"></td>
                <td width="20%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("INTERVAL")%>"></td>
            </tr>
            <%
                    }
                }
