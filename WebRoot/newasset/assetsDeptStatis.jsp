...
<script type="text/javascript">
	...
	<table width="100%" border="0">
	    <tr>
	    	...
	    	<td width="18%"><input type="text" name="deptName" size="20" class="readonlyInput" readonly style="width:100%" value="<%=dto.getDeptName()%>"  title="点击选择部门" onclick="do_SelectDepartment();"></td>
	    	...
	    	<td width="14%" align="right" rowspan="2">
	    		<img src="/images/eam_images/search.jpg" title="点击查询" onClick="do_Search();">
	    		<img src="/images/eam_images/export.jpg" title="导出到Excel" onClick="do_Export();">
	    	</td>
	    </tr>
	    <tr>
	    	<td width="10%" align="right"><span lang="zh-cn">资产型号</span>：</td>
	    	<td width="18%">
			<input type="text" name="modelNumber" size="20" style="width:100%" value="<%=dto.getModelNumber()%>"></td>
	    	<td width="10%" align="right">启用日期：</td>
	    	<td width="18%">
			<input type="text" name="startDate" size="20" style="width:86%" class="readonlyInput" readonly title="点击选择开始日期" onclick="gfPop.fStartPop(startDate, endDate)" value="<%=dto.getStartDate()%>"><img src="/images/calendar.gif" alt="点击选择开始日期" onclick="gfPop.fStartPop(startDate, endDate)"></td>
	    	<td width="10%" align="right">到：</td>
	    	<td width="18%">
			<input type="text" name="endDate" size="20" style="width:86%" title="点击选择截止日期" readonly class="readonlyInput" onclick="gfPop.fEndPop(startDate, endDate)" value="<%=dto.getEndDate()%>"><img src="/images/calendar.gif" alt="点击选择截止日期" onclick="gfPop.fEndPop(startDate, endDate)"></td>
	    </tr>
	</table>
...
<script type="text/javascript">
    var columnArr = new Array("部门名称", "资产类别一", "资产类别二", "资产名称", "资产型号", "计量单位", "数量", "原值(元)");
