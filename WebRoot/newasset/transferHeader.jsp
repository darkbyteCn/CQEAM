		...
		<td>
			<table width=100% border="0">
			    <tr>
			        ...
			        <td width=17%>
						<input name="fromGroupName"   class="input_style2" readonly style="width:100%; cursor:hand" value="<%=headerDTO.getFromGroupName()%>" title="点击选择或更改“建单组别”" onclick="do_SelectCreateGroup();"></td>
			    </tr>
			    <tr>
		...
		<td>
			<table width=100% border="0">
			    ...
			    <tr>
			        ...
			        <td  height="40"><input name="lossesDate" class="input_style1" readonly style="width:100%; " value="<%=headerDTO.getLossesDate()%>" onclick="gfPop.fPopCalendar(lossesDate)" title="点击选择或更改损耗日期"></td>
