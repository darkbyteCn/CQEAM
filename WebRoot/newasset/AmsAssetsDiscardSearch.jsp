...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.servlet.AmsAssetsDiscardServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
    printTitleBar("资产报废管理>>报废资产查询")
</script>
	<table width="100%" border="0" class="queryHeadBg">
		...
		<tr>
            ...
            <td width="3%"><input type="hidden" name="itemSpec"  style="width:80%" value="<%=dto.getItemSpec()%>"></td>
			...
			<td width="10%">
                <select size="1" name="itemStatus">
                    <option value="">--请选择--</option>
                    <option value="DISCARDED" <%=dto.getItemStatus().equals("DISCARDED") ? "selected" : ""%>>已报废</option>
                    <option value="TO_DISCARD" <%=dto.getItemStatus().equals("TO_DISCARD") ? "selected" : ""%>>待报废</option>
                </select>
			</td>
