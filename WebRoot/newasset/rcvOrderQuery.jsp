...
%>
<form action="<%=AssetsURLList.RCV_HEADER_SERVLET%>" method="post" name="mainFrm">
<jsp:include page="/message/MessageProcess"/>
<script type="text/javascript">
    printTitleBar("接收单据查询");
</script>
...
function do_ShowDetail(receiveHeaderId){
    var url = "<%=AssetsURLList.RCV_HEADER_SERVLET%>?act=<%=AssetsActionConstant.DETAIL_ACTION%>&receiveHeaderId="+receiveHeaderId;
