<%@ page import="com.sino.ams.newasset.dto.AmsAssetsSubDTO"%>
...
<%
	AmsAssetsSubDTO dto = (AmsAssetsSubDTO) request.getAttribute(QueryConstant.QUERY_DTO);
	...
	<table width="100%" border="0" class="queryHeadBg">
		...
		<tr>
			...
			<td width="20%"><input name="itemName" style="width:80%" type="text" value="<%=dto.getItemName()%>" >
                <input type="hidden" name=item_code value="<%=dto.getItemCode()%>"><a href=# title="点击选择规格型号" class="linka" onclick="do_SelectSpec();">[…]</a>
            </td>
