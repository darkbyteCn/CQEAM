		...
		<td>
			<table width=100% border="0">
			    ...
			    <tr>
			        ...
			        <td height="20" align="right">资产账簿：</td>
			        <td height="20">
						<input name="bookTypeName" class="readonlyInput" readonly style="width:100%; " value="<%=headerDTO.getBookTypeName()%>" >
					</td>
			    </tr>
<%
...
%>
			    <tr>
			        ...
			        <td width=17%>
					<!--
						<input name="fromCompanyName" class="readonlyInput" readonly style="width:100%; " value="<%=headerDTO.getFromCompanyName()%>">
					-->
						<select name="fromOrganizationId" style="width:100%" class="noEmptyInput" onChange="do_ChangeBookType(this)"><%=headerDTO.getFromCompanyOption()%></select>
					</td>
				...
				<select name="bookTypeCode" style="display:none"><%=headerDTO.getBookTypeOption()%></select>
<%		
		}
%>			    
			</table>
		...
		<td>
			<table width=100% border="0">
			    ...
			    <tr>
			        ...
			        <td  height="40"><input name="lossesDate" class="noEmptyInput" readonly style="width:100%; " value="<%=headerDTO.getLossesDate()%>" size="20"></td>
