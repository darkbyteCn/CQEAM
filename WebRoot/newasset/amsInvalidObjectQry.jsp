...
<form method="post" name="mainFrm" action="/servlet/com.sino.ams.newasset.servlet.AmsInvalidObjectServlet">
    <input type="hidden" name="act">
    <input type="hidden" name="companyName">
    <script type="text/javascript">
        printTitleBar("未编译无效对象")
    </script>
    ...
    <div id="headDiv" style="overflow:hidden;position:absolute;top:42px;left:1px;width:830px">
        <table border="1" width="100%" class="headerTable" cellpadding="0" cellspacing="0">
            <tr height="22">
                <td width="25%" align="center">对象名称</td>
                <td width="20%" align="center">对象类型</td>
                <td width="25%" align="center">最后编译日期</td>
            </tr>
        </table>
    </div>
    <div id="dataDiv" style="overflow:scroll;height:350px;width:847px;position:absolute;top:66px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table id="dataTable" width="100%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
            ...
            %>
            <tr height="22">
                <td width="25%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("OBJECT_NAME")%>"></td>
                <td width="20%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("OBJECT_TYPE")%>"></td>
                <td width="25%" align="center"><input type="text" class="finput2" style="cursor:hand" readonly value="<%=row.getStrValue("LAST_DDL_TIME")%>"></td>
            </tr>
            <%
                    }
                }
