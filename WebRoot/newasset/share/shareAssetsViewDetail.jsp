     ...
     <table id="dataTable" width="140%" border="1" bordercolor="#666666" style="TABLE-LAYOUT:fixed;word-break:break-all">
          ...
          %>
            <tr class="dataTR" onClick="executeClick(this)" style="display:none" title="资产详细信息">
				...
				<td width="6%" align="center" title="资产详细信息" style="cursor:pointer" onClick="do_ShowDetail(this)"><input type="text" name="itemName" id="itemName0" class="finput2" readonly value=""></td>
				<td width="6%" align="center" title="资产详细信息" style="cursor:pointer" ><input name="itemSpec" id="itemSpec0" style="width:100%" class="finput2" onChange="do_SetDisType(this)" /></td>
				...
				<td width="6%" align="right" title="资产详细信息" style="cursor:pointer" onClick="do_ShowDetail(this)"><select type="text" name="shareStatus" id="shareStatus0" style="width:100%" class="select_style1"   ><%=headerDTO.getShareStatusOpt()%></select></td>
				<td width="6%" align="right" title="资产详细信息" style="cursor:pointer" onClick="do_ShowDetail(this)"><input type="text" name="employeeNumber" id="employeeNumber0" class="finput3" readonly value=""></td>
                <td width="6%" align="right"><input type="text" name="userName" id="userName0" class="finput2" value=""></td>
