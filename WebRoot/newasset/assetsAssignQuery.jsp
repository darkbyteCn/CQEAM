...
<html>
<%
	AmsAssetsTransHeaderDTO dtoPara = (AmsAssetsTransHeaderDTO)request.getAttribute(QueryConstant.QUERY_DTO);
%>
<body onkeydown="autoExeFunction('do_Search()');">
<form action="/servlet/com.sino.ams.newasset.servlet.OrderAssignServlet" method="post" name="mainFrm">
<script type="text/javascript">
    printTitleBar("资产调拨管理>>调拨资产分配");
</script>
<jsp:include page="/message/MessageProcess"/>
    ...
    <table border="1" width=100% class="queryTable">
        <tr>
            ...
            <td width="11%"><input class="input_style2" type="text" name="fromCompanyName" style="width:100%" value="<%=dtoPara.getFromCompanyName()%>" class="readonlyInput" readonly style="width:100%;cursor:pointer" onclick="do_SelectCompany();"></td>
            <td width="7%" align="right">调出部门：</td>
            <td width="11%"><input class="input_style2" type="text" name="fromDeptName" style="width:100%" value="<%=dtoPara.getFromDeptName()%>" class="readonlyInput" readonly style="width:100%;cursor:pointer" onclick="do_SelectDept();" ></td>
            <td width="7%" align="right">调拨单号：</td>
            <td width="15%"><input class="input_style1" type="text" name="transNo" style="width:100%" value="<%=dtoPara.getTransNo()%>"></td>
            <td width="7%" align="right">调出日期：</td>
            <td width="8%"><input class="input_style2" type="text" name="startDate" value="<%=dtoPara.getStartDate()%>" style="width:100%" title="点击选择日期" readonly class="readonlyInput" onclick="gfPop.fStartPop(startDate, endDate)"></td>
            <td width="8%"><input class="input_style2" type="text" name="endDate" value="<%=dtoPara.getEndDate()%>" style="width:100%" title="点击选择日期" readonly class="readonlyInput" onclick="gfPop.fEndPop(startDate, endDate)"></td>
            <td width="15%">
