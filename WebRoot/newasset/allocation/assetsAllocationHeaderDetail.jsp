...
<%
	...
	if(transType.equals(AssetsDictConstant.ASS_RED) || transType.equals(AssetsDictConstant.ASS_RFU) ){//资产调拨单 或 紧急调拨单(补汇总)
...
%>
			    ...
			    <tr>
                    ...
                    <td align=right>紧急程度：</td>
			        <td ><input name="emergentLevel" readonly style="border-style:solid; border-width:0px; width:100%; background-color:#F2F9FF" value="<%=headerDTO.getEmergentLevelName()%>"></td>
