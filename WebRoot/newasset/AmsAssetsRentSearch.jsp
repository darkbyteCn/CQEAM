...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.servlet.AmsAssetsRentServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
    printTitleBar("出租资产查询")
</script>
	<table width="100%" border="0" class="queryHeadBg">
		...
		<tr>
			...
			<td width="20%"><input name="itemName" style="width:80%" type="text" value="<%=dto.getItemName()%>" >
                <input type="hidden" name=item_code value="<%=dto.getItemCode()%>"><a href=AmsAssetsRentSearch.jsp#
