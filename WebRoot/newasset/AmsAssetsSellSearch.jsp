...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.newasset.servlet.AmsAssetsSellServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
    printTitleBar("销售资产查询")
</script>
	<table width="100%" border="0" class="queryHeadBg">
		...
		<tr>
			...
			<td width="20%"><input name="itemName" style="width:80%" type="text" value="<%=dto.getItemName()%>" >
                <input type="hidden" name=item_code value="<%=dto.getItemCode()%>"><a href=AmsAssetsSellSearch.jsp#
                                                                                      title="点击选择规格型号" class="linka" onclick="do_SelectSpec();">[…]</a>
            </td>
        ...
        <td width="10%" ><a href="../assets" title="点击选择地点" onclick="do_SelectAddress(); return false;">[…]</a>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:45px;left:1px;width:840px">
	<table class="headerTable" border="1" width="130%">
		<tr height="22">
            ...
            <td width="16%" align="center">规格型号</td>
            <td width="8%" align="center">资产编号</td>
            <td width="8%" align="center">资产标签号</td>
            <td width="24%" align="center">地点名称</td>

		</tr>
	</table>
</div>
<div id="dataDiv" style="overflow:scroll;height:360px;width:857px;position:absolute;top:68px;left:1px" align="left" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
...
%>
		<tr height="23">
            ...
            <td width="23%" align="center"><%=row.getValue("DEPT_NAME")%></td>
            <td width="13%" align="center"><%=row.getValue("ITEM_NAME")%></td>
			<td width="16%" align="center"><%=row.getValue("ITEM_SPEC")%></td>
            <td width="8%" align="center"><%=row.getValue("ASSET_NUMBER")%></td>
			<td width="8%" align="center"><%=row.getValue("BARCODE")%></td>
            <td width="24%" align="center"><%=row.getValue("WORKORDER_OBJECT_NAME")%></td>
