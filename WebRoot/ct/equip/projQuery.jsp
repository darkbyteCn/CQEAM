...
<form method = "post" name = "mainFrm">
    <script type = "text/javascript">
        printTitleBar("村通设备查询--按项目")
    </script>
    <table width = "100%" border = "0" class="queryHeadBg">
        <tr>
            <td width = "10%" align = "right">公司：</td>
            <td width = "20%" colspan = 2><select name = organizationId><%=cityOption%></select></td>
            <td width = "10%" align = "right">所属工程：</td>
            <td width = "20%" colspan = 2><input name = projectName  value="<%=projectName%>"  type = text style = "width:80%"><input type = hidden name = projectId><a href = # title = "点击选择项目" class = "linka" onclick = "do_SelectProj();">[…]</a></td>
            <td width = "10%" align = "right">规格型号：</td>
            <td width = "20%" colspan = 2><input type = text  name = itemSpec value="<%=itemSpec%>"><a href = # title = "点击选择规格型号" class = "linka" onclick = "do_SelectSpec();">[…]</a></td>
        </tr>
        <tr>
