...
<form method = "post" name = "mainFrm">
    ...
    <table width = "100%" border = "0" class="queryHeadBg">
        ...
        <tr><td align = "right">资产类型：</td>
            ...
            <td align = "left"><input type = text name = itemSpec value="<%=itemSpec%>"><a href = # title = "点击选择规格型号" class = "linka" onclick = "do_SelectSpec();">[…]</a></td>
    ...
    <div style = "overflow-y:scroll;left:0px;width:100%;height:350px">
        <table width = "100%" border = "1" bordercolor = "#666666">
            ...
            <tr class = "dataTR"  onclick="do_ShowDetail('<%=row.getValue("BARCODE")%>')">
                ...
                <td style = "word-wrap:break-word" height = "22" width = "15%" align = "left"><%=row.getValue("ITEM_SPEC")%></td>
