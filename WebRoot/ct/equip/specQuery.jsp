...
<%
    ...
    String itemTypeOption = parser.getAttribute("ITEM_TYPE_OPTION").toString();
    String qryType = parser.getParameter("qryType");
    String itemSpec = parser.getParameter("itemSpec");
    String projectId = parser.getParameter("projectId");
    String projectName = parser.getParameter("projectName");
%>
<form method = "post" name = "mainFrm">
    <script type = "text/javascript">
        printTitleBar("村通设备查询--按专业")
    </script>
    <table width = "100%" border = "0" class = "queryHeadBg">
        <tr>
            <td width = "5%" align = "right">公司：</td>
            <td width = "10%"><select name = organizationId style = "width:100%"><%=cityOption%></select></td>
            <td width = "5%" align = "right">专业：</td>
            <td width = "10%"><select name = itemCategory style = "width:100%"><%=itemTypeOption%></select></td>
            <td width = "10%" align = "right">所属工程：</td>
            <td width = "15%"><input name = projectName type = text style = "width:80%" value = "<%=projectName%>"><input type = hidden name = projectId value = "<%=projectId%>">><a href = # title = "点击选择项目" class = "linka" onclick = "do_SelectProj();">[…]</a></td>
            <td width = "10%" align = "right">规格型号：</td>
            <td width = "15%"><input type = text name = itemSpec value = "<%=itemSpec%>"><a href = # title = "点击选择规格型号" class = "linka" onclick = "do_SelectSpec();">[…]</a></td>
        </tr>
        <tr>
    ...
    <div style = "overflow-y:scroll;left:0px;width:100%;height:350px">
        <table width = "100%" border = "1" bordercolor = "#666666">
            ...
            <tr class = "dataTR" onclick = "do_ShowDetail('<%=row.getValue("BARCODE")%>')">
                ...
                <td style = "word-wrap:break-word" height = "22" width = "8%" align = "left"><%=row.getValue("ITEM_CATEGORY")%></td>
                <td style = "word-wrap:break-word" height = "22" width = "10%" align = "center"><%=row.getValue("START_DATE")%></td>
                <td style = "word-wrap:break-word" height = "22" width = "15%" align = "left"><%=row.getValue("PROJECT_NAME")%></td>
                <td style = "word-wrap:break-word" height = "22" width = "15%" align = "left"><%=row.getValue("WORKORDER_OBJECT_NAME")%></td>
