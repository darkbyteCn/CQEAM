...
<script type="text/javascript">
    ...
    <table border="0" width="100%" bordercolor="red" class="queryHeadBg" id="table1">
		<tr>
			...
			<td width="25%">
				<input type="text" name="itemSpec" style="width:86%" value="<%=parser.getParameter("itemSpec")%>"><a href = # title = "点击选择规格型号" class = "linka" onclick = "do_SelectSpec();">[…]</a></td>
            <td>&nbsp;&nbsp;</td>
		</tr>
		<tr>
			...
			<td width="20%">
				...
				<input type="hidden" name="responsibilityDept" value="<%=parser.getParameter("responsibilityDept")%>"></td>
			...
			<td width="20%">
				...
				<input type="hidden" name="responsibilityUser" value="<%=parser.getParameter("responsibilityUser")%>"></td>
			<td width="10%" align="right">财务属性：</td>
			<td width="20%">
				<select name="financeProp" style="width:100%"><%=financePropName %></select> </td>
            <td width="30%" colspan="3" align="center"><img src="/images/eam_images/search.jpg" alt="IT资产确认" onClick="do_Search(); return false;">
            </td>
            <td>&nbsp;&nbsp;</td>
		</tr>
	</table>
  <div style="left:1px;width:100%;overflow-y:scroll" class="crystalScroll">
    <table width="100%" align="left" border="1" cellpadding="2" cellspacing="0"  class="headerTable">
		...
		<tr class="headerTable">
			...
			<td height="22" width="6%" align="center">财务属性</td>
			<td height="22" width="7%" align="center">启用日期</td>
		</tr>
	</table>
  </div>
    <div style="overflow-y:scroll; height:280px;width:100%;left:1px;margin-left:0" align="left">
...
%>		
			<tr class="dataTR" onclick="do_ShowDetail('<%=row.getValue("SYSTEMID")%>'); return false;">
				...
				<td height="22" width="6%" align="center"><%=row.getValue("FINANCE_PROP_NAME")%></td>
