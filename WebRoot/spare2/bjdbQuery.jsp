...
%>
  ...
  <body>
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.ams.spare2.servlet.BjdbServlet">
...
<script type="text/javascript">
    var columnArr = new Array("单据编号","仓库名称","创建人","创建日期","单据状态");
    var widthArr = new Array("13%","25%","10%","10%","10%");
