...
<%@ page import="com.sino.ams.spare2.constant.SpareConstant" %>
...
%>
<form name="mainForm" action="/servlet/com.sino.ams.spare2.servlet.BjInvTransServlet" method="post">
...
<legend>
    ...
    %>
    <img src="/images/eam_images/confirm.jpg" alt="确认" onclick="do_confirm();">
    <%
    }
        //单据非完成状态并且当前用户是创建人才有操作权限
        if (!amsItemTransH.getTransStatus().equals(SpareConstant.TO_CONFIRM) &&amsItemTransH.getCreatedBy().equals(user.getUserId())) {
    %>
