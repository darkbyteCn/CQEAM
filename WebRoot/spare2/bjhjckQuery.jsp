...
%>
  ...
  <form name="mainFrm" method="POST" action="/servlet/com.sino.ams.spare2.hjck.servlet.AmsBjckServlet">
      <script type="text/javascript">
          printTitleBar("备件坏件入省公司单");
      </script>
...
function do_Create(){
    ...
    var url = "/servlet/com.sino.ams.spare2.hjck.servlet.AmsBjckServlet";
