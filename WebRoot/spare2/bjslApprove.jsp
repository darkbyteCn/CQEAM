...
<%
    ...
    String provinceOrgId = amsItemTransH.getServletConfig().getProvinceOrgId();
...
<fieldset>
    <legend>规格型号
        ...
        <%--<img src="/images/eam_images/ok.jpg" alt="确定接收" id="img2" onClick="do_Approve(3);">--%>
...
<script type="text/javascript">
    ...
    function do_SelectItem() {
        var url = "/servlet/com.sino.ams.bean.AMSLookUpServlet?lookUpName=<%=LookUpConstant.BJSL_ITEM_INFO%>&itemCodes=<%=itemCodes%>&organizationId=<%=provinceOrgId%>";
