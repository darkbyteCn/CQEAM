...
<html>
  ...
  %>
  <form action="/servlet/com.sino.ams.spare2.dbjscstj.servlet.AmsOvertimeServlet" name="mainForm" method="post">
        <script type="text/javascript">
    printTitleBar("调拨批准后接收超时统计")
</script>
    ...
    <input type="hidden" name="act" value="<%=action%>">
       ...
       <script type="text/javascript">
        var columnArr = new Array("单据号", "单据日期", "申领人", "设备名称", "型号", "申请数量", "调拨仓库", "调拨数量", "预计归还日期");
        var widthArr = new Array("14%", "12%", "10%", "13%", "10%", "9%", "11%", "9%", "12%");
    ...
    <div style="overflow-y:scroll;height:345px;width:100%;left:1px;margin-left:0px"
        ...
        <table width="100%" border="1" bordercolor="#666666" id="dataTab">
            ...
            <tr >
                ...
                <td height="22" width="12%"><%=row.getValue("TRANS_DATE")%></td>
                <td height="22" width="10%"><%=row.getValue("USERNAME")%></td>
                <td height="22" width="13%"><%=row.getValue("ITEM_NAME")%></td>
                <td height="22" width="10%"><%=row.getValue("ITEM_SPEC")%></td>
                <td height="22" width="9%"><%=row.getValue("APPLY_QUANTITY")%></td>
                <td height="22" width="11%"><%=row.getValue("FROM_OBJECT_NAME")%></td>
                <td height="22" width="9%"><%=row.getValue("MOVE_QUANTITY")%></td>
                <td height="22" width="12%"><%=row.getValue("RESPECT_RETURN_DATE")%></td>
            </tr>
            <%
                }      }
            %>
