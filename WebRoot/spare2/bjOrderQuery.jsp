...
<%
    ...
    String url = "/servlet/com.sino.ams.spare2.servlet.AmsItemTransHServlet";
    if(transType.equals(DictConstant.BJCK)){
        orderTypeName = "出库";
        url = "/servlet/com.sino.ams.spare2.servlet.BjckServlet";
    }else if(transType.equals(DictConstant.BJFK)){
        orderTypeName = "返库";
        url = "/servlet/com.sino.ams.spare2.servlet.BjfkServlet";
    }else if(transType.equals(DictConstant.BJRK)){
        orderTypeName = "新购入库";
        url = "/servlet/com.sino.ams.spare2.servlet.AmsItemTransHServlet";
    }else if(transType.equals(DictConstant.BJBF)){
        orderTypeName = "报废";
        url = "/servlet/com.sino.ams.spare2.reject.servlet.AmsBjRejectServlet";
    }else if(transType.equals(DictConstant.BJSX)){
        orderTypeName = "送修";
        url = "/servlet/com.sino.ams.spare2.repair.servlet.BjSendRepairServlet";
    }else if(transType.equals(DictConstant.BJFH)){
        orderTypeName = "送修返还";
        url = "/servlet/com.sino.ams.spare2.returnBj.servlet.BjReturnRepairServlet";
    }else if(transType.equals(DictConstant.ZKZY)){
        orderTypeName = "子库转移";
        url = "/servlet/com.sino.ams.spare2.servlet.BjInvTransServlet";
    }
%>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.ams.spare2.servlet.AmsItemTransHServlet">
