...
<%@ page import = "com.sino.ams.spare2.invprivi.dto.AmsInvPriviDTO" %>
<%--
  created by YS
  Date: 2007-09-28
  Time: 8:23:36
...
%>
<form method = "post" name = "mainFrm" action = "/servlet/com.sino.ams.spare2.invprivi.servlet.AmsInvPriviServlet">
    ...
    <table width = "100%" border = "0" class = "queryHeadBg">
        <tr>
            ...
            <td width = "30%"><input type = "text" name = "executeUserName" readonly class = readonlyInput
            ...
            <td width = "30%"><select name = "executeInv"><%=request.getAttribute(WebAttrConstant.INV_OPTION)%></select>
            </td>
            <td width = "20%" align = "center">
                <img src = "/images/eam_images/search.jpg" style = "cursor:'hand'" onclick = "do_search();" alt = "查询">&nbsp;&nbsp;&nbsp;
                <img src = "/images/eam_images/save.jpg" alt = "保存" onClick = "do_SavePrivi();">
            </td>
        </tr>
    </table>
...
<script type = "text/javascript">
    function do_search() {
        ...
        <%--mainFrm.act.value = "<%=WebActionConstant.QUERY_ACTION%>";--%>
            mainFrm.action = "/servlet/com.sino.ams.spare2.invprivi.servlet.AmsInvPriviServlet?act=<%=WebActionConstant.QUERY_ACTION%>";
            mainFrm.submit();
        }
        else {
            alert("至少需要一个查询条件");
    ...
    <%--mainFrm.act.value = "<%=WebActionConstant.SAVE_ACTION%>";--%>
        mainFrm.action = "/servlet/com.sino.ams.spare2.invprivi.servlet.AmsInvPriviServlet?act=<%=WebActionConstant.SAVE_ACTION%>";
        mainFrm.submit();
    }
