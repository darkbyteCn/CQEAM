        ...
        <td>
            <table width="100%" id="table2" cellspacing="1" border="0">
                <tr height="22">
                    ...
                    <td width="18%"><input type="text" name="transNo" value="<%=amsItemTransH.getTransNo()%>" readonly
                                           style="width:100%"
                    ...
                    <td width="16%"><input type="text" name="fromOrganizationName"
                ...
                <tr height="22">
                    ...
                    <td><input type="text" name="respectReturnDate" readonly
                ...
                <tr height="22">
                    ...
                    <td colspan="3"><input type="text" name="reason"
                               ...
                               class="blueborderYellow" size="75">
                    </td>
                    <td align="right">授权人：</td>
                    <td><input type="text" name="authorizationUser"
                               value="<%=amsItemTransH.getAuthorizationUser()%>"
                               class="blueborderYellow"></td>
                    <td align="right">仓管员：</td>
                    <td><input type="text" name="invManager"
...
<fieldset>
    <legend>
        ...
        <img src="/images/eam_images/submit.jpg" alt="提交" id="img4" onClick="do_SavePo(2);">
        <%
