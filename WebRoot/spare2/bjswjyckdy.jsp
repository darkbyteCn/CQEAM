...
<form name="mainFrm" method="POST" action="/servlet/com.sino.ams.spare2.servlet.BjswjyckdyServlet">
    <script type="text/javascript">
        printTitleBar("备件实物借用出库打印");
    </script>
    ...
    <script type="text/javascript">
        var columnArr = new Array( "申领单号", "调拨单号", "发运公司", "仓库", "发运时间");
        var widthArr = new Array( "12%", "12%", "11%", "12%", "12%");
    ...
    <div style="overflow-y:scroll;left:1px;width:100%;height:360px">
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'"
                onMouseOut="style.backgroundColor='#ffffff'" onclick="showDetail('<%=row.getValue("TRANS_ID")%>','<%=row.getValue("FREIGHT_DATE")%>');"
                    >
                ...
                <td width="12%"><%=row.getValue("WORKORDER_OBJECT_NAME")%>
                </td>
                <td width="12%" align="center"><%=row.getValue("FREIGHT_DATE")%>
                </td>
            </tr>
            <%
                    }
...
<script language="javascript">
    ...
    function showDetail(transId,freightDate){
        var url = "/servlet/com.sino.ams.spare2.servlet.BjswjyckdyServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId="+transId+"&freightDate="+freightDate;
        ...
        window.open(url,"swjyckdy",popscript);
    }
