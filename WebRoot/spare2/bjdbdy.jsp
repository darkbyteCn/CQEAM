...
<html>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.ams.spare2.servlet.BjdbdyServlet">
...
//	document.mainFrm.flexValueId.value = primaryKey;
	...
	var url = "/servlet/com.sino.ams.spare2.servlet.BjdbdyServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId="+primaryKey;
    var popscript = "width=1020,height=700,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=yes,location=no, status=yes";
