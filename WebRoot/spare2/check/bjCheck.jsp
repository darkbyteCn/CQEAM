...
<%@ page import="com.sino.ams.spare2.check.dto.AmsItemCheckHeaderDTO" %>
...
%>
 <form action="/servlet/com.sino.ams.spare2.check.servlet.AmsBjCheckServlet" name="mainForm" method="post">
    ...
    printTitleBar("备件盘点页面")
        ...
        <tr>
            ...
            <td><img src="/images/eam_images/new_add.jpg" alt="新增"
...
<script type="text/javascript">
    ...
    function do_Create() {
        var url = "/servlet/com.sino.ams.spare2.check.servlet.AmsBjCheckServlet?act=<%=WebActionConstant.NEW_ACTION%>" ;
    ...
    function do_ShowDetail(headerId,checkLocation) {
        var url = "/servlet/com.sino.ams.spare2.check.servlet.AmsBjCheckServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&headerId=" + headerId+"&checkLocation="+checkLocation;
