...
%>
<form name="mainForm" action="/servlet/com.sino.ams.spare2.accept.servlet.SpareAcceptServlet" method="post">
...
<fieldset>
    <legend>
        <img src="/images/button/accept.gif" alt="已收到" id="img4" onClick="do_receive();">
        <img src="/images/button/noaccept.gif" alt="未收到" id="img5" onClick="no_receive();">
    ...
    <script type="text/javascript">
        var columnArr = new Array("物料编码", "设备名称", "规格型号", "数量");
        var widthArr = new Array("12%", "15%", "15%", "8%");
...
<script type="text/javascript">
    ...
    function no_receive() {
        mainForm.act.value = "NO_RECEIVE_ACTION";
        mainForm.submit();
    }
</script>
</html>