...
%>
<form name="mainForm" action="/servlet/com.sino.ams.spare2.fpjscy.servlet.AmsBjFpJsCyServlet" method="post">
    ...
    <fieldset>
        <legend>
            <img src="/images/eam_images/export.jpg" alt="导出数据" onClick="do_excel()">
...
<script type="text/javascript">
    function do_show(itemCode, detailid) {
      ...
      var url = "/servlet/com.sino.ams.spare2.fpjscy.servlet.AmsBjFpJsCyServlet?act=" + mainForm.act.value + "&detailid=" + detailid + "&itemCode=" + itemCode;
