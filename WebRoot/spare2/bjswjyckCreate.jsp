...
%>
<form name="mainForm" action="/servlet/com.sino.ams.spare2.servlet.BjswjyckServlet" method="post">
...
<fieldset>
    <legend>规格型号
        ...
        <img src="/images/eam_images/ok.jpg" alt="确定" id="img3" onClick="do_submit();">
