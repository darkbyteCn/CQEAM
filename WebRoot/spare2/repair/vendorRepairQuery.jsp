...
<form action="/servlet/com.sino.ams.spare2.repair.servlet.AmsItemRepairServlet" name="workForm" method="post">
    ...
    <script type="text/javascript">
        var columnArr = new Array("公司","厂家", "设备名称", "规格型号", "返修数量");
        var widthArr = new Array("15%","20%", "20%", "25%", "10%");
