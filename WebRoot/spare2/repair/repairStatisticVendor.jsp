...
<form name="mainFrm" method="POST" action="/servlet/com.sino.ams.spare2.repair.servlet.RepairStatisticServlet">
    <script>
                ...
                <table width="99%" align='right'>
                    <tr>
                        ...
                        <td width="15%"><select style="width:100%"
                                                name="orgId"><%=request.getAttribute(WebAttrConstant.OU_OPTION)%>
                        </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="15%"><select style="width:100%" name="year"><%=yearOption%>
                        </select></td>
                        <td width="10%" align="right">月份：</td>
                        <td width="15%"><select style="width:100%" name="month"><%=monthOption%>
                        </select></td>
    ...
    <div style="overflow-y:scroll;height:362px;width:100%;left:1px;margin-left:0px" align="left">
        <table border="1" width="100%" bordercolor="#666666"
            ...
            <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'"
                ...
                <td width="15%"><%=row.getValue("ORG_NAME")%>
                </td>
                <td width="20%"><%=row.getValue("VENDOR_NAME")%>
                </td>
                <td width="20%"><%=row.getValue("ITEM_NAME")%>
                </td>
                <td width="25%"><%=row.getValue("ITEM_SPEC")%>
                </td>
                <td width="20%" align="right"><%=row.getValue("RATE")%>%
                </td>
            </tr>
            <%
                    }
