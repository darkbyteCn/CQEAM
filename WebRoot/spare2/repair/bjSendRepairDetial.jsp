...
<%@ page import="com.sino.ams.spare2.repair.dto.AmsCustomerInfoDTO" %>

<html>
<head><title>备件送修打印</title>
        ...
        <td>
            <table width="100%" id="table2" border="0" cellspacing="1" bgcolor="#F2F9FF">
                ...
                <tr height="24">
                    ...
                    <td width="40%"><%=amsItemTransH.getCompany()%>
                    </td>
                </tr>
                <tr height="24">
                    ...
                    <td width="40%"><%=amsItemTransH.getContact()%>
                    </td>
                </tr>
                <tr height="24">
                    ...
                    <td width="40%"><%=amsItemTransH.getTel()%>
                    </td>
                </tr>
                <tr height="24">
                    ...
                    <td width="10%"><%=amsItemTransH.getFax()%>
                    </td>
                </tr>
                <tr height="24">
                    ...
                    <td width="10%"><%=amsItemTransH.getAttribute3()%>
                    </td>
                </tr>
                <tr height="24">
                    <td width="10%" align="right">送修方地址：</td>
                    <td width="10%"><%=cust.getAddress()%>
                    </td>
                    <td width="10%" align="right">联系地址：</td>
                    <td width="40%"><%=amsItemTransH.getAddress()%>
                    </td>
                </tr>
            </table>
        </td>
...
<fieldset>
    ...
    <script type="text/javascript">
        var columnArr = new Array("部件号", "设备名称", "规格型号", "送修数量");
