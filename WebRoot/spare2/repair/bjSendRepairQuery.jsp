...
<%
    ...
    String url = "/servlet/com.sino.ams.spare2.repair.servlet.BjSendRepairServlet";
%>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.ams.spare2.repair.servlet.BjSendRepairServlet">
<script type="text/javascript">
    printTitleBar("备件送修");
</script>
    <input type="hidden" name="flexValueId" value="">
	<input type="hidden" name="transType" value="<%=DictConstant.BJSX%>">
