...
%>
<form name="mainForm" action="/servlet/com.sino.ams.spare2.servlet.BjfkServlet" method="post">
        ...
        <td>
            <table width="100%" id="table2" cellspacing="1">
                <tr height="22">
                    ...
                    <td width="25%"><input type="radio" name="objectCategory" id="objectCategory0" value="71"
                                           style="background-color:#F2F9FF" checked><label
                            for="objectCategory0">正常库</label>
                        <input type="radio" name="objectCategory" id="objectCategory1" value="72"
                               style="background-color:#F2F9FF"><label for="objectCategory1">待修库</label>
                        <input type="radio" name="objectCategory" id="objectCategory2" value="73"
                               style="background-color:#F2F9FF"><label for="objectCategory2">送修库</label>
                    </td>
                    <%
                    } else {
                    %>
...
<fieldset>
    ...
    <script type="text/javascript">
        var columnArr = new Array("checkbox", "部件号", "设备名称", "规格型号", "数量");
        var widthArr = new Array("2%", "12%", "15%", "15%", "8%");
        printTableHead(columnArr, widthArr);
    </script>
    <div style="overflow-y:scroll;height:560px;width:100%;left:1px;margin-left:0"
...
function do_SelectItem() {
    var url = "/servlet/com.sino.ams.bean.AMSLookUpServlet?lookUpName=<%=LookUpConstant.BJ_ITEM_CATEGORY%>";
