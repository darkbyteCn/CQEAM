...
<form name="mainFrm" method="POST" action="/servlet/com.sino.ams.spare2.accept.servlet.SpareAcceptServlet">
    ...
    <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" class="queryHeadBg">
        <tr>
            ...
            <td width="17%"  align="left"><img src="/images/eam_images/search.jpg" onclick="do_Search();" alt="查询"></td>
        </tr>
        <tr>
