...
<legend>
    <%
        ...
        if (!amsItemTransH.getTransStatus().equals(DictConstant.IN_PROCESS) && amsItemTransH.getCreatedBy().equals(user.getUserId())) {
    %>
    ...
    %>
    <img src="/images/eam_images/confirm.jpg" alt="确认" id="img3" onClick="do_confirm();">
