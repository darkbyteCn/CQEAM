...
<html>
  ...
  <form name="mainForm" method="POST" action="/servlet/com.sino.ams.spare2.servlet.BjjyltjServlet">
      <script type="text/javascript">
          printTitleBar("备件领用量统计");
      </script>
...
<table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" class="queryHeadBg">
	...
	<tr>
        ...
        <td height="22" align="right">领用日期：</td>
...
<script type="text/javascript">
    var columnArr = new Array("领用公司","物料编码","设备名称","规格型号","领用数量");
