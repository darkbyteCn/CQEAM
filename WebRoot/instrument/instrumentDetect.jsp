...
<form action="/servlet/com.sino.ams.instrument.servlet.AmsInstrumentDetectServlet" name="mainForm" method="post">
    ...
    <table border="0" width="100%"  class="queryHeadBg">
        <tr>
            ...
            <td width=10% align="left">
                <img src="/images/eam_images/search.jpg" alt="查询仪器仪表检测"
                     onClick="do_Search(); return false;">
            </td>
            <td><img src="/images/eam_images/new_add.jpg" alt="新增仪器仪表检测"
    ...
    <input type="hidden" name="act" value="<%=action%>">
      ...
      <script type="text/javascript">
        var columnArr = new Array("单据号", "创建人", "创建日期","单据状态");
    ...
    %>
    <div style="overflow:scroll;height:362px;width:100%;left:1px;margin-left:0px"
         align="left">
...
<script type="text/javascript">
    ...
    function do_Create() {
        var url = "/servlet/com.sino.ams.instrument.servlet.AmsInstrumentDetectServlet?act=<%=WebActionConstant.NEW_ACTION%>" ;
...
//        window.open(url, 'planWin', popscript);
    ...
    function do_ShowDetail(transId) {
        ...
        var url = "/servlet/com.sino.ams.instrument.servlet.AmsInstrumentDetectServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId=" + transId;
