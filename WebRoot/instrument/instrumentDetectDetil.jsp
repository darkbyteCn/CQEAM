...
<%
    ...
    String instruStatus = (String)request.getAttribute(WebAttrConstant.INSTRU_STATUS);
%>
<form action="/servlet/com.sino.ams.instrument.servlet.AmsInstrumentDetectServlet" name="mainForm" method="post">
<script type="text/javascript">
    printTitleBar("创建仪器仪表检测单")
</script>
    ...
    <tr>
        <td>
            <table width="100%" id="table2" cellspacing="1" bgcolor="#F2F9FF">
                <tr height="22">
                    <td width="10%" align="right">检测单号：</td>
...
<fieldset style="width:100%;height:500px;border:2px groove">
    <legend>
        ...
        <img src="/images/button/ruturn.gif" alt="检测" onclick="do_check()">
        <img src="/images/eam_images/ok.jpg" alt="确定" onClick="do_ok()">
        <img src="/images/eam_images/close.jpg" alt="关闭" onclick="window.close()">
    </legend>
 <div style="left:1px;width:100%;overflow:scroll" class="crystalScroll">
        <table width="100%" border="1" class="headerTable" cellpadding="0" cellspacing="0"  class="headerTable">
            <tr height="20">
                ...
                <td width="6%" align="center">当前使用人</td>
                <td width="17%" align="center">供应商</td>
                <td width="8%" align="center">仪器仪表用途</td>
                <td width="5%" align="center">仪器仪表状态</td>
                <td width="8%" align="center">配件完整性</td>
            </tr>
        </table>
    </div>
    <div style="width:100%;overflow:scroll;height:500px">
        <table width="100%" border="1" bordercolor="#9FD6FF" id="mtlTable" cellpadding="0" cellspacing="0">
            ...
            <tr height=20px style="display:none" onclick="">
                ...
                <td align=center width="6%" name="cname" id="cname0"></td>
                <td align=center width="6%" onclick="do_selectName(this);"><input type="text" class="noneinput" readonly   style="width:100%"
                                                                                  name="dname" id="dname0"><input
                        type="hidden" name="currKeepUser" id="currKeepUser0"></td>
                <td align=center width="17%" name="vendorName" id="vendorName0"></td>
                <td align=center width="8%" name="instruUsage" id="instruUsage0"></td>
                <td align=center width="5%">
                    <input type="radio" name="instruStatus" id="yes0" value="Y" ><label for="yes0">是</label>
                    <input type="radio" name="instruStatus" id="no0"><label for="no0">否</label>

                </td>
                <td align=center width="8%">
                   <input type="radio" name="isFull" id="yes1" value="Y"  ><label for="yes1">是</label>
                   <input type="radio"  name="isFull" id="no1"  value="N" ><label for="no1">否</label>
               </td>
            ...
            <tr height=20px onclick="">
                ...
                <td align=center width="6%" name="cname" id="cname<%=i%>"><%=dto1.getCname()%>
                </td>
                <td align=center width="6%" onclick="do_selectName(this);"><input type="text" class="noneinput" readonly
                ...
                <td align=center width="17%" name="vendorName" id="vendorName<%=i%>"><%=dto1.getVendorName()%>
                </td>
                <td align=center width="8%" name="instruUsage" id="instruUsage<%=i%>"><%=dto1.getInstruUsage()%>
                </td>
                 <td align=center width="5%">
                     <input type="radio" name="instruStatus" id="instruStatus<%=i%>" value="Y" ><label for="yes0">是</label>
                     <input type="radio" name="instruStatus" id="instruStatus<%=i%>"><label for="no0">否</label>

                </td>
                <td align=center width="8%">
                    <input type="radio" name="isFull" id="isFull<%=i%>" value="Y"  ><label for="yes1">是</label>
                    <input type="radio"  name="isFull" id="isFull<%=i%>"  value="N" ><label for="no1">否</label>
