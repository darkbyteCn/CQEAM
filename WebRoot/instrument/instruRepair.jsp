...
<form action="/servlet/com.sino.ams.instrument.servlet.AmsInstrumentRepairServlet" name="mainForm" method="post">
    ...
    <input type="hidden" name="act" value="<%=action%>">
     <script type="text/javascript">
        var columnArr = new Array("单据号", "送修人", "确认人","送修日期","确认日期","单据状态");
    ...
    <div style="overflow-y:scroll;height:362px;width:100%;left:1px;margin-left:0px"
        ...
        <table width="100%" border="1" bordercolor="#666666" id="dataTab">
            ...
            <tr class="dataTR"
                ...
                <td height="22" width="7%"><%=row.getValue("REPAIRE_USER")%>
                </td>
                <td height="22" width="7%"><%=row.getValue("CONFIRM_USER")%>
                </td>
                <td height="22" width="7%" align="center"><%=row.getValue("REPAIRE_DATE")%>
                </td>
...
<script type="text/javascript">
    ...
    function do_Create() {
        var url = "/servlet/com.sino.ams.instrument.servlet.AmsInstrumentRepairServlet?act=<%=WebActionConstant.NEW_ACTION%>" ;
...
//        window.open(url, 'planWin', popscript);
    ...
    mainForm.action="/servlet/com.sino.ams.instrument.servlet.AmsInstrumentRepairServlet?transId="+transId;
    mainForm.submit();--%>
        var url = "/servlet/com.sino.ams.instrument.servlet.AmsInstrumentRepairServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId=" + transId;
