<%@ page import="com.sino.ams.spare.version.dto.AmsItemVersionDTO" %>
...
<form name="mainFrm" method="post">
    ...
    <table border="0" width="100%" style="position:absolute;top:20px">
        <tr>
            <td width="25%" align="right" height="22">设备条码：</td>
        ...
        <tr>
            <td width="100%" align="center" height="22" colspan="5">
                <img src="/images/button/save.gif" alt="保存" onclick="do_submit()"></td>
            <%--<img src="/images/button/back.gif" alt="取消" onclick="do_close();">--%>
        </tr>
    </table>
...
<script type="text/javascript">
  ...
  if (formValidate(fieldNames, fieldLabels, EMPTY_VALIDATE)) {
      with (mainFrm) {*/
        ...
        action = "/servlet/com.sino.ams.spare.version.servlet.AmsItemVersionServlet";
        submit();
    }
