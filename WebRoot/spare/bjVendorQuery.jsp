...
%>
<form name="mainFrm" method="post" action="/servlet/com.sino.ams.spare.servlet.BjVendorServlet">
<%=WebConstant.WAIT_TIP_MSG%>
<script type="text/javascript">
   printTitleBar("备件维修公司维护")
</script>
...
<div id="headDiv" style="overflow:hidden;position:absolute;top:45px;left:1px;width:840px">
	<table class="headerTable" border="1" width="100%">
        <tr height="22">
            <td width="25%" align="center">维修公司名称</td>
            <td width="25%" align="center">维修公司地址</td>
...
<%
	if(hasData){
        ...
        for(int i = 0; i < rows.getSize(); i++){
			row = rows.getRow(i);
%>
        <tr height="22" style="cursor:hand" onClick="do_ShowDetail('<%=row.getValue("VENDOR_CODE")%>')">
            <td width="25%" align="center"><input type="text" class="finput" readonly value="<%=row.getStrValue("VENDOR_NAME")%>"></td>
            <td width="25%" align="center"><input type="text" class="finput" readonly value="<%=row.getStrValue("ADDRESS")%>"></td>
            <td width="10%" align="center"><input type="text" class="finput" readonly value="<%=row.getStrValue("CONTACT")%>"></td>
            <td width="12%" align="center"><input type="text" class="finput" readonly value="<%=row.getStrValue("PHONE")%>"></td>
            <td width="12%" align="center"><input type="text" class="finput" readonly value="<%=row.getStrValue("FAX")%>"></td>
            <td width="10%" align="center"><input type="text" class="finput" readonly value="<%=row.getStrValue("SPARE_VENDOR_NAME")%>"></td>
        </tr>
<%
		}
	}
...
function do_ShowDetail(vendorCode) {
