...
%>
<form action="/servlet/com.sino.ams.spare.fpjscy.servlet.AmsBjFpJsCyServlet" name="mainForm" method="post">
...
<script type="text/javascript">
    ...
    function do_ShowDetail(transId) {
        ...
        var url = "/servlet/com.sino.ams.spare.fpjscy.servlet.AmsBjFpJsCyServlet?act=<%=WebActionConstant.DETAIL_ACTION%>&transId=" + transId;
