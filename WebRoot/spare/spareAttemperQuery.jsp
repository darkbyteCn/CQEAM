...
<form action="/servlet/com.sino.ams.spare.servlet.SpareAttemperServlet" name="mainForm" method="post">
    ...
    <script type="text/javascript">
        var columnArr = new Array( "部件号","设备名称","设备型号","设备类别", "盘点数量", "库存数量");
