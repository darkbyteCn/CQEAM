...
%>
  ...
  <form name="mainFrm"  method="POST" action="/servlet/com.sino.ams.spare.servlet.SpareBFServlet">
...
<table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" class="queryHeadBg">
	<tr>
		...
		<td width="17%" height="22"><select name="transStatus" style="width:80%"><option value="" >--请选择--</option><option value = "SAVE_TEMP" <%=parser.getParameter("transStatus").equals("SAVE_TEMP")? "selected":""%> >暂存</option><option value = "COMPLETED" <%=parser.getParameter("transStatus").equals("COMPLETED")? "selected":""%> >完成</option></select></td>
		<td width="17%" height="22" align= "right"><img src="/images/eam_images/new_add.jpg" onclick="do_Create();">&nbsp;&nbsp;</td>
	</tr>
	<tr>
...
<div style="overflow-y:scroll;left:1px;width:100%;height:335px">
