...
%>
  ...
  <form name="mainFrm" method="POST" action="/servlet/com.sino.ams.spare.hjck.servlet.AmsBjckServlet">
...
function do_Create(){
    ...
    var url = "/servlet/com.sino.ams.spare.hjck.servlet.AmsBjckServlet";
