...
<fieldset>
    ...
    <script type="text/javascript">
        ...
        var widthArr = new Array("2%", "12%", "12%", "15%", "8%");
    ...
    <div style="overflow-y:scroll;height:550px;width:100%;left:1px;margin-left:0"
        ...
        <table width="100%" border="1" bordercolor="#9FD6FF" id="dataTable" cellpadding="0" cellspacing="0">
            ...
            <tr id="mainTr<%=i%>">
                ...
                <td width="8%"><input type="text" name="serialNo" id="serialNo<%=i%>"
                                      value="<%=row.getValue("SERIAL_NO")%>"
                                      readonly class="blueborderYellow" style="width:100%">
                </td>
                <td style="display:none">
