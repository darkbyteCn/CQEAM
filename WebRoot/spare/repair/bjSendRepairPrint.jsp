    ...
    <tr>
        <td>
            <table width="100%" id="table2" border="0" cellspacing="1">
                <tr valign="center">
                    <td align="center"><img src="/images/mobile.gif"></td>
                    <td colspan="3"><font color="" size="4"><b>
                ...
                <tr height="24">
                    <td width="16%" align="right">客户方：</td>
...
<div style="left:1px;width:100%;overflow-y:visible" class="crystalScroll">
    <table id="$$$headerTable$$$" border="1" width="100%" cellpadding="0" cellspacing="0" bordercolor="#666666">
        <tr height="22">
...
<div style="width:100%;left:1px;margin-left:0;overflow-y:visible;" class="crystalScroll">
    <table width="100%" border="1" bordercolor="#9FD6FF">
        ...
        <tr height="22" style="cursor:'hand'" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
            ...
            <td width="10%"><%=row.getValue("ITEM_SPEC")%>
            </td>
            <td width="10%"><%=row.getValue("ITEM_CATEGORY")%>
            </td>
            <td width="10%"><%=row.getValue("SPARE_USAGE")%>
            </td>
            <td width="10%" align="left"><%=row.getValue("VENDOR_NAME")%>
            </td>
            <td width="5%" align="left"><%=row.getValue("QUANTITY")%>
            </td>
        </tr>
        <%
                }
