...
<form name="mainFrm" method="POST" action="/servlet/com.sino.ams.spare.servlet.SpareDBCancel">
    <script type="text/javascript">
        printTitleBar("备件调拨撤销");
    </script>
    ...
    <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" class="queryHeadBg">
        <tr>
            ...
            <td width="17%" height="22">
                <select name="transStatus" style="width:80%">
                        <%--<option value="">--请选择--</option>--%>
                        <option value="ALLOTING" <%if(parser.getParameter("transStatus").equals("ALLOTING")){%>selected<%}%>>待调出</option>
                        <%--<option value="RECEIVING" <%if(parser.getParameter("transStatus").equals("RECEIVING")){%>selected<%}%>>待接收</option>--%>
                </select>
            </td>
...
<script language="javascript">
    ...
    function do_ShowDetail(primaryKey) {
        ...
        var url = "com.sino.ams.spare.servlet.SpareDBCancel";
