...
<form name="mainFrm" method="POST" action="/servlet/com.sino.ams.spare.servlet.BjInConfirmedServlet">
    <script type="text/javascript">
        printTitleBar("备件调入确认");
    </script>
    ...
    <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" class="queryHeadBg">
        <tr>
            ...
            <td width="17%" height="22"><select name="transStatus" style="width:80%"><option value="" >--请选择--</option><option value = "RECEIVING" <%=parser.getParameter("transStatus").equals("RECEIVING")? "selected":""%> >待接收</option></select>
            </td>
     ...
     <script type="text/javascript">
        var columnArr = new Array("单据编号", "创建人", "创建日期", "单据状态","调出地市");
...
<script language="javascript">
    ...
    function do_ShowDetail(primaryKey) {
        var transType = document.mainFrm.transType.value;
        var url = "/servlet/com.sino.ams.spare.servlet.BjInConfirmedServlet";
