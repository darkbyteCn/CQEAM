...
%>
<form name="mainForm" action="/servlet/com.sino.ams.spare.bjslcy.servlet.AmsBjSlDisposeServlet" method="post">
...
<script type="text/javascript">
    function do_show(itemCode, transId) {
        ...
        var url = "/servlet/com.sino.ams.spare.bjslcy.servlet.AmsBjSlDisposeServlet?act=" + mainForm.act.value + "&transId=" + transId + "&itemCode=" + itemCode;
