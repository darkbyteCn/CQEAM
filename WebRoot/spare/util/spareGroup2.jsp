...
<head><title>请选择组别</title>
    ...
    <script language="javascript">
        ...
        function do_select() {
            window.returnValue = document.mainFrm.mySelect.value;
            window.close()
        }
        ...
        function do_submit() {
            var applyGroup = document.mainFrm.mySelect.value;
            if (applyGroup !== "") {
                var url = "/servlet/com.sino.ams.spare.servlet.RepairBackServlet?act=<%=WebActionConstant.NEW_ACTION%>&fromDept=" + applyGroup;
