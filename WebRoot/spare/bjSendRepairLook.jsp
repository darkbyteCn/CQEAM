        ...
        <td>
            <table width="100%" id="table2" border="0" cellspacing="1" bgcolor="#F2F9FF">
                <tr height="24">
                    ...
                    <td width="40%"><input type="text" name="company" class="blueborderGray"
                                           style="width:70%"   readonly
                                           value="<%=amsItemTransH.getVendorName()%>"></td>
                </tr>
                <tr height="24">
...
<fieldset>
    ...
    <script type="text/javascript">
        var columnArr = new Array("checkbox", "设备名称", "设备型号", "设备类型", "用途", "厂商","待修数量","送修数量");
    ...
    <div style="overflow-y:scroll;height:550px;width:100%;left:1px;margin-left:0" onscroll="document.getElementById('headDiv').scrollLeft = this.scrollLeft;">
        <table width="100%" border="1" bordercolor="#9FD6FF" id="dataTable" cellpadding="0" cellspacing="0" style="width:100%;TABLE-LAYOUT:fixed;word-break:break-all">
            ...
            <tr id="mainTr0" style="display:none">
                ...
                <td width="15%"><input type="text" name="itemCategory" id="itemCategory0" class="noneborderInput" style="width:100%"></td>
                <td width="15%"><input type="text" name="spareUsage" id="spareUsage0" class="noneborderInput" style="width:100%"></td>
                <td width="10%"><input type="text" name="vendorName" id="vendorName0" class="noneborderInput" style="width:100%"></td>
                <td width="8%" align="center"><input type="text" name="onhandQty" id="onhandQty0" readonly value="" class="noborderGray" style="width:100%;text-align:right">
                </td>
                <td width="8%"><input type="text" name="quantity" id="quantity0" value="" onblur="checkQty(this);" class="blueborderYellow" style="width:100%"></td>
            ...
            <tr id="mainTr<%=i%>">
                ...
                <td width="10%"><input type="text" name="itemName" id="itemName<%=i%>" class="noneborderInput" style="width:100%" value="<%=row.getValue("ITEM_NAME")%>">
                </td>
                ...
                <td width="10%"><input type="text" name="itemCategory" id="itemCategory<%=i%>" class="noneborderInput" style="width:100%" value="<%=row.getValue("ITEM_CATEGORY")%>">
                </td>
                <td width="10%"><input type="text" name="spareUsage" id="spareUsage<%=i%>" class="noneborderInput" style="width:100%" value="<%=row.getValue("SPARE_USAGE")%>">
                </td>
                <td width="10%"><input type="text" name="vendorName" id="vendorName<%=i%>" class="noneborderInput" style="width:100%" value="<%=row.getValue("VENDOR_NAME")%>">
                </td>
                ...
                <td width="5%"><input type="text" name="quantity" id="quantity<%=i%>" value="<%=row.getValue("QUANTITY")%>" class="noborderGray" style="width:100%;text-align:right">
                </td>
                <td style="display:none">
