        ...
        <td>
            <table width="100%" id="table2" cellspacing="1" border="0">
                ...
                <tr height="22">
                    ...
                    <td width="22%"><%=amsItemTransH.getSpareReason()%></td>
                </tr>
                <tr height="22">
...
<table border="0" bordercolor="#666666" style="left:1px;width:100%;">
    <tr height="22">
        ...
        <td width="12%"><%if(user.getOrganizationId().equals("82")) {%><img src="/images/fanjianqiang.jpg"><%}else{%><input type="text"  style="width:100%" readonly  class="approveInput" value=""><%}%></td>
        ...
        <td width="12%"><%if(user.getOrganizationId().equals("82")) {%><img src="/images/qianming.JPG"><%}else{%><input type="text"  style="width:100%"  readonly class="approveInput" value=""><%}%></td>
    </tr>
</table>
 </div>
</form>
