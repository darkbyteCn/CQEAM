...
<input type="hidden" name="applyGroup"  value="<%=amsItemTransH.getApplyGroup()%>">
            ...
            <table width="100%" id="table2" border="0" cellspacing="1">
               ...
               <tr height="22">
                ...
                <tr height="22">
                    ...
                    <td width="20%"><%=amsItemTransH.getSpareReasonD()%>
                    </td>
...
<DIV align=center id='hiddenDiv'>
    ...
    <img src="/images/eam_images/print.jpg" alt="打印页面" onclick="printIt();">
...
<div style="width:100%;left:1px;margin-left:0;overflow-y:visible;" class="crystalScroll">
        <table width="100%" border="1" bordercolor="#9FD6FF" id="dataTable" cellpadding="0" cellspacing="0">
            ...
            <tr id="mainTr0" style="display:none" height="30" onMouseMove="style.backgroundColor='#EFEFEF'" onMouseOut="style.backgroundColor='#ffffff'">
                ...
                <td width="5%" align="center"><input type="text" name="quantity" id="quantity0" value="" class="blueborderYellow" style="width:100%;text-align:right">
                </td>
