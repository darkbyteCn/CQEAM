...
<form method = "post" name = "mainFrm">
    ...
    <table width = "100%" border = "0" class="queryHeadBg">
        <tr>
            ...
            <td width = "20%" colspan = 2><input name = projectName  value="<%=projectName%>"  type = text style = "width:80%"><input type = hidden name = projectId><a href = # title = "点击选择项目信息" class = "linka" onclick = "do_SelectProj();">[…]</a></td>
   ...
   <div id="dataDiv" style="overflow-y:scroll;height:72%;width:100%;position:absolute;top:88px;left:0" align="left">
