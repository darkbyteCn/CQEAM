...
<form method = "post" name = "mainFrm">
    ...
    <table width = "100%" border = "0" class = "queryHeadBg">
        <tr>
            ...
            <td width = "15%"><input type = text name = itemSpec value = "<%=itemSpec%>"><a href = # title = "点击选择设备型号" class = "linka" onclick = "do_SelectSpec();">[…]</a></td>
        </tr>
        <tr>
            <td align = "center"><img src = "/images/eam_images/search.jpg" style = "cursor:'hand'" onclick = "do_search();" alt = "查询"></td>
            <td align = "center"><img src = "/images/eam_images/export.jpg" id = "queryImg" style = "cursor:'hand'" onclick = "do_exportToExcel()" alt = "导出Excel"></td>
    ...
    <div style = "overflow-y:scroll;left:0px;height:72%;width:100%;position:absolute;top:88px">
