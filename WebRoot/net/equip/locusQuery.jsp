...
<form method="post" name="mainFrm">
    ...
    <table width="100%" border="0" class="queryHeadBg">
        <tr>
            ...
            <td width="20%"><input type=text name=itemSpec value="<%=itemSpec%>"><a href = # title = " 点击选择设备型号" class
    ...
    <tr>
        ...
        <td><select name=objectCategory><%=objCateOption%>
        </select></td>
        ...
        <td><img src="/images/eam_images/export.jpg" id="queryImg" style="cursor:'hand'" onclick="do_exportToExcel()"
                 alt="导出Excel"></td>
        <td><img src="/images/eam_images/change_history.jpg" id="particularImg" style="cursor:'hand'"
                 onclick="do_showDetail()" alt="显示设备变动历史"></td>
...
<div style="overflow-y:scroll;left:0px;height:72%;width:100%;position:absolute;top:93px">
    <table width="100%" border="1" bordercolor="#666666">
        ...
        <tr class="dataTR"  onclick="do_ShowDetail('<%=row.getValue("BARCODE")%>')">
            ...
            <td style="word-wrap:break-word" height="22" width="15%" align="center"><%=row.getValue("PROJECT_NAME")%>
            </td>
