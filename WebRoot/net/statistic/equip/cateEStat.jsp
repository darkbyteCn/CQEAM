...
<form method="post" name="mainFrm">
    <script type="text/javascript">
        printTitleBar("设备现有量--按状态")
    </script>
    <table width="100%" border="0" class="queryHeadBg">
        <tr>
            <td width="10%" align="right">公司：</td>
            <td width="10%"><select name=organizationId style="width:100%"><%=cityOption%>
            </select></td>
            <td width="6%" align="right">设备专业：</td>
            <td width="12%"><select name=itemCategory style="width:100%"><%=itemCateOption%>
            </select></td>
            <td width="6%" align="right">设备型号：</td>
            <td width="10%"><input type=text name=itemSpec value="<%=itemSpec%>"><a href=# title="点击选择设备型号" class="linka"
        ...
        <td width="12%"><select name=itemStatus style="width:100%"><%=itemStatusOption%>
        </select></td>
        <td align="right"><img src="/images/eam_images/search.jpg" style="cursor:'hand'" onclick="do_search();" alt="查询"></td>
        <td align="center"><img src="/images/eam_images/export.jpg" id="queryImg" style="cursor:'hand'" onclick="do_exportToExcel()"
                 alt="导出到Excel"></td>
    ...
    <input type="hidden" name="qryType" value="<%=WebAttrConstant.BY_CATEGORY%>">

     <script type="text/javascript">
        var columnArr = new Array("公司", "设备专业", "设备名称", "设备型号", "现有量", "设备状态");
        var widthArr = new Array("10%", "10%", "25%", "25%", "10%", "10%");
        ...
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr class="dataTR">
                <td style="word-wrap:break-word" height="22" width="10%"
                    align="center"><%=row.getValue("ORGANIZATION_NAME")%>
                </td>
                <td style="word-wrap:break-word" height="22" width="10%"
                    align="center"><%=row.getValue("ITEM_CATEGORY")%>
                </td>
                <td style="word-wrap:break-word" height="22" width="25%" align="center"><%=row.getValue("ITEM_NAME")%>
                </td>
                <td style="word-wrap:break-word" height="22" width="25%" align="center"><%=row.getValue("ITEM_SPEC")%>
                </td>
                <td style="word-wrap:break-word" height="22" width="10%" align="center"><%=row.getValue("CNT")%>
                </td>
                <td style="word-wrap:break-word" height="22" width="10%" align="center"><%=row.getValue("ITEM_STATUS")%>
                </td>
            </tr>
            <%
                    }
