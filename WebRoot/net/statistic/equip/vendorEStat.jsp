...
<form method="post" name="mainFrm">
    <script type="text/javascript">
        printTitleBar("设备现有量--按供应商")
    </script>
    <table width="100%" border="0" class="queryHeadBg">
        <tr>
            <td width="10%" align="right">公司：</td>
            <td width="20%"><select name=organizationId style="width:100%"><%=cityOption%>
            </select></td>
            <td width="10%" align="right">设备型号：</td>
            <td width="20%"><input type=text value="<%=itemSpec%>" name=itemSpec><a href=# title="点击选择设备型号" class="linka"
        ...
        <tr>
            ...
            <td><select name=itemStatus style="width:100%"><%=itemStatusOption%>
            </select></td>
            <td align="right">供应商：</td>
            <td><input type=text value="<%=vendorName%>" name=vendorName><a href=# title="点击选择供应商" class="linka"
    ...
    <input type="hidden" name="qryType" value="<%=WebAttrConstant.BY_VENDOR%>">
    <input type="hidden" name="vendorId" value="<%=parser.getParameter("vendorId")%>">
    <%--<table width="835" align="left" border="1" cellpadding="2" cellspacing="0"--%>
           <%--style="position:absolute;left:1px;top:70px" class="headerTable">--%>
        <%--<tr>--%>
            <%--<td width="20%" align="center">供应商</td>--%>
            <%--<td width="25%" align="center">设备名称</td>--%>
            <%--<td width="25%" align="center">设备型号</td>--%>
            <%--<td width="10%" align="center">现有量</td>--%>
        <%--</tr>--%>
    <%--</table>--%>
      <script type="text/javascript">
        var columnArr = new Array("供应商","设备名称", "设备型号", "现有量");
    ...
    <div style="overflow-y:scroll;left:0px;width:100%;height:360px">
        <table width="100%" border="1" bordercolor="#666666">
            ...
            %>
            <tr class="dataTR">
                <td style="word-wrap:break-word" height="22" width="20%" align="center"><%=row.getValue("VENDOR_NAME")%>
                </td>
