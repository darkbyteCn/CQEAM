...
<form method="post" name="mainFrm">
    <script type="text/javascript">
        printTitleBar("全省统计--按状态")
    </script>
    <table width="100%" border="0" class="queryHeadBg">
        <tr>
            <td width="10%" align="right">公司：</td>
            <td width="10%"><select name=organizationId style="width:100%"><%=cityOption%></select></td>
            <td width="6%" align="right">设备类型：</td>
            <td width="12%"><select name=itemCategory style="width:100%"><%=itemCateOption%></select></td>
            <td width="6%" align="right">规格型号：</td>
            <td width="10%"><input type=text name=itemSpec value="<%=itemSpec%>"><a href=# title="点击选择规格型号" class="linka"
                                                                                    onclick="do_SelectSpec();">[…]</a>
            </td>

        </tr>
        <td align="right">资产类型：</td>
        <td><select name=finaceProp style="width:100%"><%=financePropOption%></select></td>
        <td align="right">设备状态：</td>
        <td width="12%"><select name=itemStatus style="width:100%"><%=itemStatusOption%></select></td>
    ...
    <input type="hidden" name="qryType" value="<%=WebAttrConstant.BY_CATEGORY%>2">
 
  <script type="text/javascript">
        var columnArr = new Array("公司", "设备分类", "设备名称", "规格型号", "现有量");
        var widthArr = new Array("10%", "10%", "25%", "25%", "10%");
        ...
        <table width="100%" border="1" bordercolor="#666666">
            ...
            <tr class="dataTR">
                <td style="word-wrap:break-word" height="22" width="10%"
                    align="center"><%=row.getValue("ORGANIZATION_NAME")%></td>
                <td style="word-wrap:break-word" height="22" width="10%"
                    align="center"><%=row.getValue("ITEM_CATEGORY")%></td>
