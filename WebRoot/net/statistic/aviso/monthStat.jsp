...
<form method = "post" name = "mainFrm">
    ...
    <table width = "100%" border = "0" class="queryTable">
        <tr>
            ...
            <td width = "20%"><select style = "width:100%" class="select_style1" name = "month"><%=monthOption%></select></td>
            <td width = 80%></td>
    ...
    <input type = "hidden" name = "qryType" value = "<%=WebAttrConstant.BY_MONTH%>">

    <script type = "text/javascript">
//        var columnArr = new Array("公司", "月份", "周次", "交接", "巡检", "维修", "搬迁", "调拨", "报废", "合计");
        var columnArr = new Array("公司", "月份", "周次", "交接", "巡检", "维修", "搬迁", "调拨", "报废", "合计");
        var widthArr = new Array("15%", "10%", "5%", "5%", "5%", "5%", "5%", "5%", "5%", "5%");
    ...
    <div style = "overflow-y:scroll; left:0px;width:100%;height:400px">
        <table width = "100%" border = "1" bordercolor = "#666666" id = "dateTable">
            ...
            <tr class = "dataTR" height = "22">
                ...
                <td width = "10%" align = "center"><%=row.getValue("MONTH_NO")%></td>
                <td width = "5%" align = "center"><%=row.getValue("WEEK_NO")%></td>
