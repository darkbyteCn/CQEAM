 ...
 */
public class GetContentOPE extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        Logger.logInfo("PDA run GetContentOPE servlet begin....");

        out.println("<?xml version=\"1.0\" encoding=\"GB2312\"?>");

        out.println("<ope_contents>");
        Connection conn = null;
        try {
            conn = DBManager.getDBConnection();
            getContentOpe(conn, out);
        ...
        out.println("</ope_contents>");
        Logger.logInfo("PDA run GetContentOPE servlet over....");
        out.close();
    }


    private void getContentOpe(Connection conn, PrintWriter out) {
        ...
        try {
            ...
            if (simpleQuery.hasResult()) {
                ...
                for (int i = 0; i < rs.getSize(); i++) {
                    ...
                    stringBuffer.append("<ope_content  ");
                    ...
                    stringBuffer.append(" ope_id=\"").append(PDAUtil.xmlFormat(row.getStrValue("OPE_ID"))).append("\"");
                    stringBuffer.append(" />");
