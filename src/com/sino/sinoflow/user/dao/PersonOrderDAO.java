...
public class PersonOrderDAO extends BaseDAO {
     ...
     */
    public PersonOrderDAO(SfUserBaseDTO userAccount, PersonOrderDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        personOrderDTO = (PersonOrderDTO) dtoParameter;
        super.sqlProducer = new PersonOrderModel((SfUserBaseDTO) userAccount, personOrderDTO);
    }
