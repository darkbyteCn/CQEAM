...
import com.sino.sinoflow.model.PendingTrayModel;
...
public class PendingTrayHome extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            SQLModel sqlModel = (new PendingTrayModel(user, null)).getPageQueryModel(keyword, subject, others, createby, sortType);
            ...
            forwardURL = "/flow/pendingTrayHome.jsp";
            commitFlag = true;
