...
public class SfDelegationServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				BaseSQLProducer sqlProducer = new SfDelegationModel(user, dtoParameter);
				PageQueryDAO pageDAO = new PageQueryDAO(req, conn, sqlProducer);
				pageDAO.setDTOClassName(SfDelegationDTO.class.getName());
				pageDAO.produceWebData();
				forwardURL = URLDefineList.DELEGATION_QUERY_PAGE;
				...
				forwardURL = URLDefineList.DELEGATION_DETAIL_PAGE;
				...
				forwardURL = URLDefineList.DELEGATION_SERLVET;
