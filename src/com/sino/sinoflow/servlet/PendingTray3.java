...
import com.sino.sinoflow.model.PendingTrayModel3;
...
public class PendingTray3 extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            SQLModel sqlModel = (new PendingTrayModel3(user, null)).getPageQueryModel(keyword, subject, others, createby, fromDate, toDate, sortTypeStr);
            ...
            forwardURL = "/flow/pendingTray3.jsp";
            commitFlag = true;
