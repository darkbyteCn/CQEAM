		...
		SQLModel sqlModel = new SQLModel();
			...
			if(taskType.equals("send")){
				sqlStr+=" SELECT CTOL.TASK_ORDER_ID,CTOL.ORDER_NUMBER,CTOL.ORDER_NAME,CTOL.IMPLEMENT_BY,\n" +
					" CTOL.IMPLEMENT_NAME,CTOL.ORDER_TYPE,CTOL.IMPLEMENT_ORGANIZATION_ID,CTOL.IMPLEMNET_ROLE_NAME,\n" +
					" CTOL.IMPLEMENT_DEPT_ID,CTOL.IMPLEMNET_DEPT_NAME,\n" ;
				sqlStr+=CommonUseUtil.getSqlStr();	
				sqlStr+=" FROM AMS_ASSETS_YAER_CHECK_TASK_ORDER_HEADER CTOH, \n" +
				...
				sqlStr+=" SELECT  CTOH.DISTRUBTE_BY, CTOH.DISTRUBTE_BY_NAME,CTOL.ORDER_NAME,CTOL.ORDER_NUMBER," +
						" SUBSTRING(CONVERT(VARCHAR(32),CTOH.CREATION_DATE,112),1,8) SEND_DATE ,CTOL.ORDER_TYPE," +
