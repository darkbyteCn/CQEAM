...
import com.sino.ams.sampling.report.model.AssetsSamplingReportOneModel;
 ...
 */
public class AssetsSamplingReportOneDAO extends AMSBaseDAO {

	public AssetsSamplingReportOneDAO(SfUserDTO userAccount, AmsAssetsSamplingHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new AssetsSamplingReportOneModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			AssetsSamplingReportOneModel modelProducer = (AssetsSamplingReportOneModel)sqlProducer;
			SQLModel sqlModel = modelProducer.getPageQueryModel();
			String reportTitle = "账实一致";
