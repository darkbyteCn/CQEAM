 ...
 */
public class AssetsSamplingReportThreeDAO extends AMSBaseDAO {

	public AssetsSamplingReportThreeDAO(SfUserDTO userAccount, AmsAssetsSamplingHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new AssetsSamplingReportThreeModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			AssetsSamplingReportThreeModel modelProducer = (AssetsSamplingReportThreeModel)sqlProducer;
