...
import com.sino.ams.sampling.dao.TaskBatchTreeDAO;
...
public class OrderFrmServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			TaskBatchTreeDAO treeDAO = new TaskBatchTreeDAO(user, dto, conn);
			AmsAssetsSamplingBatchDTO firstBatch = treeDAO.getFirstBatch();
			if(firstBatch == null){
				firstBatch = dto;
				firstBatch.setTaskName(SamplingWebAttributes.NO_TASK_REMARK);
			}
			req.setAttribute(SamplingWebAttributes.BATCH_DTO, firstBatch);
			forwardURL = SamplingURLs.ORDER_FRM_PAGE;
