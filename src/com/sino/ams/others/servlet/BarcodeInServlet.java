...
/**
 * <p>Title: SinoEAM</p>
 * <p>Description: 其它资产库存管理---条码设备出入库</p>
 ...
 *          Date: 2007-11-9
 */
public class BarcodeInServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/others/barcodeQuery.jsp?transType="+ DictConstant.TMRK;
...
//                amsItemTransH.setTransType(DictConstant.TMRK);
                ...
                forwardURL = "/others/barcodeIn.jsp";
                ...
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.ams.others.servlet.BarcodeInServlet?act=" + WebActionConstant.DETAIL_ACTION
