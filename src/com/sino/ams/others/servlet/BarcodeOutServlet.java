 ...
 *          Date: 2007-11-15
 */
public class BarcodeOutServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/others/barcodeQuery.jsp?transType="+ DictConstant.TMCK;
                ...
                forwardURL = "/others/barcodeOut.jsp";
                ...
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.ams.others.servlet.BarcodeOutServlet?act=" + WebActionConstant.DETAIL_ACTION
