 ...
 */
public class NoBarcodeOutServlet extends BaseServlet {
     public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/others/noBarcodeOutQuery.jsp";
...
//                amsItemTransH.setTransType(DictConstant.TMRK);
                ...
                forwardURL = "/others/noBarcodeOut.jsp";
                ...
                message.setIsError(!operateResult);
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.ams.others.servlet.NoBarcodeOutServlet?act=" + WebActionConstant.QUERY_ACTION;
                    showMsg = "单据" + dtoParameter.getTransNo() + "已生成!";
                } else {
                    forwardURL = "/servlet/com.sino.ams.others.servlet.NoBarcodeOutServlet?act=" + WebActionConstant.DETAIL_ACTION
                            + "&transId=" + dtoParameter.getTransId();
                }
