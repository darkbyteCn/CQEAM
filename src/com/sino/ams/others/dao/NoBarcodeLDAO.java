...
public class NoBarcodeLDAO extends BaseDAO {
	...
	/**
	 * 功能：备件事务行表(EAM) AMS_ITEM_TRANS_L 数据访问层构造函数
	...
	/**
	 * 功能：插入备件事务行表(EAM)表“AMS_ITEM_TRANS_L”数据。
	 */
	public void createData() throws DataHandleException {
		super.createData();
		getMessage().addParameterValue("备件事务行表(EAM)");
	}

	/**
	 * 功能：更新备件事务行表(EAM)表“AMS_ITEM_TRANS_L”数据。
	 */
	...
	/**
	 * 功能：删除备件事务行表(EAM)表“AMS_ITEM_TRANS_L”数据。
	 */
