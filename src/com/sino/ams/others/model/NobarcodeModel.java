...
public class NobarcodeModel extends BaseSQLProducer {
    ...
    /**
     * 功能：备件事务头表(EAM) AMS_ITEM_TRANS_H 数据库SQL构造层构造函数
    ...
    /**
     * 功能：框架自动生成备件事务头表(EAM) AMS_ITEM_TRANS_H数据插入SQLModel，请根据实际需要修改。
...
//            sqlArgs.add(amsItemTransH.getLastUpdateBy());
    ...
    /**
     * 功能：框架自动生成备件事务头表(EAM) AMS_ITEM_TRANS_H数据更新SQLModel，请根据实际需要修改。
...
//            sqlArgs.add(amsItemTransH.getToOrganizationId());
    ...
    /**
     * 功能：框架自动生成备件事务头表(EAM) AMS_ITEM_TRANS_H数据删除SQLModel，请根据实际需要修改。
    ...
    /**
     * 功能：框架自动生成备件事务头表(EAM) AMS_ITEM_TRANS_H数据详细信息查询SQLModel，请根据实际需要修改。
    ...
    /**
     * 功能：框架自动生成备件事务头表(EAM) AMS_ITEM_TRANS_H多条数据信息查询SQLModel，请根据实际需要修改。
    ...
    /**
     * 功能：框架自动生成备件事务头表(EAM) AMS_ITEM_TRANS_H页面翻页查询SQLModel，请根据实际需要修改。
