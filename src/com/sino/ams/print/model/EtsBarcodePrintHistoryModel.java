...
public class EtsBarcodePrintHistoryModel extends BaseSQLProducer {
	private SfUserDTO userAccount = null;

	public EtsBarcodePrintHistoryModel(BaseUserDTO userAccount,
			EtsBarcodePrintHistoryDTO dtoParameter) {
