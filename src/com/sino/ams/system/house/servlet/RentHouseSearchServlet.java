 ...
 * Function:租赁房屋土地查询
 */
public class RentHouseSearchServlet extends BaseServlet {
    /**
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/system/house/rent/rentSearch.jsp";
                ...
                amsHouseInfo.setLook(dtoParameter.getLook());
...
//                boolean operateResult = rentHouseDAO.deleteNullData(itemInfoDTO, fileDTO, filePaths ,lineSet);
                ...
                RentHouseModel sqlProducer = new RentHouseModel(user, dtoParameter);
                SQLModel sqlModel = sqlProducer.getRentHistoryModel();
                WebPageView wpv = new WebPageView(req, conn);
                wpv.setPageSize(15);
                wpv.produceWebData(sqlModel);
                req.setAttribute(WebAttrConstant.AMS_HOUSE_INFO_DTO, dtoParameter);
                forwardURL = "/system/house/rent/rentHistory.jsp";
            } else {
