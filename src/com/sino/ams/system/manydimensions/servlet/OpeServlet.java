...
import com.sino.ams.system.manydimensions.dao.OpeDAO;
 ...
 * Function:		业务平台属性维护
 */
public class OpeServlet extends BaseServlet {
    ...
    private void getAmsOpeIds(HttpServletRequest req, AmsElementMatchDTO dto) throws UploadException {
        try {
            ...
            String[] exarr = reqParser.getParameterValues("amsOpeId");
            if (exarr != null) {
                StringBuffer ids = new StringBuffer();
                for (int i = 0; i < exarr.length; i++) {
                    ids.append(exarr[i] + ",");
                }
                dto.setAmsOpeId(ids.substring(0, ids.length()-1));
            }
