package com.sino.ams.system.county.model.oracle;
...
public class EtsCountyModelImpl extends BaseSQLProducer {
...
//            sqlArgs.add(etsCounty.getLastUpdateDate());
    ...
    public SQLModel getPageQueryModel() throws SQLModelException {
        ...
        List sqlArgs = new ArrayList();
        EtsCountyDTO etsCounty = (EtsCountyDTO) dtoParameter;
        String sqlStr = "SELECT dbo.APP_GET_ORGNIZATION_NAME(EOCM.ORGANIZATION_ID) ORGNIZATION_NAME,\n" +
                "\t\t\t EC.COUNTY_CODE_MIS,\n" +
                ...
                + " AND ( " + SyBaseSQLUtil.isNull() + "  OR EC.COUNTY_NAME = ?)"
                + " AND ( " + SyBaseSQLUtil.isNull() + "  OR EC.COUNTY_CODE_MIS LIKE ?)"
                + " AND ( " + SyBaseSQLUtil.isNull() + "  OR EC.COUNTY_CODE_COA_CC LIKE ?)"
