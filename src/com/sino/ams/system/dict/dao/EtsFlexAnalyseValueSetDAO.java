...
/**
 * <p>Title: EtsFlexAnalyseValueSetDAO</p>
 * <p>Description:程序自动生成服务程序“EtsFlexAnalyseValueSetDAO”，请根据需要自行修改</p>
...
public class EtsFlexAnalyseValueSetDAO extends BaseDAO {
	 ...
	 */
	public EtsFlexAnalyseValueSetDAO(SfUserDTO userAccount, EtsFlexValueSetDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO  userAccount, DTO dtoParameter) {
		...
		super.sqlProducer = new EtsFlexAnalyseValueSetModel((SfUserDTO)userAccount, dtoPara);
	}

	/**
	 * 功能：插入字典分类表(AMS)表“ETS_FLEX_ANALYSE_VALUE_SET”数据。
	 * @return boolean
	 */
	...
	/**
	 * 功能：更新字典分类表(AMS)表“ETS_FLEX_ANALYSE_VALUE_SET”数据。
	 * @return boolean
	 */
	...
	private boolean saveData(String dbAction) throws DataHandleException {
		...
		try {
			String tableName = "ETS_FLEX_ANALYSE_VALUE_SET";
	...
	/**
	 * 功能：删除字典分类表(AMS)表“ETS_FLEX_ANALYSE_VALUE_SET”数据。
	 * @return boolean
	 */
