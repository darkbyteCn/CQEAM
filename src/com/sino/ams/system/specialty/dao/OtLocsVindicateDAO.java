 ...
 */
public class OtLocsVindicateDAO extends AMSBaseDAO {
...
/**
	 ...
	 */
	public OtLocsVindicateDAO(SfUserDTO userAccount, EtsObjectDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		super.sqlProducer = new OtLocsVindicateModel( (SfUserDTO) userAccount, dtoPara);
	}
	...
	public String getCategoryName() throws QueryException {
        ...
        OtLocsVindicateModel eomodel = new OtLocsVindicateModel(sfUser, etsObjectDTO);
...
//		return operateResult;
	...
	public void disabledData(String[] workorderObjectNos){ //执行批量失效操作
		EtsObjectDTO dtoPara = (EtsObjectDTO) dtoParameter;
		try {
			OtLocsVindicateModel etsObjectModel = (OtLocsVindicateModel) sqlProducer;
	...
	public File exportFile() throws DataTransException {
		...
		try {
			...
			String fileName = etsObjectDTO.getCategoryName() + "统计表.csv";
...
//
          ...
          return StrUtil.nullToString(operateResult);
     ...
     private String getNextWorkorderObjectNo() throws SQLException {
        ...
        return StrUtil.nullToString(seqProducer.getStrNextSeq("ETS_OBJECT_S"));
    }
