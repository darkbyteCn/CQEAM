 ...
 */
public class ReadDzyhAssetsInfoJt {
             ...
             if (indexOfSheet < numberOfSheet) {
                 ...
                 for (int i = startRowNum; i <= row; i++) {
                     ...
                     if (hssfRow != null) {
                         ...
                         ImportDzyhAssetsDTOJt onNetDtlDTO = new ImportDzyhAssetsDTOJt();
     ...
     private ImportDzyhAssetsDTOJt fillOrderDtlDTO(int indexk, String strValue, ImportDzyhAssetsDTOJt onNetDtlDTO) {
         if(strValue != null){
