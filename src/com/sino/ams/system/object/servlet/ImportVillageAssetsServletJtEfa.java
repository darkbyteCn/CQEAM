...
public class ImportVillageAssetsServletJtEfa extends BaseServlet {
    private final static int startRowNum = 5;
    private final static int columnNum = 33;
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            ImportVillageAssetsDAOJtEfa ImObDAO = new ImportVillageAssetsDAOJtEfa(userAccount, null, conn);
            ...
            if (action.equals("UPLOAD_ACTION")) { 
                ...
                if(dtoSet != null){
                    ...
                    if (StrUtil.isEmpty(showMsg)) {//校验没有错误
        				...
        				forwardURL = "/servlet/com.sino.ams.system.object.servlet.ImportVillageAssetsServletJtEfa?act=";
                    } else {
                        message.setMessageValue(showMsg);
                        message.setIsError(true);
                        RowSet rows = ImObDAO.getImportErrors();
                        req.setAttribute(WebAttrConstant.ETS_SPARE_DTO, rows);
                        forwardURL = "/system/object/importVillageErrorJtEfa.jsp";
                    }
                } else {
            	...
            	forwardURL = "/system/object/importVillageAssetsJtEfa.jsp";
            } else {
            ...
            if (!StrUtil.isEmpty(forwardURL)) {
    			if ( StrUtil.isEmpty( showMsg ) || !showMsg.equals("通服资产导入更新成功")) {
        ...
        try {
            ...
            if (upFiles != null) {
                if (upFiles.length == 1 && !upFiles[0].getFileName().equals("")) {
                    ...
                    ReadVillageAssetsInfoJtEfa xlsUtil = new ReadVillageAssetsInfoJtEfa();
