 ...
 */
public class ReadVillageAssetsInfo {
             ...
             if (indexOfSheet < numberOfSheet) {
                 ...
                 for (int i = startRowNum; i <= row; i++) {
                     ...
                     if (hssfRow != null) {
                         ...
                         ImportVillageAssetsDTO onNetDtlDTO = new ImportVillageAssetsDTO();
     ...
     private ImportVillageAssetsDTO fillOrderDtlDTO(int indexk, String strValue, ImportVillageAssetsDTO onNetDtlDTO) {
         if(strValue != null){
         ...
         switch (indexk) {
             ...
             case 14:
                 ...
                 break;
             case 15:
                 onNetDtlDTO.setDeprnCost(strValue);
                 break;
             case 16:
             ...
             case 17:
                 ...
                 break;
             case 18:
                 onNetDtlDTO.setUseYear(strValue);
                 break;
             case 19:
                 onNetDtlDTO.setRemainMonth(strValue);
                 break;
             case 20:
