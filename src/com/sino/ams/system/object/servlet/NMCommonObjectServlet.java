 ...
 * @version 1.0
 */
public class NMCommonObjectServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				...
				forwardURL = "/system/object/NMobjectQuery.jsp";
				...
				forwardURL = "/servlet/com.sino.ams.system.object.servlet.NMCommonObjectServlet";
				...
				forwardURL = "/system/object/NMobjectDetail.jsp";
...
//			}
				...
				String workorderObjectCode = dto.getCountyCode() + "." + dto.getLoc2Code() + "." + dto.getLoc3Code(); //组合地点代码
