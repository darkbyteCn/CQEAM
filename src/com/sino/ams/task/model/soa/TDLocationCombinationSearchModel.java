 ...
 * @version 1.0
 */
public class TDLocationCombinationSearchModel extends BaseSQLProducer {
     ...
     */
    public TDLocationCombinationSearchModel(BaseUserDTO userAccount, DTO dtoParameter) {
     ...
     */
    public SQLModel getTDChangedLocationCombinationModel(int organizationId) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "SELECT TOP 500 EO.WORKORDER_OBJECT_NO\n" +
                "FROM   ETS_OBJECT             EO,\n" +
                "       ETS_FA_ASSETS_LOCATION_TD TT\n" +
