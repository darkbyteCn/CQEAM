 ...
 * <p>描述: 构造获取指定OU组织下物理地点发生变动的模型对象</p>
 ...
 * @version 1.0
 */
public class LocationSegment2SearchModel extends BaseSQLProducer {
     ...
     */
    public LocationSegment2SearchModel(BaseUserDTO userAccount, DTO dtoParameter) {
        super(userAccount, dtoParameter);
    }

    /**
     * <p>功能说明：构造获取指定OU组织下物理地点发生变动的模型对象</p>
     *
     * @param organizationId OU组织ID
     * @return SQLModel 返回指定OU组织下物理地点发生变动的模型对象
     */
