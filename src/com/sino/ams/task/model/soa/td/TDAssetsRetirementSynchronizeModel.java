 ...
 * <p>描述: 查询EAM系统中需要同步到TD系统的资产报废数据</p>
 ...
 * @version 1.0
 */
public class TDAssetsRetirementSynchronizeModel extends BaseSQLProducer {

    public TDAssetsRetirementSynchronizeModel(BaseUserDTO userAccount, DTO dtoParameter) {
