 ...
 * <p>描述: 查询EAM系统中需要同步到TD系统的资产变动数据</p>
 ...
 * @version 1.0
 */
public class TDAssetsChangeSearchModel extends BaseSQLProducer {

    public TDAssetsChangeSearchModel(BaseUserDTO userAccount, DTO dtoParameter) {
