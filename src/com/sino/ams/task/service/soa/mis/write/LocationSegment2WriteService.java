...
import com.sino.ams.task.dao.soa.mis.LocationSegment2SearchDAO;
 ...
 * <p>描述: 通过SOA服务将将EAM系统发生的地点第二段变动同步到MIS系统</p>
 ...
 * @version 1.0
 */
public class LocationSegment2WriteService extends AbstractTaskSOAService {

    /**
     * <p>功能说明：将EAM系统发生的地点第二段变动同步到MIS系统</p>
     *
     * @throws com.sino.base.exception.DataHandleException
     *          将EAM系统发生的地点第二段变动同步到MIS系统出错时抛数据处理异常
     */
        ...
        try {
            ...
            if (rows != null && !rows.isEmpty()) {
                ...
                for (int i = 0; i < dataCount; i++) {
                    ...
                    assetsUpdateDAO.synLocComb(objectNos, "N");
                }
            }
        } catch (Throwable ex) {
            Logger.logError(ex);
    ...
    private String[] getOU2SynchronizeLocationSegment2(Connection conn, int organizationId) throws QueryException {
        String[] objects = null;
        try {
            LocationSegment2SearchDAO searchDAO = new LocationSegment2SearchDAO(taskExecutor, null, conn);
