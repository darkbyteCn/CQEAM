 ...
 * <p>描述: 通过SOA服务将EAM系统发生的报废资产报废同步到MIS系统</p>
...
public class AssetsRetirementWriteService extends AbstractTaskSOAService {
    ...
    /**
     * <p>功能说明：将EAM系统发生的报废资产报废同步到MIS系统 </p>
     *
     * @throws com.sino.base.exception.DataHandleException
     *          将EAM系统发生的报废资产报废同步到MIS系统出错时抛数据处理异常
     */
     ...
     * @throws ContainerException 当容器不包含SYSTEMID字段时抛出该异常
     */
     ...
     * @throws DataHandleException 处理数据出错时抛出数据处理异常
     */
