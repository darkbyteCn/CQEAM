...
import com.sino.ams.task.model.soa.td.TDLocationSegment2SearchModel;
 ...
 * @version 1.0
 */
public class TDLocationSegment2SearchDAO extends AMSBaseDAO {

    public TDLocationSegment2SearchDAO(BaseUserDTO userAccount, DTO dtoParameter, Connection conn) {
        super(userAccount, dtoParameter, conn);
    }

    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        sqlProducer = new TDLocationSegment2SearchModel(userAccount, dtoParameter);
    }
    ...
    public RowSet getOU2SynchronizeLocationSegment2(int organizationId) throws QueryException {
        TDLocationSegment2SearchModel modelProducer = (TDLocationSegment2SearchModel) sqlProducer;
