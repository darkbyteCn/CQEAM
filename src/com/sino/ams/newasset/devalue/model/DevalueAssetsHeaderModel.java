package com.sino.ams.newasset.devalue.model;
...
public class DevalueAssetsHeaderModel extends AMSSQLProducer {
     ...
     */
    public DevalueAssetsHeaderModel(SfUserDTO userAccount, AmsAssetsTransHeaderDTO dtoParameter) {
...
//        sqlArgs.add(fDept);
    ...
    public SQLModel getQueryBarcodeAllExcelModel(String excel,
        ...
        if ("Y".equalsIgnoreCase(userAccount.getIsTd())) {
            ...
            if (dto.getTransType().equals(AssetsDictConstant.ASS_RED)) { //调拨
                ...
                sqlArgs.add(AssetsDictConstant.ITEM_STATUS_NORMAL);
                sqlArgs.add(AssetsDictConstant.ASSETS_STATUS_FREED);
            } else if (dto.getTransType().equals(AssetsDictConstant.ASS_DEVALUE)) { //减值前提：正常或者闲置
                sqlArgs.add(AssetsDictConstant.ITEM_STATUS_NORMAL);
                sqlArgs.add(AssetsDictConstant.ASSETS_STATUS_FREED);
            }
     ...
     * @return
     */
    public SQLModel getDevalueAssetsModel(String headerId) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
//        String sqlStr =
...
//                        "           AND BARCODE = BARCODE)";
        ...
        sqlArgs.add(DictConstant.STATUS_DEVALUE);
