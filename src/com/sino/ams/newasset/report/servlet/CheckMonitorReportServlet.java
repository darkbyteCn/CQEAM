...
import com.sino.ams.newasset.report.dao.CheckMonitorReportDAO;
...
public class CheckMonitorReportServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				...
				dto.setMaintainComapnyOpt(opt);
				opt = optProducer.getDictOption(DictConstant.OBJECT_CATEGORY, dto.getObjectCategory());
				dto.setObjectCategoryOpt(opt);
				req.setAttribute(QueryConstant.QUERY_DTO, dto);

				forwardURL = AssetsURLList.SCAN_MONITOR_RPT;
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new ChkecMonitorReportModel(user, dto);
				...
				CheckMonitorReportDAO rptDAO = new CheckMonitorReportDAO(user, dto, conn);
