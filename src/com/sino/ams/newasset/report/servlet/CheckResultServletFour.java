...
import com.sino.ams.newasset.report.model.CheckResultModelFour;
...
public class CheckResultServletFour extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				...
				forwardURL = AssetsURLList.CHECK_RESULT_RPT_4;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new CheckResultModelFour(user, dto);
