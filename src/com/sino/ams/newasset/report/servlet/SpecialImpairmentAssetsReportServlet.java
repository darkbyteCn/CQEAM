...
import com.sino.ams.newasset.report.dao.SpecialImpairmentAssetsReportDAO;
import com.sino.ams.newasset.report.dto.SpecialAssetsReportDTO;
import com.sino.ams.newasset.report.model.SpecialImpairmentAssetsReportModel;
...
public class SpecialImpairmentAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.SPECIAL_IMPAIRMENT_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new SpecialImpairmentAssetsReportModel(user, dto);
                ...
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				SpecialImpairmentAssetsReportDAO rptDAO = new SpecialImpairmentAssetsReportDAO(user, dto, conn);
