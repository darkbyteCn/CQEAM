...
import com.sino.ams.newasset.report.model.ScanedItemReportModel;
...
public class ScanedItemReportServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals(WebActionConstant.DETAIL_ACTION)) {
				BaseSQLProducer sqlProducer = new ScanedItemReportModel(user, dto);
