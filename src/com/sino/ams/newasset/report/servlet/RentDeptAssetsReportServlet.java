...
import com.sino.ams.newasset.report.dao.RentDeptAssetsReportDAO;
...
public class RentDeptAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			RentDTO dto = (RentDTO) req2DTO.getDTO(req);
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.RENT_DEPT_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new RentDeptAssetsReportModel(user, dto);
				...
				RentDeptAssetsReportDAO rptDAO = new RentDeptAssetsReportDAO(user, dto, conn);
