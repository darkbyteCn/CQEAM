...
import com.sino.ams.newasset.report.model.DiffItemRptModel;
...
public class DiffItemRptServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals(WebActionConstant.DETAIL_ACTION)) {
				BaseSQLProducer sqlProducer = new DiffItemRptModel(user, dto);
