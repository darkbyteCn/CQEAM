...
import com.sino.ams.newasset.report.dao.CostDiffDtlReportDAO;
...
public class CostDiffDtlReportServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals(AssetsActionConstant.QUERY_ACTION)) {//
				...
				forwardURL = AssetsURLList.COST_DTL_RPT;
			} else if (action.equals(AssetsActionConstant.EXPORT_ACTION)) {
				CostDiffDtlReportDAO rptDAO = new CostDiffDtlReportDAO(user, dto, conn);
				rptDAO.setCalPattern(LINE_PATTERN);
