...
import com.sino.ams.newasset.report.model.NotScanedLocReportModel;
...
public class NotScanedLocRptServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals(WebActionConstant.DETAIL_ACTION)) {
				BaseSQLProducer sqlProducer = new NotScanedLocReportModel(user, dto);
				PageQueryDAO pageDAO = new PageQueryDAO(req, conn, sqlProducer);
				pageDAO.setPageSize(23);
				pageDAO.produceWebData();
				forwardURL = AssetsURLList.NOTSCANED_LOC_RPT;
			} else {
