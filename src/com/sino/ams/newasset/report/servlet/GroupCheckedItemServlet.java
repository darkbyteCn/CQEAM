...
import com.sino.ams.newasset.report.dao.GroupCheckDetailDAO;
...
public class GroupCheckedItemServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			GroupCheckDetailDAO scanDAO = new GroupCheckDetailDAO(user, dto, conn);
			if(act.equals(WebActionConstant.DETAIL_ACTION)){
				RowSet rows = scanDAO.getScanedItems();
				req.setAttribute(AssetsWebAttributes.WORKORDER_DTO, dto);
				req.setAttribute(AssetsWebAttributes.GROUP_ITEMS, rows);
				forwardURL = AssetsURLList.GROUP_ITEM_PAGE;
			} else if(act.equals(WebActionConstant.EXPORT_ACTION)){
				File file = scanDAO.getExportFile();
