...
import com.sino.ams.newasset.report.dao.LastingAssetsReportDAO;
import com.sino.ams.newasset.report.model.LastingAssetsReportModel;
 ...
 */
public class LastingAssetsReportServlet extends BaseServlet {
    /**
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            LastingAssetsReportDAO dao = new LastingAssetsReportDAO(user, dtoParameter, conn);
            ...
            if (action.equals("")) {
                ...
                forwardURL = AssetsURLList.LASTING_COM_RPT;
            } else if (action.equals(WebActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new LastingAssetsReportModel(user, dtoParameter);
                ...
                req.setAttribute(QueryConstant.QUERY_DTO, dtoParameter);
				forwardURL = AssetsURLList.LASTING_DEPT_RPT;
			} else {
