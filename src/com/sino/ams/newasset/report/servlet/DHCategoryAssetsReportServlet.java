...
import com.sino.ams.newasset.report.dao.DHCategoryAssetsReportDAO;
 ...
 * Date: 2009-6-2
 * Time: 15:11:55
 * Function:	目录构成分布(重要低耗)
 */

public class DHCategoryAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.DH_CATEGORY_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new DHCategoryAssetsReportModel(user, dto);
                ...
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				DHCategoryAssetsReportDAO dao = new DHCategoryAssetsReportDAO(user, dto, conn);
