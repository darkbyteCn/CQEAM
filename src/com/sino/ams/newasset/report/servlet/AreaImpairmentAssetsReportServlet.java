...
import com.sino.ams.newasset.report.dao.AreaImpairmentAssetsReportDAO;
 ...
 */
public class AreaImpairmentAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.AREA_IMPAIRMENT_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new AreaImpairmentAssetsReportModel(user, dto);
                ...
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				AreaImpairmentAssetsReportDAO rptDAO = new AreaImpairmentAssetsReportDAO(user, dto, conn);
