...
import com.sino.ams.newasset.report.dao.DHSpecialAssetsReportDAO;
import com.sino.ams.newasset.report.dto.SpecialAssetsReportDTO;
import com.sino.ams.newasset.report.model.DHSpecialAssetsReportModel;
...
public class DHSpecialAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.DH_SPECIAL_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new DHSpecialAssetsReportModel(user, dto);
				PageQueryDAO pageDAO = new PageQueryDAO(req, conn, sqlProducer);
				pageDAO.produceWebData();
				req.setAttribute(QueryConstant.QUERY_DTO, dto);
				forwardURL = AssetsURLList.DH_SPECIAL_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.EXPORT_ACTION)) {
				DHSpecialAssetsReportDAO rptDAO = new DHSpecialAssetsReportDAO(user, dto, conn);
