...
import com.sino.ams.newasset.report.dao.AppAreaRentAssetsReportDAO;
 ...
 * Time: 11:13:55
 */
public class AppAreaRentAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = URLDefineList.APP_AREA_RENT_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new AppAreaRentAssetsReportModel(user, dto);
                ...
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				AppAreaRentAssetsReportDAO rptDAO = new AppAreaRentAssetsReportDAO(user, dto, conn);
