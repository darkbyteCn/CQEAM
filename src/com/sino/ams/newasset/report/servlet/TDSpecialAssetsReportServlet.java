...
import com.sino.ams.newasset.report.dao.TDSpecialAssetsReportDAO;
import com.sino.ams.newasset.report.dto.SpecialAssetsReportDTO;
import com.sino.ams.newasset.report.model.TDSpecialAssetsReportModel;
...
public class TDSpecialAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.TD_SPECIAL_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new TDSpecialAssetsReportModel(user, dto);
                ...
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				TDSpecialAssetsReportDAO rptDAO = new TDSpecialAssetsReportDAO(user, dto, conn);
