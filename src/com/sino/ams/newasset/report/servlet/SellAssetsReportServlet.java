...
import com.sino.ams.newasset.report.dao.SellAssetsReportDAO;
import com.sino.ams.newasset.report.model.SellAssetsReportModel;
...
/**
 * Function	:	销售资产统计
 * <p>Description:程序自动生成服务程序“SellAssetsReportServlet”，请根据需要自行修改</p>
...
public class SellAssetsReportServlet extends BaseServlet {
...
//            req.setAttribute(WebAttrConstant.FULL_MONTH_OPTION, monthOption);
            ...
            if (action.equals("")) {
                ...
                forwardURL = URLDefineList.SELL_ASSETS_REPORT;
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
//                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dtoParameter);
				BaseSQLProducer sqlProducer = new SellAssetsReportModel(user, dtoParameter);
...
//                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dtoParameter);
				SellAssetsReportDAO dao = new SellAssetsReportDAO(user, dtoParameter, conn);
