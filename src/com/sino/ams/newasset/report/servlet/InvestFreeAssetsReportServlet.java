...
import com.sino.ams.newasset.report.dao.InvestFreeAssetsReportDAO;
 ...
 */
public class InvestFreeAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 * Function		闲置资产投资方向统计报表
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.INVEST_FREE_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new InvestFreeAssetsReportModel(user, dto);
                ...
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				InvestFreeAssetsReportDAO rptDAO = new InvestFreeAssetsReportDAO(user, dto, conn);
