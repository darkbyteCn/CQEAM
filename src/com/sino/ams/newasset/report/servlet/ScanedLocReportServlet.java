...
import com.sino.ams.newasset.report.model.ScanedLocReportModel;
...
public class ScanedLocReportServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals(WebActionConstant.DETAIL_ACTION)) {
				BaseSQLProducer sqlProducer = new ScanedLocReportModel(user, dto);
				PageQueryDAO pageDAO = new PageQueryDAO(req, conn, sqlProducer);
				pageDAO.setPageSize(23);
				pageDAO.produceWebData();
				req.setAttribute(AssetsWebAttributes.WORKORDER_DTO, dto);
				forwardURL = AssetsURLList.SCANED_LOC_RPT;
			} else {
