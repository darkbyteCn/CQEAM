...
import com.sino.ams.newasset.report.dao.ToDiscardedSpecialAssetsReportDAO;
...
public class ToDiscardedSpecialAssetsReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 * Function		 	待报废资产按专业统计
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.TODISCARDED_SPECIAL_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new ToDiscardedSpecialAssetsReportModel(user, dto);
                ...
                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				ToDiscardedSpecialAssetsReportDAO rptDAO = new ToDiscardedSpecialAssetsReportDAO(user, dto, conn);
