...
import com.sino.ams.newasset.report.dao.DonateAssetsReportDAO;
...
/**
 * Function	:	捐赠资产统计
 * <p>Description:程序自动生成服务程序“DonateAssetsReportServlet”，请根据需要自行修改</p>
...
public class DonateAssetsReportServlet extends BaseServlet {
...
//            req.setAttribute(WebAttrConstant.FULL_MONTH_OPTION, monthOption);
            ...
            if (action.equals("")) {
                ...
                forwardURL = URLDefineList.DONATE_ASSETS_REPORT;  
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
//                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dtoParameter);
				BaseSQLProducer sqlProducer = new DonateAssetsReportModel(user, dtoParameter);
...
//                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dtoParameter);
				DonateAssetsReportDAO dao = new DonateAssetsReportDAO(user, dtoParameter, conn);
