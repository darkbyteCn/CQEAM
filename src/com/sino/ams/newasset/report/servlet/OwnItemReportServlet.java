...
import com.sino.ams.newasset.report.model.OwnItemReportModel;
...
public class OwnItemReportServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals(WebActionConstant.DETAIL_ACTION)) {
				BaseSQLProducer sqlProducer = new OwnItemReportModel(user, dto);
