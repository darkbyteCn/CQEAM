...
import com.sino.ams.newasset.report.dao.LoseMatchMisReportDAO;
import com.sino.ams.newasset.report.model.LoseMatchMisReportModel;
 ...
 */
public class LoseMatchMisReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (user.isProvAssetsManager()) {	//省资产管理员
            	...
            	deptOpt = optProducer.getDeptOptionByOrgId(organizationId, dto.getResponsibilityDept());
...
//            req.setAttribute(WebAttrConstant.FULL_MONTH_OPTION, monthOption);
            ...
            if (action.equals("")) {
				...
				forwardURL = AssetsURLList.LOSE_ASSETS_REPORT;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
//                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				BaseSQLProducer sqlProducer = new LoseMatchMisReportModel(user, dto);
...
//                AssetsReportDateUtil ardu = new AssetsReportDateUtil(dto);
				LoseMatchMisReportDAO rptDAO = new LoseMatchMisReportDAO(user, dto, conn);
