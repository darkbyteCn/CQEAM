...
import com.sino.ams.newasset.report.dao.DzyhAssetsReportDAO;
 ...
 */
public class DzyhAssetsReportServlet extends BaseServlet {
    /**
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            DzyhAssetsReportDAO dao = new DzyhAssetsReportDAO(user, dtoParameter, conn);
            ...
            if (action.equals("")) {
                ...
                forwardURL = AssetsURLList.DZYH_COM_RPT;
            } else if (action.equals(WebActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new DzyhAssetsReportModel(user, dtoParameter);
...
//				RowSet rows = dao.getDeptDzyhReportData();//占时不用
