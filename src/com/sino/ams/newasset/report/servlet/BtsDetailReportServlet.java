...
import com.sino.ams.newasset.report.dao.BtsDetailReportDAO;
 ...
 * @version 1.0
 */
public class BtsDetailReportServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				...
				forwardURL = AssetsURLList.BTS_DETAIL_RRP;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new BtsDetailReportModel(user, dto);
				...
				BtsDetailReportDAO rptDAO = new BtsDetailReportDAO(user, dto, conn);
