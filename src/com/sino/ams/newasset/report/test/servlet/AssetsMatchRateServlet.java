package com.sino.ams.newasset.report.test.servlet;
...
import com.sino.ams.newasset.report.test.dao.AssetsMatchRateDAO;
...
public class AssetsMatchRateServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            String cityOption = "";
            if (user.isProvAssetsManager() && dto.getMatchAssetsType().equals("")) {
            ...
            if (action.equals("")) {
				...
				forwardURL = "/newasset/report/test/assetsMatchRateReport.jsp";
