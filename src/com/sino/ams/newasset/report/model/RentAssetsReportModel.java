...
/**
 * <p>Title: RentAssetsReportModel</p>
 * <p>Description:程序自动生成SQL构造器“RentAssetsReportModel”，请根据需要自行修改</p>
...
public class RentAssetsReportModel extends AMSSQLProducer {

	private SfUserDTO sfUser = null;

	/**
	 * 功能：出租资产统计 数据库SQL构造层构造函数
	 * @param userAccount SfUserDTO 代表本系统的最终操作用户对象
	 * @param dtoParameter AmsHouseInfoDTO 本次操作的数据
	 */
	public RentAssetsReportModel(SfUserDTO userAccount, AmsAssetsAddressVDTO dtoParameter) {
		super(userAccount, dtoParameter);
		sfUser = userAccount;
	}
	
	/**
	 * 功能：框架自动生成出租资产统计 页面翻页查询SQLModel，请根据实际需要修改。
