...
public class UnuseDeptAssetsReportModel extends AMSSQLProducer {
    private String deptCodes = "";

    public UnuseDeptAssetsReportModel(SfUserDTO userAccount, DeptAssetsReportDTO dtoParameter) {
