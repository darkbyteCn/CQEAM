...
import com.sino.ams.newasset.report.model.LocItemReportModel;
...
public class LocItemReportDAO extends AMSBaseDAO {
	public LocItemReportDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new LocItemReportModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		...
		try {
			...
			Map fieldMap = getFieldMap(exportType);
