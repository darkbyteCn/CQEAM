...
import com.sino.ams.newasset.report.model.NewAssetsNotScanedModel;
...
public class NewAssetsNotScanedDAO extends AMSBaseDAO {

	public NewAssetsNotScanedDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsNotScanedModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsNotScanedModel modelProducer = (NewAssetsNotScanedModel)sqlProducer;
