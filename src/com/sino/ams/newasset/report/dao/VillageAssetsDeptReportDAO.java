 ...
 */
public class VillageAssetsDeptReportDAO extends AMSBaseDAO {
    private SfUserDTO sfUser = null;

	public VillageAssetsDeptReportDAO(SfUserDTO userAccount, AmsAssetsAddressVDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO  userAccount, DTO dtoParameter) {
        ...
        sqlProducer = new VillageAssetsDeptReportModel((SfUserDTO)userAccount, dtoPara);
    }
 ...
 /**
	...
	public File exportFile() throws DataTransException {
		...
		try {
			...
			String fileName = "村通代管资产统计（部门）.xls";
