 ...
 */
public class NewAssetsScanedDeptDAO extends AMSBaseDAO {

	public NewAssetsScanedDeptDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsScanedDeptModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsScanedDeptModel modelProducer = (NewAssetsScanedDeptModel)sqlProducer;
