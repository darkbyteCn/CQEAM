...
public class NewAssetsMonitorIdenticalDAO extends AMSBaseDAO {

	public NewAssetsMonitorIdenticalDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsMonitorIdenticalModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsMonitorIdenticalModel modelProducer = (NewAssetsMonitorIdenticalModel)sqlProducer;
			SQLModel sqlModel = modelProducer.getPageQueryModel();
			String reportTitle = "帐实一致";
