...
public class NewAssetsMonitorFalseDAO extends AMSBaseDAO {

	public NewAssetsMonitorFalseDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsMonitorFalseModel(user, dto);
	}
