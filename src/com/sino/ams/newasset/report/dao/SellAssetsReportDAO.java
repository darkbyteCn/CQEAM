 ...
 *
 */
public class SellAssetsReportDAO extends AMSBaseDAO {
     ...
     */
    public SellAssetsReportDAO(SfUserDTO userAccount, AmsAssetsAddressVDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new SellAssetsReportModel((SfUserDTO) userAccount, dtoPara);
    }
