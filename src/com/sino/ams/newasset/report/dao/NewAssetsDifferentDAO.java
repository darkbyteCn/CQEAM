...
import com.sino.ams.newasset.report.model.NewAssetsDifferentModel;
 ...
 */
public class NewAssetsDifferentDAO extends AMSBaseDAO {

	public NewAssetsDifferentDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsDifferentModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsDifferentModel modelProducer = (NewAssetsDifferentModel)sqlProducer;
