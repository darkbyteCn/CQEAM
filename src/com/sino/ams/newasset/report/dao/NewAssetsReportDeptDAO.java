...
import com.sino.ams.newasset.report.model.NewAssetsReportDeptModel;
 ...
 */
public class NewAssetsReportDeptDAO extends AMSBaseDAO {

	public NewAssetsReportDeptDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsReportDeptModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsReportDeptModel modelProducer = (NewAssetsReportDeptModel)sqlProducer;
