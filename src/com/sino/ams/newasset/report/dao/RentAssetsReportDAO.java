 ...
 *
 */
public class RentAssetsReportDAO extends AMSBaseDAO {
     ...
     */
    public RentAssetsReportDAO(SfUserDTO userAccount, AmsAssetsAddressVDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new RentAssetsReportModel((SfUserDTO) userAccount, dtoPara);
    }
