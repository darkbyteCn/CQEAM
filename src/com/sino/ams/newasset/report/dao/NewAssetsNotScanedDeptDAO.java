...
import com.sino.ams.newasset.report.model.NewAssetsNotScanedDeptModel;
 ...
 */
public class NewAssetsNotScanedDeptDAO extends AMSBaseDAO {

	public NewAssetsNotScanedDeptDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsNotScanedDeptModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsNotScanedDeptModel modelProducer = (NewAssetsNotScanedDeptModel)sqlProducer;
			SQLModel sqlModel = modelProducer.getPageQueryModel();
			String reportTitle = "未扫描资产";
