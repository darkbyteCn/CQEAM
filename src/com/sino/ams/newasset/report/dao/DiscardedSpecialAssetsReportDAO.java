...
public class DiscardedSpecialAssetsReportDAO extends AMSBaseDAO {

	public DiscardedSpecialAssetsReportDAO(SfUserDTO userAccount, SpecialAssetsReportDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new DiscardedSpecialAssetsReportModel(user, dto);
	}

    private SpecialAssetsReportDTO dto;
	/**
	 * 功能：获取报废资产专业统计报表Excel文件
	 * @return File
	...
	public File getExportFile() throws DataTransException {
		...
		try {
			...
			String reportTitle = "专业资产构成分布(报废)";
