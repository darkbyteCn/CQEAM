...
public class DHSpecialAssetsReportDAO extends AMSBaseDAO {

	public DHSpecialAssetsReportDAO(SfUserDTO userAccount, SpecialAssetsReportDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new DHSpecialAssetsReportModel(user, dto);
	}


	/**
	 * 功能：获取低值易耗资产专业统计报表Excel文件
	 * @return File
	...
	public File getExportFile() throws DataTransException {
		...
		try {
			...
			String reportTitle = "低值易耗资产专业统计报表";
