 ...
 *
 */
public class DiscardedAssetsReportDAO extends AMSBaseDAO {
     ...
     */
    public DiscardedAssetsReportDAO(SfUserDTO userAccount, AmsAssetsAddressVDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new DiscardedAssetsReportModel((SfUserDTO) userAccount, dtoPara);
    }
      ...
      public File exportFile() throws DataTransException {
        ...
        try {
        	SQLModel sqlModel = null;
        	 String fileName = "";
             if("DISCARDED".equals(dto.getItemStatus())){
             	fileName = "已报废资产统计";
             } else if ("TO_DISCARD".equals(dto.getItemStatus())){
             	fileName = "未处置资产统计";
             }
...
//            fieldMap.put("PTD_DEPRN", "当期折旧");                          
            ...
            fieldMap.put("SUM_LAST_YEAR_RATE_COUNT", "较去年同期总数增长率");
            fieldMap.put("SUM_LAST_YEAR_RATE", "较去年同期总额增长率");
