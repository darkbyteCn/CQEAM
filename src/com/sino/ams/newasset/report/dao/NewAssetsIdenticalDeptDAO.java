 ...
 */
public class NewAssetsIdenticalDeptDAO extends AMSBaseDAO {

	public NewAssetsIdenticalDeptDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsIdenticalDeptModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsIdenticalDeptModel modelProducer = (NewAssetsIdenticalDeptModel)sqlProducer;
