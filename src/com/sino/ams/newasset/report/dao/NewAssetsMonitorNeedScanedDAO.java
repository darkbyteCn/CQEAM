...
import com.sino.ams.newasset.report.model.NewAssetsMonitorNeedScanedModel;
...
public class NewAssetsMonitorNeedScanedDAO extends AMSBaseDAO {

	public NewAssetsMonitorNeedScanedDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsMonitorNeedScanedModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsMonitorNeedScanedModel modelProducer = (NewAssetsMonitorNeedScanedModel)sqlProducer;
			SQLModel sqlModel = modelProducer.getPageQueryModel();
			String reportTitle = "已完成新转资并且需PDA扫描确认资产";
