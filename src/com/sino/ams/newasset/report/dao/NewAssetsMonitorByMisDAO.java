...
import com.sino.ams.newasset.report.model.NewAssetsMonitorByMisModel;
...
public class NewAssetsMonitorByMisDAO extends AMSBaseDAO {

	public NewAssetsMonitorByMisDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsMonitorByMisModel(user, dto);
	}



	/**
	 * 功能：获取公司MIS新增资产明细Excel文件
	 * @return File
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsMonitorByMisModel modelProducer = (NewAssetsMonitorByMisModel)sqlProducer;
			SQLModel sqlModel = modelProducer.getPageQueryModel();
			String reportTitle = "MIS新增资产";
