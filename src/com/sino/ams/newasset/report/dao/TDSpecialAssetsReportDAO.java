...
public class TDSpecialAssetsReportDAO extends AMSBaseDAO {

	public TDSpecialAssetsReportDAO(SfUserDTO userAccount, SpecialAssetsReportDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new TDSpecialAssetsReportModel(user, dto);
	}


	/**
	 * 功能：获取TD资产专业统计报表Excel文件
	 * @return File
	...
	public File getExportFile() throws DataTransException {
		...
		try {
			...
			String reportTitle = "专业资产构成(TD资产) ";
