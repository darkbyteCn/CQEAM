...
import com.sino.ams.newasset.report.model.NewAssetsIdenticalModel;
...
public class NewAssetsIdenticalDAO extends AMSBaseDAO {

	public NewAssetsIdenticalDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsIdenticalModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsIdenticalModel modelProducer = (NewAssetsIdenticalModel)sqlProducer;
