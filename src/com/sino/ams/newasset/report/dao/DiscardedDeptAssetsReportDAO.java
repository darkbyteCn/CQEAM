...
public class DiscardedDeptAssetsReportDAO extends AMSBaseDAO {

	public DiscardedDeptAssetsReportDAO(SfUserDTO userAccount, DeptAssetsReportDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new DiscardedDeptAssetsReportModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		...
		try {
			...
			String reportTitle = "部门资产构成分布(报废)";
