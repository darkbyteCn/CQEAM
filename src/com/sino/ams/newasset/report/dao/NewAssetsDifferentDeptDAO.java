...
import com.sino.ams.newasset.report.model.NewAssetsDifferentDeptModel;
 ...
 */
public class NewAssetsDifferentDeptDAO extends AMSBaseDAO {

	public NewAssetsDifferentDeptDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsDifferentDeptModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsDifferentDeptModel modelProducer = (NewAssetsDifferentDeptModel)sqlProducer;
