 ...
 */
public class NewAssetsMonitorDifferentDAO extends AMSBaseDAO {

	public NewAssetsMonitorDifferentDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsMonitorDifferentModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsMonitorDifferentModel modelProducer = (NewAssetsMonitorDifferentModel)sqlProducer;
			SQLModel sqlModel = modelProducer.getPageQueryModel();
			String reportTitle = "帐实不符";
