...
public class NewAssetsMonitorScanedDAO extends AMSBaseDAO {

	public NewAssetsMonitorScanedDAO(SfUserDTO userAccount, AmsAssetsCheckHeaderDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new NewAssetsMonitorScanedModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			NewAssetsMonitorScanedModel modelProducer = (NewAssetsMonitorScanedModel)sqlProducer;
