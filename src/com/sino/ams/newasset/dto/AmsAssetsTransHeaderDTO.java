...
public class AmsAssetsTransHeaderDTO extends AMSFlowDTO {
    ...
    private List<AmsAssetsTransLineDTO> lines = null;
    ...
    private String isImportant = ""; //是否重要资产
    
    private String emergentLevel = ""; //紧急程度
    private String emergentLevelName = ""; //紧急程度描述
    private String emergentLevelOption = ""; //紧急成都下拉框
    
    private String barcodeSearch = ""; //查询条件
    ...
    public AmsAssetsTransHeaderDTO() {
        super();
    ...
    public List<AmsAssetsTransLineDTO> getLines() {
        return lines;
    }

    public void setLines(List<AmsAssetsTransLineDTO> lines) {
        this.lines = lines;
    }
    ...
    public String getProcdureName() {
            ...
            if (!provinceCode.equals(AssetsDictConstant.PROVINCE_CODE_SN)) {
                if (transferType.equals(AssetsDictConstant.TRANS_INN_DEPT)) {
                    ...
                    procedureName = AssetsDictConstant.PROCEDURE_TRANS_BTW_COMP;
                        ...
                        .equals(AssetsDictConstant.TRANS_INN_DEPT_RFU)) {
                    procedureName = AssetsDictConstant.PROCEDURE_TRANS_INN_DEPT_RFU;
                }
            } else {
        ...
        } else if (transType.equals(AssetsDictConstant.ASS_RFU)) { //紧急调拨(补流程)
            procedureName = AssetsDictConstant.PROCEDURE_TRANS_INN_DEPT_RFU;
        }
