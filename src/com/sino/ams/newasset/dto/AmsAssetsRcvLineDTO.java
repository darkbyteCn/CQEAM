...
public class AmsAssetsRcvLineDTO extends AmsAssetsTransLineDTO {

    private int receiveHeaderId;
    private String receiveLineId = "";
    private String transLineId;

    public AmsAssetsRcvLineDTO() {
        super();
    }
    ...
    public void setReceiveHeaderId(int receiveHeaderId) {
