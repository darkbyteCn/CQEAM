 ...
 */
public class AmsAssetsDonateDAO extends AMSBaseDAO {
    public AmsAssetsDonateDAO(BaseUserDTO userAccount, AmsAssetsFreeDTO dtoParameter, Connection conn) {
        super(userAccount, dtoParameter, conn);
    }

    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        AmsAssetsFreeDTO ffDTO=(AmsAssetsFreeDTO) dtoParameter;
        super.sqlProducer = new AmsAssetsDonateModel((SfUserDTO)userAccount, ffDTO);
    }
