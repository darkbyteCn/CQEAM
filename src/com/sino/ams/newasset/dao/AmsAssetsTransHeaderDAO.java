...
public class AmsAssetsTransHeaderDAO extends AMSProcedureBaseDAO {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        sqlProducer = new AmsAssetsTransHeaderModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    protected void prepareProcedureData(){
        ...
        if (headerDTO.getTransType().equals(AssetsDictConstant.ASS_DIS)) {
            headerDTO.setOrderName(headerDTO.getTransTypeValue());
        }
    }


    public boolean reject() throws DataHandleException {
        return super.rejectProcedure();
    }
    ...
    private void cancelOrderHeader() throws DataHandleException {
        AmsAssetsTransHeaderDTO headerDTO = (AmsAssetsTransHeaderDTO) dtoParameter;
        AmsAssetsTransHeaderModel modelProducer = (AmsAssetsTransHeaderModel) sqlProducer;
...
//            custData.setReportPerson(sfUser.getUsername());
     ...
     * @throws QueryException
     */
    public boolean isCurrFlowFinanceGroup(int fromGroup) throws QueryException {
        AmsAssetsTransHeaderModel modelProducer = (AmsAssetsTransHeaderModel) sqlProducer;
        SQLModel sqlModel = modelProducer.isCurrFlowFinanceGroup(fromGroup);
        SimpleQuery simp = new SimpleQuery(sqlModel, conn);
        simp.executeQuery();
        return simp.hasResult();
    }
