...
import com.sino.ams.newasset.model.SpecialOrderApproveModel;
...
public class SpecialOrderApproveDAO extends AMSBaseDAO {

    /**
     * 功能：资产业务头表(EAM)--取代原表 AMS_ASSETS_TRANS_HEADER 数据访问层构造函数
     * @param userAccount SfUserDTO 代表本系统的最终操作用户对象
     * @param dtoParameter AmsSpecialAssetsDTO 本次操作的数据
     * @param conn Connection 数据库连接，由调用者传入。
     */
    public SpecialOrderApproveDAO(SfUserDTO userAccount, AmsSpecialAssetsDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new SpecialOrderApproveModel((SfUserDTO) userAccount, dto);
    }
    ...
    public boolean approveOrder(FlowDTO flowDTO, DTOSet orderLines, String[] barcodes) {
        ...
        try {
            if (canApprove()) {
                ...
                setDTOParameter(dto);
                SpecialOrderApproveModel modelProducer = (SpecialOrderApproveModel)sqlProducer;
...
//		return simp.hasResult();
    ...
    public Object getDataByPrimaryKey() throws QueryException {
        ...
        AmsSpecialAssetsDTO data = (AmsSpecialAssetsDTO) primaryKeyData;
