...
public class AdminConfirmDAO extends AMSBaseDAO {
	 ...
	 */
	public AdminConfirmDAO(SfUserDTO userAccount,
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		super.sqlProducer = new AdminConfirmModel((SfUserDTO) userAccount,
												  dtoPara);
	}
	...
	public File exportCheckedAssets(String[] barcodes) throws
		...
		File file = null;
		try {
			AdminConfirmModel modelProducer = (AdminConfirmModel) sqlProducer;
