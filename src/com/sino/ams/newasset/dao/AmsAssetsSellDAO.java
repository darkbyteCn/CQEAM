 ...
 */
public class AmsAssetsSellDAO extends AMSBaseDAO {
    public AmsAssetsSellDAO(BaseUserDTO userAccount, AmsAssetsFreeDTO dtoParameter, Connection conn) {
        super(userAccount, dtoParameter, conn);
    }

    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        AmsAssetsFreeDTO ffDTO=(AmsAssetsFreeDTO) dtoParameter;
        super.sqlProducer = new AmsAssetsSellModel((SfUserDTO)userAccount, ffDTO);
    }
