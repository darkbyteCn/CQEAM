...
public class OdEtsFaAssetsDAO extends AMSBaseDAO {
     ...
     */
    public OdEtsFaAssetsDAO(SfUserDTO userAccount, AmsAssetsAddressVDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        sqlProducer = new OdEtsFaAssetsModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public File exportQueryAssets() throws DataTransException, SQLModelException {
    	OdEtsFaAssetsModel assetsModel = (OdEtsFaAssetsModel) sqlProducer;
...
//		rule.setSheetSize(2000);
    ...
    public File exportFile() throws DataTransException {
        ...
        try {
            ...
            rule.setSourceConn(conn);
            String fileName = "其它个人报废实物资产.xls";
            String filePath = WorldConstant.USER_HOME;
            filePath += WorldConstant.FILE_SEPARATOR;
            filePath += fileName;
            rule.setTarFile(filePath);
            ...
            CustomTransData custData = new CustomTransData();
            custData.setReportTitle("其它个人报废实物资产");
