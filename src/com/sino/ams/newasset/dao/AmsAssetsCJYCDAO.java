 ...
 */
public class AmsAssetsCJYCDAO extends AMSBaseDAO {
    SfUserDTO sfUser = null;

    public AmsAssetsCJYCDAO(SfUserDTO userAccount, AmsAssetsCJYCDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new AmsAssetsCJYCModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public File exportFile() throws DataTransException {
        ...
        try {
            ...
            String fileName = "资产折旧趋势预测报表.xls";
