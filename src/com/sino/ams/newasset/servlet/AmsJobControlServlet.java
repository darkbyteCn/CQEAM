...
import com.sino.ams.newasset.dao.AmsJobControlDAO;
import com.sino.ams.newasset.dto.AmsAssetsAddressVDTO;
import com.sino.ams.newasset.model.AmsJobControlModel;
 ...
 */
public class AmsJobControlServlet extends BaseServlet {
    /**
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            AmsJobControlDAO dao = new AmsJobControlDAO(user, dtoParameter, conn);
            ...
            if (action.equals("")) {
                ...
                forwardURL = AssetsURLList.JOB_CONTROL_QRY;
            } else if (action.equals(WebActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new AmsJobControlModel(user, dtoParameter);
