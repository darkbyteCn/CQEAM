...
import com.sino.ams.newasset.dto.AmsAssetsAddressVDetailDTO;
...
public class EtsFaAssetsServlet extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws
        ...
        try {
            ...
            EtsFaAssetsDAO assetsDAO = new EtsFaAssetsDAO(user, dto, conn);
            ...
            if (action.equals("")) {
                ...
                if( treeCategory.equals(AssetsWebAttributes.ASSETS_TREE_CONFIRM) ){ //个人待确认资产查询 
                	forwardURL = "/newasset/confirm/assetsQuery.jsp";
                }else{
                ...
                option = optProducer.getFAContentOption(dto.getFaContentCode());
                dto.setFaContentOption(option);
                BaseSQLProducer sqlProducer = new EtsFaAssetsModel(user, dto);
                ...
                dto.setIsTD(isTD);
                assetsDAO = new EtsFaAssetsDAO(user, dto, conn);
//                assetsDAO.setDTOClassName(AmsAssetsAddressVDTO.class.getName());
