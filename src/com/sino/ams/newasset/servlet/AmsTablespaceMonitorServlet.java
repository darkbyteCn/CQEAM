...
import com.sino.ams.newasset.dao.AmsTablespaceMonitorDAO;
 ...
 */
public class AmsTablespaceMonitorServlet extends BaseServlet {
    /**
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            AmsTablespaceMonitorDAO dao = new AmsTablespaceMonitorDAO(user, dtoParameter, conn);
            ...
            if (action.equals("")) {
                ...
                forwardURL = AssetsURLList.TABLESPACE_MONITOR_QRY;
            } else if (action.equals(WebActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new AmsTablespaceMonitorModel(user, dtoParameter);
