...
import com.sino.ams.newasset.dao.AmsAssetsCJYCDAO;
import com.sino.ams.newasset.dto.AmsAssetsCJYCDTO;
import com.sino.ams.newasset.model.AmsAssetsCJYCModel;
 ...
 */
public class AmsAssetsCJYCServlet extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            AmsAssetsCJYCDAO dao = new AmsAssetsCJYCDAO(user, dtoParameter, conn);
            ...
            String monthOption = op.getMonthOption(dtoParameter.getFromMonth());
            String tomonthOption = op.getMonthOption(dtoParameter.getFromMonth());
            ...
            if (action.equals("")) {
                forwardURL = "/newasset/assetsCJYC.jsp";
            } else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new AmsAssetsCJYCModel(user, dtoParameter);
