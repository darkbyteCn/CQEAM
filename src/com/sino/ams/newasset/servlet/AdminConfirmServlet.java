...
import com.sino.ams.newasset.dao.AdminConfirmDAO;
import com.sino.ams.newasset.dto.AmsAssetsTransLineDTO;
import com.sino.ams.newasset.model.AdminConfirmModel;
 ...
 * @version 1.0
 */
public class AdminConfirmServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws
		...
		try {
			...
			AdminConfirmDAO confirmDAO = new AdminConfirmDAO(user, dto, conn);
			if (action.equals("")) {
				dto.setCalPattern(LINE_PATTERN);
				req.setAttribute(QueryConstant.QUERY_DTO, dto);
				forwardURL = AssetsURLList.ADMIN_CONFIRM_PAGE;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new AdminConfirmModel(user, dto);
				...
				forwardURL = AssetsURLList.ADMIN_CONFIRM_SERVLET;
