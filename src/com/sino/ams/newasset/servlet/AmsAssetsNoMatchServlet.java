...
import com.sino.ams.newasset.dao.AmsAssetsNoMatchDAO;
 ...
 */
public class AmsAssetsNoMatchServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws
        ...
        try {
            ...
            AmsAssetsNoMatchDTO dtoParameter = (AmsAssetsNoMatchDTO) req2DTO.
                                               getDTO(req);
            AmsAssetsNoMatchDAO dao = new AmsAssetsNoMatchDAO(user,
                    dtoParameter, conn);
            ...
            if (action.equals("")) {
                forwardURL = "/newasset/assetsNoMatchQuery.jsp";
            } else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new AmsAssetsNoMatchModel(user,
                        dtoParameter);
