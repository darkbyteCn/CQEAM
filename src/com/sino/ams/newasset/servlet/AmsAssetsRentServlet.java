...
import com.sino.ams.newasset.dao.AmsAssetsRentDAO;
 ...
 */
public class AmsAssetsRentServlet extends BaseServlet {
        ...
        Connection conn = null;
         try {
            ...
            if(action.equals("")){
                ...
                forwardURL= URLDefineList.ASSETS_RENT_SEARCH;
            } else if(action.equals(WebActionConstant.QUERY_ACTION)){
                BaseSQLProducer sqlProducer = new AmsAssetsRentModel(user, dtoParameter);
            	...
            	AmsAssetsRentDAO aafrDAO = new AmsAssetsRentDAO(user, dtoParameter, conn);
