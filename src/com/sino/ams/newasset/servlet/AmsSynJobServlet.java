...
import com.sino.ams.newasset.dao.AmsSynJobDAO;
 ...
 */
public class AmsSynJobServlet extends BaseServlet {
    /**
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            AmsSynJobDAO dao = new AmsSynJobDAO(user, dtoParameter, conn);
            ...
            if (action.equals("")) {
                ...
                forwardURL = AssetsURLList.SYN_JOB_QRY;
            } else if (action.equals(WebActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new AmsSynJobModel(user, dtoParameter);
