 ...
 * @version 1.0
 */
public class PriviRightServlet extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws
        ...
        try {
            ...
            if (StrUtil.isEmpty(deptName) &&
                ...
                req.setAttribute(AssetsWebAttributes.ALL_USER_OPTION,
                                 allUserOptions);
                req.setAttribute(AssetsWebAttributes.EXIST_USER_OPTION,
                                 existUserOptions);
