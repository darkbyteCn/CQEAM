...
import com.sino.ams.newasset.dao.ItemAdminConfirmDAO;
 ...
 * @version 1.0
 */
public class ItemAdminConfirmServlet extends BaseServlet {
    /**
     * 所有的Servlet都必须实现的方法。
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws
        ...
        try {
            ...
            String confirmType = req.getParameter("confirmType");
            String action = dto.getAct();
            dto.setCalPattern(LINE_PATTERN);
            conn = getDBConnection(req);
            ItemAdminConfirmDAO confirmDAO = new ItemAdminConfirmDAO(user, dto, conn);
            if (action.equals("")) {
                dto.setCalPattern(LINE_PATTERN);
                req.setAttribute(QueryConstant.QUERY_DTO, dto);
                forwardURL = "/newasset/itemAdminConfirmQuery.jsp";
            } else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
                ItemAdminConfirmModel sqlProducer = new ItemAdminConfirmModel(user, dto);
                boolean isAdminConfirm=confirmType.equalsIgnoreCase("admin");
                sqlProducer.setAdminConfirm(isAdminConfirm);
                ...
                dto.setCalPattern(LINE_PATTERN);
                req.setAttribute(QueryConstant.QUERY_DTO, dto);
                forwardURL = "/newasset/itemAdminConfirmQuery.jsp?confirmType=" + confirmType;
                ...
                forwardURL = "/servlet/com.sino.ams.newasset.servlet.ItemAdminConfirmServlet";
                forwardURL += "?act=" + AssetsActionConstant.QUERY_ACTION + "&confirmType=" + confirmType;
                ...
                if (exportType.equals(AssetsWebAttributes.EXPORT_SELECTED_ASSETS)) {
                    ...
                    file = confirmDAO.exportCheckedAssets(barcodes,isAdminConfirm);
                } else {
                    file = confirmDAO.exportQueryAssets(isAdminConfirm);
                }
