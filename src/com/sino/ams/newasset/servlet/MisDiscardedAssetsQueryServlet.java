...
import com.sino.ams.newasset.dao.MisDiscardedAssetsQueryDAO;
...
public class MisDiscardedAssetsQueryServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 * Function 	MIS资产折旧查询
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				...
				req.setAttribute(WebAttrConstant.ALL_ORG_OPTION, opt);
				req.setAttribute(QueryConstant.QUERY_DTO, dto);
				forwardURL = AssetsURLList.MIS_DISCARDED_ASSETS_QRY;
			} else if (action.equals(AssetsActionConstant.QUERY_ACTION)) {
				String opt = optProducer.getOrganizationOption(dto.getOrganizationId());
				req.setAttribute(WebAttrConstant.ALL_ORG_OPTION, opt);
				BaseSQLProducer sqlProducer = new MisDiscardedAssetsQueryModel(user, dto);
				...
				MisDiscardedAssetsQueryDAO exportDAO = new MisDiscardedAssetsQueryDAO(user, dto, conn);
