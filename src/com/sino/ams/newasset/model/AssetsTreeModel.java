 ...
 * <p>Description:程序自动生成SQL构造器“AssetsTreeModel”，请根据需要自行修改</p>
...
public class AssetsTreeModel extends AMSSQLProducer {
	 ...
	 */
	public AssetsTreeModel(SfUserDTO userAccount,
	...
	public SQLModel getPersonalTreeModel() {
		...
		String sqlStr = "SELECT"
						...
						+ " AND  AAAV.ASSET_ID IS NOT NULL "
						+
				" AND (AAAV.ITEM_STATUS IS NULL OR AAAV.ITEM_STATUS = '' OR AAAV.ITEM_STATUS = ?)" //" + SyBaseSQLUtil.isNull() + " 
						+ " AND NOT EXISTS("
						+ " SELECT"
						+ " NULL"
						+ " FROM"
		...
		System.out.println( "sqlStr：" + sqlStr + "getEmployeeId: " + userAccount.getEmployeeId());
	...
	public SQLModel getDeptTreeModel(String[] deptCodes) {
		SQLModel sqlModel = new SQLModel();
		List sqlArgs = new ArrayList();
		String deptCode = ArrUtil.arrToSqlStr(deptCodes);
		String sqlStr = "SELECT"
