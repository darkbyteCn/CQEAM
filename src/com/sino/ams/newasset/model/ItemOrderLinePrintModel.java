...
public class ItemOrderLinePrintModel extends AMSSQLProducer {
	 ...
	 */
	public ItemOrderLinePrintModel(SfUserDTO userAccount, AmsAssetsTransLineDTO dtoParameter) {
	...
	private SQLModel getDataByTransIdModel(String transId) {
		...
		if (transType.equals(AssetsDictConstant.ASS_SUB)) { //资产减值单据
			sqlStr = "SELECT"
					 ...
					 + " AAAV.MODEL_NUMBER,"
					 + " NVL(AAAV.CURRENT_UNITS, 1) CURRENT_UNITS,"
					 + " AAAV.VENDOR_NAME,"
			...
			sqlStr = "SELECT"
					 ...
					 + " dbo.AAP_GET_TO_ORGNIZATION_ID(AATL.LINE_ID) TO_ORGANIZATION_ID,"
					 + " AATL.OLD_FA_CATEGORY_CODE,"
					 + " AATL.OLD_DEPRECIATION_ACCOUNT,"
					 + " ISNULL(AATL.FA_CATEGORY_CODE, AAAV.FA_CATEGORY_CODE) FA_CATEGORY_CODE,"
					 + " AATL.DEPRECIATION_ACCOUNT,"
