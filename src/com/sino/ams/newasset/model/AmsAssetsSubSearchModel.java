 ...
 *
 */
public class AmsAssetsSubSearchModel extends AMSSQLProducer{
	 public AmsAssetsSubSearchModel(BaseUserDTO userAccount, AmsAssetsSubDTO dtoParameter) {
	    ...
	    public SQLModel getPageQueryModel() throws SQLModelException {
	        ...
	        AmsAssetsSubDTO fiDTO= (AmsAssetsSubDTO) dtoParameter;
