...
public class AmsItemAllocationApproveModel extends AMSSQLProducer {
    private String aggBarcodes = "";

	public AmsItemAllocationApproveModel(SfUserDTO userAccount, AmsAssetsTransHeaderDTO dtoParameter) {
	...
	public SQLModel getAssetsDiscardModel() {
		...
		String sqlStr = "UPDATE"
						...
						+ " AND AATL.BARCODE = BARCODE"
                        + " AND ((AATL.REMARK <> '不允许报废') OR (AATL.REMARK IS NULL))"
                        + " AND AATH.TRANS_TYPE = ?"
						+ " AND AATH.TRANS_ID = ?)";
