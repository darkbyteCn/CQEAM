 ...
 */
public class AmsAssetsSellModel extends AMSSQLProducer {
    public AmsAssetsSellModel(BaseUserDTO userAccount, AmsAssetsFreeDTO dtoParameter) {
