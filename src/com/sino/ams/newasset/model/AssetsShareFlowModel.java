...
public class AssetsShareFlowModel extends AMSSQLProducer {

    private SfUserDTO user = null;

    public AssetsShareFlowModel(SfUserDTO userAccount, FreeFlowDTO dtoParameter) {
...
//		sqlArgs.add(userAccount.getUserId());
    ...
    public SQLModel getQueryBarcodeExcelModel(String excel, FreeFlowDTO dto) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
