 ...
 * </p>
 * <p>
 * Description:程序自动生成SQL构造器“AmsFaAssetsModel”，请根据需要自行修改
 * </p>
 * <p>
...
//					+ " AAAV.BARCODE = ?";
			sql.append( " SELECT \n " );
			sql.append( " AAAV.*, \n " );
			sql.append( " (CASE dbo.IS_IMPORTANT_ASSETS( AAAV.CONTENT_CODE )  WHEN 'Y' THEN '是' WHEN 'N' THEN '否' ELSE '' END ) IS_IMPORTANT_ASSETS \n " );
