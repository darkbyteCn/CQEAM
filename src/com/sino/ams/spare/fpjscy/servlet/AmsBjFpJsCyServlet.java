package com.sino.ams.spare.fpjscy.servlet;
...
import com.sino.ams.spare.fpjscy.dao.AmsBjFpJsCyDAO;
 ...
 *         Date: 2007-11-29
 */
public class AmsBjFpJsCyServlet extends BaseServlet {
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			AmsBjFpJsCyDAO dao = new AmsBjFpJsCyDAO(user, dtoParameter, conn);
			...
			if (action.equals("")) {
				forwardURL = "/spare/fpjscy/bjfpjscy.jsp";
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new AmsBjFpJsCyModel(user, dtoParameter);
				...
				forwardURL = "/spare/fpjscy/bjfpjscyDetail.jsp";
			} else if (action.equals(WebActionConstant.EXPORT_ACTION)) {
				String transId = req.getParameter("transId");
				File file = dao.exportFile(transId);
				...
				RowSet row = dao.getData(detailid, itemCode);
				req.setAttribute("DIFFENTED", row);
				forwardURL = "/spare/fpjscy/bjfpjscyDetailList.jsp";
