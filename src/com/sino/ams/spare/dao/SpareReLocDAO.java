 ...
 * Function; 备件返修率统计_年
 */
public class SpareReLocDAO extends AMSBaseDAO {
     private SfUserDTO sfUser = null;
     private String searchYear;
     private String searchMonth;

    public SpareReLocDAO(SfUserDTO userAccount, AmsItemTransLDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new SpareReLocModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public File exportFile() throws DataTransException {
        ...
        try {
            ...
            String fileName = "备件返修率统计_地市.xls";
            ...
            if(searchMonth.equals("")) {
                title = searchYear + "年各地市备件返修率统计";
            } else {
                title = searchYear + "年" + searchMonth + "月各地市备件返修率统计";
            }
