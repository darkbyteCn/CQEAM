 ...
 *          Date: 2007-10-26
 */
public class BjdbApproveServlet extends BaseServlet {
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
			...
			try {
				...
				if (action.equals(WebActionConstant.DETAIL_ACTION)) {
					...
					if (!operateResult) {
						forwardURL = "/servlet/com.sino.ams.spare.servlet.BjdbApproveServlet?act=" + WebActionConstant.DETAIL_ACTION
