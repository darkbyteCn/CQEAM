 ...
 */
public class BjhjghServlet extends BaseServlet {
		...
		try {
			...
			if (action.equals("")) {//没用到
				...
				if (orderHeader == null) {
					...
					orderHeader.setTransType(DictConstant.HJGH);
                ...
                String toObjectNo = itemTransHDAO.getBjghToObjectNo();
                orderHeader.setToObjectNo(toObjectNo);
				...
				forwardURL = "/spare/bjhjghCreate.jsp";
				...
				message = itemTransHDAO.getMessage();
				forwardURL = "/servlet/com.sino.ams.spare.servlet.BjhjghServlet" + "?act=" + WebActionConstant.DETAIL_ACTION + "&transId=" + dto.getTransId();
				...
				AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
				req.setAttribute("AIT_LINES", ldao.getLines(orderHeader.getTransId()));
				forwardURL = "/spare/print/spareHJGHPrint.jsp";
                ...
                String onhandQty = itemTransHDAO.checkKYL(barcode, fromObjectNo);
