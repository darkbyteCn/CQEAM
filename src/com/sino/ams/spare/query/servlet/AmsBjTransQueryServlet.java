...
import com.sino.ams.spare.query.dao.AmsBjTransQueryDAO;
...
public class AmsBjTransQueryServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                forwardURL = "/spare/query/bjTransQuery.jsp";
                ...
                if (transType.equals(DictConstant.BJBF)) {
                    ...
                    forwardURL = "/spare/query/bjRejectQuery.jsp?actId=" + dto.getActId();
                    ...
                    forwardURL = "/spare/query/bjReturnQueryDetail.jsp";
                    ...
                    forwardURL = "/spare/query/bjAlotQuery.jsp?actId=" + dto.getActId();
...
//                    String trans = "trans";
//                    forwardURL = "/servlet/com.sino.ams.spare.servlet.BjdbServlet?act=" + WebActionConstant.DETAIL_ACTION + "&transId=" + dtoParameter.getTransId() + "&trans=" + trans;
                    forwardURL = "/spare/query/bjDBQuery.jsp?actId=" + dto.getActId();
                    ...
                    forwardURL = "/spare/query/bjckQuery.jsp";
                    ...
                    AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
                    req.setAttribute("AIT_LINES", ldao.getLines(dtoParameter.getTransId()));
                    forwardURL = "/spare/query/xgrkOrderQuery.jsp";
                    ...
                    AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
                    req.setAttribute("AIT_LINES", ldao.getLines(dtoParameter.getTransId()));
                    forwardURL = "/spare/query/bjfkCreateQuery.jsp";
                    ...
                    AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
                    req.setAttribute("AIT_LINES", ldao.getLines(dtoParameter.getTransId()));
                    forwardURL = "/spare/query/bjslQuery.jsp";
                    ...
                    AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
                    req.setAttribute("AIT_LINES", ldao.getLines(dtoParameter.getTransId()));
                    forwardURL = "/spare/query/noBarcodeOut.jsp";
                    ...
                    AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
                    req.setAttribute("AIT_LINES", ldao.getLines(dtoParameter.getTransId()));
                    forwardURL = "/spare/query/noBarcodeIn.jsp";
                    ...
                    AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
                    req.setAttribute("AIT_LINES", ldao.getLines(dtoParameter.getTransId()));
                    forwardURL = "/spare/query/barcodeOutQuery.jsp";
                    ...
                    AmsItemTransLDAO ldao = new AmsItemTransLDAO(user, null, conn);
                    req.setAttribute("AIT_LINES", ldao.getLines(dtoParameter.getTransId()));
                    forwardURL = "/spare/query/barcodeInQuery.jsp";
