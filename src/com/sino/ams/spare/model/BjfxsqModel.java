 ...
 */
public class BjfxsqModel extends BaseSQLProducer {

    private SfUserDTO sfUser = null;

    public BjfxsqModel(SfUserDTO userAccount, AmsItemTransHDTO dtoParameter) {
    ...
    public SQLModel getQty(String barcode, String transId, String lineId1, String org, String objectNo) {
        ...
        if (org.equals("0")) {//只省公司分配
            if (objectNo.equals("")) {
                sqlStr = "SELECT ASI.BARCODE,\n" +
                        ...
                        "       AND EOCM.ORGANIZATION_ID *= AITD.ORGANIZATION_ID\n" +
                        "       AND AITD.TRANS_ID = ?\n" +
                        "       AND ASI.BARCODE = ?\n" +
                        "       AND AITD.LINE_ID = ?\n" +
                ...
                sqlStr = "SELECT ASI.BARCODE,\n" +
                        ...
                        "       AND EO.OBJECT_CATEGORY = '71'\n" +
                        "       AND EOCM.ORGANIZATION_ID *= AITD.ORGANIZATION_ID\n" +
                        "       AND EO.WORKORDER_OBJECT_NO *= AITD.OBJECT_NO\n" +
                        "       AND AITD.TRANS_ID = ?\n" +
                        "       AND ASI.BARCODE = ?\n" +
                        "       AND AITD.LINE_ID = ?\n" +
                        "       AND ASI.ORGANIZATION_ID = 82\n" +
    ...
    public SQLModel updateQtyModel(int qty, int actQty, int orgId, String barcode) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
    ...
    public SQLModel insertQtyModel(String barcode, int qty, int actQty, int orgId) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
    ...
    public SQLModel selectQtyModel(String barcode, int orgId) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
    ...
    public SQLModel deleteQtyModel(int qty, int actQty, int orgId, String barcode) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "UPDATE AMS_SPARE_DIFF_NUM\n" +
                "   SET APPLY_NUMBER = APPLY_NUMBER - ?,\n" +
    ...
    public SQLModel hasObjectNo(String transId, String barcode) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "SELECT AITD.OBJECT_NO\n" +
    ...
    public SQLModel cancelFP(AmsItemTransHDTO dto) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "DELETE FROM AMS_ITEM_TRANS_D AITD WHERE AITD.TRANS_ID = ?";
    ...
    public SQLModel getTransDQuenty(String trandId) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "SELECT AITD.BARCODE,\n" +
                "       AITD.OBJECT_NO,\n" +
                "       AITD.QUANTITY\n" +
                "  FROM AMS_ITEM_TRANS_D AITD\n" +
                " WHERE AITD.TRANS_ID = ?";
    ...
    public SQLModel cancelTrandDQuery(AmsItemTransLDTO dto) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
    ...
    public SQLModel hasSpareCount(String barcode) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "SELECT 1\n" +
                "  FROM AMS_SPARE_INFO ASI,\n" +
    ...
    public SQLModel insertTransDetail(AmsItemTransHDTO amsItemTransH, AmsItemTransLDTO dto, String detailId) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
    ...
    public SQLModel updateTransDetail(AmsItemTransHDTO dto) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "UPDATE AMS_SPARE_INFO\n" +
                "   SET RESERVE_QUANTITY = RESERVE_QUANTITY - ?\n" +
    ...
    public SQLModel updateQty(AmsItemTransLDTO dto) {
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "UPDATE AMS_ITEM_TRANS_L\n" +
                ...
                "       ORD_QTY = ?\n" +
                " WHERE LINE_ID = ?";
        sqlArgs.add(dto.getProQty());
        sqlArgs.add(dto.getOrdQty());
        sqlArgs.add(dto.getLineId());
        sqlModel.setSqlStr(sqlStr);
        sqlModel.setArgs(sqlArgs);
        return sqlModel;
