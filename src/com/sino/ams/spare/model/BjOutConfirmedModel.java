 ...
 */
    public class BjOutConfirmedModel extends BaseSQLProducer {

    private SfUserDTO sfUser = null;

    public BjOutConfirmedModel(SfUserDTO userAccount, AmsItemAllocateHDTO dtoParameter) {
     ...
     public SQLModel getPageQueryModel() throws SQLModelException {
        ...
        String sqlStr = "SELECT AIAH.TRANS_NO,\n" +
                ...
                " WHERE AIAH.TRANS_STATUS = 'ALLOTING'\n" +
    ...
    public SQLModel getPrimaryKeyDataModel() {
        ...
        String sqlStr = "SELECT AIAH.TRANS_ID,\n" +
                ...
                "       EO2.WORKORDER_OBJECT_NO TO_OBJECT_NO,\n" +
    ...
    public SQLModel getDataByTransIdMode2(String transId){
        ...
        String sqlStr = "SELECT AIAD.DETAIL_ID,\n" +
                ...
                "       AND ASV.VENDOR_ID = ASSC.VENDOR_ID\n" +
                "       AND AIAD.TRANS_ID = ?";
        sqlArgs.add(transId);
     ...
     */
      ...
      public SQLModel getUpdateHStatusModel(String transId){        //更新单据的状态
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr ="UPDATE AMS_ITEM_ALLOCATE_H SET TRANS_STATUS = 'CANCEL' WHERE TRANS_ID = ?";
        sqlArgs.add(transId);
        sqlModel.setSqlStr(sqlStr);
        sqlModel.setArgs(sqlArgs);
        return sqlModel;
    ...
    public SQLModel updateObjectNo(String transId, String objectNo) {
        SQLModel model = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "UPDATE AMS_ITEM_ALLOCATE_H SET TO_OBJECT_NO = ? WHERE TRANS_ID = ?";
