...
//        String act = req.getParameter("act");
		try {
			...
			RepairStatisticDTO dtoParameter = null;//bean类，存储信息
			Request2DTO req2DTO = new Request2DTO();
			req2DTO.setDTOClassName(RepairStatisticDTO.class.getName()); //设置欲构造的DTOClass的名称
			dtoParameter = (RepairStatisticDTO) req2DTO.getDTO(req);   //从表单里取数据来构造单个DTO
