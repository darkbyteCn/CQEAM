 ...
 * Function     资产报废同步
 */
public class AssetsDiscardedDAO extends AMSBaseDAO {
	 ...
	 */
	public AssetsDiscardedDAO(SfUserDTO userAccount, EamSyschronizeDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		super.sqlProducer = new AssetsDiscardedModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
        AssetsDiscardedModel modelProducer = (AssetsDiscardedModel) sqlProducer;
