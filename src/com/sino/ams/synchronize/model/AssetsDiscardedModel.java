 ...
 * Function     资产报废同步
 */
public class AssetsDiscardedModel extends AMSSQLProducer {
/**
	 ...
	 */
	public AssetsDiscardedModel(SfUserDTO userAccount, EamSyschronizeDTO dtoParameter) {
...
//                        "       AMD2.DEPT_CODE OLD_DEPT_CODE,\n" +
                        ...
                        "       EFA.SCRAP_VALUE,\n" +
                        "       EFA.LIFE_IN_YEARS,\n" +
                        "       (EFA.LIFE_IN_YEARS * 12 -datediff(month,GETDATE(), EFA.DATE_PLACED_IN_SERVICE)) REMAIN_MONTHS\n" +
        ...
        if(userAccount.getOrganizationId()!=82){
            ...
            sqlArgs.add(userAccount.getOrganizationId());
                 ...
                 sqlStr +=
                        ...
                        "                 AND (ASCL.SYN_STATUS = 0 OR ASCL.SYN_STATUS is null )\n" +
                        "                 AND ASCL.IS_EXIST = 'Y')\n" +
