...
import com.sino.ams.synchronize.dao.AssetsDiscardedDAO;
import com.sino.ams.synchronize.dto.EamSyschronizeDTO;
import com.sino.ams.synchronize.model.AssetsDiscardedModel;
 ...
 * Function     资产报废同步
 */
public class AssetsDiscardedServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			AssetsDiscardedDAO commitDAO = new AssetsDiscardedDAO(user, dto, conn);
...
//			dto.setTransferTypeOption(option);
			if (action.equals("")) {
				...
				BaseSQLProducer sqlProducer = new AssetsDiscardedModel(user, dto);
				...
				forwardURL = "/servlet/com.sino.ams.synchronize.servlet.AssetsDiscardedServlet?act=QUERY_ACTION";
			}
