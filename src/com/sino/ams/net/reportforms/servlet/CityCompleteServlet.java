...
import com.sino.ams.net.reportforms.dao.CityCompleteDAO;
 ...
 */
public class CityCompleteServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            CityCompleteDAO situsDAO = new CityCompleteDAO(user, dtoParameter, conn);
            ...
            if (act.equals("")) {
                ...
                forwardURL = URLDefineList.CITY_COMPLETE_STATISTIC;
            } else if (act.equals(WebActionConstant.QUERY_ACTION)) {                             //查询出所有
                BaseSQLProducer sqlProducer = new CityCompleteModel(user, dtoParameter);
