...
import com.sino.ams.net.reportforms.dao.FalsityRateDAO;
 ...
 */
public class FalsityRateServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            FalsityRateDAO situsDAO = new FalsityRateDAO(user, dtoParameter, conn);
            ...
            if (act.equals("")) {
                ...
                forwardURL = URLDefineList.FALSE_RATE_STATISTIC;
            } else if (act.equals(WebActionConstant.QUERY_ACTION)) {                             //查询出所有
                BaseSQLProducer sqlProducer = new FalsityRateModel(user, dtoParameter);
