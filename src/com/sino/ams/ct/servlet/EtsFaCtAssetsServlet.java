...
/**
 * <p>Title: EtsFaCtAssetsServlet</p>
 * <p>Description:程序自动生成服务程序“EtsFaCtAssetsServlet”，请根据需要自行修改</p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: 北京思诺博信息技术有限公司</p>
 * @author yushibo
 * @version 1.0
 */
public class EtsFaCtAssetsServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res)
		...
		int itemCategory = StrUtil.strToInt(req.getParameter("itemCategory"));
		...
		try {
			...
			EtsItemInfoDAO etsItemInfoDAO = new EtsItemInfoDAO(user,
					dtoParameter, conn);
			OptionProducer op = new OptionProducer(user, conn);
			String company = dtoParameter.getCompany();
			String companySelect = op.getAllOrganization( ConvertUtil.String2Int( company ), true);
			...
			if (action.equals("")) {
				...
				BaseSQLProducer sqlProducer = new EtsItemInfoModel(user,
						dtoParameter);
				...
				req.setAttribute(WebAttrConstant.ETS_ITEM_DTO, dtoParameter);
				EtsItemInfoDTO etsItemInfo = (EtsItemInfoDTO) req
						.getAttribute(WebAttrConstant.ETS_ITEM_DTO);
				if (etsItemInfo == null) {
					etsItemInfo = dtoParameter;
				}
				//etsItemInfo.setBarcode1(etsItemInfoDAO.getBarcode());
				...
				etsItemInfoDAO.setCalPattern(LINE_PATTERN);
				dtoParameter = (EtsItemInfoDTO)etsItemInfoDAO.getDataByPrimaryKey();
				if (dtoParameter == null) {
					dtoParameter = new EtsItemInfoDTO();
				...
				forwardURL = AssetsURLList.ASSETS_DTL_CT_PAGE;
