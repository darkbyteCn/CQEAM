...
//===================二级字典=============================
    ...
    String ORDER_TYPE_DB = "17"; //调拨工单
    String ORDER_TYPE_HDV = "18"; //交接工单
//    String ORDER_TYPE_ZERO ="19"; //零购工单
    String ZERO_PRJ_ID="d87500c590d34fd3882dd1a73757ef0d";//零购工单虚拟工程编号
//end=================================工单类型===========================//
...
//end===========================工单状态===============================//
    ...
    String FLOW_CANCEL = "FLOW_CANCEL"; //撤销
//end=========================流程处理类型===========================//
...
//end===============线缆用途=========================//
    ...
    //start===============资产单据类型=========================//
    String ASS_RED = "ASS-RED"; //调拨单
    String ASS_DIS = "ASS-DIS"; //报废单
    String ASS_DIS_OTHER = "ASS-DIS-OTHER"; //报废单
    String ASS_FAV = "ASS-FAV"; //赠与单
    String ASS_CLR = "ASS-CLR"; //清理单
    String ASS_FREE = "ASS-FREE";//闲置单
    String ASS_RFU = "ASS-RFU"; //紧急调拨单(补汇总)
    String ASS_DEVALUE = "ASS-DEVALUE"; //减值单
//end===============资产单据类型=========================//
    ...
    String ZKZY = "ZKZY"; //子库转移
    String JCHG = "JCHG";//检测合格
    String HJGH = "HJGH";//省公司坏件应急归还
    String BFHS = "BFHS";//报废回收
//end===============备件单据类型=========================//
...
//end===============库存权限=========================//
    ...
    String FIN_PROP_RENT = "RENT_ASSETS"; //租赁
    String FIN_PROP_DG = "DG_ASSETS"; //通服村通资产,代管
    String FIN_PROP_QD = "QD_ASSETS"; //通服渠道资产
    String FIN_PROP_TT = "TT_ASSETS"; //铁通资产
    String FIN_PROP_DH = "DH_ASSETS"; //低值易耗
    String FIN_PROP_TD = "TD_ASSETS";//TD资产
//end===============设备财务属性=========================//
...
//end===============返修情况统计=========================//
    ...
    String ITEM_STATUS_TO_DISCARD_TRANS = "TO_DISCARD_TRANS";  //待报废-公司间调拨
    ...
    String ITEM_STATUS_TO_ASSETS = "TO_ASSETS";//待转资
    String ITEM_STATUS_PRE_ASSETS = "PRE_ASSETS";//预转资
//end===============设备状态=========================//
...
//end===================省公司代码==================
    ...
    String[] GRP_FLOW_CAPTI = {"普通组别", "流程组别", "共用组别"};

    String[] BOOLEAN_VALUE = {"Y", "N"};
    String[] BOOLEAN_CAPTI = {"是", "否"};
