...
public class AmsInstrumentEamYbMaintainModel extends AMSSQLProducer {
     ...
     */
	public AmsInstrumentEamYbMaintainModel(SfUserDTO userAccount, AmsInstrumentEamYbMaintainDTO dtoParameter) {
	...
	public SQLModel getPageQueryModel() {
        ...
        String sqlStr = "SELECT"
        				...
        				+ " AND EYM.STATUS = 'YB_STATUS_NORMAL'"
        				+ " AND EYM.ORG_ID = ?"
	...
	//得到送修的仪器仪表库
	public SQLModel getInsSendRepairInvModel(){
		SQLModel sqlModel = new SQLModel();
		List sqlArgs = new ArrayList();
		String sqlStr = "SELECT"
		...
		sqlArgs.add(userAccount.getOrganizationId());
		sqlArgs.add(DictConstant.INV_SEND_REPAIR);
