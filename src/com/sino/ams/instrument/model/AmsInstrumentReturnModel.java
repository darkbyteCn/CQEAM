 ...
 */
public class AmsInstrumentReturnModel extends AMSSQLProducer {

    public AmsInstrumentReturnModel(SfUserDTO userAccount, AmsInstrumentHDTO dtoParameter) {
        super(userAccount, dtoParameter);
    }

    public SQLModel updateItemStatus(String barcodeNo){
        SQLModel sqlModel = new SQLModel();
        List sqlArgs = new ArrayList();
        String sqlStr = "update ets_item_info set item_status = 'NORMAL'\n" +
                "  where barcode = ?";
    ...
    public SQLModel getDataCreateModel() throws SQLModelException {
        ...
        try {
            ...
            String sqlStr = "INSERT INTO AMS_INSTRU_TRANS_H\n" +
                    "  (TRANS_ID, TRANS_NO, TRANS_TYPE, TRANS_STATUS,CONFIRM_USER,CONFIRM_DATE, RETURN_USER, RETURN_DATE,ORGANIZATION_ID)\n" +
                    "VALUES\n" +
                    "  (?, ?, ?, ?, ?,GETDATE(), ?, ?, ?)";
...
//    }
  ...
  public SQLModel updateItemInfo(String barcode){
      ...
      String str = "UPDATE "
            + " ETS_ITEM_INFO EII"
			+ " SET"
            + " EII.ITEM_STATUS ='NORMAL',"
//            + " RESPONSIBILITY_USER = "+userAccount.getUserId()+",\n"
//            + " RESPONSIBILITY_DEPT = '',\n"
            + " EII.MAINTAIN_USER = null,\n"                            //"+ maintainUser +"
            + " EII.LAST_UPDATE_DATE = GETDATE(),\n"
			+ " EII.LAST_UPDATE_BY = "+userAccount.getUserId()+"\n"
			+ " WHERE"
			+ " EII.BARCODE = '"+barcode+"'\n";
      sqlModel.setSqlStr(str);
      sqlModel.setArgs(sqlArgs);
