 ...
 */
public class AmsInstrumentDetectModel extends BaseSQLProducer {
    public SfUserDTO sfUser = null;

    public AmsInstrumentDetectModel(SfUserDTO userAccount, AmsInstrumentHDTO dtoParameter) {
   ...
   public SQLModel getPageQueryModel() throws SQLModelException {  //仪器仪表检测查询sql
        SQLModel sqlModel = new SQLModel();
        try {
            List sqlArgs = new ArrayList();
            AmsInstrumentHDTO amsInstrumentHInfo = (AmsInstrumentHDTO) dtoParameter;
