...
public class AmsInstrumentRegistrationDTO extends CommonRecordDTO {
...
//----------------------------------------以下是ETS_ITEM_INFO表中的字段-----------------------------------------//
	...
	private int responsibilityUser1 = SyBaseSQLUtil.NULL_INT_VALUE; //责任人1
...
//----------------------------------------以下是ETS_OBJECT表中的字段--------------------------------------------//
	...
	private int  organizationId = -1; //公司名称
...
//--------------------------------------以下是仪器仪表借用日志(EAM_YB_BORROW_LOG)表中的字段------------------------//
	...
	private String borrowUserId = ""; //借用人
...
//--------------------------------------以下是本类的构造方法和SET、GET方法----------------------------------------//
	...
	public int getResponsibilityUser1() {
		return responsibilityUser1;
	}

	public void setResponsibilityUser1(int responsibilityUser1) {
