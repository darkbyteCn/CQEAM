...
//----------------------------以下是EAM_YB_CHK_MAINSTAIN(仪器仪表检修表)中的字段--------------------------------//
	...
	private int checkUserId = SyBaseSQLUtil.NULL_INT_VALUE; //检修人
...
//---------------------------------------以下是ETS_ITEM_INFO表中的字段----------------------------------------//
	private int organizationId = SyBaseSQLUtil.NULL_INT_VALUE; //公司ID

//---------------------------------------以下是SF_USER表中的字段----------------------------------------------//
	private int userId = SyBaseSQLUtil.NULL_INT_VALUE; //对应检修人的ID
