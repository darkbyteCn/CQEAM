...
import com.sino.ams.instrument.dao.AmsInstrumentEamYbMaintainDAO;
 ...
 */
public class AmsInstrumentEamYbMaintainServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			AmsInstrumentEamYbMaintainDAO dao = new AmsInstrumentEamYbMaintainDAO(user, dtoParameter, conn);
			OptionProducer op = new OptionProducer(user, conn);
			String instrumentMame = op.getInstrument("") ;     //产生仪器仪表的地市选项
			req.setAttribute(WebAttrConstant.BORROW_OPTION, instrumentMame);
			if (action.equals("")) {
				req.setAttribute(WebAttrConstant.AMS_INSTRUMENT_REPAIR, dtoParameter);
				forwardURL = "/instrument/instrumentRepair.jsp";
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new AmsInstrumentEamYbMaintainModel(user, dtoParameter);
				...
				AmsInstrumentEamYbMaintainDTO amsInstrumentInfo = (AmsInstrumentEamYbMaintainDTO) req.getAttribute(WebAttrConstant.AMS_INSTRUMENT_REPAIR);
                ...
                req.setAttribute(WebAttrConstant.AMS_INSTRUMENT_REPAIR, amsInstrumentInfo);
                //showMsg = "仪器仪表登记卡批量删除成功!";
//              forwardURL = URLDefineList.INSTRUMENT_REGISTRATION;
                forwardURL = "/servlet/com.sino.ams.instrument.servlet.AmsInstrumentEamYbMaintainServlet?act=" + WebActionConstant.QUERY_ACTION;
			} 
