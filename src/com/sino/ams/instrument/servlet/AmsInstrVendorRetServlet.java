...
import com.sino.ams.instrument.dao.AmsInstrVendorRetDAO;
 ...
 */
public class AmsInstrVendorRetServlet extends BaseServlet {
	 public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			AmsInstrVendorRetDAO dao = new AmsInstrVendorRetDAO(user, dtoParameter, conn);
			...
			if (action.equals("")) {
				forwardURL = "/instrument/instruVendorReturn.jsp";
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new AmsInstrVendorRetModel(user, dtoParameter);
				...
				amsInstrumentInfo.setTransType(DictConstant.INS_VRE);  //仪器仪表借用单据ams_instrument_info。TRANS_TYPE事物类型
				req.setAttribute(WebAttrConstant.AMS_INSTRUMENTH_DTO, amsInstrumentInfo);
				forwardURL = "/instrument/instruVendorReturnInfo.jsp";
