...
import com.sino.ams.instrument.dao.AmsInstrumentEamYbObjectNoDAO;
...
public class AmsInstrumentEamYbObjectNoServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			AmsInstrumentEamYbObjectNoDAO etsObjectDAO = new AmsInstrumentEamYbObjectNoDAO(user, dtoParameter, conn);
			...
			if (action.equals("")) {
				...
				forwardURL = URLDefineList.INSTRUMENT_QUERY_PAGE;
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
				String countyOption = optProducer.getCountyOption(dtoParameter.getCountyCode());
				req.setAttribute(WebAttrConstant.COUNTY_OPTION, countyOption);
				BaseSQLProducer sqlProducer = new AmsInstrumentEamYbObjectNoModel(user, dtoParameter);
				...
				req.setAttribute(WebAttrConstant.COUNTY_OPTION, countyOption);
				req.setAttribute(WebAttrConstant.ETS_OBJECT_DTO, dtoParameter);
				forwardURL = URLDefineList.INSTRUMENT_DETAIL_PAGE;
				...
				req.setAttribute(WebAttrConstant.ETS_OBJECT_DTO, dtoParameter);
//				forwardURL = URLDefineList.INSTRUMENT_QUERY_PAGE;
				forwardURL = URLDefineList.INSTRUMENT_QUERY_SERVLET;
