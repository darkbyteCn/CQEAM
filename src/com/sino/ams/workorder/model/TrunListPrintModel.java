...
public class TrunListPrintModel extends BaseSQLProducer {
	SfUserDTO sfUser = null;
	public TrunListPrintModel(BaseUserDTO userAccount, DTO dtoParameter) {
	...
	public SQLModel getPageQueryModel() throws SQLModelException {
		...
		EtsBarcodePrintHistoryDTO dto = (EtsBarcodePrintHistoryDTO)dtoParameter;
