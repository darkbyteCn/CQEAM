 ...
 * @version 1.0
 */
public class DeptItemModel extends AMSSQLProducer {

	public DeptItemModel(SfUserDTO userAccount, EtsWorkorderDTO dtoParameter) {
	 ...
	 * @return SQLModel
	 */
	public SQLModel getDeptOwnItemModel() {
		SQLModel sqlModel = new SQLModel();
	 ...
	 * @throws SQLModelException
	 */
	public SQLModel getDeptScanedItemModel() throws SQLModelException {
		SQLModel sqlModel = new SQLModel();
		try {
			String sqlStr = "SELECT"
							+ " EII.BARCODE,"
	 ...
	 * @throws SQLModelException
	 */
	public SQLModel getDeptNotScanedItemModel() throws SQLModelException {
		SQLModel sqlModel = new SQLModel();
		try {
			String sqlStr = "SELECT"
							+ " EII.BARCODE,"
