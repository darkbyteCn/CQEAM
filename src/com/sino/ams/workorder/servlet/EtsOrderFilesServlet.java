 ...
 * <p>Description:程序自动生成服务程序“EtsOrderFilesServlet”，请根据需要自行修改</p>
...
public class EtsOrderFilesServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				forwardURL = "com.sino.ams.workorder.servlet.EtsOrderFilesServlet的翻页查询JSP页面，一般在类似于URLDefineList的常量接口中定义";
				...
				EtsOrderFilesDTO etsOrderFiles = (EtsOrderFilesDTO)req.getAttribute("获取因为失败而保持的数据，请根据实际情况修改");
				if(etsOrderFiles == null){
					etsOrderFiles= dtoParameter;//表示没有因失败而保持的数据，则产生默认的对象数据，数据由com.sino.ams.workorder.dto.EtsOrderFilesDTO的构造函数确定
				}
				req.setAttribute("详细数据属性，请根据实际情况修改", etsOrderFiles);
				forwardURL = "com.sino.ams.workorder.servlet.EtsOrderFilesServlet详细数据JSP页面，一般在类似于URLDefineList的常量接口中定义";
				...
				forwardURL = "可再次执行com.sino.ams.workorder.servlet.EtsOrderFilesServlet的QUERY_ACTION，请根据实际情况确定";
