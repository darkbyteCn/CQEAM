 ...
 * @version 1.0
 */
public class DeptNotScanItemServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if(action.equals(WebActionConstant.DETAIL_ACTION)) {
				BaseSQLProducer sqlProducer = new DeptItemModel(user, dto);
				PageQueryDAO pageDAO = new PageQueryDAO(req, conn, sqlProducer);
				pageDAO.setPageSize(23);
				pageDAO.produceWebData();
				forwardURL = URLDefineList.DEPT_NOT_SCANED_ITEM;
			} else {
