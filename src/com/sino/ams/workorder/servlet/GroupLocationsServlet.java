 ...
 * @version 1.0
 */
public class GroupLocationsServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if(act.equals(WebActionConstant.DETAIL_ACTION)){
				...
				RowSet rows = scanDAO.getScanedLocations();
				req.setAttribute(WebAttrConstant.WORKORDER_DTO, dto);
				req.setAttribute(WebAttrConstant.GROUP_LOCATIONS, rows);
				forwardURL = URLDefineList.GROUP_LOCATION_PAGE;
			} else {
