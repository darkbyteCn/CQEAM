 ...
 * <p>Description:程序自动生成服务程序“EtsSuggestionServlet”，请根据需要自行修改</p>
...
public class EtsSuggestionServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            if (action.equals("")) {
				forwardURL = "com.sino.ams.workorder.servlet.EtsSuggestionServlet的翻页查询JSP页面，一般在类似于URLDefineList的常量接口中定义";
				...
				req.setAttribute("详细数据属性，请根据实际情况修改", dtoParameter);
				forwardURL = "com.sino.ams.workorder.servlet.EtsSuggestionServlet详细数据JSP页面，一般在类似于URLDefineList的常量接口中定义";
			} else if (action.equals(WebActionConstant.CREATE_ACTION)) {
				etsSuggestionDAO.createData();
				forwardURL = "可再次执行com.sino.ams.workorder.servlet.EtsSuggestionServlet的QUERY_ACTION，请根据实际情况确定";
