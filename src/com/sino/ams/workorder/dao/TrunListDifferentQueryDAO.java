...
import com.sino.ams.workorder.model.TrunListDifferentQueryModel;
 ...
 * Function	:		转资清单差异DAO
 */
public class TrunListDifferentQueryDAO extends BaseDAO {
    public TrunListDifferentQueryDAO(SfUserDTO userAccount, EtsWorkorderDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new TrunListDifferentQueryModel((SfUserDTO)userAccount, ffDTO);
    }
    ...
    private Map getFieldMap(EtsWorkorderDTO dto){
        ...
        fieldMap.put("CREATION_DATE", "差异处理时间");
        fieldMap.put("CREATED_BY", "差异处理人");
        fieldMap.put("DIFF_PROCESS_DESC", "差异处理结果");
