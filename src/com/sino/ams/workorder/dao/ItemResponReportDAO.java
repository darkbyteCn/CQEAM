...
import com.sino.ams.workorder.model.ItemResponReportModel;
...
public class ItemResponReportDAO extends AMSBaseDAO {
	...
	public ItemResponReportDAO(SfUserDTO userAccount, EtsWorkorderDTO dtoParameter, Connection conn) {
