...
public class ZeroTurnListPrintQueryDAO extends BaseDAO {
	private SfUserDTO user = null;
	public ZeroTurnListPrintQueryDAO(SfUserDTO userAccount, ZeroTurnLineDTO dtoParameter,
			Connection conn) {
...
//        super.sqlProducer = new TrunListQueryModel((SfUserDTO)userAccount, ffDTO);
        super.sqlProducer = new ZeroTrunListPrintQueryModel((SfUserDTO)userAccount, ffDTO);
	 ...
	 */
	public File exportFile(ZeroTurnLineDTO dto,String opinion,List partBarCode) throws DataTransException {
		File file = null;
		try {
			SQLModel sqlModel;
			...
			String reportTitle = reportTitle = "零购转资条码查询";
	...
	private Map getFieldMap(ZeroTurnLineDTO dto){
