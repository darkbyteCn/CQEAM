...
public class TrunListDetailQueryDAO extends BaseDAO {
	
	public TrunListDetailQueryDAO(SfUserDTO userAccount, EtsWorkorderDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new TrunListDetailQueryModel((SfUserDTO)userAccount, ffDTO);
    }
