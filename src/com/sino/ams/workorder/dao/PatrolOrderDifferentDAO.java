 ...
 * Date: 2009-6-12
 * Time: 11:34:55
 * Function	:		巡检工单清单差异DAO
 */
public class PatrolOrderDifferentDAO extends BaseDAO {
    public PatrolOrderDifferentDAO(SfUserDTO userAccount, EtsWorkorderDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new PatrolOrderDifferentModel((SfUserDTO)userAccount, ffDTO);
    }
	...
	public File getExportFile(EtsWorkorderDTO dto) throws DataTransException {
		...
		try {
			...
			String reportTitle = reportTitle = "巡检清单差异";
