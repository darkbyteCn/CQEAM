...
import com.sino.ams.prematch.dao.PaMatchAMSDAO;
...
public class PaMatchAMSServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (action.equals("")) {
				...
				forwardURL = URLDefineList.PA_MATCH_AMS;
			} else if (action.equals(AMSActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new PaMatchAMSModel(user, dtoParameter);
...
//				pageDAO.setCountPages(false);
				...
				PaMatchAMSDAO paAssetsDAO = new PaMatchAMSDAO(user, dtoParameter, conn);
