...
public class TFMatchResultDAO extends AMSBaseDAO {

    public TFMatchResultDAO(SfUserDTO userAccount, EtsOuCityMapDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        sqlProducer = new TFMatchResultModel(user, dto);
    }
