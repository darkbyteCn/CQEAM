 ...
 */
public class AmsMactPropertyDAO extends AMSBaseDAO  {
	 ...
	 */
	public AmsMactPropertyDAO(SfUserDTO userAccount, AmsMactPropertyDTO dtoParameter, Connection conn) {
	...
	*/
	 ...
	 protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
	   ...
	   super.sqlProducer = new AmsMactPropertyModel((SfUserDTO) userAccount, dtoPara);
	}
