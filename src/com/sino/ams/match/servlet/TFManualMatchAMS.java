...
import com.sino.ams.match.model.TFManualMatchAMSModel;
...
public class TFManualMatchAMS extends BaseServlet {
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		String forwardURL = "/match/tf/tfManualMatchAMS.jsp";
		...
		try {
			...
			TFManualMatchDAO matchDAO = new TFManualMatchDAO(user, dto, conn);
			ServletConfigDTO configDTO = getServletConfig(req);
			if (act.equals(WebActionConstant.QUERY_ACTION)) {
				AMSSQLProducer sqlProducer = new TFManualMatchAMSModel(user, dto);
