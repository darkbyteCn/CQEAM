...
import com.sino.ams.match.model.ManualMatchMISModel;
 ...
 *          Date: 2007-11-26
 */
public class ManualMatchMIS extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        String forwardURL = "/match/manualMatchMIS.jsp";
...
//                req.setAttribute("COUNTY_OPTION", op.getCountyOptionMIS(itemInfo.getCountyCodeMis()));
            ...
            if (act.equals(WebActionConstant.QUERY_ACTION)) {
                AMSSQLProducer sqlProducer = new ManualMatchMISModel(user, itemInfo);
                ...
                forwardURL = "";
                ManualMatchMISModel sqlProducer = new ManualMatchMISModel(user, itemInfo);
