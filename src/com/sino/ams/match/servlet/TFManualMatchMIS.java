...
import com.sino.ams.match.model.TFManualMatchMISModel;
...
public class TFManualMatchMIS extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        String forwardURL = "/match/tf/tfManualMatchMIS.jsp";
...
//                req.setAttribute("COUNTY_OPTION", op.getCountyOptionMIS(itemInfo.getCountyCodeMis()));
            ...
            if (act.equals(WebActionConstant.QUERY_ACTION)) {
                AMSSQLProducer sqlProducer = new TFManualMatchMISModel(user, itemInfo);
                ...
                forwardURL = "";
                TFManualMatchMISModel sqlProducer = new TFManualMatchMISModel(user, itemInfo);
