		...
		try {
			if (lookUpName.equals("")) {
				...
				if (lookUpName.equals(LookUpConstant.LOOK_UP_SYS_ITEM)) {
					...
					dispFieldNames = new String[]{"CATALOG_VALUE_ID", "CATALOG_NAME"};
					dispFieldLabels = new String[]{"目录编号", "品名"};
					retFields = new String[]{"CATALOG_VALUE_ID", "CATALOG_NAME"};
					viewPercent = new String[]{"30%", "60%"};
					qryFieldNames = new String[]{"CATALOG_VALUE_ID", "CATALOG_NAME"};
					...
					dispFieldNames = new String[]{"BARCODE", "USER_NAME"};
					dispFieldLabels = new String[]{"标签号", "领用人姓名"};
					retFields = new String[]{"EMPLOYEE_ID", "RESPONSIBILITY_USER", "USER_NAME", "BARCODE"};
					viewPercent = new String[]{"40%", "40%"};
					qryFieldNames = new String[]{"BARCODE", "USER_NAME"};
					qryFieldLabels = new String[]{"标签号", "领用人姓名"};
					...
					dispFieldNames = new String[]{"BARCODE_FLAG", "CATALOG_NAME", "UNIT"};
					dispFieldLabels = new String[]{"标签编号", "品名", "计量单位"};
					retFields = new String[]{"BARCODE_FLAG", "CATALOG_NAME", "UNIT"};
