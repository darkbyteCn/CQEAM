...
public interface LookUpInvConstant {
	...
	String LOOK_UP_WORKORDER_OBJECT_NO_DZYH = "LOOK_UP_WORKORDER_OBJECT_NO_DZYH"; //选择低值易耗品仓库
    String LOOK_UP_WORKORDER_OBJECT_NO_NAME="LOOK_UP_WORKORDER_OBJECT_NO_NAME";
}
