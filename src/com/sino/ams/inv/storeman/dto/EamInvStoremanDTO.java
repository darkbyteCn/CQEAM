package com.sino.ams.inv.storeman.dto;
...
public class EamInvStoremanDTO extends EtsObjectDTO {
	...
	private int createdUser; //SF_USER表中的USERNAME属性，为了识别创建人名字
	...
	private int createdById; //EAM_INV_STOREMAN表中的CREATED_BY这个字段的对应字段
	private int lastUpdateById; //EAM_INV_STOREMAN表中的LAST_UPDATE_BY这个字段对应的字段
