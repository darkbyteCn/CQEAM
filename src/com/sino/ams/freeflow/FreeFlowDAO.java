 ...
 */
public class FreeFlowDAO extends AMSBaseDAO {
    public FreeFlowDAO(SfUserDTO userAccount, FreeFlowDTO dtoParameter, Connection conn) {
        super(userAccount, dtoParameter, conn);
    }

    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        FreeFlowDTO ffDTO=(FreeFlowDTO) dtoParameter;
        super.sqlProducer = new FreeFlowModel((SfUserDTO)userAccount, ffDTO);
    }
...
//			throw new DataHandleException(ex);
        ...
        public boolean cancelOrders(String[] transIds) {
            ...
            boolean autoCommit = true;
            FreeFlowDTO headerDTO = (FreeFlowDTO) dtoParameter;
            FreeFlowModel modelProducer = (FreeFlowModel) sqlProducer;
            try {
                autoCommit = conn.getAutoCommit();
                conn.setAutoCommit(false);
        ...
        public File exportFile() throws DataTransException { //导出模板
            ...
            FreeFlowModel modelProducer = (FreeFlowModel)
                                                      sqlProducer;
