...
public class OracleParameterSearchModel extends DefaultRDSBaseSQLModelImpl implements RDSBaseSQLModel {

    public OracleParameterSearchModel(BaseUserDTO userAccount, DTO dtoParameter) {
