...
public class OracleViewSearchModel extends DefaultRDSBaseSQLModelImpl implements RDSBaseSQLModel {

    public OracleViewSearchModel(BaseUserDTO userAccount, DTO dtoParameter) {
