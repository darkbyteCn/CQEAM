...
public class OracleCategorySearchModel extends DefaultRDSBaseSQLModelImpl implements RDSBaseSQLModel {

    public OracleCategorySearchModel(BaseUserDTO userAccount, DTO dtoParameter) {
