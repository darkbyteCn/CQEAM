...
public class SybaseFavoriteLeftModel extends DefaultRDSBaseSQLModelImpl implements RDSBaseSQLModel {

    public SybaseFavoriteLeftModel(BaseUserDTO userAccount, DTO dtoParameter) {
