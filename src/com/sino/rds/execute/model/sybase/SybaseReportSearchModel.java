...
public class SybaseReportSearchModel extends DefaultRDSBaseSQLModelImpl implements RDSBaseSQLModel {

    public SybaseReportSearchModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    private SQLModel getDataByLookUpIdModel() {
        ...
        String sqlStr = "SELECT RRD.REPORT_ID,\n" +
                ...
                "       dbo.GET_RDS_FLEX_VALUE('COUNT_PAGES', RRD.COUNT_PAGES) COUNT_PAGES_NAME,\n" +
                "       RRD.SUPPORT_DRILL_DOWN,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('SUPPORT_DRILL_DOWN',\n" +
