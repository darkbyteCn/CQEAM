...
public class SybaseReportQueryModel extends DefaultRDSBaseSQLModelImpl implements ReportQueryModel {

    public SybaseReportQueryModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getPageQueryModel() {
        ...
        String sqlStr = "SELECT RRD.REPORT_ID,\n" +
                ...
                "       OR (? = '' OR RRD.REPORT_CODE LIKE ?)\n" +
                "       OR (? = '' OR RRD.REPORT_NAME LIKE ?))\n" +
                "       AND RRD.ENABLED = 'Y'\n" +
