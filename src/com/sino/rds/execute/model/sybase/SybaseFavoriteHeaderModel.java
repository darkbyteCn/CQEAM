...
public class SybaseFavoriteHeaderModel extends DefaultRDSBaseSQLModelImpl implements FavoriteHeaderModel {

    public SybaseFavoriteHeaderModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getDataUpdateModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "UPDATE RDS_FAVORITE_HEADER\n" +
                "SET    FAVORITE_NAME    = ?,\n" +
                "       FAVORITE_REMARK  = ?,\n" +
    ...
    public SQLModel getDeleteByPrimaryKeyModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "DELETE FROM RDS_FAVORITE_HEADER WHERE HEADER_ID = ?";
        List<String> sqlArgs = new ArrayList<String>();
        FavoriteHeaderFrm frm = (FavoriteHeaderFrm) dtoParameter;
    ...
    public SQLModel getPageQueryModel() {
        ...
        String sqlStr = "SELECT RFH.HEADER_ID,\n" +
                ...
                "       RFH.LAST_UPDATE_BY\n" +
                "FROM   RDS_FAVORITE_HEADER RFH\n" +
                "WHERE  RFH.CREATED_BY = CONVERT(INT, ?)";
        List<String> sqlArgs = new ArrayList<String>();
        sqlArgs.add(getUserId());
        sqlModel.setSqlStr(sqlStr);
        sqlModel.setArgs(sqlArgs);
