...
public class OracleLookUpDefineModel extends DefaultRDSBaseSQLModelImpl implements LookUpDefineModel {

    public OracleLookUpDefineModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getPageQueryModel() {
        ...
        String sqlStr = "SELECT RLD.LOOK_UP_ID,\n" +
                ...
                "       AND RLD.LOOK_UP_NAME = NVL(?, RLD.LOOK_UP_NAME)";
        List<String> sqlArgs = new ArrayList<String>();
        LookUpDefineFrm frm = (LookUpDefineFrm) dtoParameter;
    ...
    public SQLModel getReportIdByPrimaryKeyModel() {
        ...
        String sqlStr = "SELECT RLD.REPORT_ID\n" +
                "FROM   RDS_LOOKUP_DEFINE RLD\n" +
                "WHERE  RLD.LOOK_UP_ID = NVL(?, RLD.LOOK_UP_ID)\n" +
                "       AND RLD.LOOK_UP_CODE = NVL(?, RLD.LOOK_UP_CODE)\n";
