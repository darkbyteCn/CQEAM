...
public class SybaseLovDefineModel extends DefaultRDSBaseSQLModelImpl implements LovDefineModel {

    public SybaseLovDefineModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getDataUpdateModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "UPDATE RDS_LOV_DEFINE\n" +
                "SET    LOV_NAME            = ?,\n" +
                "       CONNECTION_ID       = ?,\n" +
                "       ADD_BLANK           = ?,\n" +
                "       LOV_TYPE            = ?,\n" +
    ...
    public SQLModel getPageQueryModel() {
        ...
        String sqlStr = "SELECT RLD.LOV_ID,\n" +
                "       RLD.LOV_NAME,\n" +
                "       RLD.LOV_TYPE,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('LOV_TYPE', RLD.LOV_TYPE) LOV_TYPE_NAME,\n" +
                "       RLD.LOV_SQL,\n" +
                "       RLD.LOV_VALUE,\n" +
                ...
                "       RLD.ADD_BLANK,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('ENABLED_FLAG', RLD.ADD_BLANK) ADD_BLANK_NAME,\n" +
                "       RLD.CREATION_DATE,\n" +
                "       RLD.CREATED_BY,\n" +
