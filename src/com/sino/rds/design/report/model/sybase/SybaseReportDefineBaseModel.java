...
public abstract class SybaseReportDefineBaseModel extends DefaultRDSBaseSQLModelImpl implements ReportDefineBaseModel {

    public SybaseReportDefineBaseModel(BaseUserDTO userAccount, DTO dtoParameter) {
        super(userAccount, dtoParameter);
    }

    public SQLModel getNextReportCodeModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "SELECT dbo.GET_RDS_NEXT_RPT_CODE() RPT_CODE";
