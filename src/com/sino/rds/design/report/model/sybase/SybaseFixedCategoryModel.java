...
public class SybaseFixedCategoryModel extends DefaultRDSBaseSQLModelImpl implements FixedCategoryModel {

    public SybaseFixedCategoryModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getDataUpdateModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "UPDATE RDS_FIXED_CATEGORY \n" +
                "SET    DEFINE_VALUE     = ?,\n" +
                "       SORT_NUMBER      = ?,\n" +
                "       PARENT_ID      = ?,\n" +
