...
public class SybaseReportParameterProcessModel extends DefaultRDSBaseSQLModelImpl implements ReportParameterProcessModel {

    public SybaseReportParameterProcessModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getDataUpdateModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "UPDATE RDS_REPORT_PARAMETER\n" +
                "SET    \n" +
                "       FIELD_NAME        = ?,\n" +
                "       FIELD_DESC        = ?,\n" +
                "       FIELD_WIDTH       = ?,\n" +
    ...
    public SQLModel getReportParameterDeleteByIdsModel() {
        SQLModel sqlModel = new SQLModel();
        ReportParameterFrm frm = (ReportParameterFrm) dtoParameter;
        String parameterIds = frm.getParameterIds();
        parameterIds = StrUtil.replaceStr(parameterIds, ",", "', '");
        parameterIds = "'" + parameterIds + "'";
        String sqlStr = "DELETE FROM RDS_REPORT_PARAMETER WHERE PARAMETER_ID IN (" + parameterIds + ")";
        sqlModel.setSqlStr(sqlStr);
        return sqlModel;
    }
    ...
    public SQLModel getPrimaryKeyDataModel() {
        ...
        String sqlStr = "SELECT RRP.PARAMETER_ID,\n" +
                ...
                "       RRP.FIELD_DESC,\n" +
                "       RRP.INPUT_TYPE,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('INPUT_TYPE', RRP.INPUT_TYPE) INPUT_TYPE_NAME,\n" +
                "       RRP.LOV_ID,\n" +
                "       RLD.LOV_NAME,\n" +
                "       RRP.LOOK_UP_ID,\n" +
                "       RLD2.LOOK_UP_NAME,\n" +
                ...
                "       RRP.FIELD_ALIGN,\n" +
                "       RRP.NULL_ABLE,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('NULL_ABLE', RRP.NULL_ABLE) NULL_ABLE_NAME,\n" +
                "       RRP.CALENDAR_TYPE,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('CALENDAR_TYPE', RRP.CALENDAR_TYPE) CALENDAR_TYPE_NAME,\n" +
                "       RRP.DEFAULT_VALUE,\n" +
                "       RRP.ENABLED,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('ENABLED_FLAG', RRP.NULL_ABLE) ENABLED_NAME,\n" +
    ...
    public SQLModel getSelectedFieldsModel() {
        ...
        fieldIds = "'" + StrUtil.replaceStr(fieldIds, ",", "', '") + "'";
        String sqlStr = "SELECT RRP.PARAMETER_ID,\n" +
                "       RRP.FIELD_ID,\n" +
                "       RRP.FIELD_NAME,\n" +
                "       RRP.FIELD_DESC,\n" +
                ...
                "       RRP.ENABLED\n" +
                "FROM   RDS_REPORT_PARAMETER RRP\n" +
                "WHERE  RRP.FIELD_ID IN (" + fieldIds + ")\n" +
                "       AND RRP.REPORT_ID = ?\n" +
                "UNION ALL\n" +
                ...
                "          'RIGHT'\n" +
                "         WHEN RMF.FIELD_TYPE = 'DECIMAL' THEN\n" +
                "          'RIGHT'\n" +
