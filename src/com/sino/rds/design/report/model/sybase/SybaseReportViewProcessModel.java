...
public class SybaseReportViewProcessModel extends DefaultRDSBaseSQLModelImpl implements ReportViewProcessModel {

    public SybaseReportViewProcessModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getDataUpdateModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "UPDATE RDS_REPORT_VIEW\n" +
                "SET    REPORT_ID          = ?,\n" +
                "       FIELD_WIDTH        = ?,\n" +
                "       FIELD_ALIGN        = ?,\n" +
                "       DATA_PATTERN       = ?,\n" +
                "       DOT_NUMBER         = CONVERT(INT, ?),\n" +
                "       DATA_SRC_TYPE      = ?,\n" +
                "       COMPUTE_EXPRESSION = ?,\n" +
                "       FIELD_NAME         = ?,\n" +
                "       FIELD_DESC         = ?,\n" +
    ...
    public SQLModel getReportViewDeleteByIdsModel() {
        ...
        String sqlStr = "DELETE FROM RDS_REPORT_VIEW WHERE VIEW_ID IN (" + viewIds + ")";
        sqlModel.setSqlStr(sqlStr);
        return sqlModel;
    }
    ...
    public SQLModel getPrimaryKeyDataModel() {
        ...
        String sqlStr = "SELECT RRV.VIEW_ID,\n" +
                ...
                "       RRV.DOT_NUMBER,\n" +
                "       RRV.ENABLED,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('ENABLED_FLAG', RRV.ENABLED) ENABLED_NAME,\n" +
                "       RRV.CREATION_DATE,\n" +
                "       RRV.CREATED_BY,\n" +
