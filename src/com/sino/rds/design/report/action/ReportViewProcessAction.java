...
import com.sino.rds.design.report.service.ReportViewProcessService;
...
public class ReportViewProcessAction extends RDSBaseAction {
    ...
    public ActionForward performTask(ActionMapping mapping, ActionForm form, HttpServletRequest req, HttpServletResponse res) throws ServletException {
        ...
        String forwardName = "";
        ReportViewProcessFrm frm = (ReportViewProcessFrm) form;
        ...
        try {
            ...
            ReportViewProcessService service = new ReportViewProcessService(userAccount, frm, conn);
