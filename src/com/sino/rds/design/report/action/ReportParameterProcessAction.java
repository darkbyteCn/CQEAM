...
import com.sino.rds.design.report.service.ReportParameterProcessService;
import com.sino.rds.share.constant.RDSActionConstant;
import com.sino.rds.share.form.ReportParameterProcessFrm;
...
public class ReportParameterProcessAction extends RDSBaseAction {
    ...
    public ActionForward performTask(ActionMapping mapping, ActionForm form, HttpServletRequest req, HttpServletResponse res) throws ServletException {
        ...
        String forwardName = "";
        ReportParameterProcessFrm frm = (ReportParameterProcessFrm) form;
        ...
        try {
            ...
            ReportParameterProcessService service = new ReportParameterProcessService(userAccount, frm, conn);
