...
public class SybaseDataModelProcessModel extends DefaultRDSBaseSQLModelImpl implements DataModelProcessModel {

    public SybaseDataModelProcessModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getDataUpdateModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "UPDATE RDS_DATA_MODEL \n" +
                "SET    MODEL_NAME       = ?,\n" +
                "       CONNECTION_ID    = ?,\n" +
                "       MODEL_DESC       = ?,\n" +
                "       DATA_SRC_TYPE    = ?,\n" +
    ...
    public SQLModel getDataModelStatusUpdateModel() {
        ...
        String sqlStr = "UPDATE RDS_DATA_MODEL\n" +
                ...
                "       LAST_UPDATE_DATE = GETDATE(),\n" +
                "       LAST_UPDATE_BY   = CONVERT(INT, ?)\n" +
                "WHERE  MODEL_ID IN (" + frm.getModelIds() + ")";
        List<String> sqlArgs = new ArrayList<String>();
    ...
    public SQLModel getPrimaryKeyDataModel() {
        ...
        String sqlStr = "SELECT RDM.MODEL_ID,\n" +
                ...
                "       RDM.OWNER,\n" +
                "       RDM.ENABLED,\n" +
                "       dbo.GET_RDS_FLEX_VALUE('ENABLED_FLAG', RDM.ENABLED) ENABLED_NAME,\n" +
                "       RDM.CREATION_DATE,\n" +
                "       RDM.CREATED_BY,\n" +
    ...
    public SQLModel getPageQueryModel() {
        ...
        String sqlStr = "SELECT RDM.MODEL_ID,\n" +
                ...
                "       AND (? = '' OR RDM.MODEL_NAME LIKE ?)\n" +
                "       AND (? = '' OR RDM.DATA_SRC_TYPE = ?)\n" +
                "       AND (? = '' OR RDM.ENABLED = ?)\n" +
