...
public class OracleDBConnectionModel extends DefaultRDSBaseSQLModelImpl implements RDSBaseSQLModel {

    public OracleDBConnectionModel(BaseUserDTO userAccount, DTO dtoParameter) {
    ...
    public SQLModel getDataUpdateModel() {
        SQLModel sqlModel = new SQLModel();
        String sqlStr = "UPDATE RDS_DB_CONNECTION RDC\n" +
                "SET    RDC.DB_DRIVER        = ?,\n" +
                "       RDC.CONNECTION_NAME  = ?,\n" +
                "       RDC.DB_URL           = ?,\n" +
                "       RDC.DB_USER          = ?,\n" +
                "       RDC.DB_PWD           = ?,\n" +
                "       RDC.LAST_UPDATE_DATE = SYSDATE,\n" +
                "       RDC.LAST_UPDATE_BY   = ?\n" +
