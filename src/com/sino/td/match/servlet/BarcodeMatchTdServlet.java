...
import com.sino.td.match.dao.BarcodeMatchTdDAO;
 ...
 */
public class BarcodeMatchTdServlet extends BaseServlet {
...
/**
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			BarcodeMatchTdDAO barcodeMatchDAO = new BarcodeMatchTdDAO(user, dto, conn);
			...
			if (action.equals("")) {
				...
				forwardURL = URLDefineList.BARCODE_MATCH_TD;
			} else if (action.equals(WebActionConstant.QUERY_ACTION)) {
				BaseSQLProducer sqlProducer = new BarcodeMatchTdModel(user, dto);
				...
				req.setAttribute(WebAttrConstant.IS_MATCH_OPTION, getIsMatchOption(dto.getMatch()));
				req.setAttribute(WebAttrConstant.BARCODE_MATCH_DTO, dto);
				forwardURL = URLDefineList.BARCODE_MATCH_TD_SERVLET;
