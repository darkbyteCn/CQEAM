...
import com.sino.td.match.model.ManualMatchTdMISModel;
 ...
 *          Date: 2007-11-26
 */
public class ManualMatchTdMIS extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        //String forwardURL = "/td/match/manualMatchTdMIS.jsp";
    	String forwardURL = URLDefineList.MANUAL_MATCH_TD_MIS;
        ...
        try {
            ...
            if (act.equals(WebActionConstant.QUERY_ACTION)) {
                AMSSQLProducer sqlProducer = new ManualMatchTdMISModel(user, itemInfo);
                ...
                forwardURL = "";
                ManualMatchTdMISModel sqlProducer = new ManualMatchTdMISModel(user, itemInfo);
...
//            ManualMatchTdMISModel sqlProducer = new ManualMatchTdMISModel(user, itemInfo2);
//            SQLModel sqlMode2 = sqlProducer.getPageQueryModel();
            TransRule rule = new TransRule();
            rule.setDataSource(sqlMode2);
//            rule.setCalPattern(CalendarConstant.LINE_PATTERN);
            rule.setSourceConn(conn);
            String fileName = "MIS设备信息.xls";
            ...
            custData.setReportTitle("MIS设备信息");
