...
public class EtsItemMatchTdRecDAO extends BaseDAO {
     ...
     */
    public EtsItemMatchTdRecDAO(SfUserDTO userAccount, EtsItemMatchRecDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new EtsItemMatchTdRecModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public void saveDTO(EtsItemMatchRecDTO dto) throws DataHandleException {
        ...
        try {
            ...
            EtsItemMatchTdRecModel modelProducer = (EtsItemMatchTdRecModel) sqlProducer;
