...
public class EtsFaTdAssetsDAO extends AMSBaseDAO {
	 ...
	 */
	public EtsFaTdAssetsDAO(SfUserDTO userAccount, AmsAssetsAddressVDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new EtsFaTdAssetsModel((SfUserDTO) userAccount, dtoPara);
	}
	...
	public File exportCheckedAssets(String[] barcodes) throws DataTransException {
		File file = null;
		EtsFaTdAssetsModel assetsModel = (EtsFaTdAssetsModel) sqlProducer;
