...
public class TdAdminConfirmDAO extends AMSBaseDAO {
	 ...
	 */
	public TdAdminConfirmDAO(SfUserDTO userAccount,
						   TdAssetsTransLineDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		super.sqlProducer = new TdAdminConfirmModel((SfUserDTO) userAccount,
												  dtoPara);
	}
	...
	public boolean confirmAssets(DTOSet confirmAssets) {
		...
		TdAssetsConfirmDAO confirmDAO = null;
		try {
			confirmDAO = new TdAssetsConfirmDAO(userAccount, null, conn);
	...
	public File exportCheckedAssets(String[] barcodes) throws
		...
		File file = null;
		try {
			TdAdminConfirmModel modelProducer = (TdAdminConfirmModel) sqlProducer;
