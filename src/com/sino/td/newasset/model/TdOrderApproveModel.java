...
public class TdOrderApproveModel extends AMSSQLProducer {
	 ...
	 */
	public TdOrderApproveModel(SfUserDTO userAccount, TdAssetsTransHeaderDTO dtoParameter) {
...
//		TdAssetsTransHeaderDTO dto = (TdAssetsTransHeaderDTO) dtoParameter;
//		List sqlArgs = new ArrayList();
//        String sqlStr = "UPDATE TD_ASSETS_TRANS_LINE AATL SET AATL.REMARK = '不允许报废' WHERE AATL.TRANS_ID = ? AND AATL.BARCODE NOT IN ?";
//		sqlArgs.add(dto.getTransId());
...
//	}
    public SQLModel updateTransLineRemark() {
		...
		TdAssetsTransHeaderDTO dto = (TdAssetsTransHeaderDTO) dtoParameter;
		List sqlArgs = new ArrayList();
        String sqlStr = "UPDATE TD_ASSETS_TRANS_LINE AATL SET AATL.REMARK = '不允许报废' WHERE AATL.TRANS_ID = ? AND AATL.BARCODE NOT IN "+aggBarcodes;
		sqlArgs.add(dto.getTransId());
		sqlModel.setSqlStr(sqlStr);
		sqlModel.setArgs(sqlArgs);
		return sqlModel;
	...
	public SQLModel deleteTransLineRemark(String barcode) {
		...
		TdAssetsTransHeaderDTO dto = (TdAssetsTransHeaderDTO) dtoParameter;
		List sqlArgs = new ArrayList();
        String sqlStr = "UPDATE TD_ASSETS_TRANS_LINE AATL SET AATL.REMARK = NULL  WHERE  AATL.BARCODE = ?";
        sqlArgs.add(barcode);
        sqlModel.setSqlStr(sqlStr);
        sqlModel.setArgs(sqlArgs);
