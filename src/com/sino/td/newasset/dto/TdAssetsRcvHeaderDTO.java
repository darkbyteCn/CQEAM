...
public class TdAssetsRcvHeaderDTO extends CommonRecordDTO {
    ...
    /**
     * 功能：设置调拨资产接收头表(部门间和公司间需要)属性 接收人
     * @param receiveUser String
     */
    ...
    /**
     * 功能：设置调拨资产接收头表(部门间和公司间需要)属性 接收OU
     * @param receiveOrganizationId String
     */
    ...
    /**
     * 功能：获取调拨资产接收头表(部门间和公司间需要)属性 接收人
     * @return String
     */
    ...
    /**
     * 功能：获取调拨资产接收头表(部门间和公司间需要)属性 接收OU
     * @return String
     */
