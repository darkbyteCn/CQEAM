    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws	ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                if (provinceCode.equals(AssetsDictConstant.PROVINCE_CODE_NM)) { //内蒙特有
                ...
                } else if (provinceCode.equals(AssetsDictConstant.PROVINCE_CODE_SX)) { //山西移动
...
//                  String groupPid = headerDAO.findGroupFlowId();(占不用，查找当前用户流程ID)
