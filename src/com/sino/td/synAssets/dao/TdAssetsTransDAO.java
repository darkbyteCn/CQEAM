 ...
 * Function     资产调拨结果同步
 */
public class TdAssetsTransDAO extends AMSBaseDAO {
	 ...
	 */
	public TdAssetsTransDAO(SfUserDTO userAccount, EamSyschronizeDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		super.sqlProducer = new TdAssetsTransModel(user, dto);
	}
	...
	public File getExportFile() throws DataTransException {
        TdAssetsTransModel modelProducer = (TdAssetsTransModel) sqlProducer;
        SQLModel sqlModel = modelProducer.getPageQueryModel();
        String reportTitle = "TD资产调拨结果报表";
