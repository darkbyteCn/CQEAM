 ...
 */
public class TDAssetsUpdateModel extends AMSSQLProducer {
...
/**
	 ...
	 */
	public TDAssetsUpdateModel(SfUserDTO userAccount, TDSrvEamSyschronizeDTO dtoParameter) {
...
/**
	...
	public SQLModel getPageQueryModel() {
		...
		TDSrvEamSyschronizeDTO dto = (TDSrvEamSyschronizeDTO) dtoParameter;
		String sqlStr;
		sqlStr = "SELECT" +
				 "       EII.SYSTEMID,\n" +
				 "       EFA.ASSET_ID,\n" +
				 ...
				 "   AND (EFA.MODEL_NUMBER <> ESI.ITEM_SPEC OR EFA.MANUFACTURER_NAME <> AM.MANUFACTURER_NAME OR EFA.ASSETS_DESCRIPTION <> ESI.ITEM_NAME)\n" +		 
