package com.sino.soa.td.srv.assetbook.model;
 ...
 */
public class SBFIFATdAssetBookModel extends BaseSQLProducer {
	 ...
	 */
	public SBFIFATdAssetBookModel(SfUserDTO userAccount, SBFIFATdAssetBookDTO dtoParameter) {
	...
	public SQLModel getDataCreateModel() {
		...
		SBFIFATdAssetBookDTO srvAssetBookDTO = (SBFIFATdAssetBookDTO)dtoParameter;
	...
	public SQLModel getDataDeleteModel() {
		SQLModel sqlModel = new SQLModel();
		List sqlArgs = new ArrayList();
		SBFIFATdAssetBookDTO srvAssetBook = (SBFIFATdAssetBookDTO)dtoParameter;
