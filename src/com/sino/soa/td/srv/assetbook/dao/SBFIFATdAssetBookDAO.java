package com.sino.soa.td.srv.assetbook.dao;
...
import com.sino.soa.td.srv.assetbook.model.SBFIFATdAssetBookModel;
 ...
 */
public class SBFIFATdAssetBookDAO extends BaseDAO {

    private SfUserDTO sfUser = null;
    private int errorCount = 0;

    public SBFIFATdAssetBookDAO(SfUserDTO userAccount, SBFIFATdAssetBookDTO dtoParameter, Connection conn) {
        super(userAccount, dtoParameter, conn);
        sfUser = userAccount;
    }

    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        SBFIFATdAssetBookDTO dtoPara = (SBFIFATdAssetBookDTO) dtoParameter;
        super.sqlProducer = new SBFIFATdAssetBookModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public int synAssetBook(DTOSet ds) {
        ...
        try {
            ...
            for (int i = 0; i < ds.getSize(); i++) {
                ...
                SBFIFATdAssetBookModel modelProducer = (SBFIFATdAssetBookModel) sqlProducer;
