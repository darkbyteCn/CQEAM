package com.sino.soa.td.srv.PageInquiryAssetDistribution.srv;
...
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdistributionsrv.SBFIFAPageInquiryAssetDistributionSrv;   
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdistributionsrv.SBFIFATDPageInquiryAssetDistributionSrv; 
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdistributionsrv.PageInquiryAssetDistributionSrvOutputItem; 
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdistributionsrv.PageInquiryAssetDistributionSrvRequest; 
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdistributionsrv.PageInquiryAssetDistributionSrvResponse; 
...
public final class TDPageInquiryAssetDistributionSrv {
    ...
    private static final QName SERVICE_NAME = new QName("http://eip.zte.com/SB_FI_FA_PageInquiryAssetDistributionSrv", "SB_FI_FA_TDPageInquiryAssetDistributionSrv");

    public TDPageInquiryAssetDistributionSrv() throws DatatypeConfigurationException {
    }

    public void excute() throws Exception {
        URL wsdlURL = SBFIFATDPageInquiryAssetDistributionSrv.WSDL_LOCATION;
        SBFIFATDPageInquiryAssetDistributionSrv ss = new SBFIFATDPageInquiryAssetDistributionSrv(wsdlURL, SERVICE_NAME);
        ...
        
        {
            ...
            PageInquiryAssetDistributionSrvRequest _process_payload = null;
             MsgHeader msgHeader = new MsgHeader();
	            ...
	            msgHeader.setPAGESIZE(new BigDecimal(2));
        ...
        if (returnMessage.getErrorFlag().equalsIgnoreCase("Y")) {
            ...
            BigDecimal pageSize = new BigDecimal(2);
    ...
    public String toString() {
        ...
        for (int i = 0; i < ds.getSize(); i++) {
            ...
            s = s + "资产账簿:" + dto.getBookTypeCode() + "  资产ID:" + dto.getAssetId() + " 资产标签号:" + dto.getAssetNumber()+"\n";
        }
        return s;
    } 
    
    public static void main(String[] args) throws Exception {
        TDPageInquiryAssetDistributionSrv srv = new TDPageInquiryAssetDistributionSrv();
         srv.setBookTypeCode("SXMC_FA_4187");  //资产账簿名称
         //srv.setAssetNumber("4187-00000002");    //资产标签号 
         srv.excute();
