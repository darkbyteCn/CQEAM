package com.sino.soa.td.srv.pagequiryaccountbalance.model;
 ...
 */
public class SBFIGLTdPageQuiryAccountBalanceModel extends BaseSQLProducer {

	private SfUserDTO sfUser = null;

	public SBFIGLTdPageQuiryAccountBalanceModel(SfUserDTO userAccount, SBFIGLTdPageQuiryAccountBalanceDTO dtoParameter) {
    ...
    public SQLModel getEcouInforModel(String codeCombinationId, String periodName) {
        ...
        String sqlStr = "SELECT * FROM ZTE_TD_ACCOUNT_BALANCE ZGAB WHERE ZGAB.CODE_COMBINATION_ID = CONVERT(FLOAT, ?) AND ZGAB.PERIOD_NAME = ?";
	...
	public SQLModel getDataCreateModel() throws SQLModelException {
		SQLModel sqlModel = new SQLModel();
		List sqlArgs = new ArrayList();
		SBFIGLTdPageQuiryAccountBalanceDTO srvAssetCategory = (SBFIGLTdPageQuiryAccountBalanceDTO)dtoParameter;
		String sqlStr = "INSERT INTO "
			+ " ZTE_TD_ACCOUNT_BALANCE(" 
			+ " ROW_ID,"
			+ " SET_OF_BOOKS,"
			+ " PERIOD_NAME,"
			+ " CURRENCY_CODE,"
	...
	public SQLModel getDataUpdateModel() throws SQLModelException {
		...
		List sqlArgs = new ArrayList();
		SBFIGLTdPageQuiryAccountBalanceDTO srvAssetCategory = (SBFIGLTdPageQuiryAccountBalanceDTO)dtoParameter;
		String sqlStr = "UPDATE ZTE_TD_ACCOUNT_BALANCE"
                    + " SET"
                    + " SET_OF_BOOKS = ?,"
                    + " PERIOD_NAME = ?,"
                    + " CURRENCY_CODE = ?,"
