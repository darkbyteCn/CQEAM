package com.sino.soa.td.srv.pagequiryaccountbalance.srv;
...
import com.sino.soa.td.eip.fi.gl.sb_fi_gl_pageinquiryaccountbalancesrv.SBFIGLPageInquiryAccountBalanceSrv;
import com.sino.soa.td.eip.fi.gl.sb_fi_gl_pageinquiryaccountbalancesrv.SBFIGLPageInquiryAccountBalanceSrvOutputItem;
import com.sino.soa.td.eip.fi.gl.sb_fi_gl_pageinquiryaccountbalancesrv.SBFIGLPageInquiryAccountBalanceSrvRequest;
import com.sino.soa.td.eip.fi.gl.sb_fi_gl_pageinquiryaccountbalancesrv.SBFIGLTDPageInquiryAccountBalanceSrv;
import com.sino.soa.td.eip.fi.gl.sb_fi_gl_pageinquiryaccountbalancesrv.msgheader.MsgHeader;
 ...
 */
public final class SBFIGLTdPageQuiryAccountBalanceSrv {
    ...
    public SBFIGLTdPageQuiryAccountBalanceSrv() throws DatatypeConfigurationException {
    ...
    public void execute() throws CalendarException, DTOException, DatatypeConfigurationException {
        ...
        {
            System.out.println("SB_FI_GL_TDPageInquiryAccountBalanceSrv Invoking process...");
                ...
                for (int i = 1; i < totalPage + 1; i++) {
                    ...
                    if (_process__return.getErrorFlag().equalsIgnoreCase("Y")) {
                        ...
                        for (int k = 0; k < itemList.size(); k++) {
                            ...
                            SBFIGLTdPageQuiryAccountBalanceDTO categoryDTO = new SBFIGLTdPageQuiryAccountBalanceDTO();
    ...
    public static void main(String[] args) throws Exception {
        SBFIGLTdPageQuiryAccountBalanceSrv categorySrv = new SBFIGLTdPageQuiryAccountBalanceSrv();
        categorySrv.setSetOfBooks("SOB_SXMC");
        categorySrv.setPeriodNameFrom("MAR-09");
        categorySrv.setPeriodNameTo("MAR-09");
