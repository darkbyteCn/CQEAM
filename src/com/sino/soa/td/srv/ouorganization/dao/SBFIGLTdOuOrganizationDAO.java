package com.sino.soa.td.srv.ouorganization.dao;
...
import com.sino.soa.td.srv.ouorganization.model.SBFIGLTdOuOrganizationModel;
 ...
 */
public class SBFIGLTdOuOrganizationDAO extends BaseDAO {

	private SfUserDTO sfUser = null;
    private int errorCount = 0;

	public SBFIGLTdOuOrganizationDAO(SfUserDTO userAccount, SBFIGLTdOuOrganizationDTO dtoParameter, Connection conn) {
		super(userAccount, dtoParameter, conn);
		sfUser = userAccount;
	}

	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		SBFIGLTdOuOrganizationDTO dtoPara = (SBFIGLTdOuOrganizationDTO)dtoParameter;
		super.sqlProducer = new SBFIGLTdOuOrganizationModel((SfUserDTO)userAccount, dtoPara);
	}
	...
	public int isSavaOuInfor(DTOSet ds){
        ...
        try {
        	...
        	for (int i =0 ; i < ds.getSize(); i++) {
        		SBFIGLTdOuOrganizationDTO dto = (SBFIGLTdOuOrganizationDTO) ds.getDTO(i);
        		initSQLProducer(sfUser,dto);
        		SBFIGLTdOuOrganizationModel modelProducer = (SBFIGLTdOuOrganizationModel) sqlProducer;
