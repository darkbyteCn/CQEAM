package com.sino.soa.td.srv.valueinfo.model;
 ...
 */
public class SBSYSYTdInquiryVSetValueInfoModel extends BaseSQLProducer {

    private SfUserDTO sfUser = null;

    public SBSYSYTdInquiryVSetValueInfoModel(SfUserDTO userAccount, SBSYSYTdInquiryVSetValueInfoDTO dtoParameter) {
    ...
    public SQLModel getDataCreateModel() throws SQLModelException {
        ...
        try {
            ...
            SBSYSYTdInquiryVSetValueInfoDTO mFndFlexValues = (SBSYSYTdInquiryVSetValueInfoDTO) dtoParameter;
