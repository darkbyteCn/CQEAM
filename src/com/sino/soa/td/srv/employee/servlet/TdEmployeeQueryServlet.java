...
import com.sino.soa.td.srv.employee.dao.TdEmployeeQueryDAO;
 ...
 */
public class TdEmployeeQueryServlet extends BaseServlet {
	/**
	 * 所有的Servlet都必须实现的方法。
	 *
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			SBHRHRSrvTdEmployeeInfoDTO dto = (SBHRHRSrvTdEmployeeInfoDTO) req2DTO.getDTO(req);
			...
			if (action.equals("")) {
                ...
                req.setAttribute(QueryConstant.QUERY_DTO, dto);
				BaseSQLProducer sqlProducer = new TdEmployeeQueryModel(user, dto);
				...
				TdEmployeeQueryDAO exportDAO = new TdEmployeeQueryDAO(user, dto, conn);
