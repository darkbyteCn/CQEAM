package com.sino.soa.td.srv.pagequiryassetcustdetail.srv;
...
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetcustdetailsrv.*;
 ...
 */
public final class SBFIFATdPageinquiryAssetCustDetailSrv {
    ...
    public SBFIFATdPageinquiryAssetCustDetailSrv() throws DatatypeConfigurationException {
    ...
    public void execute() throws CalendarException, DTOException, DatatypeConfigurationException {
        ...
        {
            System.out.println("SB_FI_GL_TDPageinquiryAssetCustDetailSrv Invoking process...");
                ...
                for (int i = 1; i < totalPage + 1; i++) {
                    ...
                    if (_process__return.getErrorFlag().equalsIgnoreCase("Y")) {
                        ...
                        for (int k = 0; k < itemList.size(); k++) {
                            ...
                            SBFIFATdPageinquiryAssetCustDetailDTO categoryDTO = new SBFIFATdPageinquiryAssetCustDetailDTO();
                            ...
                            categoryDTO.setProjectNumber(item.getPROJRCTNUMBER());
                            ...
                            categoryDTO.setEmployeeNumber(item.getEMPLOYEENUMBER());
    ...
    public String toString() {
        ...
        for (int i = 0; i < ds.getSize(); i++) {
            ...
            s = s + dto.getProjectNumber() + "  date:" + dto.getDatePlacedInService() + 
    ...
    public static void main(String[] args) throws Exception {
        SBFIFATdPageinquiryAssetCustDetailSrv categorySrv = new SBFIFATdPageinquiryAssetCustDetailSrv();
        categorySrv.setBookTypeCode("SXMC_FA_8188");
        categorySrv.setProjectNumber("M0981004");
        categorySrv.execute();
        System.out.println(""+categorySrv.toString());
    }
