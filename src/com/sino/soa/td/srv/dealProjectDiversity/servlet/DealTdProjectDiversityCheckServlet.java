package com.sino.soa.td.srv.dealProjectDiversity.servlet;
...
import com.sino.soa.td.srv.dealProjectDiversity.dao.DealTdProjectDiversityCheckDAO;
...
import com.sino.soa.util.dto.SynLogDTO;
	 ...
	 */
public class DealTdProjectDiversityCheckServlet extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            req2DTO.setDTOClassName(DealTdProjectDiversityCheckDTO.class.getName());
            DealTdProjectDiversityCheckDTO dtoParameter = (DealTdProjectDiversityCheckDTO) req2DTO.getDTO(req);
            String action = dtoParameter.getAct();
            conn = getDBConnection(req);
            DealTdProjectDiversityCheckDAO srvAssetCategoryDAO = new DealTdProjectDiversityCheckDAO(user, dtoParameter, conn);
            OrgOptionProducer optionProducer = new OrgOptionProducer(user, conn);
            String range = "Y",misProjectId = "",diffTypeCode = "";//非TD
...
//            diffTypeCode = req.getParameter("diffTypeCode");       //差异类型
            ...
            if (action.equals("")) {
            	forwardURL = "/srv/dealProjectDiversity/dealProjectDiversityCheckTD.jsp";
            } else if (action.equals(SrvWebActionConstant.QUERY_ACTION)) {
            	if(!misProjectId.equals("") && !diffTypeCode.equals("")){
            		BaseSQLProducer sqlProducer = new DealTdProjectDiversityCheckModel(user,dtoParameter);
