package com.sino.soa.td.srv.dealProjectDiversity.model;
 ...
 */
public class DealTdProjectDiversityCheckModel extends BaseSQLProducer {

	private SfUserDTO sfUser = null;

	public DealTdProjectDiversityCheckModel(SfUserDTO userAccount,
			DealTdProjectDiversityCheckDTO dtoParameter) {
	...
	public SQLModel getEcouInforModel(String projectAssetId, String taskId,
		...
		String sqlStr = "SELECT * FROM ZTE_TD_CUST_DETAIL ZFCD WHERE (? = -1 OR ZFCD.PROJECT_ASSET_ID = ? ) AND (? = -1 OR ZFCD.TASK_ID = ? ) AND  (? = -1 OR ZFCD.PROJECT_ID = ? )";
	...
	public SQLModel getDataImpDeleteModel(String projectNum,String bookTypeCode)
		...
		SQLModel sqlModel = new SQLModel();
		List sqlArgs = new ArrayList();
		String sqlStr = "DELETE FROM ETS_TD_CUST_DETAIL_IMP2 WHERE BOOK_TYPE_CODE=? AND CREATE_USER_ID = ? AND PROJRCT_NUMBER= ? ";
	...
	public SQLModel getDataCreateModel() throws SQLModelException {
		...
		String sqlStr = "INSERT INTO " + " ETS_TD_CUST_DETAIL_IMP2("
				+ " TAG_NUMBER,"
				+ " ASSET_NAME,"
				+ " ASSET_DESCRIPTION,"
				+ " MODEL_NUMBER,"
	...
	public SQLModel getDataUpdateModel() throws SQLModelException {
		...
		List sqlArgs = new ArrayList();
		DealTdProjectDiversityCheckDTO srvAssetCategory = (DealTdProjectDiversityCheckDTO) dtoParameter;
		String sqlStr = "UPDATE ZTE_TD_CUST_DETAIL" + " SET"
...
//	}
	...
	public SQLModel getPageQueryModel() throws SQLModelException {
		...
		String sqlStr = "SELECT " 
				...
				+ " WHERE" 
				+ " EDPVE.MIS_PROJECT_ID IN("+srvAssetCategory.getMisProjectId()+")"
				+ " AND EDPVE.BOOK_TYPE_CODE=EOCM.BOOK_TYPE_CODE"  //帐套限制
				+ " AND EOCM.ORGANIZATION_ID=EPPA.ORGANIZATION_ID"//帐套限制
				+ " AND EDPVE.DIFF_TYPE_CODE IN ("+srvAssetCategory.getDiffTypeCode()+")" 
