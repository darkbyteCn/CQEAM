package com.sino.soa.td.srv.pagequiryassetdeprecation.model;
 ...
 */
public class SBFIFATdPageQuiryAssetDeprecationModel extends BaseSQLProducer {

	private SfUserDTO sfUser = null;

	public SBFIFATdPageQuiryAssetDeprecationModel(SfUserDTO userAccount, SBFIFATdPageQuiryAssetDeprecationDTO dtoParameter) {
    ...
    public SQLModel getEcouInforModel(String tagNumber, String periodName) {
        ...
        String sqlStr = "SELECT ZPDD.TAG_NUMBER, ZPDD.PERIOD_NAME FROM ZTE_TD_DEPRN_DETAIL ZPDD WHERE ZPDD.TAG_NUMBER = ? AND ZPDD.PERIOD_NAME = ?";
	...
	public SQLModel getDataCreateModel() throws SQLModelException {
		SQLModel sqlModel = new SQLModel();
		List sqlArgs = new ArrayList();
		SBFIFATdPageQuiryAssetDeprecationDTO srvAssetCategory = (SBFIFATdPageQuiryAssetDeprecationDTO)dtoParameter;
	...
	public SQLModel getDataUpdateModel() throws SQLModelException {
		...
		List sqlArgs = new ArrayList();
		SBFIFATdPageQuiryAssetDeprecationDTO srvAssetCategory = (SBFIFATdPageQuiryAssetDeprecationDTO)dtoParameter;
		String sqlStr = "UPDATE ZTE_TD_DEPRN_DETAIL"
                    + " SET"
                    + " BOOK_TYPE_CODE = ?,"
