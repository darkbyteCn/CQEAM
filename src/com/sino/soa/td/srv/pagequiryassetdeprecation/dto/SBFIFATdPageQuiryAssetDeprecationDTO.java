package com.sino.soa.td.srv.pagequiryassetdeprecation.dto;
 ...
 */
public class SBFIFATdPageQuiryAssetDeprecationDTO extends CheckBoxDTO {
    ...
    private String retirementPendingFlag = "";

    private String OrgOption = "";

    public SBFIFATdPageQuiryAssetDeprecationDTO() {
        super();
    }
    ...
    public void setRetirementPendingFlag(String retirementPendingFlag) {
        this.retirementPendingFlag = retirementPendingFlag;
    }
