package com.sino.soa.td.srv.pagequiryassetdeprecation.srv;
...
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdeprecationsrv.*;
 ...
 */
public final class SBFIFATdPageQuiryAssetDeprecationSrv {

    private static final QName SERVICE_NAME = new QName("http://eip.zte.com/common/fi/SB_FI_FA_PageInquiryAssetDeprecationSrv", "SB_FI_FA_TDPageInquiryAssetDeprecationSrv");
    ...
    public SBFIFATdPageQuiryAssetDeprecationSrv() throws DatatypeConfigurationException {

    }


    public void execute() throws CalendarException, DTOException, DatatypeConfigurationException {
        URL wsdlURL = SBFIFATDPageInquiryAssetDeprecationSrv.WSDL_LOCATION;
        SBFIFATDPageInquiryAssetDeprecationSrv ss = new SBFIFATDPageInquiryAssetDeprecationSrv(wsdlURL, SERVICE_NAME);
        ...
        http.setClient(httpClientPolicy);
        {
            ...
            com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdeprecationsrv.InquiryAssetDeprecationSrvRequest _process_payload = null;
            ...
            com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetdeprecationsrv.InquiryAssetDeprecationSrvResponse _process__return = port.process(_process_payload);
                ...
                for (int i = 1; i < totalPage + 1; i++) {
                    ...
                    if (_process__return.getErrorFlag().equalsIgnoreCase("Y")) {
                        ...
                        for (int k = 0; k < itemList.size(); k++) {
                            ...
                            SBFIFATdPageQuiryAssetDeprecationDTO categoryDTO = new SBFIFATdPageQuiryAssetDeprecationDTO();
...
//                            +"--"+categoryDTO.getSalvageValue()+"--"+categoryDTO.getLifeYears()+"--"+categoryDTO.getRetirementPendingFlag());
    ...
    public static void main(String[] args) throws Exception {
        SBFIFATdPageQuiryAssetDeprecationSrv categorySrv = new SBFIFATdPageQuiryAssetDeprecationSrv();
