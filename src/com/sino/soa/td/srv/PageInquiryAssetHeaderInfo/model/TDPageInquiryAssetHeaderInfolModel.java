package com.sino.soa.td.srv.PageInquiryAssetHeaderInfo.model;
...
public class TDPageInquiryAssetHeaderInfolModel extends BaseSQLProducer {
     ...
     */
    public TDPageInquiryAssetHeaderInfolModel(SfUserDTO userAccount, InquiryAssetHeaderInfoSrvDTO dtoParameter) {
...
//          + " ASSET_ID,"
    ...
    public SQLModel getAssetExistsModel() {
        ...
        String sqlStr = "SELECT"
                + "	ECOM.ASSET_ID"
                + "	FROM ZTE_FA_ASSET_HEADER ECOM WHERE ECOM.ASSET_ID=?";
        sqlModel.setSqlStr(sqlStr);
