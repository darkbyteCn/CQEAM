package com.sino.soa.td.srv.PageInquiryAssetHeaderInfo.srv;
...
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetheaderinfosrv.SBFIFAPageInquiryAssetHeaderInfoSrv;
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetheaderinfosrv.SBFIFATDPageInquiryAssetHeaderInfoSrv;   
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetheaderinfosrv.PageInquiryAssetHeaderInfoSrvOutputItem;
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetheaderinfosrv.PageInquiryAssetHeaderInfoSrvRequest;
import com.sino.soa.td.eip.fi.fa.sb_fi_fa_pageinquiryassetheaderinfosrv.PageInquiryAssetHeaderInfoSrvResponse;
...
public final class TDPageInquiryAssetHeaderInfoSrv {
    ...
    public TDPageInquiryAssetHeaderInfoSrv() throws DatatypeConfigurationException {
    ...
    public String toString() {
        ...
        for (int i = 0; i < ds.getSize(); i++) {
            ...
            s = s + "资产账簿:" + dto.getBookTypeCode() + "  资产ID:" + dto.getAssetId() + " 资产标签号:" + dto.getTagNumber()+"--- "+dto.getDescription()  +"\n";
        }
        return s;
    } 
    
    public static void main(String[] args) throws Exception {
        TDPageInquiryAssetHeaderInfoSrv srv = new TDPageInquiryAssetHeaderInfoSrv();
         srv.setBookTypeCode("SXMC_FA_8187");  //资产账簿名称
         //srv.setLocalionDep("10000002");
         srv.setTagNumber("8187-00000002");    //资产标签号 4187-00000002
        srv.excute();
