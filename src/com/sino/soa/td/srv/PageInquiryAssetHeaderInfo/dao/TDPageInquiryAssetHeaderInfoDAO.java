package com.sino.soa.td.srv.PageInquiryAssetHeaderInfo.dao;
...
import com.sino.soa.td.srv.PageInquiryAssetHeaderInfo.model.TDPageInquiryAssetHeaderInfolModel;
...
public class TDPageInquiryAssetHeaderInfoDAO extends BaseDAO {
     ...
     */
    public TDPageInquiryAssetHeaderInfoDAO(SfUserDTO userAccount, InquiryAssetHeaderInfoSrvDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new TDPageInquiryAssetHeaderInfolModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public int saveRetireAssets(DTOSet ds) {
        ...
        try {
            for (int i = 0; i < ds.getSize(); i++) {
                ...
                TDPageInquiryAssetHeaderInfolModel modelProducer = (TDPageInquiryAssetHeaderInfolModel) sqlProducer;                
                if (!isAssetExists()) {
    ...
    /**
     * 更新资产头信息(ZTE_ 到ETS_FA_ASSET表)
     * @return
     */
    @SuppressWarnings("unused")
	public boolean assetHeaderODI_TD() {
    	boolean isSyn= false;
