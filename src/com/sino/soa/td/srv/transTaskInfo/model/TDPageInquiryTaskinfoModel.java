package com.sino.soa.td.srv.transTaskInfo.model;
 ...
 * @author wangzp
 * function:查询项目任务信息服务(分页)_TD 
 */

public class TDPageInquiryTaskinfoModel extends BaseSQLProducer {

	private SfUserDTO sfUser = null;

	/**
	 * 功能：sinoeam.ZTE_TD_PROJECT_TASK_INFO 数据库SQL构造层构造函数
	 * @param userAccount SfUserDTO 代表本系统的最终操作用户对象
	 * @param dtoParameter SrvTaskinfoDTO 本次操作的数据
	 */
	public TDPageInquiryTaskinfoModel(SfUserDTO userAccount, PageInquiryTaskinfoDTO dtoParameter) {
		super(userAccount, dtoParameter);
		sfUser = userAccount;
	}

	/**
	 * 功能：框架自动生成sinoeam.ZTE_TD_PROJECT_TASK_INFO数据插入SQLModel，请根据实际需要修改。
	...
	/**
	 * 功能：框架自动生成ZTE_TD_PROJECT_TASK_INFO数据更新SQLModel，请根据实际需要修改。
	...
	public SQLModel getDataUpdateModel() throws SQLModelException {
		SQLModel sqlModel = new SQLModel();
			...
			List sqlArgs = new ArrayList();
			PageInquiryTaskinfoDTO srvTaskinfo = (PageInquiryTaskinfoDTO)dtoParameter;
			String sqlStr = "UPDATE ZTE_TD_PROJECT_TASK_INFO"
				+ " SET"
				+ " ORG_ID = ?,"
				+ " ORG_NAME = ?,"
				+ " PROJECT_ID = ?,"
	...
	/**
	 * 功能：框架自动生成sinoeam.ZTE_TD_PROJECT_TASK_INFO数据删除SQLModel，请根据实际需要修改。
	...
	/**
	 * 功能：框架自动生成sinoeam.ZTE_TD_PROJECT_TASK_INFO数据详细信息查询SQLModel，请根据实际需要修改。
	...
	/**
	 * 功能：框架自动生成sinoeam.ZTE_TD_PROJECT_TASK_INFO多条数据信息查询SQLModel，请根据实际需要修改。
	...
	/**
	 * 功能：框架自动生成sinoeam.ZTE_TD_PROJECT_TASK_INFO页面翻页查询SQLModel，请根据实际需要修改。
	...
	public SQLModel existsProjectTaskModel(String taskNumber , String projectNum){
		...
		List sqlArgs = new ArrayList();
		PageInquiryTaskinfoDTO srvTaskinfo = (PageInquiryTaskinfoDTO)dtoParameter;
		String sqlStr ="SELECT * FROM ZTE_TD_PROJECT_TASK_INFO ST WHERE ST.TASK_NUMBER = ? AND ST.SEGMENT1= ?";
