...
public final class SBFIFAInquiryAssetPeriodStatusSrv_SBFIFAInquiryAssetPeriodStatusSrvPort_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        com.sino.soa.mis.eip.fi.fa.sb_fi_fa_inquiryassetperiodstatussrv.inquiryassetperiodstatussrv.InquiryAssetPeriodStatusSrvRequest _process_payload = null;
        com.sino.soa.mis.eip.fi.fa.sb_fi_fa_inquiryassetperiodstatussrv.inquiryassetperiodstatussrv.InquiryAssetPeriodStatusSrvResponse _process__return = port.process(_process_payload);
