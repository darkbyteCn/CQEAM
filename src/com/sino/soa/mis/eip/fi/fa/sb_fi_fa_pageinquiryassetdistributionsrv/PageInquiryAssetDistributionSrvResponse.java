 ...
 *         &lt;element name="PageInquiryAssetDistributionSrvOutputCollection" type="{http://eip.zte.com/SB_FI_FA_PageInquiryAssetDistributionSrv}PageInquiryAssetDistributionSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {
    ...
    "currentpage",
    "instanceid",
    "pageInquiryAssetDistributionSrvOutputCollection"
})
@XmlRootElement(name = "PageInquiryAssetDistributionSrvResponse")
public class PageInquiryAssetDistributionSrvResponse {
    ...
    @XmlElement(name = "PageInquiryAssetDistributionSrvOutputCollection", required = true, nillable = true)
    protected PageInquiryAssetDistributionSrvOutputCollection pageInquiryAssetDistributionSrvOutputCollection;
    ...
    /**
     * Gets the value of the pageInquiryAssetDistributionSrvOutputCollection property.
     * 
     * @return
     *     possible object is
     *     {@link PageInquiryAssetDistributionSrvOutputCollection }
     *     
     */
    public PageInquiryAssetDistributionSrvOutputCollection getPageInquiryAssetDistributionSrvOutputCollection() {
        return pageInquiryAssetDistributionSrvOutputCollection;
    }

    /**
     * Sets the value of the pageInquiryAssetDistributionSrvOutputCollection property.
     * 
     * @param value
     *     allowed object is
     *     {@link PageInquiryAssetDistributionSrvOutputCollection }
     *     
     */
    public void setPageInquiryAssetDistributionSrvOutputCollection(PageInquiryAssetDistributionSrvOutputCollection value) {
        this.pageInquiryAssetDistributionSrvOutputCollection = value;
    }
