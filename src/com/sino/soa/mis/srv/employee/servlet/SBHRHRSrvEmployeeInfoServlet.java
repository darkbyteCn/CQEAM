...
//                employeeInfoSrv.setEmployeeNumber("41260175");
                ...
                if (srvMessage.getErrorFlag().equalsIgnoreCase("Y")) {
                    ...
                    DTOSet ds = employeeInfoSrv.getDs();       //员工信息
                   ...
                   //2.查询员工分配(分页)服务
                    ...
                    //注：此处时间向前提200天
                    //System.out.println("传入时间:"+SynUpdateDateUtils.getDate3(dtoParameter.getStartLastUpdateDate()));
