 ...
 */
public class MisEmployeeQueryDAO extends AMSBaseDAO {

	public MisEmployeeQueryDAO(SfUserDTO userAccount, SBHRHRSrvEmployeeInfoDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		...
		sqlProducer = new MisEmployeeQueryModel(user,dto);
	}

	public File getExportFile() throws DataTransException {
		File file = null;
		try {
			MisEmployeeQueryModel modelProducer = (MisEmployeeQueryModel) sqlProducer;
