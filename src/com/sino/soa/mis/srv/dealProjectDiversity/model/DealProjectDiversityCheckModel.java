package com.sino.soa.mis.srv.dealProjectDiversity.model;
 ...
 */
public class DealProjectDiversityCheckModel extends BaseSQLProducer {

	private SfUserDTO sfUser = null;

	public DealProjectDiversityCheckModel(SfUserDTO userAccount,
			DealProjectDiversityCheckDTO dtoParameter) {
...
//	}
	...
	public SQLModel getPageQueryModel() throws SQLModelException {
		...
		String sqlStr = "SELECT " 
				...
				+ " EDPVE.EAM_VALUE,"
				+ " EPPA.SEGMENT1"
				+ " FROM EAM_DIFF_PA_VS_EII EDPVE,ETS_PA_PROJECTS_ALL EPPA,ETS_OU_CITY_MAP EOCM" 
				+ " WHERE" 
