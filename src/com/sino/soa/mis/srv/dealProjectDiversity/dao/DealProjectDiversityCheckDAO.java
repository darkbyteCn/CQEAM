package com.sino.soa.mis.srv.dealProjectDiversity.dao;
 ...
 */
public class DealProjectDiversityCheckDAO extends BaseDAO {

	private SfUserDTO sfUser = null;

	public DealProjectDiversityCheckDAO(SfUserDTO userAccount,
			DealProjectDiversityCheckDTO dtoParameter, Connection conn) {
		super(userAccount, dtoParameter, conn);
		sfUser = userAccount;
	}

	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		DealProjectDiversityCheckDTO dtoPara = (DealProjectDiversityCheckDTO) dtoParameter;
		super.sqlProducer = new DealProjectDiversityCheckModel(
