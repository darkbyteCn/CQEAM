package com.sino.soa.mis.srv.assettransincompanysrv.model;
 ...
 */
public class SBFIFAAssetsTransInCompanyModel extends AMSSQLProducer {
	private SfUserDTO sfUser = null;

	public SBFIFAAssetsTransInCompanyModel(SfUserDTO userAccount, SBFIFAAssetsTransInCompanyDTO dtoParameter) {
	...
	public SQLModel getPageQueryModel() {
        ...
        if (!dto.getTransferType().equals("OTHER")) {
            sqlStr = "SELECT\n" +
                 ...
                 "       AME1.EMPLOYEE_ID NEW_USER,\n" +
                 "       AME1.USER_NAME NEW_USER_NAME,\n" +
                 "       AMD1.DEPT_CODE NEW_DEPT,\n" +
                 ...
                 "       EO1.WORKORDER_OBJECT_LOCATION OLD_ASSETS_LOCATION,\n" +
                 "       AME2.EMPLOYEE_ID OLD_USER,\n" +
                 "       AME2.USER_NAME OLD_USER_NAME,\n" +
                 ...
                 "       AND ASTL.RESPONSIBILITY_USER = AME1.EMPLOYEE_ID\n" +
                 "       AND ASTL.RESPONSIBILITY_DEPT *= AMD1.DEPT_CODE\n" +
                 "       AND EII.ADDRESS_ID = AOA.ADDRESS_ID\n" +
                 "       AND ASTL.ASSIGNED_TO_LOCATION = EO.WORKORDER_OBJECT_NO\n" +
                 "       AND ASTL.OLD_LOCATION = EO1.WORKORDER_OBJECT_NO\n" +
                 "       AND EII.SYSTEMID = EIM.SYSTEMID\n" +
                 "       AND EIM.ASSET_ID = EFA.ASSET_ID\n" +
                 "       AND ASTL.OLD_RESPONSIBILITY_USER *=AME2.EMPLOYEE_ID\n" +
	...
	public SQLModel getSynAssModel(String systemId) {
        ...
        if (!dto.getTransferType().equals("OTHER")) {
            sqlStr = "SELECT\n" +
                 ...
                 "       EFA.TAG_NUMBER OLD_BARDOE,\n" +
                 "       EFA.ASSET_NUMBER,\n" +
                 "       EO1.WORKORDER_OBJECT_LOCATION OLD_ASSETS_DESCRIPTION,\n" +
                 "       EFA.MODEL_NUMBER OLD_MODEL_NUMBER,\n" +
                 "       EO1.WORKORDER_OBJECT_LOCATION OLD_ASSETS_LOCATION,\n" +
                 "       AME2.EMPLOYEE_ID OLD_USER,\n" +
                 "       AME2.USER_NAME OLD_USER_NAME,\n" +
    ...
    public SQLModel getAutoSynAssModel() {
        ...
        String sqlStr = "SELECT EII.SYSTEMID,\n" +
                ...
                "       EFA.TAG_NUMBER OLD_BARDOE,\n" +
                "       EFA.ASSET_NUMBER,\n" +
                "       EO1.WORKORDER_OBJECT_NAME OLD_ASSETS_DESCRIPTION,\n" +
                "       EFA.MODEL_NUMBER OLD_MODEL_NUMBER,\n" +
                "       EO1.WORKORDER_OBJECT_LOCATION OLD_ASSETS_LOCATION,\n" +
                "       AME2.EMPLOYEE_ID OLD_USER,\n" +
                "       AME2.USER_NAME OLD_USER_NAME,\n" +
