package com.sino.soa.mis.srv.InquiryRetiredAssetDetail.dao;
...
import com.sino.soa.mis.srv.InquiryRetiredAssetDetail.model.PageRetiredAssetDetailModel;
...
public class PagRetiredAssetDetailDAO extends BaseDAO {
     ...
     */
    public PagRetiredAssetDetailDAO(SfUserDTO userAccount, PageRetiredAssetDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new PageRetiredAssetDetailModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public int saveRetireAssets(DTOSet ds) {
        ...
        try {
            for (int i = 0; i < ds.getSize(); i++) {
                ...
                PageRetiredAssetDetailModel modelProducer = (PageRetiredAssetDetailModel) sqlProducer;                
                if (!isAssetExists()) {
