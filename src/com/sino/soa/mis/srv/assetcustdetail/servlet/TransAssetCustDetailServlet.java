package com.sino.soa.mis.srv.assetcustdetail.servlet;
 ...
 * @author wangzp
 * function:查询转资物料清单_非TD(ODI) 
 */

public class TransAssetCustDetailServlet extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                long start = System.currentTimeMillis();
                String envCode = SynUpdateDateUtils.getEnvCode("TransMetaCustDetailSrv", conn);
