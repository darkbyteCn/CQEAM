package com.sino.soa.mis.srv.vendor.dao;
...
import com.sino.soa.mis.srv.vendor.model.SrvVendorInfoModel;
...
public class SrvVendorInfoDAO extends BaseDAO {
	 ...
	 */
	public SrvVendorInfoDAO(SfUserDTO userAccount, SrvVendorInfoDTO dtoParameter, Connection conn) {
	...
	protected void initSQLProducer(BaseUserDTO  userAccount, DTO dtoParameter) { 
		SrvVendorInfoDTO dtoPara = (SrvVendorInfoDTO)dtoParameter;
		super.sqlProducer = new SrvVendorInfoModel((SfUserDTO)userAccount, dtoPara);
	}
	
	/**
	 * 功能：对供应商信息的更新是否成功。
	 * @param DTOSet ds SOA传入的数据  条件:在最后一次更新时间早于 当前时间之间才可更新
	 */
	public int synVendorInfo(DTOSet ds){
        ...
        try {
        	...
        	for (int i =0 ; i < ds.getSize(); i++) {
        		...
        		SrvVendorInfoModel modelProducer = (SrvVendorInfoModel) sqlProducer;
        		 
        		if(SynUpdateDateUtils.getBetweenDays(SynUpdateDateUtils.getLastUpdateDate(SrvType.SRV_VENDOR, conn),(dto.getLastUpdateDate().toString()))>0){
