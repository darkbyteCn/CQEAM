package com.sino.soa.mis.srv.assetcategory.srv;
...
import com.sino.soa.mis.eip.fi.fa.sb_fi_fa_pageinquiryassetcategorysrv.*;
 ...
 */
public final class SBFIFAInquiryAssetCategorySrv {
    ...
    public SBFIFAInquiryAssetCategorySrv() throws DatatypeConfigurationException {
                ...
                for (int i = 1; i < totalPage + 1; i++) {
                    ...
                    if (_process__return.getErrorFlag().equalsIgnoreCase("Y")) {
                        ...
                        for (int k = 0; k < itemList.size(); k++) {
                            ...
                            SBFIFASrvAssetCategoryDTO categoryDTO = new SBFIFASrvAssetCategoryDTO();
            ...
            if (_process__return.getErrorFlag().equalsIgnoreCase("Y")) {
                ...
                for (int i = 1; i < totalPage + 1; i++) {
                    ...
                    if (_process__return.getErrorFlag().equalsIgnoreCase("Y")) {
                        ...
                        for (int k = 0; k < itemList.size(); k++) {
                            PageInquiryAssetCategorySrvOutputItem item = itemList.get(k);
                            String sengments = item.getSEGMENT1()+"."+item.getSEGMENT2()+"."+item.getSEGMENT3();
                            System.out.println(sengments);
                            if (!map.containsValue(sengments)) {
                                map.put("category"+k, sengments);
                            }
                        }
...
//                        }
    ...
    public static void main(String[] args) throws Exception {
        SBFIFAInquiryAssetCategorySrv categorySrv = new SBFIFAInquiryAssetCategorySrv();
        categorySrv.cal();
    }
