package com.sino.soa.mis.srv.assetcategory.dao;
...
import com.sino.soa.mis.srv.assetcategory.model.SBFIFASrvAssetCategoryModel;
 ...
 */
public class SBFIFASrvAssetCategoryDAO extends BaseDAO {

	private SfUserDTO sfUser = null;
    private int errorCount = 0;

	public SBFIFASrvAssetCategoryDAO(SfUserDTO userAccount, SBFIFASrvAssetCategoryDTO dtoParameter, Connection conn) {
		super(userAccount, dtoParameter, conn);
		sfUser = userAccount;
	}

	protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
		SBFIFASrvAssetCategoryDTO dtoPara = (SBFIFASrvAssetCategoryDTO)dtoParameter;
		super.sqlProducer = new SBFIFASrvAssetCategoryModel((SfUserDTO)userAccount, dtoPara);
	}
	...
	public int SavaAssetCategory(DTOSet ds){
        ...
        try {
        	...
        	for (int i =0 ; i < ds.getSize(); i++) {
        		...
        		SBFIFASrvAssetCategoryDTO dto = (SBFIFASrvAssetCategoryDTO) ds.getDTO(i);
        		initSQLProducer(sfUser,dto);
        		SBFIFASrvAssetCategoryModel modelProducer = (SBFIFASrvAssetCategoryModel) sqlProducer;
