package com.sino.soa.mis.srv.assetretire.model;
 ...
 * DSC : 资产报废同步
 */
public class AssetRetirementModel extends AMSSQLProducer {
    private AssetRetirementDTO dto = null;

    public AssetRetirementModel(BaseUserDTO userAccount, AssetRetirementDTO dtoParameter) {
