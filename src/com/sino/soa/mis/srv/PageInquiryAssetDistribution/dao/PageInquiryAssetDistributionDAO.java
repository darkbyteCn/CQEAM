package com.sino.soa.mis.srv.PageInquiryAssetDistribution.dao;
...
import com.sino.soa.mis.srv.PageInquiryAssetDistribution.model.PageInquiryAssetDistributionlModel;   
...
public class PageInquiryAssetDistributionDAO extends BaseDAO {
     ...
     */
    public PageInquiryAssetDistributionDAO(SfUserDTO userAccount, InquiryAssetDistributionDTO dtoParameter, Connection conn) {
    ...
    protected void initSQLProducer(BaseUserDTO userAccount, DTO dtoParameter) {
        ...
        super.sqlProducer = new PageInquiryAssetDistributionlModel((SfUserDTO) userAccount, dtoPara);
    }
    ...
    public int saveRetireAssets(DTOSet ds) {
        ...
        try {
            for (int i = 0; i < ds.getSize(); i++) {
                ...
                PageInquiryAssetDistributionlModel modelProducer = (PageInquiryAssetDistributionlModel) sqlProducer;                
                if (!isAssetExists()) {
	...
	public boolean assetDistributionODI() {
    	boolean isSyn= false;
