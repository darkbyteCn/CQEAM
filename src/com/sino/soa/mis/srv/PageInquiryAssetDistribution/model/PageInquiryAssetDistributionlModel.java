package com.sino.soa.mis.srv.PageInquiryAssetDistribution.model;
...
public class PageInquiryAssetDistributionlModel extends BaseSQLProducer {
     ...
     */
    public PageInquiryAssetDistributionlModel(SfUserDTO userAccount, InquiryAssetDistributionDTO dtoParameter) {
    ...
    public SQLModel getAssetExistsModel() {
        ...
        String sqlStr = "SELECT"
                + "	ECOM.ASSET_ID"
                + "	FROM ZTE_FA_ASSET_DISTRIBUTION ECOM WHERE ECOM.ASSET_ID=?";
        sqlModel.setSqlStr(sqlStr);
