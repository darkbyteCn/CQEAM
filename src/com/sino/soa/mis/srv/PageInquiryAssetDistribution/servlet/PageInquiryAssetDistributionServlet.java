package com.sino.soa.mis.srv.PageInquiryAssetDistribution.servlet;
...
import com.sino.soa.mis.srv.PageInquiryAssetDistribution.dao.PageInquiryAssetDistributionDAO;    
import com.sino.soa.mis.srv.PageInquiryAssetDistribution.dto.InquiryAssetDistributionDTO;     
import com.sino.soa.mis.srv.PageInquiryAssetDistribution.srv.PageInquiryAssetDistributionSrv; 
...
public class PageInquiryAssetDistributionServlet extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            PageInquiryAssetDistributionDAO retiredAssetDetailDAO = new PageInquiryAssetDistributionDAO(user, dtoParameter, conn);
            AssetsOptProducer optProducer = new AssetsOptProducer(user, conn);
            String opt = optProducer.getBookTypeOption(dtoParameter.getBookTypeCode());
            dtoParameter.setOrgOption(opt);
            if (action.equals("")) {
            	req.setAttribute(QueryConstant.QUERY_DTO, dtoParameter);
                forwardURL = SrvURLDefineList.SRV_ASSET_DISTRIBUTION_PAGE;
            } else if (action.equals(SrvWebActionConstant.QUERY_ACTION)) {
            	PageInquiryAssetDistributionSrv service = new PageInquiryAssetDistributionSrv();
               ...
               boolean isSyn=retiredAssetDetailDAO.assetDistributionODI();
         	    message=new Message();
               if(isSyn){
                   message.setMessageValue("调用'资产分配行信息'存储过程成功!"); 
               }else{
            	   message.setMessageValue("调用'资产分配行信息'存储过程失败！请检查!"); 
               }
           	    req.setAttribute(QueryConstant.QUERY_DTO, dtoParameter);
                forwardURL = SrvURLDefineList.SRV_ASSET_DISTRIBUTION_PAGE;
