...
import com.sino.nm.ams.instrument.dao.AmsInstrumentEamYbChkTaskDAO;
import com.sino.nm.ams.instrument.dto.AmsInstrumentEamYbChkTaskDTO;
import com.sino.nm.ams.instrument.model.AmsInstrumentEamYbChkTaskModel;
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res)
		...
		try{
			...
			if(action.equals("")){
				...
				forwardURL = "/nm/instrument/instrumentTaskQuery.jsp";
				...
				forwardURL = "/nm/instrument/instrumentTaskAdd.jsp?taskId=" + taskId;
				...
				req.setAttribute(QueryConstant.QUERY_DTO, dto);
				forwardURL = "/nm/instrument/instrumentTaskDetail.jsp";
