...
import com.sino.nm.ams.instrument.dao.AmsInstrumentEamYbChkMaintainDAO;
...
//			String cityOption1 = op.getAllOrganization("", true);
			String cityOption1 = op.getAllOrganization(dto.getOrganizationId(), true);			
			req.setAttribute(WebAttrConstant.CITY_OPTION, cityOption1);
			if (action.equals("")) {
				req.setAttribute(QueryConstant.QUERY_DTO, dto);
				forwardURL = "/nm/instrument/instrumentYbChkMaintain.jsp";
...
//				String taskId = req.getParameter("taskId");
				...
				forwardURL = "/servlet/com.sino.nm.ams.instrument.servlet.AmsInstrumentEamYbChkMaintainServlet?act=" + WebActionConstant.QUERY_ACTION;
			} else {
