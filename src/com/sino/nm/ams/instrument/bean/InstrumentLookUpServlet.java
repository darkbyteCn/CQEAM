		...
		try {
			if (lookUpName.equals("")) {
				...
				if(lookUpName.equals(InstrumentLookUpConstant.LOOK_UP_CHECK_USER)){ //选择检修人
					dispNames = new String[] {"LOGIN_NAME", "USERNAME"};
					dispLabels = new String[] {"登录名", "检修人姓名"};
					viewPercent = new String[] {"30%", "40%"};
					retFields = new String[] {"USER_ID", "LOGIN_NAME", "USERNAME"};
					qryNames = new String[] {"LOGIN_NAME", "USERNAME"};
					qryLabels = new String[] {"登录名", "检修人姓名"};
					primaryKeys = new String[] {"LOGIN_NAME"};
