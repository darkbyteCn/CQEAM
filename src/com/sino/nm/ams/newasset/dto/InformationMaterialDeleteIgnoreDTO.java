...
public class InformationMaterialDeleteIgnoreDTO extends CommonRecordDTO {
	...
	public String getInportantLevel() {
		return inportantLevel;
	}

	public void setInportantLevel(String inportantLevel) {
		this.inportantLevel = inportantLevel;
	}
