...
import com.sino.nm.ams.others.dao.NobarcodeDAO;
import com.sino.nm.ams.others.dao.NoBarcodeLDAO;
import com.sino.nm.ams.others.dao.DeptItemBarcodeDAO;
import com.sino.nm.ams.others.model.NobarcodeModel;
 ...
 */
public class DeptItemBarcodeOutServlet extends BaseServlet {
     public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/nm/others/deptBarcodeQuery.jsp?transType="+ DictConstant.TMCK;
...
//                amsItemTransH.setTransType(DictConstant.TMRK);
                ...
                forwardURL = "/nm/others/deptBarcodeOut.jsp";
            } else if (action.equals(WebActionConstant.DETAIL_ACTION)) {
                itemTransHDAO.setCalPattern(CalendarConstant.LINE_PATTERN);
                ...
                req.setAttribute("AIT_LINES", ldao.getDeptLines(amsItemTransH.getTransId()));
                forwardURL = "/nm/others/deptBarcodeOut.jsp";
                ...
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.nm.ams.others.servlet.DeptItemBarcodeOutServlet?act=" + WebActionConstant.DETAIL_ACTION
                ...
                message.setIsError(!operateResult);
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.nm.ams.others.servlet.DeptItemBarcodeOutServlet?act=" + WebActionConstant.QUERY_ACTION;
