 ...
 */
public class DeptNoBarcodeServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/nm/others/deptNoBarcodeQuery.jsp";
...
//                amsItemTransH.setTransType(DictConstant.TMRK);
                ...
                forwardURL = "/nm/others/deptNoBarcode.jsp";
                ...
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeServlet?act=" + WebActionConstant.DETAIL_ACTION
                ...
                message.setIsError(!operateResult);
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeServlet?act=" + WebActionConstant.QUERY_ACTION;
