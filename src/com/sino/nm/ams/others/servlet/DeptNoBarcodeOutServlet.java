 ...
 */
public class DeptNoBarcodeOutServlet extends BaseServlet {
     public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/nm/others/DeptNoBarcodeOutQuery.jsp";
...
//                amsItemTransH.setTransType(DictConstant.TMRK);
                ...
                forwardURL = "/nm/others/DeptNoBarcodeOut.jsp";
                ...
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeOutServlet?act=" + WebActionConstant.DETAIL_ACTION
                ...
                message.setIsError(!operateResult);
                if (operateResult) {
                    forwardURL = "/servlet/com.sino.nm.ams.others.servlet.DeptNoBarcodeOutServlet?act=" + WebActionConstant.QUERY_ACTION;
