package com.sino.nm.ams.inv.storeman.servlet;
...
import com.sino.nm.ams.inv.storeman.base.constant.web.WebInvActionConstant;
import com.sino.nm.ams.inv.storeman.bean.StrUtilHave;
import com.sino.nm.ams.inv.storeman.dao.AmsInvPriviDAO;
import com.sino.nm.ams.inv.storeman.dao.EamInvStoremanDAO;
...
public class EamInvStoremanServlet extends BaseServlet {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res)
		...
		try{
			...
			String invCategoryOpt = optProducer.getDictOption("INV_TYPE", dto.getObjectCategory());//仓库类型列表
			...
			if(action.equals("")){
				...
				forwardURL = "/nm/inv/storeman/storemanQuery.jsp";
				...
				forwardURL = "/nm/inv/storeman/addStoreman.jsp?workorderObjectNo=" + workorderObjectNo + "&storemanId=" + storemanId;
				...
				forwardURL = "/nm/inv/storeman/storemanDetail.jsp";
				...
				forwardURL = "/servlet/" + getClass().getName();
				forwardURL += "?act=" + WebActionConstant.QUERY_ACTION;
//				forwardURL = "/servlet/com.sino.nm.ams.inv.storeman.servlet.EamInvStoremanServlet?act=" + WebActionConstant.QUERY_ACTION;
				//isOpener = true;
				...
				//req.setAttribute(QueryConstant.QUERY_DTO, dto);
				//forwardURL = "/nm/inv/storeman/addStoreman.jsp";
				out.flush();
				out.close();
			}
