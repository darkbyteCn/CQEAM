package com.sino.nm.spare2.allot.dao;
...
import com.sino.nm.spare2.allot.model.AmsBjsAllotModel;
    ...
    public void saveLines(DTOSet lines) throws SQLException {
        ...
        try {
            ...
            for (int i = 0; i < lines.getSize(); i++) {
                ...
                cStmt.setString(3, ConvertUtil.int2String(dto.getToOrganizationId()));
