...
import com.sino.nm.spare2.dao.BjdbApproveDAO;
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals(WebActionConstant.DETAIL_ACTION)) {
                ...
                forwardURL = "/spare2/bjdbApprove.jsp";
                ...
                if (!operateResult) {
                    forwardURL = "com.sino.ams.spare2.allot.servlet.AmsBjsAllotServlet?act=approve&transId=" + dtoParameter.getTransId();
                } else {
                    showMsg = "备件分配单已确认!";
                }
