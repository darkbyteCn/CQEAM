package com.sino.nm.spare2.allot.servlet;
...
import com.sino.nm.spare2.allot.dto.AmsBjsAllotDDto;
...
public class AmsBjsAllotServlet extends BaseServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String toOrgId = StrUtil.nullToString(req.getParameter("toOrganizationId"));
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                req.setAttribute("OU_OPTIONS", op.getAllOrganization(ConvertUtil.String2Int(toOrgId)));
                forwardURL = "/spare2/allot/bjfpCreateNew.jsp";
...
//                    req.setAttribute("OU_OPTIONS", op.getAllOrganization(toOrgId));
                ...
                req.setAttribute(WebAttrConstant.ALLOT_H_DTO, dto);
                req.setAttribute(WebAttrConstant.ALLOT_D_DTO, dao.getLines(dto.getTransId()));
                forwardURL = "/spare2/allot/bjfpConfirm.jsp";
                ...
                if (operateResult) {
                    ...
                    if (dtoParameter.getTransId().equals("")) {
                        forwardURL = "/servlet/com.sino.ams.spare2.allot.servlet.AmsBjsAllotServlet?act=";
                    } else {
                        forwardURL = "/servlet/com.sino.ams.spare2.allot.servlet.AmsBjsAllotServlet?act=" + WebActionConstant.DETAIL_ACTION
