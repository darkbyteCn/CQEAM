...
import com.sino.nm.spare2.model.BjswjyckcxModel;
 ...
 *          Date: 2008-6-24
 */
public class BjswyjckcxServlet extends BaseServlet {
    public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("")) {
                ...
                forwardURL = "/nm/spare2/bjswjyckcx.jsp";
            } else if (action.equals(WebActionConstant.QUERY_ACTION)) {
                BaseSQLProducer sqlProducer = new BjswjyckcxModel(user, dtoParameter);
