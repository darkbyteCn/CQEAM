...
public class SfActInfoDTO extends CheckBoxDTO{
	...
	/**
	 * 功能：设置流转过程，在办流转信息属性 ACT文档类型 0:标准, 1:阅示, 2:会签, 3:并流 4.主流(辅流时的主流) 5.辅流 6.子流
	...
	/**
	 * 功能：设置流转过程，在办流转信息属性 SFACT_TASK_DIV_RIGHT
	...
	/**
	 * 功能：设置流转过程，在办流转信息属性 SFACT_TASK_COMMENT_DIV
	...
	/**
	 * 功能：设置流转过程，在办流转信息属性 Bit 0: 0 - 顺序处理 1 - 同时处理 Bit 1: 0 - 等待 1 - 不等待 Bit 2: 0 - 主任务 1 - 阅示任务
	...
	/**
	 * 功能：获取流转过程，在办流转信息属性 ACT文档类型 0:标准, 1:阅示, 2:会签, 3:并流 4.主流(辅流时的主流) 5.辅流 6.子流
	 * @return String
	 */
	...
	/**
	 * 功能：获取流转过程，在办流转信息属性 SFACT_TASK_DIV_RIGHT
	 * @return String
	 */
	...
	/**
	 * 功能：获取流转过程，在办流转信息属性 SFACT_TASK_COMMENT_DIV
	 * @return String
	 */
	...
	/**
	 * 功能：获取流转过程，在办流转信息属性 Bit 0: 0 - 顺序处理 1 - 同时处理 Bit 1: 0 - 等待 1 - 不等待 Bit 2: 0 - 主任务 1 - 阅示任务
	 * @return String
	 */
