...
public class SfActInfoServlet extends BaseServlet {
		...
		try {
			...
			if (action.equals("")) {
				...
				req.setAttribute(WebAttrConstant.PROJECT_OPTION_STR,
						projectOptionStr);
				forwardURL =URLDefineList.TRASK_QUERY_PAGE;
				 ...
				 pageView.produceWebData(sfActInfoModel.getPageQueryModel(req));
				forwardURL =URLDefineList.TRASK_QUERY_PAGE;
			}else if(action.equals(WebActionConstant.DETAIL_ACTION))
			{
//				pageView.produceWebData(sfActInfoModel.getPrimaryKeyDataModel(req));
                pageView.produceWebData(sfActInfoModel.getPrimaryKeyMointingModel(req));
//                forwardURL =URLDefineList.TRASK_DETAIL_PAGE;
                forwardURL = URLDefineList.TRASK_DETAIL_PAGE;
            }else {
