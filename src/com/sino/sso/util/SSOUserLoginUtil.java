...
public class SSOUserLoginUtil {
    ...
    public static void main(String[] args) {
        ...
        SSOUserLoginUtil loginUtil=new SSOUserLoginUtil(configDTO);
        SfUserDTO userDTO=loginUtil.validateUser("40000000");
